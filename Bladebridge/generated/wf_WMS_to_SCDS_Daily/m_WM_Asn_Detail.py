#Code converted on 2023-06-12 20:30:53
import os
...
# read_infa_paramfile('', 'm_WM_Asn_Detail') ProcessingUtils

# COMMAND ----------
# Processing node SQ_Shortcut_to_WM_ASN_DETAIL, type SOURCE 
# COLUMN COUNT: 5

SQ_Shortcut_to_WM_ASN_DETAIL = spark.read.jdbc(os.environ.get('_CONNECT_STRING'), f"""SELECT
WM_ASN_DETAIL.LOCATION_ID,
WM_ASN_DETAIL.WM_ASN_DETAIL_ID,
WM_ASN_DETAIL.WM_CREATED_TSTMP,
WM_ASN_DETAIL.WM_LAST_UPDATED_TSTMP,
WM_ASN_DETAIL.LOAD_TSTMP
FROM WM_ASN_DETAIL
WHERE WM_ASN_DETAIL_ID IN (SELECT ASN_DETAIL_ID FROM WM_ASN_DETAIL_PRE)""", 
properties={
...
SQ_Shortcut_to_WM_ASN_DETAIL_PRE = spark.read.jdbc(os.environ.get('_CONNECT_STRING'), f"""SELECT
WM_ASN_DETAIL_PRE.DC_NBR,
WM_ASN_DETAIL_PRE.ASN_DETAIL_ID,
WM_ASN_DETAIL_PRE.ASN_ID,
WM_ASN_DETAIL_PRE.TC_PURCHASE_ORDERS_ID,
WM_ASN_DETAIL_PRE.PURCHASE_ORDERS_ID,
WM_ASN_DETAIL_PRE.SKU_ID,
WM_ASN_DETAIL_PRE.SKU_NAME,
WM_ASN_DETAIL_PRE.SKU_ATTR_1,
WM_ASN_DETAIL_PRE.SKU_ATTR_2,
WM_ASN_DETAIL_PRE.SKU_ATTR_3,
WM_ASN_DETAIL_PRE.SKU_ATTR_4,
WM_ASN_DETAIL_PRE.SKU_ATTR_5,
WM_ASN_DETAIL_PRE.BUSINESS_PARTNER_ID,
WM_ASN_DETAIL_PRE.PACKAGE_TYPE_ID,
WM_ASN_DETAIL_PRE.PACKAGE_TYPE_DESC,
WM_ASN_DETAIL_PRE.PACKAGE_TYPE_INSTANCE,
WM_ASN_DETAIL_PRE.EPC_TRACKING_RFID_VALUE,
WM_ASN_DETAIL_PRE.ORDER_TYPE_DESC,
WM_ASN_DETAIL_PRE.GTIN,
WM_ASN_DETAIL_PRE.SHIPPED_QTY,
WM_ASN_DETAIL_PRE.STD_PACK_QTY,
WM_ASN_DETAIL_PRE.STD_CASE_QTY,
WM_ASN_DETAIL_PRE.ASN_DETAIL_STATUS,
WM_ASN_DETAIL_PRE.RECEIVED_QTY,
WM_ASN_DETAIL_PRE.STD_SUB_PACK_QTY,
WM_ASN_DETAIL_PRE.LPN_PER_TIER,
WM_ASN_DETAIL_PRE.TIER_PER_PALLET,
WM_ASN_DETAIL_PRE.MFG_DATE,
WM_ASN_DETAIL_PRE.SHIP_BY_DATE,
WM_ASN_DETAIL_PRE.MFG_PLNT,
WM_ASN_DETAIL_PRE.EXPIRE_DATE,
WM_ASN_DETAIL_PRE.INCUBATION_DATE,
WM_ASN_DETAIL_PRE.EPC_REQ_ON_ALL_CASES,
WM_ASN_DETAIL_PRE.WEIGHT_UOM_ID_BASE,
WM_ASN_DETAIL_PRE.REGION_ID,
WM_ASN_DETAIL_PRE.IS_ASSOCIATED_TO_OUTBOUND,
WM_ASN_DETAIL_PRE.IS_CANCELLED,
WM_ASN_DETAIL_PRE.IS_CLOSED,
WM_ASN_DETAIL_PRE.INVN_TYPE,
WM_ASN_DETAIL_PRE.PROD_STAT,
WM_ASN_DETAIL_PRE.BATCH_NBR,
WM_ASN_DETAIL_PRE.CNTRY_OF_ORGN,
WM_ASN_DETAIL_PRE.SHIPPED_LPN_COUNT,
WM_ASN_DETAIL_PRE.RECEIVED_LPN_COUNT,
WM_ASN_DETAIL_PRE.UNITS_ASSIGNED_TO_LPN,
WM_ASN_DETAIL_PRE.PROC_IMMD_NEEDS,
WM_ASN_DETAIL_PRE.QUALITY_CHECK_HOLD_UPON_RCPT,
WM_ASN_DETAIL_PRE.REFERENCE_ORDER_NBR,
WM_ASN_DETAIL_PRE.ACTUAL_WEIGHT,
WM_ASN_DETAIL_PRE.ACTUAL_WEIGHT_PACK_COUNT,
WM_ASN_DETAIL_PRE.NBR_OF_PACK_FOR_CATCH_WT,
WM_ASN_DETAIL_PRE.PUTWY_TYPE,
WM_ASN_DETAIL_PRE.RETAIL_PRICE,
WM_ASN_DETAIL_PRE.PRICE_TIX_AVAIL,
WM_ASN_DETAIL_PRE.CREATED_SOURCE_TYPE,
WM_ASN_DETAIL_PRE.CREATED_SOURCE,
WM_ASN_DETAIL_PRE.CREATED_DTTM,
WM_ASN_DETAIL_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_ASN_DETAIL_PRE.LAST_UPDATED_SOURCE,
WM_ASN_DETAIL_PRE.LAST_UPDATED_DTTM,
WM_ASN_DETAIL_PRE.HIBERNATE_VERSION,
WM_ASN_DETAIL_PRE.TC_COMPANY_ID,
WM_ASN_DETAIL_PRE.TC_PO_LINE_ID,
WM_ASN_DETAIL_PRE.INVENTORY_SEGMENT_ID,
WM_ASN_DETAIL_PRE.PPACK_GRP_CODE,
WM_ASN_DETAIL_PRE.CUT_NBR,
WM_ASN_DETAIL_PRE.QTY_CONV_FACTOR,
WM_ASN_DETAIL_PRE.QTY_UOM_ID,
WM_ASN_DETAIL_PRE.WEIGHT_UOM_ID,
WM_ASN_DETAIL_PRE.QTY_UOM_ID_BASE,
WM_ASN_DETAIL_PRE.TC_ORDER_ID,
WM_ASN_DETAIL_PRE.ORDER_ID,
WM_ASN_DETAIL_PRE.TC_ORDER_LINE_ID,
WM_ASN_DETAIL_PRE.ORDER_LINE_ITEM_ID,
WM_ASN_DETAIL_PRE.SEQ_NBR,
WM_ASN_DETAIL_PRE.EXP_RECEIVE_CONDITION_CODE,
WM_ASN_DETAIL_PRE.ASN_RECV_RULES,
WM_ASN_DETAIL_PRE.CHECKSUM,
WM_ASN_DETAIL_PRE.ACTUAL_WEIGHT_RECEIVED,
WM_ASN_DETAIL_PRE.REF_FIELD_1,
WM_ASN_DETAIL_PRE.REF_FIELD_3,
WM_ASN_DETAIL_PRE.REF_FIELD_2,
WM_ASN_DETAIL_PRE.REF_FIELD_4,
WM_ASN_DETAIL_PRE.REF_FIELD_5,
WM_ASN_DETAIL_PRE.REF_FIELD_6,
WM_ASN_DETAIL_PRE.REF_FIELD_7,
WM_ASN_DETAIL_PRE.REF_FIELD_8,
WM_ASN_DETAIL_PRE.REF_FIELD_9,
WM_ASN_DETAIL_PRE.REF_FIELD_10,
WM_ASN_DETAIL_PRE.REF_NUM1,
WM_ASN_DETAIL_PRE.REF_NUM2,
WM_ASN_DETAIL_PRE.REF_NUM3,
WM_ASN_DETAIL_PRE.REF_NUM4,
WM_ASN_DETAIL_PRE.REF_NUM5,
WM_ASN_DETAIL_PRE.DISPOSITION_TYPE,
WM_ASN_DETAIL_PRE.PRE_RECEIPT_STATUS,
WM_ASN_DETAIL_PRE.INV_DISPOSITION,
WM_ASN_DETAIL_PRE.EXT_PLAN_ID,
WM_ASN_DETAIL_PRE.PURCHASE_ORDERS_LINE_ITEM_ID,
WM_ASN_DETAIL_PRE.PROCESSED_FOR_TRLR_MOVES
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
	...
	"FIL_UNCHANGED_RECORDS___EXPIRE_DATE as EXPIRE_DATE", \
	"FIL_UNCHANGED_RECORDS___INCUBATION_DATE as INCUBATION_DATE", \
	"decode ( ltrim ( rtrim ( upper ( FIL_UNCHANGED_RECORDS___EPC_REQ_ON_ALL_CASES ) ) ) , '1','1' , 'Y','1','0' ) as EPC_REQ_ON_ALL_CASES_EXP", \
	"FIL_UNCHANGED_RECORDS___WEIGHT_UOM_ID_BASE as WEIGHT_UOM_ID_BASE", \
	"FIL_UNCHANGED_RECORDS___REGION_ID as REGION_ID", \
	"FIL_UNCHANGED_RECORDS___IS_ASSOCIATED_TO_OUTBOUND as IS_ASSOCIATED_TO_OUTBOUND", \
	"FIL_UNCHANGED_RECORDS___IS_CANCELLED as IS_CANCELLED", \
	...
	"FIL_UNCHANGED_RECORDS___RECEIVED_LPN_COUNT as RECEIVED_LPN_COUNT", \
	"FIL_UNCHANGED_RECORDS___UNITS_ASSIGNED_TO_LPN as UNITS_ASSIGNED_TO_LPN", \
	"decode ( ltrim ( rtrim ( upper ( FIL_UNCHANGED_RECORDS___PROC_IMMD_NEEDS ) ) ) , '1','1' , 'Y','1','0' ) as PROC_IMMD_NEEDS_EXP", \
	...
	"FIL_UNCHANGED_RECORDS___PUTWY_TYPE as PUTWY_TYPE", \
	"FIL_UNCHANGED_RECORDS___RETAIL_PRICE as RETAIL_PRICE", \
	"decode ( ltrim ( rtrim ( upper ( FIL_UNCHANGED_RECORDS___PRICE_TIX_AVAIL ) ) ) , '1','1' , 'Y','1','0' ) as PRICE_TIX_AVAIL_EXP", \
	"FIL_UNCHANGED_RECORDS___CREATED_SOURCE_TYPE as CREATED_SOURCE_TYPE", \
	"FIL_UNCHANGED_RECORDS___CREATED_SOURCE as CREATED_SOURCE", \
	"FIL_UNCHANGED_RECORDS___CREATED_DTTM as CREATED_DTTM", \
	"FIL_UNCHANGED_RECORDS___LAST_UPDATED_SOURCE_TYPE as LAST_UPDATED_SOURCE_TYPE", \
...
Shortcut_to_WM_ASN_DETAIL1 = UPD_INS_UPD.selectExpr( \
	...
	"CAST(TC_ORDER_ID AS VARCHAR) as WM_TC_ORDER_ID", \
	"CAST(TC_ORDER_LINE_ID AS VARCHAR) as WM_TC_ORDER_LINE_ID", \
	"CAST(TC_PURCHASE_ORDERS_ID AS VARCHAR) as WM_TC_PURCHASE_ORDERS_ID", \
	"CAST(TC_PO_LINE_ID AS VARCHAR) as WM_TC_PO_LINE_ID", \
	...
	"CAST(CUT_NBR AS VARCHAR) as WM_CUT_NBR", \
	"CAST(BATCH_NBR AS VARCHAR) as WM_BATCH_NBR", \
	"CAST(SEQ_NBR AS VARCHAR) as WM_SEQ_NBR", \
	"CAST(ORDER_TYPE_DESC AS VARCHAR) as WM_ORDER_TYPE_DESC", \
	"CAST(REFERENCE_ORDER_NBR AS VARCHAR) as WM_REFERENCE_ORDER_NBR", \
	"CAST(BUSINESS_PARTNER_ID AS VARCHAR) as WM_BUSINESS_PARTNER_ID", \
	"CAST(PACKAGE_TYPE_ID AS BIGINT) as WM_PACKAGE_TYPE_ID", \
	"CAST(PACKAGE_TYPE_DESC AS VARCHAR) as WM_PACKAGE_TYPE_DESC", \
	"CAST(PACKAGE_TYPE_INSTANCE AS VARCHAR) as WM_PACKAGE_TYPE_INSTANCE", \
	"CAST(EPC_TRACKING_RFID_VALUE AS VARCHAR) as WM_EPC_TRACKING_RFID_VALUE", \
	"CAST(PRE_RECEIPT_STATUS AS VARCHAR) as WM_PRE_RECEIPT_STATUS", \
	"CAST(INVN_TYPE AS VARCHAR) as WM_INVN_TYPE", \
	"CAST(PUTWY_TYPE AS VARCHAR) as WM_PUTWY_TYPE", \
	"CAST(PROD_STAT AS VARCHAR) as WM_PROD_STAT", \
	"CAST(MFG_PLNT AS VARCHAR) as MFG_PLNT", \
	"CAST(REGION_ID AS BIGINT) as WM_REGION_ID", \
	"CAST(CNTRY_OF_ORGN AS VARCHAR) as COUNTRY_OF_ORIGIN", \
	"CAST(INVENTORY_SEGMENT_ID AS BIGINT) as WM_INVENTORY_SEGMENT_ID", \
	"CAST(INV_DISPOSITION AS VARCHAR) as WM_INV_DISPOSITION", \
	"CAST(PPACK_GRP_CODE AS VARCHAR) as WM_PPACK_GRP_CD", \
	"CAST(EXP_RECEIVE_CONDITION_CODE AS VARCHAR) as WM_EXP_RECEIVE_CONDITION_CD", \
	"CAST(ASN_RECV_RULES AS VARCHAR) as ASN_RECV_RULES", \
	"CAST(DISPOSITION_TYPE AS VARCHAR) as WM_DISPOSITION_TYPE", \
	"CAST(EXT_PLAN_ID AS VARCHAR) as WM_EXT_PLAN_ID", \
	...
	"CAST(EPC_REQ_ON_ALL_CASES AS BIGINT) as EPC_REQ_ON_ALL_CASES_FLAG", \
	"CAST(IS_ASSOCIATED_TO_OUTBOUND AS BIGINT) as ASSOCIATED_TO_OUTBOUND_FLAG", \
	"CAST(PROCESSED_FOR_TRLR_MOVES AS BIGINT) as WM_PROCESSED_FOR_TRLR_MOVES_FLAG", \
	"CAST(PROC_IMMD_NEEDS AS BIGINT) as PROCESS_IMMEDIATE_NEEDS_FLAG", \
	"CAST(QUALITY_CHECK_HOLD_UPON_RCPT AS BIGINT) as QUALITY_CHECK_HOLD_UPON_RCPT_FLAG", \
	"CAST(PRICE_TIX_AVAIL AS BIGINT) as PRICE_TIX_AVAIL_FLAG", \
	"CAST(SKU_ID AS BIGINT) as WM_SKU_ID", \
	"CAST(SKU_NAME AS VARCHAR) as WM_SKU_NAME", \
	"CAST(GTIN AS VARCHAR) as GTIN", \
	"CAST(SKU_ATTR_1 AS VARCHAR) as WM_SKU_ATTR_1", \
	"CAST(SKU_ATTR_2 AS VARCHAR) as WM_SKU_ATTR_2", \
	"CAST(SKU_ATTR_3 AS VARCHAR) as WM_SKU_ATTR_3", \
	"CAST(SKU_ATTR_4 AS VARCHAR) as WM_SKU_ATTR_4", \
	"CAST(SKU_ATTR_5 AS VARCHAR) as WM_SKU_ATTR_5", \
	"CAST(RETAIL_PRICE AS BIGINT) as RETAIL_PRICE", \
	"CAST(UNITS_ASSIGNED_TO_LPN AS BIGINT) as UNITS_ASSIGNED_TO_LPN", \
	"CAST(SHIPPED_LPN_COUNT AS BIGINT) as SHIPPED_LPN_CNT", \
	"CAST(RECEIVED_LPN_COUNT AS BIGINT) as RECEIVED_LPN_CNT", \
	...
	"CAST(ACTUAL_WEIGHT_PACK_COUNT AS BIGINT) as ACTUAL_WEIGHT_PACK_CNT", \
	...
	"CAST(REF_FIELD_1 AS VARCHAR) as REF_FIELD_1", \
	"CAST(REF_FIELD_2 AS VARCHAR) as REF_FIELD_2", \
	"CAST(REF_FIELD_31 AS VARCHAR) as REF_FIELD_3", \
	"CAST(REF_FIELD_4 AS VARCHAR) as REF_FIELD_4", \
	"CAST(REF_FIELD_5 AS VARCHAR) as REF_FIELD_5", \
	"CAST(REF_FIELD_6 AS VARCHAR) as REF_FIELD_6", \
	"CAST(REF_FIELD_7 AS VARCHAR) as REF_FIELD_7", \
	"CAST(REF_FIELD_8 AS VARCHAR) as REF_FIELD_8", \
	"CAST(REF_FIELD_9 AS VARCHAR) as REF_FIELD_9", \
	"CAST(REF_FIELD_10 AS VARCHAR) as REF_FIELD_10", \
