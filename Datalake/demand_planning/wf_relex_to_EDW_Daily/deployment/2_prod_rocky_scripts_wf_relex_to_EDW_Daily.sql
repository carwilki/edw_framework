...
, 'EDW_PRD' --source_db
, 'DP_FORECAST_WEEK_HIST' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'DP_FORECAST_WEEK_HIST_history' --target_table_name
, 'full' --load_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'DP_ACCURACY_DAY_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Export_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'DP_PRODUCT_LOCATION_SETTINGS_HIST' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'DP_PRODUCT_LOCATION_SETTINGS_HIST_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'DP_DEMAND_DAY_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Export_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'DP_ORDER_PROJECTION_DAY_HIST' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'DP_ORDER_PROJECTION_DAY_HIST_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Export_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'DP_ORDER_PROJECTION_WEEK_HIST' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'DP_ORDER_PROJECTION_WEEK_HIST_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
