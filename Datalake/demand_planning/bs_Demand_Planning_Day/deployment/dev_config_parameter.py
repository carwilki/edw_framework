...
raw='dev_raw'
parameter_file_name='m_dp_site_vend_pre'
parameter_section='m_dp_site_vend_pre'
...
parameter_file_name='m_dp_sku_link_pre'
parameter_section='m_dp_sku_link_pre'
parameter_key='source_bucket'
...
parameter_file_name='m_SAP_Sku_Link_Type'
parameter_section='m_SAP_Sku_Link_Type'
parameter_key='source_bucket'
