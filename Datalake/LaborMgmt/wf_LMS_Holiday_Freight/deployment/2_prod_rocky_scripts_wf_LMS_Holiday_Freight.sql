...
, 'EDW_PRD' --source_db
, 'inventory_event_str_sku' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'inventory_event_str_sku_history' --target_table_name
, 'full' --load_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'sto_type_lu_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'holiday_sto_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
