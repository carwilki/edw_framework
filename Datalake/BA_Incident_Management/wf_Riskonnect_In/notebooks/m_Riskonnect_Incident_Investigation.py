...
Shortcut_to_INCIDENT_INVESTIGATIONS = upd_inc_investigation.selectExpr(
	...
	"CAST(substring(DESCRIPTION_OF_CORRECTIVE_ACTION_1, 1,100) AS STRING) as ACTION_PLAN_1_DESC",
	...
	"CAST(substring(DESCRIPTION_OF_CORRECTIVE_ACTION_3, 1,100) AS STRING) as ACTION_PLAN_3_DESC",
