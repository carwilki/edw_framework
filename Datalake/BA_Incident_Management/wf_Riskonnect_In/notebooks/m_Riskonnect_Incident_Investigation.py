...
Shortcut_to_INCIDENT_INVESTIGATIONS = upd_inc_investigation.selectExpr(
	...
	"CAST(substring(DESCRIPTION_OF_INCIDENT, 1,30000) AS STRING) as INVESTIGATION_INCIDENT_DESC",
	...
	"CAST(substring(DESCRIBE_UNSAFE_CONDITION, 1,100) AS STRING) as UNSAFE_CONDITION_DESC",
	"CAST(UNSAFE_ACT_CONTRIBUTED_FLAG AS TINYINT) as UNSAFE_ACT_CONTRIBUTED_FLAG",
	"CAST(substring(DESCRIPTION_UNSAFE_ACT, 1,100) AS STRING) as UNSAFE_ACT_DESC",
	"CAST(DEVIATION_FROM_CURRENT_POLICY_PROCEDURE_FLAG AS TINYINT) as DEVIATION_FROM_CURRENT_POLICY_PROCEDURE_FLAG",
	"CAST(substring(DESCRIPTION_DEVIATION, 1,100) AS STRING) as DEVIATION_DESC",
	...
	"CAST(substring(DESCRIPTION_EQUIPMENT, 1,100) AS STRING) as EQUIPMENT_DESC",
	"CAST(EQUIP_FUNCTIONING_PROPERLY AS TINYINT) as EQUIPMENT_FUNCTIONING_PROPERLY_FLAG",
	"CAST(substring(DESCRIPTION_IF_FUNCTIONING_IMPROPERLY, 1,100) AS STRING) as EQUIPMENT_FUNCTIONING_IMPROPERLY_DESC",
	"CAST(MACHINE_TOOL_SUBSTANCE_OBJECT_INVOLVED AS TINYINT) as MACHINE_TOOL_SUBSTANCE_OBJECT_INVOLVED_FLAG",
	"CAST(substring(DESCRIPTION_MACHIN_TOOL_SUBSTANCE_OBJECT, 1,100) AS STRING) as MACHINE_TOOL_SUBSTANCE_OBJECT_DESC",
	"CAST(substring(ADDITIONAL_CONTRIBUTING_CONDITIONS, 1,100) AS STRING) as ADDITIONAL_CONTRIBUTING_CONDITIONS",
	"CAST(substring(HOW_INCIDENT_COULD_HAVE_BEEN_PREVENTED AS STRING, 1,25000)) as PREVENTION_STRATEGY",
	"CAST(substring(HOW_WILL_STORE_LEADERSHIP_SUPPORT, 1,1000) AS STRING) as LEADERSHIP_SUPPORT_STRATEGY",
	...
	"CAST(substring(DESCRIPTION_OF_CORRECTIVE_ACTION_1, 1,500) AS STRING) as ACTION_PLAN_1_DESC",
	...
	"CAST(substring(DESCRIPTION_OF_CORRECTIVE_ACTION_2, 1,500) AS STRING) as ACTION_PLAN_2_DESC",
	...
	"CAST(substring(DESCRIPTION_OF_CORRECTIVE_ACTION_3, 1,500) AS STRING) as ACTION_PLAN_3_DESC",
