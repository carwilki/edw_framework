...
CREATE TABLE INCIDENT_CLAIMS_PRE
...
CREATE TABLE INCIDENT_INVESTIGATIONS_PRE
...
USING delta
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/incident_management/incident_claims';
...
USING delta
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/incident_management/incident_investigations'
;
...
CREATE TABLE  EMPLOYEE_PROFILE_WK
...
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/incident_management/employee_profile_wk'
;
...
CREATE TABLE INCIDENT_DATA_LOOKUP
...
USING delta
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/incident_management/incident_data_lookup';
