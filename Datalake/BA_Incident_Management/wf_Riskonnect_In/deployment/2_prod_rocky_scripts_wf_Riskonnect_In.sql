...
, 'refine' --target_db
, 'NULL' --target_schema
, 'INCIDENT_CLAIMS_history' --target_table_name
, 'full' --load_type
...
, 'NZ_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'INCIDENT_INVESTIGATIONS' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'INCIDENT_INVESTIGATIONS_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'INCIDENT_DATA_LOOKUP' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'INCIDENT_DATA_LOOKUP_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
