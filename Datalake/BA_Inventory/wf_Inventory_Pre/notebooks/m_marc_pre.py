...
SQ_Shortcut_to_MARC = SQ_Shortcut_to_MARC \
	.withColumnRenamed(SQ_Shortcut_to_MARC.columns[0],'MANDT') \
...
FILTRANS = SQ_Shortcut_to_MARC.filter("cast(MANDT as double) IS NOT NULL AND cast(MATNR as double) IS NOT NULL AND cast(WERKS as double) IS NOT NULL")
