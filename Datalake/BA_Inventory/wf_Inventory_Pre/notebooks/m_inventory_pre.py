...
WHERE mard_pre.mandt = marc_pre.mandt 
  ...
  and mard_pre.werks = mbew_pre.bwkey"""
)  # .withColumn("sys_row_id", monotonically_increasing_id())

# Conforming fields names to the component layout
SQ_MARD_MARC_MBEW = (
    SQ_MARD_MARC_MBEW.withColumnRenamed(SQ_MARD_MARC_MBEW.columns[0], "DAY_DT")
...
SQ_MARD_MARC_MBEW_temp = SQ_MARD_MARC_MBEW.toDF(
    *["SQ_MARD_MARC_MBEW___" + col for col in SQ_MARD_MARC_MBEW.columns]
)
