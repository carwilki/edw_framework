...
, 'EDW_PRD' --source_db
, 'INV_UNAVAILABLE_HIST' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'INV_UNAVAILABLE_HIST_history' --target_table_name
, 'full' --load_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'SKU_PROFILE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'SITE_PROFILE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
