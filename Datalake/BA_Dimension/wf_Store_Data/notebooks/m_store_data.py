...
EXPTRANS = SQ_Shortcut_to_STORE_DATA_FLAT1_temp.selectExpr(
	...
	"DECIMAL(i_OUT_OF_BALANCE_CNT) as o_OUT_OF_BALANCE_CNT",
	"DECIMAL(i_OUT_OF_BALANCE_VALUE) as o_OUT_OF_BALANCE_VALUE",
	"DECIMAL(i_BANK_DEPOSIT_VAR_PCT) as o_BANK_DEPOSIT_VAR_PCT",
