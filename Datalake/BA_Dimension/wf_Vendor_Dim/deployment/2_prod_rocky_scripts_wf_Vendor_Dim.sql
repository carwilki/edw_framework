...
, 'refine' --target_db
, 'NULL' --target_schema
, 'VENDOR_TYPE_history' --target_table_name
, 'full' --load_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'VENDOR_PROFILE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'VENDOR_SUBRANGE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
