...
parameter_section='m_RELEX_DC_Shipments_Out' 
...
parameter_value='WHSE_SHIP_DC_DAY.LOAD_DT>to_date("06/18/2020","MM/dd/yyyy")'
insert_param_config(raw,parameter_file_name,parameter_section,parameter_key,parameter_value)

parameter_file_name='wf_RELEX_DC_Shipments_Out' 
parameter_section='m_RELEX_DC_Shipments_Out' 
parameter_key='Last_Run_Date' 
parameter_value='06/18/2020'
insert_param_config(raw,parameter_file_name,parameter_section,parameter_key,parameter_value)
...
parameter_value='WM_ORDERS.UPDATE_TSTMP>to_date("10/09/2020","MM/dd/yyyy")' 
insert_param_config(raw,parameter_file_name,parameter_section,parameter_key,parameter_value)

parameter_file_name='wf_RELEX_DC_Shipments_Out' 
parameter_section='m_RELEX_2018_DC_Shipments_Out' 
parameter_key='Delta_Filter2' 
parameter_value='WM_ORDER_LINE_ITEM.UPDATE_TSTMP>to_date("10/09/2020","MM/dd/yyyy")' 
insert_param_config(raw,parameter_file_name,parameter_section,parameter_key,parameter_value)

parameter_file_name='wf_RELEX_DC_Shipments_Out' 
parameter_section='m_RELEX_2018_DC_Shipments_Out' 
parameter_key='Last_Run_Date1' 
parameter_value='10/09/2020' 
insert_param_config(raw,parameter_file_name,parameter_section,parameter_key,parameter_value)
...
parameter_section='m_RELEX_CAN_DC_Shipments_Out' 
parameter_key='Delta_Filter' 
parameter_value='MOVEMENT_DAY.UPDATE_DT>to_date("06/18/2020","MM/dd/yyyy")'
insert_param_config(raw,parameter_file_name,parameter_section,parameter_key,parameter_value)
