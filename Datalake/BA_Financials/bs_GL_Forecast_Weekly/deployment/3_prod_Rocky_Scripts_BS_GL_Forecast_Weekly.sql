...
, 'refine' --target_db
, 'NULL' --target_schema
, 'GL_EXCHANGE_RATE_history' --target_table_name
, 'full' --load_type
...
, 'NZ_Export_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'GL_PLAN_FORECAST_DAY' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'TRUE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'GL_PLAN_FORECAST_DAY_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
