...
#Code converted on 2023-08-17 15:37:07
import os
import argparse
...
# Processing node SQ_Shortcut_to_GL_FORECAST_PRE1, type SOURCE 
# COLUMN COUNT: 7

SQ_Shortcut_to_GL_FORECAST_PRE1 = spark.sql(f"""SELECT
FISCAL_MO,
GL_ACCT_NBR,
GL_CAT_CD,
STORE_NBR,
...
SQ_Shortcut_to_GL_FORECAST_PRE = spark.sql(f"""SELECT DISTINCT
FISCAL_MO,
GL_ACCT_NBR,
GL_CAT_CD,
STORE_NBR,
...
SQ_Shortcut_to_GL_FORECAST_PRE1_temp = SQ_Shortcut_to_GL_FORECAST_PRE1.toDF(*["SQ_Shortcut_to_GL_FORECAST_PRE1___" + col for col in SQ_Shortcut_to_GL_FORECAST_PRE1.columns])
SQ_Shortcut_to_GL_FORECAST_PRE_temp = SQ_Shortcut_to_GL_FORECAST_PRE.toDF(*["SQ_Shortcut_to_GL_FORECAST_PRE___" + col for col in SQ_Shortcut_to_GL_FORECAST_PRE.columns])

JNRTRANS = SQ_Shortcut_to_GL_FORECAST_PRE1_temp.join(SQ_Shortcut_to_GL_FORECAST_PRE_temp,[SQ_Shortcut_to_GL_FORECAST_PRE1_temp.SQ_Shortcut_to_GL_FORECAST_PRE1___FISCAL_MO == SQ_Shortcut_to_GL_FORECAST_PRE_temp.SQ_Shortcut_to_GL_FORECAST_PRE___FISCAL_MO, SQ_Shortcut_to_GL_FORECAST_PRE1_temp.SQ_Shortcut_to_GL_FORECAST_PRE1___GL_ACCT_NBR == SQ_Shortcut_to_GL_FORECAST_PRE_temp.SQ_Shortcut_to_GL_FORECAST_PRE___GL_ACCT_NBR, SQ_Shortcut_to_GL_FORECAST_PRE1_temp.SQ_Shortcut_to_GL_FORECAST_PRE1___GL_CAT_CD == SQ_Shortcut_to_GL_FORECAST_PRE_temp.SQ_Shortcut_to_GL_FORECAST_PRE___GL_CAT_CD, SQ_Shortcut_to_GL_FORECAST_PRE1_temp.SQ_Shortcut_to_GL_FORECAST_PRE1___STORE_NBR == SQ_Shortcut_to_GL_FORECAST_PRE_temp.SQ_Shortcut_to_GL_FORECAST_PRE___STORE_NBR, SQ_Shortcut_to_GL_FORECAST_PRE1_temp.SQ_Shortcut_to_GL_FORECAST_PRE1___COMPANY_NBR == SQ_Shortcut_to_GL_FORECAST_PRE_temp.SQ_Shortcut_to_GL_FORECAST_PRE___COMPANY_NBR],'right_outer').selectExpr(
	"SQ_Shortcut_to_GL_FORECAST_PRE___FISCAL_MO as US_FISCAL_MO",
	"SQ_Shortcut_to_GL_FORECAST_PRE___GL_ACCT_NBR as US_GL_ACCT_NBR",
	"SQ_Shortcut_to_GL_FORECAST_PRE___GL_CAT_CD as US_GL_CAT_CD",
	"SQ_Shortcut_to_GL_FORECAST_PRE___STORE_NBR as US_STORE_NBR",
	"SQ_Shortcut_to_GL_FORECAST_PRE___COMPANY_NBR as US_COMPANY_NBR",
	"SQ_Shortcut_to_GL_FORECAST_PRE___CURRENCY_ID as US_CURRENCY_ID",
	"SQ_Shortcut_to_GL_FORECAST_PRE___GL_FORECAST_AMT as US_GL_FORECAST_AMT",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___FISCAL_MO as LOC_FISCAL_MO",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___GL_ACCT_NBR as LOC_GL_ACCT_NBR",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___GL_CAT_CD as LOC_GL_CAT_CD",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___STORE_NBR as LOC_STORE_NBR",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___COMPANY_NBR as LOC_COMPANY_NBR",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___CURRENCY_ID as LOC_CURRENCY_ID",
	"SQ_Shortcut_to_GL_FORECAST_PRE1___GL_FORECAST_AMT as LOC_GL_FORECAST_AMT").withColumn("sys_row_id", monotonically_increasing_id())

# COMMAND ----------

JNRTRANS.printSchema
...
EXPTRANS = JNRTRANS.selectExpr(
  ...
  "US_GL_CAT_CD as US_GL_CAT_CD",
   "US_STORE_NBR as US_STORE_NBR",
	...
	"CASE WHEN LOC_GL_FORECAST_AMT > 0.0 THEN ROUND(LOC_GL_FORECAST_AMT / US_GL_FORECAST_AMT, 6) ELSE 1.00000 END as RATE"
)
...
#  "US_STORE_NBR as US_STORE_NBR",
# 	"RATE as in_RATE") \
# 	.groupBy("PERIOD","US_GL_ACCT_NBR","US_GL_CAT_CD","US_STORE_NBR","COMPANY") \
...
Shortcut_to_GL_EXCHANGE_RATE1 = UPD_upd_insert.selectExpr(
	...
	"CAST(FORECAST_EXCH_RATE AS DECIMAL(9,6)) as FORECAST_EXCH_RATE",
	"CAST(NULL AS DECIMAL(9,6)) as F1_ADJ_EXCH_RATE",
...
try:
  spark.sql(f"""
        ...
        update set 
          ...
          FORECAST_EXCH_RATE=source.FORECAST_EXCH_RATE
        """)
  logger.info(f"Merge with GL_EXCHANGE_RATE completed]")
  logPrevRunDt("GL_EXCHANGE_RATE", "GL_EXCHANGE_RATE", "Completed", "N/A", f"{raw}.log_run_details")
except Exception as e:
