...
, 'legacy' --target_db
, 'NULL' --target_schema
, 'TS_ACTIVITY_history' --target_table_name
, 'full' --load_type
...
, 'NZ_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'TS_ACTIVITY_CATEGORY' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'legacy' --target_db
, 'NULL' --target_schema
, 'TS_ACTIVITY_CATEGORY_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'legacy' --target_db
, 'NULL' --target_schema
, 'TS_ACTIVITY_TYPE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'legacy' --target_db
, 'NULL' --target_schema
, 'TS_ACTIVITY_XREF_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'legacy' --target_db
, 'NULL' --target_schema
, 'TS_EMPLOYEE_TIME_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
