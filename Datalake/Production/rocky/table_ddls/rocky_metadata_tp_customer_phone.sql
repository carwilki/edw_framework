...
VALUES (
"NZ_Migration", null, '${nz_db}', "EDW_PRD", "TP_CUSTOMER_PHONE",
null, true, "customer", false, "delta",
"refine", "public", "tp_customer_phone", "append", "LOAD_DT", 
...
VALUES (
'${cust_sensitive_db}', "refine_tp_customer_phone", "refine", "tp_customer_phone",
