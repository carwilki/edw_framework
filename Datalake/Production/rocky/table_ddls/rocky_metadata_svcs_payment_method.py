...
# MAGIC %md 
# MAGIC ####rocky table svcs_payment_method, as it is required source for wf_PRISM_Daily

# COMMAND ----------

# MAGIC %sql
# MAGIC INSERT INTO dev_work.rocky_ingestion_metadata (
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako4_legacy', "EDW_PRD", "SVCS_PAYMENT_METHOD",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "svcs_payment_method", "upsert", "UPDATE_TSTMP", 
# MAGIC "SVCS_PAYMENT_METHOD_GID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
