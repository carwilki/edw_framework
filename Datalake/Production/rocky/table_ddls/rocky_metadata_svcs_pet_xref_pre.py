...
# MAGIC %md 
# MAGIC ####rocky table svcs_pet_xref_pre, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8', "EDW_PRD", "SVCS_PET_XREF_PRE",
# MAGIC null, false, null, false, "delta",
# MAGIC "raw", null, "svcs_pet_xref_pre", "full", null, 
