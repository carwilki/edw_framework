...
# MAGIC %md
# MAGIC ####Rocky table USR_ASSESSMENT_EXCEPTIONS, as it is a required source for wf_ORA2NZ_EDU_Replication_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8', "EDW_PRD", "USR_ASSESSMENT_EXCEPTIONS",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "USR_ASSESSMENT_EXCEPTIONS", "full", null, 
