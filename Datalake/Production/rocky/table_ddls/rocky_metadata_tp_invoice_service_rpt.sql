...
-- MAGIC %sql
-- MAGIC update pii_metadata.pii_metadata_store set database_name= "cust_sensitive", table_name= "refine_tp_invoice_service_rpt", updated_ts= current_timestamp(), update_user = "rjalan" where table_name = 'tp_invoice_service_rpt'
