...
-- MAGIC %md
-- MAGIC rocky JOB_CODE as it is required for wf_Aspect_Ancillary_File
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "JOB_CODE",
null, false, null, false, "delta",
"legacy", null, "job_code", "upsert", "UPDATE_TSTMP", 
"JOB_CODE", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
null, array("abelsare@petsmart.com","pkulkarni@petsmart.com","sjaiswal@petsmart.com"), 3, '{"Department":"Netezza-Migration"}', false,
