...
-- MAGIC %md
-- MAGIC ####rocky table GL_PROFIT_CENTER_PROFILE, as it is required source for wf_GL_Project_Control
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "GL_PROFIT_CENTER_PROFILE",
null, false, null, false, "delta",
"legacy", null, "gl_profit_center_profile", "upsert", "UPDATE_DT", 
"GL_PROFIT_CENTER_GID", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
