...
VALUES (
"NZ_Migration", null, 'NZ_Export_Mako8', "EDW_PRD", "EMPL_EARNINGS_WK",
null, true, "employee_protected", false, "delta",
"legacy", null, "empl_earnings_wk", "full", null, 
null, null, "weekly", null, array("DUMMY_TIDAL_JOB"), 
...
values('empl_protected','legacy_empl_earnings_wk','legacy','empl_earnings_wk',false,'dbodake',now(),now())
...
where table_name IN ("legacy_empl_earnings_wk")
