...
# MAGIC %md 
# MAGIC ####rocky table sds_work_order_status, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "SDS_PRD", "SDS_WORK_ORDER_STATUS",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "sds_work_order_status", "upsert", "UPDATE_TSTMP", 
# MAGIC "SDS_WORK_ORDER_STATUS_GID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
