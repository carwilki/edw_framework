...
# MAGIC %md 
# MAGIC ####rocky table sds_override_reason, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "SDS_PRD", "SDS_OVERRIDE_REASON",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "sds_override_reason", "upsert", "UPDATE_TSTMP", 
# MAGIC "SDS_OVERRIDE_REASON_GID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
