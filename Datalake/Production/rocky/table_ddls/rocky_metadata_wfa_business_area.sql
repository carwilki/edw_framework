...
drop table if exists ${legacy_db}.WFA_BUSINESS_AREA
...
VALUES (
"NZ_Migration", null, '${nz_db}', "EDW_PRD", "WFA_BUSINESS_AREA",
null, false, null, false, "delta",
"legacy", "public", "wfa_business_area", "append", "UPDATE_DT", 
"WFA_BUSN_AREA_ID", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
