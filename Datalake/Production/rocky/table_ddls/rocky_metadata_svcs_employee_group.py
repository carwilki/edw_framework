...
# MAGIC %md 
# MAGIC ####rocky table svcs_employee_group, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "SVCS_EMPLOYEE_GROUP",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "svcs_employee_group", "upsert", "UPDATE_TSTMP", 
# MAGIC "SVCS_EMPLOYEE_GROUP_GID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
