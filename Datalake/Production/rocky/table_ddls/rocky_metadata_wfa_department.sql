...
drop table if exists ${legacy_db}.WFA_DEPARTMENT
...
VALUES (
"NZ_Migration", null, '${nz_db}', "EDW_PRD", "WFA_DEPARTMENT",
null, false, null, false, "delta",
"legacy", "public", "wfa_department", "append", "UPDATE_DT", 
"WFA_DEPT_ID", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
