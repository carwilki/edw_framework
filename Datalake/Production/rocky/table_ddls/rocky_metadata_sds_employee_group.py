...
# MAGIC %md 
# MAGIC ####rocky table sds_employee_group, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "SDS_PRD", "SDS_EMPLOYEE_GROUP",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "sds_employee_group", "upsert", "UPDATE_TSTMP", 
# MAGIC "SDS_EMPLOYEE_GROUP_ID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
