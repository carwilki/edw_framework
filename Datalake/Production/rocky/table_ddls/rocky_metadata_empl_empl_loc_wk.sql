...
-- MAGIC )
-- MAGIC VALUES (
-- MAGIC "NZ_Migration", null, 'NZ_Export_Mako8', "EDW_PRD", "EMPL_EMPL_LOC_WK",
-- MAGIC null, true, "employee_protected", false, "delta",
-- MAGIC "legacy", null, "empl_empl_loc_wk", "full", null, 
...
-- MAGIC %sql
-- MAGIC  insert into qa_work.pii_dynamic_view_control (secured_database, secured_table_name,view_database,view_name,view_created_flg,load_user_name,load_dt_tm,update_dt_tm)
-- MAGIC  values('empl_protected','legacy_empl_empl_loc_wk','legacy','empl_empl_loc_wk',false,'sjaiswal',now(),now())
...
-- MAGIC where table_name IN ("legacy_empl_empl_loc_wk")
