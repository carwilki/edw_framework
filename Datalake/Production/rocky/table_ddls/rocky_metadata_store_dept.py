...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8', "EDW_PRD", "STORE_DEPT",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "STORE_DEPT", "upsert", "UPDATE_TSTMP", 
# MAGIC "STORE_DEPT_NBR", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
# MAGIC null, array("abelsare@petsmart.com","sjaiswal@petsmart.com"), 3, '{"Department":"Netezza-Migration"}', false,
