...
-- MAGIC %md
-- MAGIC rocky MERCHCAT as it is required source for wF_JDA_Extract
...
VALUES ("NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "MERCHCAT",
null, false, null, false, "delta",
"legacy", null, "merchcat", "full"", null, 
