...
-- MAGIC %md
-- MAGIC rocky SAP_CLASS as it is required for wf_Aspect_Ancillary_File
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "SAP_CLASS",
null, false, null, false, "delta",
"legacy", null, "sap_class", "full", null, 
