...
# MAGIC %md 
# MAGIC ####rocky table sds_service_category, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "SDS_PRD", "SDS_SERVICE_CATEGORY",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "sds_service_category", "upsert", "UPDATE_TSTMP", 
# MAGIC "SDS_SERVICE_CATEGORY_GID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
