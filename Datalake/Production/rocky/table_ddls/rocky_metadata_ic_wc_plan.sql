...
-- MAGIC %md
-- MAGIC ####rocky table IC_WC_PLAN, as it is required source for wf_Plan_Act_Turnover
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "IC_WC_PLAN",
null, false, null, false, "delta",
"legacy", null, "ic_wc_plan", "upsert", "UPDATE_DT", 
"FISCAL_YR,LOCATION_ID", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
