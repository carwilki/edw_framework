...
# MAGIC %md
# MAGIC ####rocky table PRIMARY_VENDOR, as it is required source for wf_POG_Weekly_Extracts
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "PRIMARY_VENDOR",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "primary_vendor", "full", null, 
