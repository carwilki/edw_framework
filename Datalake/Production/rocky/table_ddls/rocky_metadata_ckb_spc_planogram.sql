...
-- MAGIC %md
-- MAGIC ####rocky table CKB_SPC_PLANOGRAM, as it is required source for bs_replenishment_profile
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "CKB_SPC_PLANOGRAM",
null, false, null, false, "delta",
"legacy", null, "ckb_spc_planogram", "upsert", "UPDATE_DT", 
"CKB_DB_PLANOGRAM_KEY", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
