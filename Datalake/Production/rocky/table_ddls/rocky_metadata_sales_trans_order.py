...
# MAGIC %md
# MAGIC ####rocky table SALES_TRANS_ORDER, as it is required source for wf_ShopperTrak_Sales
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8', "EDW_PRD", "SALES_TRANS_ORDER",
null, false, null, false, "delta",
"legacy", null, "SALES_TRANS_ORDER", "append", "DATE_LOADED", 
null, null, "daily", null, array("DUMMY_TIDAL_JOB"), 
null, array("abelsare@petsmart.com","sjaiswal@PetSmart.com","dbodake@petsmart.com"), 3, '{"Department":"Netezza-Migration"}', false,
