...
-- MAGIC %md
-- MAGIC ####rocky table employee_subgroup
...
VALUES (
"NZ_Migration", null, 'NZ_Mako8', "EDW_PRD", "employee_subgroup",
null, false, null, false, "delta",
"legacy", null, "employee_subgroup", "upsert", "UPDATE_TSTMP", 
"EMPL_GROUP_CD,EMPL_SUBGROUP_CD", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
null, array("pkulkarni@petsmart.com","sjaiswal@petsmart.com"), 3, '{"Department":"Netezza-Migration"}', false,
