...
# MAGIC %md
# MAGIC ####rocky table usr_store_divisions, as it is required source for wf_sales_ranking_wk workflow
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "USR_STORE_DIVISIONS",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "usr_store_divisions", "full", null, 
