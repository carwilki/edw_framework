...
drop table if exists ${legacy_db}.WFA_TASK
...
VALUES (
"NZ_Migration", null, '${nz_db}', "EDW_PRD", "WFA_TASK",
null, false, null, false, "delta",
"legacy", "public", "wfa_task", "append", "UPDATE_DT", 
"WFA_TASK_ID", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
