...
-- MAGIC %md
-- MAGIC rocky POG_PROJECT as it is required source for wF_JDA_Extract
...
VALUES ("NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "POG_PROJECT",
null, false, null, false, "delta",
"legacy", null, "pog_project", "full"", null, 
