...
-- MAGIC %md
-- MAGIC rocky MERCH_DISCOUNT_DAY as it is required source for bs_pog_agg
...
VALUES ("NZ_Migration", null, 'NZ_Export_Mako8', "EDW_PRD", "MERCH_DISCOUNT_DAY",
null, false, null, false, "delta",
"legacy", null, "merch_discount_day", "upsert", "DAY_DT", 
"DAY_DT,PRODUCT_ID,LOCATION_ID", "DAY_DT > current_date-60", "daily", null, array("DUMMY_TIDAL_JOB"), 
