...
# MAGIC %md 
# MAGIC ####rocky table PS2_LABOR_PLAN_WK, as it is required source for wf_plan_store
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "PS2_LABOR_PLAN_WK",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "ps2_labor_plan_wk", "upsert", "UPDATE_DT", 
# MAGIC "WEEK_DT,LOCATION_ID,VERSION,BUSINESS_AREA",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
