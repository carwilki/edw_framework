...
# MAGIC %md
# MAGIC ####rocky table BRAND, as it is required source for wf_POG_Weekly_Extracts
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "BRAND",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "brand", "upsert", "UPDATE_DT", 
# MAGIC "BRAND_CD", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
