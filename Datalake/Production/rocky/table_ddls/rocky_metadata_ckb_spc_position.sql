...
-- MAGIC %md
-- MAGIC ####rocky table CKB_SPC_POSITION, as it is required source for wf_ckb_spc_rpt
...
VALUES (
"NZ_Migration", null, 'NZ_Export_mako8', "EDW_PRD", "CKB_SPC_POSITION",
null, false, null, false, "delta",
"legacy", null, "ckb_spc_position", "upsert", "UPDATE_DT", 
"CKB_DB_POSITION_KEY,CKB_DB_PLANOGRAM_KEY", null, "daily", null, array("DUMMY_TIDAL_JOB"), 
