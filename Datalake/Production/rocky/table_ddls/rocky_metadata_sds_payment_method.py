...
# MAGIC %md 
# MAGIC ####rocky table sds_payment_method, as it is required source for wf_PRISM_Daily
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "SDS_PRD", "SDS_PAYMENT_METHOD",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "sds_payment_method", "upsert", "UPDATE_TSTMP", 
# MAGIC "SDS_PAYMENT_METHOD_GID",null, "daily", null, array("DUMMY_TIDAL_JOB"), 
