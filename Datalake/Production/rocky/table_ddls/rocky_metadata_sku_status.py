...
# MAGIC %md
# MAGIC ####rocky table SKU_STATUS, as it is required source for wf_POG_Weekly_Extracts
...
# MAGIC )
# MAGIC VALUES (
# MAGIC "NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "SKU_STATUS",
# MAGIC null, false, null, false, "delta",
# MAGIC "legacy", null, "sku_status", "full", null, 
