...
VALUES (
"NZ_Migration", null, 'NZ_Mako8_legacy', "EDW_PRD", "EMPLOYEE_PROFILE",
null, true, "employee_protected", false, "delta",
"legacy", null, "employee_profile", "full", null, 
...
values('empl_protected','legacy_employee_profile','legacy','employee_profile',false,'dbodake',now(),now())
...
where table_name IN ("legacy_employee_profile")
