#Code converted on 2023-07-24 08:25:23
import os
import argparse
...
from Datarawlake.utils.configs import *
...
CS_StartPeriod_Dt=' ' #args.CS_StartPeriod_Dt
CS_EndPeriod_Dt=' ' #args.CS_EndPeriod_Dt
...
SQ_Shortcut_to_GL_PLAN_FORECAST_MONTH = spark.sql(f"""SELECT CURRENT_TIMESTAMP AS START_TSTMP,
  ...
  FROM {raw}.MA_SALES_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
# TODO is the rest here just noise ??? can be deletd
