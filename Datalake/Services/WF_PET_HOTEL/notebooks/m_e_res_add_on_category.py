...
SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY = spark.sql(
    f"""SELECT
...
E_RES_UPDATED_BY,
LOAD_TSTMP
FROM {legacy}.E_RES_ADD_ON_CATEGORY"""
...
SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_PRE = spark.sql(
    f"""SELECT
ADD_ON_CATEGORY_ID,
...
DESCRIPTION,
SORT_ORDER
FROM {raw}.E_RES_ADD_ON_CATEGORY_PRE"""
).withColumn("sys_row_id", monotonically_increasing_id())
...
SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_PRE_temp = (
    SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_PRE.toDF(
        *[
            "SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_PRE___" + col
            for col in SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_PRE.columns
        ]
    )
)
...
# for each involved DataFrame, append the dataframe name to each column
SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_temp = SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY.toDF(
    *[
        "SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY___" + col
        for col in SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY.columns
    ]
)
EXP_E_RES_ADD_ON_CATEGORY_PRE_temp = EXP_E_RES_ADD_ON_CATEGORY_PRE.toDF(
    *[
        "EXP_E_RES_ADD_ON_CATEGORY_PRE___" + col
        for col in EXP_E_RES_ADD_ON_CATEGORY_PRE.columns
    ]
)

JNR_E_RES_ADD_ON_CATEGORY = SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_temp.join(
    EXP_E_RES_ADD_ON_CATEGORY_PRE_temp,
    [
        SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY_temp.SQ_Shortcut_to_E_RES_ADD_ON_CATEGORY___E_RES_ADD_ON_CATEGORY_ID
        == EXP_E_RES_ADD_ON_CATEGORY_PRE_temp.EXP_E_RES_ADD_ON_CATEGORY_PRE___ADD_ON_CATEGORY_ID
    ],
    "right_outer",
).selectExpr(
...
# for each involved DataFrame, append the dataframe name to each column
JNR_E_RES_ADD_ON_CATEGORY_temp = JNR_E_RES_ADD_ON_CATEGORY.toDF(
    *["JNR_E_RES_ADD_ON_CATEGORY___" + col for col in JNR_E_RES_ADD_ON_CATEGORY.columns]
)

FIL_E_RES_ADD_ON_CATEGORY = (
    JNR_E_RES_ADD_ON_CATEGORY_temp.selectExpr(
...
# for each involved DataFrame, append the dataframe name to each column
FIL_E_RES_ADD_ON_CATEGORY_temp = FIL_E_RES_ADD_ON_CATEGORY.toDF(
    *["FIL_E_RES_ADD_ON_CATEGORY___" + col for col in FIL_E_RES_ADD_ON_CATEGORY.columns]
)
...
# for each involved DataFrame, append the dataframe name to each column
EXP_E_RES_ADD_ON_CATEGORY_temp = EXP_E_RES_ADD_ON_CATEGORY.toDF(
    *["EXP_E_RES_ADD_ON_CATEGORY___" + col for col in EXP_E_RES_ADD_ON_CATEGORY.columns]
)
...
try:
    ...
    DuplicateChecker.check_for_duplicate_primary_keys(
        Shortcut_to_E_RES_ADD_ON_CATEGORY1, ["E_RES_ADD_ON_CATEGORY_ID"]
    )
