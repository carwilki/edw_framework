...
SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS = spark.sql(f"""SELECT
...
UPDATE_TSTMP,
LOAD_TSTMP
FROM {legacy}.E_RES_SELECTED_MEDICATIONS""").withColumn("sys_row_id", monotonically_increasing_id())
...
SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE = spark.sql(f"""SELECT
...
TOTAL_PRICE,
LOAD_TSTMP
FROM {raw}.E_RES_SELECTED_MEDICATIONS_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_temp = SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS.toDF(*["SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS___" + col for col in SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS.columns])
SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE_temp = SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE.toDF(*["SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE___" + col for col in SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE.columns])

JNR_E_RES_SELECTED_MEDICATIONS = SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_temp.join(SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE_temp,[SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_temp.SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS___E_RES_SELECTED_MEDICATION_ID == SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE_temp.SQ_Shortcut_to_E_RES_SELECTED_MEDICATIONS_PRE___SELECTED_MEDICATION_ID],'right_outer').selectExpr(
...
# for each involved DataFrame, append the dataframe name to each column
JNR_E_RES_SELECTED_MEDICATIONS_temp = JNR_E_RES_SELECTED_MEDICATIONS.toDF(*["JNR_E_RES_SELECTED_MEDICATIONS___" + col for col in JNR_E_RES_SELECTED_MEDICATIONS.columns])

FIL_E_RES_SELECTED_MEDICATIONS = JNR_E_RES_SELECTED_MEDICATIONS_temp.selectExpr(
...
# for each involved DataFrame, append the dataframe name to each column
FIL_E_RES_SELECTED_MEDICATIONS_temp = FIL_E_RES_SELECTED_MEDICATIONS.toDF(*["FIL_E_RES_SELECTED_MEDICATIONS___" + col for col in FIL_E_RES_SELECTED_MEDICATIONS.columns])
...
# for each involved DataFrame, append the dataframe name to each column
EXP_E_RES_SELECTED_MEDICATIONS_temp = EXP_E_RES_SELECTED_MEDICATIONS.toDF(*["EXP_E_RES_SELECTED_MEDICATIONS___" + col for col in EXP_E_RES_SELECTED_MEDICATIONS.columns])
...
try:
	primary_key = """source.E_RES_SELECTED_MEDICATION_ID = target.E_RES_SELECTED_MEDICATION_ID"""
	refined_perf_table = f"{legacy}.E_RES_SELECTED_MEDICATIONS"
	DuplicateChecker.check_for_duplicate_primary_keys(
		spark, Shortcut_to_E_RES_SELECTED_MEDICATIONS1, ["E_RES_SELECTED_MEDICATION_ID"]
    )
	executeMerge(Shortcut_to_E_RES_SELECTED_MEDICATIONS1, refined_perf_table, primary_key)
	logger.info(f"Merge with {refined_perf_table} completed]")
	logPrevRunDt("E_RES_SELECTED_MEDICATIONS", "E_RES_SELECTED_MEDICATIONS", "Completed", "N/A", f"{raw}.log_run_details")
except Exception as e:
	logPrevRunDt("E_RES_SELECTED_MEDICATIONS", "E_RES_SELECTED_MEDICATIONS","Failed",str(e), f"{raw}.log_run_details", )
	raise e
