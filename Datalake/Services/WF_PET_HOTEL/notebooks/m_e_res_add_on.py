...
SQ_Shortcut_to_E_RES_ADD_ONS_PRE = spark.sql(f"""SELECT
ADD_ON_ID,
ADD_ON_NAME,
SKU_NBR,
ADD_ON_DESCRIPTION,
...
UPDATE_AT,
LOAD_TSTMP
FROM {raw}.E_RES_ADD_ONS_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
SQ_Shortcut_to_E_RES_ADD_ONS_PRE_temp = SQ_Shortcut_to_E_RES_ADD_ONS_PRE.toDF(*["SQ_Shortcut_to_E_RES_ADD_ONS_PRE___" + col for col in SQ_Shortcut_to_E_RES_ADD_ONS_PRE.columns])
...
SQ_Shortcut_to_E_RES_ADD_ONS = spark.sql(f"""SELECT
E_RES_ADD_ON_ID,
ADD_ON_NAME,
SKU_NBR,
ADD_ON_DESC,
...
E_RES_UPDATED_BY,
UPDATE_TSTMP
FROM {legacy}.E_RES_ADD_ONS""").withColumn("sys_row_id", monotonically_increasing_id())
...
# for each involved DataFrame, append the dataframe name to each column
EXP_E_RES_ADD_ONS_PRE_temp = EXP_E_RES_ADD_ONS_PRE.toDF(*["EXP_E_RES_ADD_ONS_PRE___" + col for col in EXP_E_RES_ADD_ONS_PRE.columns])
SQ_Shortcut_to_E_RES_ADD_ONS_temp = SQ_Shortcut_to_E_RES_ADD_ONS.toDF(*["SQ_Shortcut_to_E_RES_ADD_ONS___" + col for col in SQ_Shortcut_to_E_RES_ADD_ONS.columns])

JNR_E_RES_ADD_ON = SQ_Shortcut_to_E_RES_ADD_ONS_temp.join(EXP_E_RES_ADD_ONS_PRE_temp,[SQ_Shortcut_to_E_RES_ADD_ONS_temp.SQ_Shortcut_to_E_RES_ADD_ONS___E_RES_ADD_ON_ID == EXP_E_RES_ADD_ONS_PRE_temp.EXP_E_RES_ADD_ONS_PRE___ADD_ON_ID],'right_outer').selectExpr(
...
# for each involved DataFrame, append the dataframe name to each column
JNR_E_RES_ADD_ON_temp = JNR_E_RES_ADD_ON.toDF(*["JNR_E_RES_ADD_ON___" + col for col in JNR_E_RES_ADD_ON.columns])

FIL_E_RES_ADD_ON = JNR_E_RES_ADD_ON_temp.selectExpr(
...
# for each involved DataFrame, append the dataframe name to each column
FIL_E_RES_ADD_ON_temp = FIL_E_RES_ADD_ON.toDF(*["FIL_E_RES_ADD_ON___" + col for col in FIL_E_RES_ADD_ON.columns])
...
# for each involved DataFrame, append the dataframe name to each column
EXP_E_RES_ADD_ON_temp = EXP_E_RES_ADD_ON.toDF(*["EXP_E_RES_ADD_ON___" + col for col in EXP_E_RES_ADD_ON.columns])
...
try:
	...
	logPrevRunDt("E_RES_ADD_ONS", "E_RES_ADD_ONS", "Completed", "N/A", f"{raw}.log_run_details")
except Exception as e:
	logPrevRunDt("E_RES_ADD_ONS", "E_RES_ADD_ONS","Failed",str(e), f"{raw}.log_run_details", )
	raise e
