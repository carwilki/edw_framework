...
, 'refine' --target_db
, 'NULL' --target_schema
, 'E_RES_ADD_ONS_history' --target_table_name
, 'full' --load_type
...
, 'NZ_Mako8' --source_type
, 'SDS_PRD' --source_db
, 'E_RES_ADD_ON_CATEGORY' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'E_RES_ADDS_ON_CATEGORY_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Mako8' --source_type
, 'SDS_PRD' --source_db
, 'E_RES_SELECTED_ADD_ONS' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'E_RES_SELECTED_ADD_ONS_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Mako8' --source_type
, 'SDS_PRD' --source_db
, 'E_RES_SELECTED_MEDICATIONS' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'E_RES_SELECTED_MEDICATIONS_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'legacy_E_RES_PETS_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'legacy_E_RES_REQUESTS_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
