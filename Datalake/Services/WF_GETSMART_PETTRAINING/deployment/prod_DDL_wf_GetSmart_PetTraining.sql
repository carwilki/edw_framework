...
use legacy;
CREATE TABLE IF NOT EXISTS  GS_PT_HISTORY
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/services/gs_pt_history' 
;
...
use legacy;
CREATE TABLE IF NOT EXISTS  GS_PT_TRAINING
(GS_PT_TRAINING_ID BIGINT not null
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/services/gs_pt_training' 
;
...
use legacy;
CREATE TABLE IF NOT EXISTS  GS_PT_TRAINING_TYPE
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/services/gs_pt_training_type' 
;
...
use legacy;
CREATE TABLE IF NOT EXISTS  GS_PT_TRAVEL
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/services/gs_pt_travel' 
;
...
use raw;
CREATE TABLE IF NOT EXISTS  GS_PT_HISTORY_PRE
( GS_PT_HISTORY_ID BIGINT not null
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/services/gs_pt_history_pre' 
;
...
use raw;
CREATE TABLE IF NOT EXISTS  GS_PT_TRAINING_PRE
( GS_PT_TRAINING_ID BIGINT not null
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/services/gs_pt_training_pre' 
;
...
use raw;
CREATE TABLE IF NOT EXISTS  GS_PT_TRAINING_TYPE_PRE
( GS_PT_TRAINING_TYPE_ID INT not null
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/services/gs_pt_training_type_pre' 
;
...
use raw;
CREATE TABLE IF NOT EXISTS  GS_PT_TRAVEL_PRE
( GS_PT_TRAVEL_ID BIGINT not null
...
USING delta 
LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/services/gs_pt_travel_pre' 
;
