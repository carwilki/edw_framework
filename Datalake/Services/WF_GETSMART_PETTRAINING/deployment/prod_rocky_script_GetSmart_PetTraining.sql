...
, 'refine' --target_db
, 'NULL' --target_schema
, 'GS_PT_HISTORY_history' --target_table_name
, 'full' --load_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'GS_PT_TRAINING_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'NZ_Mako8' --source_type
, 'EDW_PRD' --source_db
, 'GS_PT_TRAINING_TYPE' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'GS_PT_TRAINING_TYPE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'GS_PT_TRAVEL_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
