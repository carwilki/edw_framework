...
JNRTRANS_temp = JNRTRANS_temp.selectExpr('*', '''md5(concat ( ifnull(JNRTRANS___GS_PT_TRAVEL_ID  , "") 
, ifnull(JNRTRANS___HOME_STORE_ID , "") 
, ifnull(JNRTRANS___ASSOCIATE_ID , "") 
, ifnull(JNRTRANS___ASSOCIATE_FIRST_NAME , "") 
, ifnull(JNRTRANS___ASSOCIATE_LAST_NAME , "") 
, ifnull(JNRTRANS___DM , "") 
, ifnull(JNRTRANS___TRAINING_STORE_ID , "") 
, ifnull(JNRTRANS___TRAINING_START_DT , "") 
, ifnull(JNRTRANS___TRAINING_END_DT , "") 
, ifnull(JNRTRANS___TRAINING_STATUS , "") 
, ifnull(JNRTRANS___TRAINING_TYPE , "") 
, ifnull(JNRTRANS___CREATED_DT, "") 
, ifnull(JNRTRANS___CREATED_BY, "") 
, ifnull(JNRTRANS___MODIFIED_BY, "") 
, ifnull(JNRTRANS___MODIFIED_DT, "") 
)) as md5pre''',
'''md5(concat( ifnull(JNRTRANS___GS_PT_TRAVEL_ID1 , "") 
, ifnull(JNRTRANS___HOME_STORE_ID1 , "") 
, ifnull(JNRTRANS___ASSOCIATE_ID1 , "") 
, ifnull(JNRTRANS___ASSOCIATE_FIRST_NAME1 , "") 
, ifnull(JNRTRANS___ASSOCIATE_LAST_NAME1 , "") 
, ifnull(JNRTRANS___DM1 , "") 
, ifnull(JNRTRANS___TRAINING_STORE_ID1 , "") 
, ifnull(JNRTRANS___TRAINING_START_DT1 , "") 
, ifnull(JNRTRANS___TRAINING_END_DT1 , "") 
, ifnull(JNRTRANS___TRAINING_STATUS1 , "") 
, ifnull(JNRTRANS___TRAINING_TYPE1 , "") 
, ifnull(JNRTRANS___CREATED_DT1 , "")
, ifnull(JNRTRANS___CREATED_BY1 , "")
, ifnull(JNRTRANS___MODIFIED_BY1 , "")
, ifnull(JNRTRANS___MODIFIED_DT1 , "")
)) as md5base''')
