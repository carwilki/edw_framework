...
EXP_MD5_UPD_FLAG = JNRTRANS_temp\
	.withColumn("MD5_RESULTS", expr("""IF (MD5 ( concat ( JNRTRANS___AIRLINE_DEPART_DT , JNRTRANS___AIRLINE_DEPART_TIME , JNRTRANS___AIRLINE_RETURN_DT , JNRTRANS___AIRLINE_RETURN_TIME , JNRTRANS___AIRLINE_SEAT_PREFERENCE , JNRTRANS___HOTEL_CHECKIN_DT , JNRTRANS___HOTEL_CHECKOUT_DT , JNRTRANS___LEGAL_NAME , JNRTRANS___BIRTHDATE , JNRTRANS___GENDER , JNRTRANS___PREFERRED_HOTEL , JNRTRANS___PREFERRED_HOTEL_ADDRESS , JNRTRANS___PREFERRED_HOTEL_PHONE , JNRTRANS___PREFERRED_HOTEL_CONTACT , JNRTRANS___PREFERRED_HOTEL_RATE , JNRTRANS___HOTEL_ROOM_TYPE , JNRTRANS___PREFERRED_ROOMMATE , JNRTRANS___MODIFIED_BY ) ) != MD5 (concat( JNRTRANS___AIRLINE_DEPART_DT1 , JNRTRANS___AIRLINE_DEPART_TIME1 , JNRTRANS___AIRLINE_RETURN_DT1 , JNRTRANS___AIRLINE_RETURN_TIME1 , JNRTRANS___AIRLINE_SEAT_PREFERENCE1 , JNRTRANS___HOTEL_CHECKIN_DT1 , JNRTRANS___HOTEL_CHECKOUT_DT1 , JNRTRANS___LEGAL_NAME1 , JNRTRANS___BIRTHDATE1 , JNRTRANS___GENDER1 , JNRTRANS___PREFERRED_HOTEL1 , JNRTRANS___PREFERRED_HOTEL_ADDRESS1 , JNRTRANS___PREFERRED_HOTEL_PHONE1 , JNRTRANS___PREFERRED_HOTEL_CONTACT1 , JNRTRANS___PREFERRED_HOTEL_RATE1 , JNRTRANS___HOTEL_ROOM_TYPE1 , JNRTRANS___PREFERRED_ROOMMATE1 , JNRTRANS___MODIFIED_BY1 )), 1, 0)""")) \
