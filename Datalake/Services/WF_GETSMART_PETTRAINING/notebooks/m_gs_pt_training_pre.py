...
Shortcut_to_GS_PT_TRAINING_PRE = EXP_LOAD_TSTMP.selectExpr(
	"CAST(ID as BIGINT) as GS_PT_TRAINING_ID",
	"CAST(TravelID as BIGINT) as GS_PT_TRAVEL_ID",
	"CAST(HomeStoreID as BIGINT) as HOME_STORE_ID",
	...
	"CAST(TrainingStoreID as BIGINT) as TRAINING_STORE_ID",
	"CAST(DateTrainingStart AS TIMESTAMP) as TRAINING_START_DT",
	"CAST(DateTrainingEnd AS TIMESTAMP) as TRAINING_END_DT",
	"CAST(TrainingStatus AS INT) as TRAINING_STATUS",
	"CAST(TrainingType AS INT) as TRAINING_TYPE",
