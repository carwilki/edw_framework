...
source_file = get_source_file_rfx('RFX_PRJ_RESPONSE', source_bucket)
...
SQ_Shortcut_to_RFX_PRJ_RESPONSE_temp = SQ_Shortcut_to_RFX_PRJ_RESPONSE.toDF(*["SQ_Shortcut_to_RFX_PRJ_RESPONSE___" + col for col in SQ_Shortcut_to_RFX_PRJ_RESPONSE.columns])
...
Shortcut_to_RFX_PRJ_RESPONSE_PRE.write.mode("overwrite").saveAsTable(f'{raw}.RFX_PRJ_RESPONSE_PRE')
