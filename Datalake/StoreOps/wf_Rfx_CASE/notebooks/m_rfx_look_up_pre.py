...
SQ_Shortcut_to_RFX_LOOK_UP_temp = SQ_Shortcut_to_RFX_LOOK_UP.toDF(*["SQ_Shortcut_to_RFX_LOOK_UP___" + col for col in SQ_Shortcut_to_RFX_LOOK_UP.columns])
...
Shortcut_to_RFX_LOOK_UP_PRE.write.mode("overwrite").saveAsTable(f'{raw}.RFX_LOOK_UP_PRE')
