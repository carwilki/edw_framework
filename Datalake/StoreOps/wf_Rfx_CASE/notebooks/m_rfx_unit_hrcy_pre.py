...
source_file = get_src_file('RFX_UNIT_HIERARCHY', source_bucket)
...
if SQ_Shortcut_to_RFX_UNIT_HRCY.head() is None:
    df = spark.sql(f"TRUNCATE TABLE {raw}.RFX_UNIT_HRCY_PRE")
