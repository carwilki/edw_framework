...
, 'EDW_PRD' --source_db
, 'RFX_SWA_STORE_WALK' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'RFX_SWA_STORE_WALK_history' --target_table_name
, 'full' --load_type
...
, 'EDW_PRD' --source_db
, 'RFX_SWA_WALK_RESPONSE' --source_table
, null --table_desc
, 'FALSE' --is_pii
, null --pii_type
, 'FALSE' --has_hard_deletes
...
, 'refine' --target_db
, 'NULL' --target_schema
, 'RFX_SWA_WALK_RESPONSE_history' --target_table_name
, 'full' --load_type
, null --source_delta_column
, null --primary_key
, null --initial_load_filter
