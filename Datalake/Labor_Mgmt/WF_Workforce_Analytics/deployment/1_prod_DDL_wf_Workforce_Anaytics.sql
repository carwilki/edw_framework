...
CREATE TABLE
    raw_WFA_TSCHD_PRE (
        ...
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tschd_pre';
...
CREATE TABLE
    raw_WFA_TSCHD_PREV_PRE (
        ...
        CORE_HRS DECIMAL(16, 6),
        NON_CORE_HRS DECIMAL(16, 6)
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tschd_prev_pre';
...
CREATE TABLE
    raw_WFA_TDTL_PRE (
        ...
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tdtl_pre';
...
CREATE TABLE
    raw_WFA_TDTL_PREV_PRE (
        ...
        LOCKED_SWT INT,
        GRP_SCHD_SKEY BIGINT
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tdtl_prev_pre';
...
CREATE TABLE
    ...
    ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_org_pre';
...
CREATE TABLE
    WFA_PAYCD (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_paycd';
...
CREATE TABLE
    WFA_PAYCD_PRE (
        ...
        CORE_HRS_SWT INT,
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_paycd_pre' ;
...
CREATE TABLE
    WFA_EMP (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_emp' ;
...
CREATE TABLE
    WFA_EMP_PRE (
        ...
        EM_MNR_SWT INT,
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_emp_pre';
...
CREATE TABLE
    WFA_LBRACCT (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_lbracct';
...
CREATE TABLE
    WFA_LBRACCT_PRE (
        ...
        SRC_SKEY INT,
        TENANT_SKEY INT
    ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_lbracct_pre';
...
CREATE TABLE
    WFA_FCST_SLS_DEPT (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_dept';
...
CREATE TABLE
    WFA_FCST_SLS_TASK (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_task';
...
CREATE TABLE
    raw_WFA_TSCHD_DIFF_PRE (
        ...
        CORE_HRS DECIMAL(16, 6),
        NON_CORE_HRS DECIMAL(16, 6)
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tschd_diff_pre';
...
CREATE TABLE
    legacy_WFA_TSCHD (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_tschd';
...
CREATE TABLE
    legacy_WFA_TDTL (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_tdtl';
...
CREATE TABLE
    raw_WFA_TDTL_DIFF_PRE (
        ...
        LOCKED_SWT INT,
        GRP_SCHD_SKEY BIGINT
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tdtl_diff_pre';
...
CREATE TABLE
    ...
    ) USING delta LOCATION 'gs://petm-bdpl-prod-empl-protected-nzlegacy-p1-gcs-gbl/labor_mgmt/employee_profile';
...
--*****  Creating table:  "WFA_FCST_SLS_PRE" , ***** Creating table: "WFA_FCST_SLS_PRE"
use raw;

CREATE TABLE
    WFA_FCST_SLS_PRE (
        FCST_SLS_SKEY DECIMAL(20, 0) not null, 
        BUSN_DAT TIMESTAMP, 
        ORG_SKEY BIGINT, 
        ACTL_AMT DECIMAL(16, 6), 
        ACTL_HRS DECIMAL(16, 6), 
        ACTL_RATE_AMT DECIMAL(16, 6), 
        ACTL_CLNT1_NBR DECIMAL(16, 6), 
        ACTL_CLNT2_NBR DECIMAL(16, 6), 
        ACTL_CLNT3_NBR DECIMAL(16, 6), 
        ACTL_CLNT4_NBR DECIMAL(16, 6), 
        ACTL_CLNT5_NBR DECIMAL(16, 6), 
        ACTL_CLNT6_NBR DECIMAL(16, 6), 
        ACTL_CLNT7_NBR DECIMAL(16, 6), 
        ACTL_REG_AMT DECIMAL(16, 6), 
        ACTL_REG_HRS DECIMAL(16, 6), 
        ACTL_OT_AMT DECIMAL(16, 6), 
        ACTL_OT_HRS DECIMAL(16, 6), 
        ...
        FCST_HRS DECIMAL(16, 6), 
        FCST_RATE_AMT DECIMAL(16, 6), 
        FCST_ORIG_CLNT1_NBR DECIMAL(16, 6), 
        FCST_CLNT1_NBR DECIMAL(16, 6), 
        FCST_ORIG_CLNT2_NBR DECIMAL(16, 6), 
        FCST_CLNT2_NBR DECIMAL(16, 6), 
        FCST_ORIG_CLNT3_NBR DECIMAL(16, 6), 
        FCST_CLNT3_NBR DECIMAL(16, 6), 
        FCST_ORIG_CLNT4_NBR DECIMAL(16, 6), 
        FCST_CLNT4_NBR DECIMAL(16, 6), 
        FCST_ORIG_CLNT5_NBR DECIMAL(16, 6), 
        FCST_CLNT5_NBR DECIMAL(16, 6), 
        FCST_ORIG_CLNT6_NBR DECIMAL(16, 6), 
        FCST_CLNT6_NBR DECIMAL(16, 6), 
        FCST_ORIG_CLNT7_NBR DECIMAL(16, 6), 
        FCST_CLNT7_NBR DECIMAL(16, 6), 
        BUD_AMT DECIMAL(16, 6), 
        BUD_HRS DECIMAL(16, 6), 
        BUD_RATE_AMT DECIMAL(16, 6), 
        BUD_SLS_AMT DECIMAL(16, 6), 
        LOCKED_SWT BIGINT, 
        UPDT_DTM TIMESTAMP
        ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_pre';
--DISTRIBUTE ON (FCST_SLS_SKEY)


--*****  Creating table:  "WFA_ORG_FACT_PRE" , ***** Creating table: "WFA_ORG_FACT_PRE"
use raw;

CREATE TABLE 
    WFA_ORG_FACT_PRE (
        ORG_ID BIGINT not null, LOCATION_ID INT, 
        WFA_BUSN_AREA_ID SMALLINT, 
        WFA_BUSN_AREA_DESC STRING, 
        WFA_DEPT_ID SMALLINT,
         WFA_DEPT_DESC STRING, 
        WFA_TASK_ID SMALLINT, 
        WFA_TASK_DESC STRING, 
        ORG_SKEY BIGINT, ORG_LVL_NBR BIGINT
        ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_org_fact_pre';
