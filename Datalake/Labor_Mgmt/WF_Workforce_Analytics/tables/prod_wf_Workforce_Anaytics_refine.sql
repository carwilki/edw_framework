...
CREATE TABLE
    WFA_PAYCD (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-refine-p1-gcs-gbl/labor_mgmt/wfa_paycd';
...
CREATE TABLE
    WFA_PAYCD_PRE (
        ...
        CORE_HRS_SWT INT,
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-raw-p1-gcs-gbl/labor_mgmt/wfa_paycd_pre' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_EMP (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-refine-p1-gcs-gbl/labor_mgmt/wfa_emp' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_ORG (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-refine-p1-gcs-gbl/labor_mgmt/wfa_org' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_LBRACCT (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-refine-p1-gcs-gbl/labor_mgmt/wfa_lbracct';
...
CREATE TABLE
    WFA_FCST_SLS_DEPT (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-refine-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_dept' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_FCST_SLS_TASK (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-prod-refine-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_task';
