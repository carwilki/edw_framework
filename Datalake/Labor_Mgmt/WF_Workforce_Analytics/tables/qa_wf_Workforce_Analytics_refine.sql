...
CREATE TABLE
    WFA_ORG_PRE (
        ...
        ORG_LVL_NBR BIGINT,
        ORG_TYP_ID BIGINT,
        ORG_TYP_NAM national STRING,
        ORG_TYP_DES national STRING,
        ORG_TYP_DISP_NBR BIGINT,
        ORG_JOB_SWT INT,
        ORG_RT_SWT INT,
        ORG_EFF_DAT TIMESTAMP not null,
        ORG_EXP_DAT TIMESTAMP,
        ORG_LVL06_NAM national STRING,
        ORG_LVL07_NAM national STRING,
        ORG_LVL08_NAM national STRING,
        ORG_LVL09_NAM national STRING,
        ORG_LVL10_NAM national STRING,
        UPDT_DTM TIMESTAMP,
        REC_ACTV_SWT INT,
        REC_EXP_DTM TIMESTAMP,
        LBRLVL_ID BIGINT,
        LBRLVL_DISP_NBR BIGINT,
        LBRLVL_NAM national STRING,
        LBRLVL_ENTRY_ID BIGINT,
        LBRLVL_ENTRY_NAM national STRING,
        LBRLVL_ENTRY_DES national STRING,
        LBRLVL_ENTRY_ACTV_SWT INT
    ) USING delta LOCATION 'gs://petm-bdpl-qa-raw-p1-gcs-gbl/labor_mgmt/wfa_org_pre' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_PAYCD (
        ...
        PAYCD_NAM national STRING,
        PAYCD_TYP_COD national STRING,
        ...
        PAYCAT_NAM national STRING,
        CORE_HRS_SWT INT,
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-refine-p1-gcs-gbl/labor_mgmt/wfa_paycd' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_PAYCD_PRE (
        ...
        CORE_HRS_SWT INT,
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-raw-p1-gcs-gbl/labor_mgmt/wfa_paycd_pre' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_EMP (
        ...
        PRSN_NBR_TXT national STRING,
        SR_RANK_DAT TIMESTAMP,
        DFLT_TZONE_SKEY BIGINT,
        DFLT_TZONE_DES national STRING,
        DVC_GRP_NAM national STRING,
        ...
        BADGE_COD national STRING,
        EMP_BADGE_EFF_DAT TIMESTAMP,
        EMP_BADGE_EXP_DAT TIMESTAMP,
        EM_MNR_SWT INT,
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-refine-p1-gcs-gbl/labor_mgmt/wfa_emp' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_EMP_PRE (
        ...
        EM_MNR_SWT INT,
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-raw-p1-gcs-gbl/labor_mgmt/wfa_emp_pre' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_ORG (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-refine-p1-gcs-gbl/labor_mgmt/wfa_org' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
,
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-refine-p1-gcs-gbl/labor_mgmt/wfa_lbracct' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_LBRACCT_PRE (
        ...
        SRC_SKEY INT,
        TENANT_SKEY INT
    ) USING delta LOCATION 'gs://petm-bdpl-qa-raw-p1-gcs-gbl/labor_mgmt/wfa_lbracct_pre' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_FCST_SLS_DEPT (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-refine-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_dept' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');
...
CREATE TABLE
    WFA_FCST_SLS_TASK (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-refine-p1-gcs-gbl/labor_mgmt/wfa_fcst_sls_task' TBLPROPERTIES ('delta.feature.allowColumnDefaults' = 'supported');

--DISTRIBUTE ON (ORG_ID)
--*****  Creating table:  "WFA_TSCHD_PRE" , ***** Creating table: "WFA_TSCHD_PRE"
use qa_empl_protected;
...
CREATE TABLE
    raw_WFA_TSCHD_PRE (
        ...
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tschd_pre';

--DISTRIBUTE ON (TSCHD_ID)--*****  Creating table:  "WFA_TSCHD_DIFF_PRE" , ***** Creating table: "WFA_TSCHD_DIFF_PRE"
use qa_empl_protected;
...
CREATE TABLE
    raw_WFA_TSCHD_DIFF_PRE (
        ...
        CORE_HRS DECIMAL(16, 6),
        NON_CORE_HRS DECIMAL(16, 6)
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tschd_diff_pre';
...
CREATE TABLE
    ...
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tdtl_diff_pre';
...
CREATE TABLE
    raw_WFA_TSCHD_PREV_PRE (
        ...
        CORE_HRS DECIMAL(16, 6),
        NON_CORE_HRS DECIMAL(16, 6)
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tschd_prev_pre';
...
CREATE TABLE
    raw_WFA_TDTL_PRE (
        ...
        GRP_SCHD_SKEY BIGINT,
        UPDT_DTM TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tdtl_pre';
...
CREATE TABLE
    raw_WFA_TDTL_PREV_PRE (
        ...
        LOCKED_SWT INT,
        GRP_SCHD_SKEY BIGINT
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-raw-p1-gcs-gbl/labor_mgmt/wfa_tdtl_prev_pre';
...
CREATE TABLE
    legacy_WFA_TSCHD (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_tschd';
...
CREATE TABLE
    legacy_WFA_TDTL (
        ...
        UPDATE_DT TIMESTAMP,
        LOAD_DT TIMESTAMP
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-nzlegacy-p1-gcs-gbl/labor_mgmt/wfa_tdtl';
...
CREATE TABLE
    ...
    ) USING delta LOCATION 'gs://petm-bdpl-qa-empl-protected-nzlegacy-p1-gcs-gbl/labor_mgmt/employee_profile';
