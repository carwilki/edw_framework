...
FIL_IS_STORE_NBR = SQ_Shortcut_to_DIM_ORG_temp.selectExpr(
	...
	"SQ_Shortcut_to_DIM_ORG___LBRLVL_ENTRY_ACTV_SWT as LBRLVL_ENTRY_ACTV_SWT").filter(col("ORG_LVL06_NAM").cast("int").isNotNull()).withColumn("sys_row_id", monotonically_increasing_id())
