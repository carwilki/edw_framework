...
Shortcut_to_WFA_LBRACCT = Upd_Wfa_Lbracct.selectExpr(
	"CAST(LBRACCT_ID AS BIGINT) as LBRACCT_ID",
	...
	"CAST(LBRACCT1_ID AS BIGINT) as LBRACCT1_ID",
	...
	"CAST(LBRACCT2_ID AS BIGINT) as LBRACCT2_ID",
	...
	"CAST(LBRACCT3_ID AS BIGINT) as LBRACCT3_ID",
	...
	"CAST(LBRACCT4_ID AS BIGINT) as LBRACCT4_ID",
	...
	"CAST(LBRACCT5_ID AS BIGINT) as LBRACCT5_ID",
	...
	"CAST(LBRACCT6_ID AS BIGINT) as LBRACCT6_ID",
	...
	"CAST(LBRACCT7_ID AS BIGINT) as LBRACCT7_ID",
	...
	"CAST(SRC_SKEY AS BIGINT) as SRC_SKEY",
	"CAST(TENANT_SKEY AS BIGINT) as TENANT_SKEY",
