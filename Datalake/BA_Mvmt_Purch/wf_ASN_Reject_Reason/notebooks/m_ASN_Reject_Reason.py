...
EXP_REQ_FIELDS = SQ_Shortcut_to_ASN_N_CPLT_RPT.selectExpr(
    ...
    "IF (ASN_CREATE_TM IS NULL,ASN_CREATE_TM ,date_format( ASN_CREATE_TM , 'HH:mm:ss' )) as ASN_CREATE_TIME",
    ...
    "IF (GR_CREATE_TM IS NULL,GR_CREATE_TM ,date_format( GR_CREATE_TM , 'HH:mm:ss' )) as GR_CREATE_TIME",
...
Shortcut_to_ASN_REJECT_RSN = EXP_ALL_FIELDS.selectExpr(
    ...
    "CAST(ASN_CREATE_TIME as STRING)as ASN_CREATE_TIME",
    ...
    "CAST(GR_CREATE_TIME as STRING) as GR_CREATE_TIME",
