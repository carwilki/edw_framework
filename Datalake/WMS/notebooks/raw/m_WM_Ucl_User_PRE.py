#Code converted on 2023-05-16 15:07:14
import os
...
EXPTRANS = SQ_Shortcut_to_UCL_USER.selectExpr(
	"sys_row_id as sys_row_id",
	"'$$DC_NBR' as DC_NBR_EXP",
	"SQ_Shortcut_to_UCL_USER.UCL_USER_ID as UCL_USER_ID",
	"SQ_Shortcut_to_UCL_USER.COMPANY_ID as COMPANY_ID",
	"SQ_Shortcut_to_UCL_USER.USER_NAME as USER_NAME",
	"SQ_Shortcut_to_UCL_USER.USER_PASSWORD as USER_PASSWORD",
	"SQ_Shortcut_to_UCL_USER.IS_ACTIVE as IS_ACTIVE",
	"SQ_Shortcut_to_UCL_USER.CREATED_SOURCE_TYPE_ID as CREATED_SOURCE_TYPE_ID",
	"SQ_Shortcut_to_UCL_USER.CREATED_SOURCE as CREATED_SOURCE",
	"SQ_Shortcut_to_UCL_USER.CREATED_DTTM as CREATED_DTTM",
	"SQ_Shortcut_to_UCL_USER.LAST_UPDATED_SOURCE_TYPE_ID as LAST_UPDATED_SOURCE_TYPE_ID",
	"SQ_Shortcut_to_UCL_USER.LAST_UPDATED_SOURCE as LAST_UPDATED_SOURCE",
	"SQ_Shortcut_to_UCL_USER.LAST_UPDATED_DTTM as LAST_UPDATED_DTTM",
	"SQ_Shortcut_to_UCL_USER.USER_TYPE_ID as USER_TYPE_ID",
	"SQ_Shortcut_to_UCL_USER.LOCALE_ID as LOCALE_ID",
	"SQ_Shortcut_to_UCL_USER.LOCATION_ID as LOCATION_ID",
	"SQ_Shortcut_to_UCL_USER.USER_FIRST_NAME as USER_FIRST_NAME",
	"SQ_Shortcut_to_UCL_USER.USER_MIDDLE_NAME as USER_MIDDLE_NAME",
	"SQ_Shortcut_to_UCL_USER.USER_LAST_NAME as USER_LAST_NAME",
	"SQ_Shortcut_to_UCL_USER.USER_PREFIX as USER_PREFIX",
	"SQ_Shortcut_to_UCL_USER.USER_TITLE as USER_TITLE",
	"SQ_Shortcut_to_UCL_USER.TELEPHONE_NUMBER as TELEPHONE_NUMBER",
	"SQ_Shortcut_to_UCL_USER.FAX_NUMBER as FAX_NUMBER",
	"SQ_Shortcut_to_UCL_USER.ADDRESS_1 as ADDRESS_1",
	"SQ_Shortcut_to_UCL_USER.ADDRESS_2 as ADDRESS_2",
	"SQ_Shortcut_to_UCL_USER.CITY as CITY",
	"SQ_Shortcut_to_UCL_USER.STATE_PROV_CODE as STATE_PROV_CODE",
	"SQ_Shortcut_to_UCL_USER.POSTAL_CODE as POSTAL_CODE",
	"SQ_Shortcut_to_UCL_USER.COUNTRY_CODE as COUNTRY_CODE",
	"SQ_Shortcut_to_UCL_USER.USER_EMAIL_1 as USER_EMAIL_1",
	"SQ_Shortcut_to_UCL_USER.USER_EMAIL_2 as USER_EMAIL_2",
	"SQ_Shortcut_to_UCL_USER.COMM_METHOD_ID_DURING_BH_1 as COMM_METHOD_ID_DURING_BH_1",
	"SQ_Shortcut_to_UCL_USER.COMM_METHOD_ID_DURING_BH_2 as COMM_METHOD_ID_DURING_BH_2",
	"SQ_Shortcut_to_UCL_USER.COMM_METHOD_ID_AFTER_BH_1 as COMM_METHOD_ID_AFTER_BH_1",
	"SQ_Shortcut_to_UCL_USER.COMM_METHOD_ID_AFTER_BH_2 as COMM_METHOD_ID_AFTER_BH_2",
	"SQ_Shortcut_to_UCL_USER.COMMON_NAME as COMMON_NAME",
	"SQ_Shortcut_to_UCL_USER.LAST_PASSWORD_CHANGE_DTTM as LAST_PASSWORD_CHANGE_DTTM",
	"SQ_Shortcut_to_UCL_USER.LOGGED_IN as LOGGED_IN",
	"SQ_Shortcut_to_UCL_USER.LAST_LOGIN_DTTM as LAST_LOGIN_DTTM",
	"SQ_Shortcut_to_UCL_USER.DEFAULT_BUSINESS_UNIT_ID as DEFAULT_BUSINESS_UNIT_ID",
	"SQ_Shortcut_to_UCL_USER.DEFAULT_WHSE_REGION_ID as DEFAULT_WHSE_REGION_ID",
	"SQ_Shortcut_to_UCL_USER.CHANNEL_ID as CHANNEL_ID",
	"SQ_Shortcut_to_UCL_USER.HIBERNATE_VERSION as HIBERNATE_VERSION",
	"SQ_Shortcut_to_UCL_USER.NUMBER_OF_INVALID_LOGINS as NUMBER_OF_INVALID_LOGINS",
	"SQ_Shortcut_to_UCL_USER.TAX_ID_NBR as TAX_ID_NBR",
	"SQ_Shortcut_to_UCL_USER.EMP_START_DATE as EMP_START_DATE",
	"SQ_Shortcut_to_UCL_USER.BIRTH_DATE as BIRTH_DATE",
	"SQ_Shortcut_to_UCL_USER.GENDER_ID as GENDER_ID",
	"SQ_Shortcut_to_UCL_USER.PASSWORD_RESET_DATE_TIME as PASSWORD_RESET_DATE_TIME",
	"SQ_Shortcut_to_UCL_USER.PASSWORD_TOKEN as PASSWORD_TOKEN",
	"SQ_Shortcut_to_UCL_USER.ISPASSWORDMANAGEDINTERNALLY as ISPASSWORDMANAGEDINTERNALLY",
	"SQ_Shortcut_to_UCL_USER.COPY_FROM_USER as COPY_FROM_USER",
	"SQ_Shortcut_to_UCL_USER.EXTERNAL_USER_ID as EXTERNAL_USER_ID",
	"SQ_Shortcut_to_UCL_USER.SECURITY_POLICY_GROUP_ID as SECURITY_POLICY_GROUP_ID",
