...
logger.info(
    "Query to extract data from" + refined_perf_table + " executed successfully"
)
...
EXP_INT_CONV = SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.select(
    ...
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.PERF_SMRY_TRAN_ID.alias(
        "PERF_SMRY_TRAN_ID"
    ),
    ...
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.JOB_FUNCTION_NAME.alias(
        "JOB_FUNCTION_NAME"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.SPVSR_LOGIN_USER_ID.alias(
        "SPVSR_LOGIN_USER_ID"
    ),
    ...
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.PAID_OVERLAP_OSDL.alias(
        "PAID_OVERLAP_OSDL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.UNPAID_OVERLAP_OSDL.alias(
        "UNPAID_OVERLAP_OSDL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.PAID_OVERLAP_NSDL.alias(
        "PAID_OVERLAP_NSDL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.UNPAID_OVERLAP_NSDL.alias(
        "UNPAID_OVERLAP_NSDL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.PAID_OVERLAP_OSIL.alias(
        "PAID_OVERLAP_OSIL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.UNPAID_OVERLAP_OSIL.alias(
        "UNPAID_OVERLAP_OSIL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.PAID_OVERLAP_UDIL.alias(
        "PAID_OVERLAP_UDIL"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.UNPAID_OVERLAP_UDIL.alias(
        "UNPAID_OVERLAP_UDIL"
    ),
    ...
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.RESOURCE_GROUP_ID.alias(
        "RESOURCE_GROUP_ID"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.COMP_ASSIGNMENT_ID.alias(
        "COMP_ASSIGNMENT_ID"
    ),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.REFLECTIVE_CODE.alias("REFLECTIVE_CODE"),
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE.LOAD_TSTMP.alias("LOAD_TSTMP"),
).select(
...
SQ_Shortcut_to_SITE_PROFILE = spark.sql(site_profile_query).withColumn(
    "sys_row_id", monotonically_increasing_id()
)
...
JNR_WM_E_CON_PERF_SMRY = SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY.join(
    JNR_SITE_PROFILE,
    [
        SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY.LOCATION_ID
        == JNR_SITE_PROFILE.LOCATION_ID,
        SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY.WM_PERF_SMRY_TRAN_ID
        == JNR_SITE_PROFILE.PERF_SMRY_TRAN_ID,
    ],
    "right_outer",
).select(
    ...
    SQ_Shortcut_to_WM_E_CONSOL_PERF_SMRY.WM_PERF_SMRY_TRAN_ID.alias(
        "in_WM_PERF_SMRY_TRAN_ID"
    ),
...
EXP_EVAL_VALUES = FIL_NO_CHANGE_REC.select(
    ...
    FIL_NO_CHANGE_REC.in_WM_MOD_TSTMP.alias("WM_MOD_TSTMP"),
).select(
    (col("sys_row_id")).alias("sys_row_id"),
    col("LOCATION_ID"),
    col("PERF_SMRY_TRAN_ID"),
    ...
    (
        when(
            (col("in_LOAD_TSTMP").isNull()), (date_trunc("second", current_timestamp()))
        ).otherwise(col("in_LOAD_TSTMP"))
    ).alias("LOAD_TSTMP"),
...
UPD_VALIDATE = UPD_VALIDATE.withColumn(
    "pyspark_data_action",
    when((UPD_VALIDATE.in_WM_PERF_SMRY_TRAN_ID.isNull()), (lit(0))).otherwise(lit(1)),
)
...
Shortcut_to_WM_E_CONSOL_PERF_SMRY = UPD_VALIDATE.select(
    ...
    UPD_VALIDATE.PERF_SMRY_TRAN_ID.cast(DecimalType(20, 0)).alias(
    ...
    UPD_VALIDATE.UNPAID_OVERLAP_OSDL.cast(DecimalType(20, 7)).alias(
        "UNPAID_OVERLAP_OSDL"
    ),
    UPD_VALIDATE.PAID_OVERLAP_NSDL.cast(DecimalType(20, 7)).alias("PAID_OVERLAP_NSDL"),
    UPD_VALIDATE.UNPAID_OVERLAP_NSDL.cast(DecimalType(20, 7)).alias(
        "UNPAID_OVERLAP_NSDL"
    ),
    UPD_VALIDATE.PAID_OVERLAP_OSIL.cast(DecimalType(20, 7)).alias("PAID_OVERLAP_OSIL"),
    UPD_VALIDATE.UNPAID_OVERLAP_OSIL.cast(DecimalType(20, 7)).alias(
        "UNPAID_OVERLAP_OSIL"
    ),
    UPD_VALIDATE.PAID_OVERLAP_UDIL.cast(DecimalType(20, 7)).alias("PAID_OVERLAP_UDIL"),
    UPD_VALIDATE.UNPAID_OVERLAP_UDIL.cast(DecimalType(20, 7)).alias(
        "UNPAID_OVERLAP_UDIL"
    ),
