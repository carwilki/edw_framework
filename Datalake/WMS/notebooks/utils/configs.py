...
def getMaxDate(refine_table_name,env):
    if refine_table_name=='WM_E_DEPT':
        maxDateQuery= '''select WM_CREATE_TSTMP,WM_MOD_TSTMP,WM_CREATED_TSTMP,greatest(coalesce(WM_CREATE_TSTMP,WM_MOD_TSTMP,WM_CREATED_TSTMP),coalesce(WM_MOD_TSTMP,WM_CREATE_TSTMP,WM_CREATED_TSTMP) ,coalesce(WM_CREATED_TSTMP,WM_CREATE_TSTMP,WM_MOD_TSTMP) ) as max_date from '''+env+'''refine.'''+refine_table_name #refinetable name to be added
    elif refine_table_name=='WM_UCL_USER':
        maxDateQuery= '''select greatest(coalesce(WM_CREATED_TSTMP,WM_LAST_UPDATED_TSTMP),coalesce(WM_LAST_UPDATED_TSTMP,WM_CREATED_TSTMP) ) as max_date from '''+env+'''refine.'''+refine_table_name
    elif refine_table_name=='WM_E_CONSOL_PERF_SMRY':
        maxDateQuery= '''select greatest(coalesce(WM_CREATE_TSTMP,WM_MOD_TSTMP),coalesce(WM_MOD_TSTMP,WM_CREATE_TSTMP) ) as max_date from '''+env+'''refine.'''+refine_table_name
