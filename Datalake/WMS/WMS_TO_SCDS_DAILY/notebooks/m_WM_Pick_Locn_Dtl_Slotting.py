...
WM_PICK_LOCN_DTL_SLOTTING_PRE.DC_NBR,
WM_PICK_LOCN_DTL_SLOTTING_PRE.PICK_LOCN_DTL_ID,
WM_PICK_LOCN_DTL_SLOTTING_PRE.HIST_MATCH,
WM_PICK_LOCN_DTL_SLOTTING_PRE.CUR_ORIENTATION,
WM_PICK_LOCN_DTL_SLOTTING_PRE.IGN_FOR_RESLOT,
WM_PICK_LOCN_DTL_SLOTTING_PRE.REC_LANES,
WM_PICK_LOCN_DTL_SLOTTING_PRE.REC_STACKING,
WM_PICK_LOCN_DTL_SLOTTING_PRE.HI_RESIDUAL_1,
WM_PICK_LOCN_DTL_SLOTTING_PRE.OPT_PALLET_PATTERN,
WM_PICK_LOCN_DTL_SLOTTING_PRE.SI_NUM_1,
WM_PICK_LOCN_DTL_SLOTTING_PRE.SI_NUM_2,
WM_PICK_LOCN_DTL_SLOTTING_PRE.SI_NUM_3,
WM_PICK_LOCN_DTL_SLOTTING_PRE.SI_NUM_4,
WM_PICK_LOCN_DTL_SLOTTING_PRE.SI_NUM_5,
WM_PICK_LOCN_DTL_SLOTTING_PRE.SI_NUM_6,
WM_PICK_LOCN_DTL_SLOTTING_PRE.MULT_LOC_GRP,
WM_PICK_LOCN_DTL_SLOTTING_PRE.REPLEN_GROUP,
WM_PICK_LOCN_DTL_SLOTTING_PRE.CREATED_SOURCE_TYPE,
WM_PICK_LOCN_DTL_SLOTTING_PRE.CREATED_SOURCE,
WM_PICK_LOCN_DTL_SLOTTING_PRE.CREATED_DTTM,
WM_PICK_LOCN_DTL_SLOTTING_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_PICK_LOCN_DTL_SLOTTING_PRE.LAST_UPDATED_SOURCE,
WM_PICK_LOCN_DTL_SLOTTING_PRE.LAST_UPDATED_DTTM
FROM WM_PICK_LOCN_DTL_SLOTTING_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_PICK_LOCN_DTL_SLOTTING.LOCATION_ID,
WM_PICK_LOCN_DTL_SLOTTING.WM_PICK_LOCN_DTL_ID,
WM_PICK_LOCN_DTL_SLOTTING.REPLEN_GROUP,
WM_PICK_LOCN_DTL_SLOTTING.CUR_ORIENTATION,
WM_PICK_LOCN_DTL_SLOTTING.REC_LANES,
WM_PICK_LOCN_DTL_SLOTTING.REC_STACKING,
WM_PICK_LOCN_DTL_SLOTTING.MULT_LOC_GRP,
WM_PICK_LOCN_DTL_SLOTTING.HIST_MATCH,
WM_PICK_LOCN_DTL_SLOTTING.IGN_FOR_RESLOT_FLAG,
WM_PICK_LOCN_DTL_SLOTTING.OPT_PALLET_PATTERN,
WM_PICK_LOCN_DTL_SLOTTING.HI_RESIDUAL_1,
WM_PICK_LOCN_DTL_SLOTTING.SI_NUM_1,
WM_PICK_LOCN_DTL_SLOTTING.SI_NUM_2,
WM_PICK_LOCN_DTL_SLOTTING.SI_NUM_3,
WM_PICK_LOCN_DTL_SLOTTING.SI_NUM_4,
WM_PICK_LOCN_DTL_SLOTTING.SI_NUM_5,
WM_PICK_LOCN_DTL_SLOTTING.SI_NUM_6,
WM_PICK_LOCN_DTL_SLOTTING.WM_CREATED_SOURCE_TYPE,
WM_PICK_LOCN_DTL_SLOTTING.WM_CREATED_SOURCE,
WM_PICK_LOCN_DTL_SLOTTING.WM_CREATED_TSTMP,
WM_PICK_LOCN_DTL_SLOTTING.WM_LAST_UPDATED_SOURCE_TYPE,
WM_PICK_LOCN_DTL_SLOTTING.WM_LAST_UPDATED_SOURCE,
WM_PICK_LOCN_DTL_SLOTTING.WM_LAST_UPDATED_TSTMP,
WM_PICK_LOCN_DTL_SLOTTING.LOAD_TSTMP
FROM WM_PICK_LOCN_DTL_SLOTTING
WHERE WM_PICK_LOCN_DTL_ID IN (SELECT PICK_LOCN_DTL_ID FROM WM_PICK_LOCN_DTL_SLOTTING_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
