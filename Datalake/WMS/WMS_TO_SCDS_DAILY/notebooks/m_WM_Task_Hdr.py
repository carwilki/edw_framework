...
WM_TASK_HDR.LOCATION_ID,
WM_TASK_HDR.WM_TASK_HDR_ID,
WM_TASK_HDR.WM_CREATE_TSTMP,
WM_TASK_HDR.WM_MOD_TSTMP,
WM_TASK_HDR.LOAD_TSTMP
FROM WM_TASK_HDR
WHERE WM_TASK_HDR_ID IN (SELECT TASK_HDR_ID FROM WM_TASK_HDR_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_TASK_HDR_PRE.DC_NBR,
WM_TASK_HDR_PRE.TASK_HDR_ID,
WM_TASK_HDR_PRE.TASK_ID,
WM_TASK_HDR_PRE.WHSE,
WM_TASK_HDR_PRE.TASK_DESC,
WM_TASK_HDR_PRE.INVN_TYPE,
WM_TASK_HDR_PRE.INVN_NEED_TYPE,
WM_TASK_HDR_PRE.DFLT_TASK_PRTY,
WM_TASK_HDR_PRE.CURR_TASK_PRTY,
WM_TASK_HDR_PRE.XPECTD_DURTN,
WM_TASK_HDR_PRE.ACTL_DURTN,
WM_TASK_HDR_PRE.ERLST_START_DATE_TIME,
WM_TASK_HDR_PRE.LTST_START_DATE_TIME,
WM_TASK_HDR_PRE.LTST_CMPL_DATE_TIME,
WM_TASK_HDR_PRE.BEGIN_AREA,
WM_TASK_HDR_PRE.BEGIN_ZONE,
WM_TASK_HDR_PRE.BEGIN_AISLE,
WM_TASK_HDR_PRE.END_AREA,
WM_TASK_HDR_PRE.END_ZONE,
WM_TASK_HDR_PRE.END_AISLE,
WM_TASK_HDR_PRE.START_CURR_WORK_GRP,
WM_TASK_HDR_PRE.START_CURR_WORK_AREA,
WM_TASK_HDR_PRE.END_CURR_WORK_GRP,
WM_TASK_HDR_PRE.END_CURR_WORK_AREA,
WM_TASK_HDR_PRE.START_DEST_WORK_GRP,
WM_TASK_HDR_PRE.START_DEST_WORK_AREA,
WM_TASK_HDR_PRE.END_DEST_WORK_GRP,
WM_TASK_HDR_PRE.END_DEST_WORK_AREA,
WM_TASK_HDR_PRE.TASK_TYPE,
WM_TASK_HDR_PRE.TASK_GENRTN_REF_CODE,
WM_TASK_HDR_PRE.TASK_GENRTN_REF_NBR,
WM_TASK_HDR_PRE.NEED_ID,
WM_TASK_HDR_PRE.TASK_BATCH,
WM_TASK_HDR_PRE.STAT_CODE,
WM_TASK_HDR_PRE.CREATE_DATE_TIME,
WM_TASK_HDR_PRE.MOD_DATE_TIME,
WM_TASK_HDR_PRE.USER_ID,
WM_TASK_HDR_PRE.RLS_DATE_TIME,
WM_TASK_HDR_PRE.TASK_CMPL_REF_CODE,
WM_TASK_HDR_PRE.TASK_CMPL_REF_NBR,
WM_TASK_HDR_PRE.OWNER_USER_ID,
WM_TASK_HDR_PRE.ONE_USER_PER_GRP,
WM_TASK_HDR_PRE.NEXT_TASK_ID,
WM_TASK_HDR_PRE.EXCEPTION_CODE,
WM_TASK_HDR_PRE.CURR_LOCN_ID,
WM_TASK_HDR_PRE.TASK_PARM_ID,
WM_TASK_HDR_PRE.RULE_ID,
WM_TASK_HDR_PRE.VOCOLLECT_ASSIGN_ID,
WM_TASK_HDR_PRE.CURR_USER_ID,
WM_TASK_HDR_PRE.MHE_FLAG,
WM_TASK_HDR_PRE.PICK_TO_TOTE_FLAG,
WM_TASK_HDR_PRE.MHE_ORD_STATE,
WM_TASK_HDR_PRE.PRT_TASK_LIST_FLAG,
WM_TASK_HDR_PRE.RPT_PRTR_REQSTR,
WM_TASK_HDR_PRE.ORIG_TASK_ID,
WM_TASK_HDR_PRE.DOC_ID,
WM_TASK_HDR_PRE.VOCO_INTRNL_REVERSE_ID,
WM_TASK_HDR_PRE.WM_VERSION_ID,
WM_TASK_HDR_PRE.ITEM_ID,
WM_TASK_HDR_PRE.LOCN_HDR_ID,
WM_TASK_HDR_PRE.TASK_RULE_PARM_ID,
WM_TASK_HDR_PRE.PICK_CART_TYPE,
WM_TASK_HDR_PRE.REPRINT_COUNT,
WM_TASK_HDR_PRE.ESTIMATED_TIME,
WM_TASK_HDR_PRE.ESTIMATED_DISTANCE,
WM_TASK_HDR_PRE.LOAD_TSTMP
FROM WM_TASK_HDR_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
