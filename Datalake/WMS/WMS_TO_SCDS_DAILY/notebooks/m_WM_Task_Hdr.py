...
Shortcut_to_WM_TASK_HDR1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(TASK_RULE_PARM_ID AS INT) as WM_TASK_RULE_PARM_ID",
	"CAST(TASK_PARM_ID AS INT) as WM_TASK_PARM_ID",
	"CAST(RULE_ID AS INT) as WM_RULE_ID",
	...
	"CAST(MHE_FLAG AS TINYINT) as WM_MHE_FLAG",
	"CAST(PICK_TO_TOTE_FLAG AS TINYINT) as PICK_TO_TOTE_FLAG",
	"CAST(MHE_ORD_STATE AS STRING) as WM_MHE_ORD_STATE",
	"CAST(PRT_TASK_LIST_FLAG AS TINYINT) as PRT_TASK_LIST_FLAG",
