...
Shortcut_to_WM_LPN_DETAIL1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(LPN_DETAIL_STATUS AS BIGINT) as WM_LPN_DETAIL_STATUS", 
	...
	"CAST(PACK_CODE AS BIGINT) as WM_PACK_CD", 
	"CAST(RECEIVED_QTY AS BIGINT) as WM_RECEIVED_QTY", 
	"CAST(STD_PACK_QTY AS BIGINT) as WM_STD_PACK_QTY", 
	"CAST(STD_SUB_PACK_QTY AS BIGINT) as WM_STD_SUB_PACK_QTY", 
	"CAST(STD_BUNDLE_QTY AS BIGINT) as WM_STD_BUNDLE_QTY", 
	...
	"CAST(HAZMAT_UOM AS BIGINT) as WM_HAZMAT_UOM_ID", 
