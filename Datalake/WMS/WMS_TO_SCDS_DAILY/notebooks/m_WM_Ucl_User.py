...
# FIL_UNCHANGED_RECORDS_temp.printSchema()
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( 
	...
	"IF(( FIL_UNCHANGED_RECORDS___i_USER_NAME1 IS NULL AND FIL_UNCHANGED_RECORDS___i_LOCATION_ID IS NULL ), 1, 2) as o_UPDATE_VALIDATOR" 
)
...
Shortcut_to_WM_UCL_USER = UPD_INS_UPD.selectExpr(
	...
	"CAST(LOCALE_ID AS SMALLINT) as WM_LOCALE_ID",
	"CAST(USER_TYPE_ID AS SMALLINT) as WM_USER_TYPE_ID",
	...
	"CAST(DEFAULT_BUSINESS_UNIT_ID AS INT) as DEFAULT_WM_BUSINESS_UNIT_ID",
	"CAST(DEFAULT_WHSE_REGION_ID AS INT) as DEFAULT_WM_WHSE_REGION_ID",
	"CAST(CHANNEL_ID AS BIGINT) as WM_CHANNEL_ID",
	"CAST(COMM_METHOD_ID_DURING_BH_1 AS SMALLINT) as WM_COMM_METHOD_ID_DURING_BH_1",
	"CAST(COMM_METHOD_ID_DURING_BH_2 AS SMALLINT) as WM_COMM_METHOD_ID_DURING_BH_2",
	"CAST(COMM_METHOD_ID_AFTER_BH_1 AS SMALLINT) as WM_COMM_METHOD_ID_AFTER_BH_1",
	"CAST(COMM_METHOD_ID_AFTER_BH_2 AS SMALLINT) as WM_COMM_METHOD_ID_AFTER_BH_2",
	"CAST(ISPASSWORDMANAGEDINTERNALLY AS TINYINT) as PASSWORD_MANAGED_INTERNALLY_FLAG",
	"CAST(LOGGED_IN1 AS TINYINT) as LOGGED_IN_FLAG",
	"CAST(LAST_LOGIN_DTTM AS TIMESTAMP) as LAST_LOGIN_TSTMP",
	"CAST(NUMBER_OF_INVALID_LOGINS1 AS SMALLINT) as NUMBER_OF_INVALID_LOGINS",
	...
	"CAST(CREATED_SOURCE_TYPE_ID AS SMALLINT) as WM_CREATED_SOURCE_TYPE_ID",
	"CAST(CREATED_SOURCE AS STRING) as WM_CREATED_SOURCE",
	"CAST(CREATED_DTTM AS TIMESTAMP) as WM_CREATED_TSTMP",
	"CAST(LAST_UPDATED_SOURCE_TYPE_ID AS SMALLINT) as WM_LAST_UPDATED_SOURCE_TYPE_ID",
