...
FROM WM_UCL_USER_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
FROM WM_UCL_USER
WHERE USER_NAME IN (SELECT USER_NAME FROM WM_UCL_USER_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
