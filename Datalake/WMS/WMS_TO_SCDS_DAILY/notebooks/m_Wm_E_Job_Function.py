...
WM_E_JOB_FUNCTION.LOCATION_ID,
WM_E_JOB_FUNCTION.WM_JOB_FUNCTION_ID,
WM_E_JOB_FUNCTION.WM_CREATED_TSTMP,
WM_E_JOB_FUNCTION.WM_LAST_UPDATED_TSTMP,
...
WM_E_JOB_FUNCTION_PRE.DC_NBR,
WM_E_JOB_FUNCTION_PRE.JOB_FUNC_ID,
WM_E_JOB_FUNCTION_PRE.NAME,
WM_E_JOB_FUNCTION_PRE.DESCRIPTION,
WM_E_JOB_FUNCTION_PRE.STARTUP_TIME,
WM_E_JOB_FUNCTION_PRE.CLEANUP_TIME,
WM_E_JOB_FUNCTION_PRE.CREATE_DATE_TIME,
WM_E_JOB_FUNCTION_PRE.MOD_DATE_TIME,
WM_E_JOB_FUNCTION_PRE.USER_ID,
WM_E_JOB_FUNCTION_PRE.WHSE,
WM_E_JOB_FUNCTION_PRE.TRANSITION_START_TIME,
WM_E_JOB_FUNCTION_PRE.TRANSITION_END_TIME,
WM_E_JOB_FUNCTION_PRE.JF_TYPE,
WM_E_JOB_FUNCTION_PRE.LEVEL_1,
WM_E_JOB_FUNCTION_PRE.LEVEL_2,
WM_E_JOB_FUNCTION_PRE.LEVEL_3,
WM_E_JOB_FUNCTION_PRE.LEVEL_4,
WM_E_JOB_FUNCTION_PRE.LEVEL_5,
WM_E_JOB_FUNCTION_PRE.OPS_CODE_ID,
WM_E_JOB_FUNCTION_PRE.APPLY_TEAM_SETUP_TIME,
WM_E_JOB_FUNCTION_PRE.TEAM_STARTUP_TIME,
WM_E_JOB_FUNCTION_PRE.TEAM_CLEANUP_TIME,
WM_E_JOB_FUNCTION_PRE.TEAM_TRANSITION_START_TIME,
WM_E_JOB_FUNCTION_PRE.TEAM_TRANSITION_END_TIME,
WM_E_JOB_FUNCTION_PRE.MISC_TXT_1,
WM_E_JOB_FUNCTION_PRE.MISC_TXT_2,
WM_E_JOB_FUNCTION_PRE.MISC_NUM_1,
WM_E_JOB_FUNCTION_PRE.MISC_NUM_2,
WM_E_JOB_FUNCTION_PRE.DFLT_PROC_ZONE_ID,
WM_E_JOB_FUNCTION_PRE.PROC_ZONE_TEMPL_ID,
WM_E_JOB_FUNCTION_PRE.MSRMNT_ID,
WM_E_JOB_FUNCTION_PRE.VERSION_ID,
WM_E_JOB_FUNCTION_PRE.OBS_THRESHOLD_EP,
WM_E_JOB_FUNCTION_PRE.TRACK_HIST_TIME,
WM_E_JOB_FUNCTION_PRE.TRAIN_PERIOD,
WM_E_JOB_FUNCTION_PRE.RETRAIN_PERIOD,
WM_E_JOB_FUNCTION_PRE.OS_ONLY,
WM_E_JOB_FUNCTION_PRE.RETRAIN_REQ_DURATION,
WM_E_JOB_FUNCTION_PRE.PERF_GOAL_IND,
WM_E_JOB_FUNCTION_PRE.TRAINING_REQD,
WM_E_JOB_FUNCTION_PRE.USE_JF_TRAIN,
WM_E_JOB_FUNCTION_PRE.PERF_EVAL_PERIOD_ID,
WM_E_JOB_FUNCTION_PRE.DFLT_MAX_OCCUPANCY,
WM_E_JOB_FUNCTION_PRE.UNQ_SEED_ID,
WM_E_JOB_FUNCTION_PRE.DEFAULT_ACT_ID,
WM_E_JOB_FUNCTION_PRE.CREATED_DTTM,
WM_E_JOB_FUNCTION_PRE.LAST_UPDATED_DTTM,
WM_E_JOB_FUNCTION_PRE.PLAN_EP,
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___APPLY_TEAM_SETUP_TIME ) ) ) , 'Y','1' , '1','1','0' ) as APPLY_TEAM_SETUP_TIME_O", \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___TRACK_HIST_TIME ) ) ) , 'Y','1' , '1','1','0' ) as TRACK_HIST_TIME_O", \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___OS_ONLY ) ) ) , 'Y','1' , '1','1','0' ) as OS_ONLY_O", \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___PERF_GOAL_IND ) ) ) , 'Y','1' , '1','1','0' ) as PERF_GOAL_IND_O", \
	"FIL_UNCHANGED_RECORDS___TRAINING_REQD as TRAINING_REQD", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___TRAINING_REQD ) ) ) , 'Y','1' , '1','1','0' ) as TRAINING_REQD_O", \
	"FIL_UNCHANGED_RECORDS___USE_JF_TRAIN as USE_JF_TRAIN", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___USE_JF_TRAIN ) ) ) , 'Y','1' , '1','1','0' ) as USE_JF_TRAIN_O", \
