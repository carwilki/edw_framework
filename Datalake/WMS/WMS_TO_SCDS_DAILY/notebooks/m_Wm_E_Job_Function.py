...
Shortcut_to_WM_E_JOB_FUNCTION1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(JOB_FUNC_ID AS BIGINT) as WM_JOB_FUNCTION_ID", 
	...
	"CAST(UNQ_SEED_ID AS BIGINT) as WM_UNQ_SEED_ID", 
	"CAST(DEFAULT_ACT_ID AS BIGINT) as WM_DEFAULT_ACT_ID", 
	...
	"CAST(APPLY_TEAM_SETUP_TIME AS BIGINT) as APPLY_TEAM_SETUP_TIME_FLAG", 
	...
	"CAST(OPS_CODE_ID AS BIGINT) as WM_OPS_CD_ID", 
	"CAST(DFLT_PROC_ZONE_ID AS BIGINT) as WM_DFLT_PROC_ZONE_ID", 
	"CAST(PROC_ZONE_TEMPL_ID AS BIGINT) as WM_PROC_ZONE_TEMPL_ID", 
	"CAST(MSRMNT_ID AS BIGINT) as WM_MSRMNT_ID", 
	"CAST(OBS_THRESHOLD_EP AS BIGINT) as OBS_THRESHOLD_EP", 
	"CAST(TRACK_HIST_TIME AS BIGINT) as TRACK_HIST_TIME_FLAG", 
	"CAST(TRAIN_PERIOD AS BIGINT) as TRAIN_PERIOD", 
	"CAST(RETRAIN_PERIOD AS BIGINT) as RETRAIN_PERIOD", 
	"CAST(OS_ONLY AS BIGINT) as OS_ONLY_FLAG", 
	"CAST(RETRAIN_REQ_DURATION AS BIGINT) as RETRAIN_REQ_DURATION", 
	"CAST(PERF_GOAL_IND AS BIGINT) as PERF_GOAL_FLAG", 
	"CAST(TRAINING_REQD AS BIGINT) as TRAINING_REQD_FLAG", 
	"CAST(USE_JF_TRAIN AS BIGINT) as USE_JF_TRAIN_FLAG", 
