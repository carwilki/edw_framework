...
def m_WM_E_Consol_Perf_Smry_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_E_CONSOL_PERF_SMRY = jdbcOracleConnection(
        f"""SELECT
    ...
    SQ_Shortcut_to_E_CONSOL_PERF_SMRY_temp = SQ_Shortcut_to_E_CONSOL_PERF_SMRY.toDF(*["SQ_Shortcut_to_E_CONSOL_PERF_SMRY___" + col for col in SQ_Shortcut_to_E_CONSOL_PERF_SMRY.columns])
    ...
    Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(CLOCK_IN_STATUS AS SMALLINT) as CLOCK_IN_STATUS",
        "CAST(TOTAL_SAM AS DECIMAL(20,7)) as TOTAL_SAM",
        "CAST(TOTAL_PAM AS DECIMAL(13,5)) as TOTAL_PAM",
        "CAST(TOTAL_TIME AS DECIMAL(13,5)) as TOTAL_TIME",
        "CAST(OSDL AS DECIMAL(13,5)) as OSDL",
        "CAST(OSIL AS DECIMAL(13,5)) as OSIL",
        "CAST(NSDL AS DECIMAL(13,5)) as NSDL",
        "CAST(SIL AS DECIMAL(13,5)) as SIL",
        "CAST(UDIL AS DECIMAL(13,5)) as UDIL",
        "CAST(UIL AS DECIMAL(13,5)) as UIL",
        "CAST(ADJ_OSDL AS DECIMAL(13,5)) as ADJ_OSDL",
        "CAST(ADJ_OSIL AS DECIMAL(13,5)) as ADJ_OSIL",
        "CAST(ADJ_UDIL AS DECIMAL(13,5)) as ADJ_UDIL",
        "CAST(ADJ_NSDL AS DECIMAL(13,5)) as ADJ_NSDL",
        "CAST(PAID_BRK AS DECIMAL(13,5)) as PAID_BRK",
        "CAST(UNPAID_BRK AS DECIMAL(13,5)) as UNPAID_BRK",
        "CAST(REF_OSDL AS DECIMAL(13,5)) as REF_OSDL",
        "CAST(REF_OSIL AS DECIMAL(13,5)) as REF_OSIL",
        "CAST(REF_UDIL AS DECIMAL(13,5)) as REF_UDIL",
        "CAST(REF_NSDL AS DECIMAL(13,5)) as REF_NSDL",
        "CAST(REF_ADJ_OSDL AS DECIMAL(13,5)) as REF_ADJ_OSDL",
        "CAST(REF_ADJ_OSIL AS DECIMAL(13,5)) as REF_ADJ_OSIL",
        "CAST(REF_ADJ_UDIL AS DECIMAL(13,5)) as REF_ADJ_UDIL",
        "CAST(REF_ADJ_NSDL AS DECIMAL(13,5)) as REF_ADJ_NSDL",
        "CAST(MISC_NUMBER_1 AS DECIMAL(13,5)) as MISC_NUMBER_1",
        ...
        "CAST(REF_SAM AS DECIMAL(13,5)) as REF_SAM",
        "CAST(REF_PAM AS DECIMAL(13,5)) as REF_PAM",
        ...
        "CAST(LABOR_COST_RATE AS DECIMAL(20,7)) as LABOR_COST_RATE",
        "CAST(PAID_OVERLAP_OSDL AS DECIMAL(20,7)) as PAID_OVERLAP_OSDL",
        "CAST(UNPAID_OVERLAP_OSDL AS DECIMAL(20,7)) as UNPAID_OVERLAP_OSDL",
        "CAST(PAID_OVERLAP_NSDL AS DECIMAL(20,7)) as PAID_OVERLAP_NSDL",
        "CAST(UNPAID_OVERLAP_NSDL AS DECIMAL(20,7)) as UNPAID_OVERLAP_NSDL",
        "CAST(PAID_OVERLAP_OSIL AS DECIMAL(20,7)) as PAID_OVERLAP_OSIL",
        "CAST(UNPAID_OVERLAP_OSIL AS DECIMAL(20,7)) as UNPAID_OVERLAP_OSIL",
        "CAST(PAID_OVERLAP_UDIL AS DECIMAL(20,7)) as PAID_OVERLAP_UDIL",
        "CAST(UNPAID_OVERLAP_UDIL AS DECIMAL(20,7)) as UNPAID_OVERLAP_UDIL",
        "CAST(VERSION_ID AS INT) as VERSION_ID",
        "CAST(TEAM_CODE AS STRING) as TEAM_CODE",
        "CAST(DEFAULT_JF_FLAG AS INT) as DEFAULT_JF_FLAG",
        "CAST(EMP_PERF_SMRY_ID AS DECIMAL(20,0)) as EMP_PERF_SMRY_ID",
        "CAST(TOTAL_QTY AS DECIMAL(13,5)) as TOTAL_QTY",
    ...
    overwriteDeltaPartition(Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE,"DC_NBR",dcnbr,target_table_name)
    logger.info(
