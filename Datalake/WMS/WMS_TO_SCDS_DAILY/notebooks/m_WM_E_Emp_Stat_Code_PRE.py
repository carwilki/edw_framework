...
def m_WM_E_Emp_Stat_Code_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_E_EMP_STAT_CODE = jdbcOracleConnection( f"""SELECT
    ...
    SQ_Shortcut_to_E_EMP_STAT_CODE_temp = SQ_Shortcut_to_E_EMP_STAT_CODE.toDF(*["SQ_Shortcut_to_E_EMP_STAT_CODE___" + col for col in SQ_Shortcut_to_E_EMP_STAT_CODE.columns])
