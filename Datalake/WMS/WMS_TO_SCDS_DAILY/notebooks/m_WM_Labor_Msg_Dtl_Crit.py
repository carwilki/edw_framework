...
refined_perf_table = f"{refine}.WM_LABOR_MSG_DTL_CRIT"
raw_perf_table = f"{raw}.WM_LABOR_MSG_DTL_CRIT_PRE"
...
LOCATION_ID,
WM_LABOR_MSG_DTL_CRIT_ID,
WM_CREATED_TSTMP,
WM_LAST_UPDATED_TSTMP,
LOAD_TSTMP
FROM {refined_perf_table}
WHERE WM_LABOR_MSG_DTL_CRIT_ID IN (SELECT LABOR_MSG_DTL_CRIT_ID FROM {raw_perf_table})""").withColumn("sys_row_id", monotonically_increasing_id())
...
FIL_UNCHANGED_RECORDS = JNR_WM_LABOR_MSG_DTL_CRIT_temp.selectExpr( \
	...
	.filter("i_WM_LABOR_MSG_DTL_CRIT_ID IS NULL OR ( i_WM_LABOR_MSG_DTL_CRIT_ID IS NOT NULL AND ( COALESCE(CREATED_DTTM, date'1900-01-01') != COALESCE(i_WM_CREATED_TSTMP, date'1900-01-01') OR COALESCE(LAST_UPDATED_DTTM, date'1900-01-01') != COALESCE(WM_LAST_UPDATED_TSTMP, date'1900-01-01') ) )").withColumn("sys_row_id", monotonically_increasing_id())
...
Shortcut_to_WM_LABOR_MSG_DTL_CRIT1 = UPD_INS_UPD.selectExpr( 
	"CAST(LOCATION_ID AS BIGINT) as LOCATION_ID", 
	"CAST(LABOR_MSG_DTL_CRIT_ID AS BIGINT) as WM_LABOR_MSG_DTL_CRIT_ID", 
...
#   refined_perf_table = "WM_LABOR_MSG_DTL_CRIT"
  executeMerge(Shortcut_to_WM_LABOR_MSG_DTL_CRIT1, refined_perf_table, primary_key)
