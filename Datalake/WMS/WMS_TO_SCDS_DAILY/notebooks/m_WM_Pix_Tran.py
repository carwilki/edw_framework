...
Shortcut_to_WM_PIX_TRAN1 = UPD_INS_UPD.selectExpr( \
	...
	"CAST(PIX_TRAN_ID AS BIGINT) as WM_PIX_TRAN_ID", \
	"CAST(TRAN_NBR AS BIGINT) as WM_TRAN_NBR", \
	"CAST(PIX_SEQ_NBR AS BIGINT) as WM_PIX_SEQ_NBR", \
	...
	"CAST(RCPT_VARI AS BIGINT) as WM_RCPT_VARI_FLAG", \
	"CAST(RCPT_CMPL AS BIGINT) as WM_RCPT_CMPL_FLAG", \
