...
def m_WM_E_Msrmnt_Rule_Condition_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_E_MSRMNT_RULE_CONDITION = jdbcOracleConnection(
        f"""SELECT
    ...
    SQ_Shortcut_to_E_MSRMNT_RULE_CONDITION_temp = SQ_Shortcut_to_E_MSRMNT_RULE_CONDITION.toDF(*["SQ_Shortcut_to_E_MSRMNT_RULE_CONDITION___" + col for col in SQ_Shortcut_to_E_MSRMNT_RULE_CONDITION.columns])
