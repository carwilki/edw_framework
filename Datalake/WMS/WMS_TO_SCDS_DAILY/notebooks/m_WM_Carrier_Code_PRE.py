...
def m_WM_Carrier_Code_PRE(dcnbr, env):
    ...
    refine_table_name = "CARRIER_CODE"
    ...
    SQ_Shortcut_to_CARRIER_CODE = gu.jdbcOracleConnection(
        f"""SELECT
    ...
    SQ_Shortcut_to_CARRIER_CODE_temp = SQ_Shortcut_to_CARRIER_CODE.toDF(
        *[
            "SQ_Shortcut_to_CARRIER_CODE___" + col
            for col in SQ_Shortcut_to_CARRIER_CODE.columns
        ]
    )
    ...
    gu.overwriteDeltaPartition(
        Shortcut_to_WM_CARRIER_CODE_PRE, "DC_NBR", dcnbr, target_table_name
    )
    logger.info(
