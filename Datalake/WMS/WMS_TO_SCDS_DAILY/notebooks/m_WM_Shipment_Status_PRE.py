...
def m_WM_Shipment_Status_PRE(dcnbr, env):
    ...
    refine_table_name = "WM_SHIPMENT_STATUS"
    ...
    SQ_Shortcut_to_SHIPMENT_STATUS = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    gu.overwriteDeltaPartition(Shortcut_to_WM_SHIPMENT_STATUS_PRE, "DC_NBR", dcnbr, target_table_name)
