...
Shortcut_to_WM_ITEM_FACILITY_MAPPING_WMS1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(DFLT_WAVE_PROC_TYPE AS SMALLINT) as WM_DFLT_WAVE_PROC_TYPE",
	"CAST(XCESS_WAVE_NEED_PROC_TYPE AS TINYINT) as WM_XCESS_WAVE_NEED_PROC_TYPE",
	"CAST(VIOLATE_FIFO_ALLOC_QTY_MATCH AS TINYINT) as WM_VIOLATE_FIFO_ALLOC_QTY_MATCH_FLAG",
	...
	"CAST(FIFO_RANGE AS SMALLINT) as WM_FIFO_RANGE",
	...
	"CAST(ASSIGN_DYNAMIC_ACTV_PICK_SITE AS TINYINT) as WM_ASSIGN_DYNAMIC_ACTV_PICK_SITE_FLAG",
	"CAST(ASSIGN_DYNAMIC_CASE_PICK_SITE AS TINYINT) as WM_ASSIGN_DYNAMIC_CASE_PICK_SITE_FLAG",
	"CAST(VENDOR_TAGGED_EPC_FLAG AS TINYINT) as WM_VENDOR_TAGGED_EPC_FLAG",
	"CAST(DFLT_MIN_FROM_PREV_LOCN_FLAG AS TINYINT) as WM_DFLT_MIN_FROM_PREV_LOCN_FLAG",
	"CAST(LPN_PER_TIER AS INT) as WM_LPN_PER_TIER",
	"CAST(TIER_PER_PLT AS INT) as WM_TIER_PER_PLT",
	"CAST(VENDOR_CARTON_PER_TIER AS INT) as WM_VENDOR_CARTON_PER_TIER",
	"CAST(VENDOR_TIER_PER_PLT AS INT) as WM_VENDOR_TIER_PER_PLT",
	"CAST(ORD_CARTON_PER_TIER AS INT) as WM_ORD_CARTON_PER_TIER",
	"CAST(ORD_TIER_PER_PLT AS INT) as WM_ORD_TIER_PER_PLT",
	"CAST(MAX_UNITS_IN_DYNAMIC_ACTV AS DECIMAL(13,5)) as WM_MAX_UNITS_IN_DYNAMIC_ACTV",
	"CAST(MAX_CASES_IN_DYNAMIC_ACTV AS INT) as WM_MAX_CASES_IN_DYNAMIC_ACTV",
	"CAST(MAX_UNITS_IN_DYNAMIC_CASE_PICK AS DECIMAL(13,5)) as WM_MAX_UNITS_IN_DYNAMIC_CASE_PICK",
	"CAST(MAX_CASES_IN_DYNAMIC_CASE_PICK AS INT) as WM_MAX_CASES_IN_DYNAMIC_CASE_PICK",
	"CAST(NBR_OF_DYN_ACTV_PICK_PER_ITEM AS SMALLINT) as WM_NBR_OF_DYN_ACTV_PICK_PER_ITEM",
	"CAST(NBR_OF_DYN_CASE_PICK_PER_ITEM AS SMALLINT) as WM_NBR_OF_DYN_CASE_PICK_PER_ITEM",
	...
	"CAST(SLOT_ROTATE_EACHES_FLAG AS TINYINT) as WM_SLOT_ROTATE_EACHES_FLAG",
	"CAST(SLOT_ROTATE_INNERS_FLAG AS TINYINT) as WM_SLOT_ROTATE_INNERS_FLAG",
	"CAST(SLOT_ROTATE_BINS_FLAG AS TINYINT) as WM_SLOT_ROTATE_BINS_FLAG",
	"CAST(SLOT_ROTATE_CASES_FLAG AS TINYINT) as WM_SLOT_ROTATE_CASES_FLAG",
	"CAST(SLOT_3D_SLOTTING_FLAG AS TINYINT) as WM_SLOT_3D_SLOTTING_FLAG",
	"CAST(SLOT_NEST_EACHES_FLAG AS TINYINT) as WM_SLOT_NEST_EACHES_FLAG",
