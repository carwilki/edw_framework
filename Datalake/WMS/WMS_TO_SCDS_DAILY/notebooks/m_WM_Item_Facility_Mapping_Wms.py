...
Shortcut_to_WM_ITEM_FACILITY_MAPPING_WMS1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(ITEM_FACILITY_MAPPING_ID AS BIGINT) as WM_ITEM_FACILITY_MAPPING_ID", 
	...
	"CAST(DFLT_WAVE_PROC_TYPE AS BIGINT) as WM_DFLT_WAVE_PROC_TYPE", 
	"CAST(XCESS_WAVE_NEED_PROC_TYPE AS BIGINT) as WM_XCESS_WAVE_NEED_PROC_TYPE", 
	"CAST(VIOLATE_FIFO_ALLOC_QTY_MATCH AS BIGINT) as WM_VIOLATE_FIFO_ALLOC_QTY_MATCH_FLAG", 
	...
	"CAST(FIFO_RANGE AS BIGINT) as WM_FIFO_RANGE", 
	"CAST(PRTL_CASE_ALLOC_THRESH_UNITS AS BIGINT) as WM_PRTL_CASE_ALLOC_THRESH_UNITS", 
	"CAST(PRTL_CASE_PUTWY_THRESH_UNITS AS BIGINT) as WM_PRTL_CASE_PUTWY_THRESH_UNITS", 
	"CAST(ASSIGN_DYNAMIC_ACTV_PICK_SITE AS BIGINT) as WM_ASSIGN_DYNAMIC_ACTV_PICK_SITE_FLAG", 
	"CAST(ASSIGN_DYNAMIC_CASE_PICK_SITE AS BIGINT) as WM_ASSIGN_DYNAMIC_CASE_PICK_SITE_FLAG", 
	"CAST(VENDOR_TAGGED_EPC_FLAG AS BIGINT) as WM_VENDOR_TAGGED_EPC_FLAG", 
	"CAST(DFLT_MIN_FROM_PREV_LOCN_FLAG AS BIGINT) as WM_DFLT_MIN_FROM_PREV_LOCN_FLAG", 
	"CAST(LPN_PER_TIER AS BIGINT) as WM_LPN_PER_TIER", 
	"CAST(TIER_PER_PLT AS BIGINT) as WM_TIER_PER_PLT", 
	"CAST(VENDOR_CARTON_PER_TIER AS BIGINT) as WM_VENDOR_CARTON_PER_TIER", 
	"CAST(VENDOR_TIER_PER_PLT AS BIGINT) as WM_VENDOR_TIER_PER_PLT", 
	"CAST(ORD_CARTON_PER_TIER AS BIGINT) as WM_ORD_CARTON_PER_TIER", 
	"CAST(ORD_TIER_PER_PLT AS BIGINT) as WM_ORD_TIER_PER_PLT", 
	"CAST(MAX_UNITS_IN_DYNAMIC_ACTV AS BIGINT) as WM_MAX_UNITS_IN_DYNAMIC_ACTV", 
	"CAST(MAX_CASES_IN_DYNAMIC_ACTV AS BIGINT) as WM_MAX_CASES_IN_DYNAMIC_ACTV", 
	"CAST(MAX_UNITS_IN_DYNAMIC_CASE_PICK AS BIGINT) as WM_MAX_UNITS_IN_DYNAMIC_CASE_PICK", 
	"CAST(MAX_CASES_IN_DYNAMIC_CASE_PICK AS BIGINT) as WM_MAX_CASES_IN_DYNAMIC_CASE_PICK", 
	"CAST(NBR_OF_DYN_ACTV_PICK_PER_ITEM AS BIGINT) as WM_NBR_OF_DYN_ACTV_PICK_PER_ITEM", 
	"CAST(NBR_OF_DYN_CASE_PICK_PER_ITEM AS BIGINT) as WM_NBR_OF_DYN_CASE_PICK_PER_ITEM", 
	...
	"CAST(AVERAGE_MOVEMENT AS BIGINT) as WM_AVERAGE_MOVEMENT", 
	"CAST(CASE_SIZE_TYPE AS STRING) as WM_CASE_SIZE_TYPE", 
	"CAST(ITEM_AVG_WT AS BIGINT) as WM_ITEM_AVG_WT", 
	"CAST(PICK_RATE AS BIGINT) as WM_PICK_RATE", 
	"CAST(WAGE_VALUE AS BIGINT) as WM_WAGE_VALUE", 
	"CAST(PACK_RATE AS BIGINT) as WM_PACK_RATE", 
	"CAST(SPL_PROC_RATE AS BIGINT) as WM_SPL_PROC_RATE", 
	...
	"CAST(SLOT_ROTATE_EACHES_FLAG AS BIGINT) as WM_SLOT_ROTATE_EACHES_FLAG", 
	"CAST(SLOT_ROTATE_INNERS_FLAG AS BIGINT) as WM_SLOT_ROTATE_INNERS_FLAG", 
	"CAST(SLOT_ROTATE_BINS_FLAG AS BIGINT) as WM_SLOT_ROTATE_BINS_FLAG", 
	"CAST(SLOT_ROTATE_CASES_FLAG AS BIGINT) as WM_SLOT_ROTATE_CASES_FLAG", 
	"CAST(SLOT_3D_SLOTTING_FLAG AS BIGINT) as WM_SLOT_3D_SLOTTING_FLAG", 
	"CAST(SLOT_NEST_EACHES_FLAG AS BIGINT) as WM_SLOT_NEST_EACHES_FLAG", 
	...
	"CAST(MISC_NUMERIC_1 AS BIGINT) as MISC_NUM_1", 
	"CAST(MISC_NUMERIC_2 AS BIGINT) as MISC_NUM_2", 
	"CAST(MISC_NUMERIC_3 AS BIGINT) as MISC_NUM_3", 
