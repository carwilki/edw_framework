...
FROM WM_ITEM_FACILITY_MAPPING_WMS
WHERE WM_ITEM_FACILITY_MAPPING_ID IN (SELECT ITEM_FACILITY_MAPPING_ID FROM WM_ITEM_FACILITY_MAPPING_WMS_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
FROM WM_ITEM_FACILITY_MAPPING_WMS_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
