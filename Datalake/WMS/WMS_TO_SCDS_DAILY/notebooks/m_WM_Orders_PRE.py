...
def m_WM_Orders_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_ORDERS1 = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    Shortcut_to_WM_ORDERS_PRE = ExP_TRN.selectExpr( \
    	...
    	"CAST(BLOCK_AUTO_CREATE AS BIGINT) as BLOCK_AUTO_CREATE", \
    	"CAST(BLOCK_AUTO_CONSOLIDATE AS BIGINT) as BLOCK_AUTO_CONSOLIDATE", \
    	...
    	"CAST(IS_BOOKING_REQUIRED AS BIGINT) as IS_BOOKING_REQUIRED", \
    	...
    	"CAST(IS_SUSPENDED AS BIGINT) as IS_SUSPENDED", \
    	"CAST(NORMALIZED_BASELINE_COST AS BIGINT) as NORMALIZED_BASELINE_COST", \
    	...
    	"CAST(BASELINE_COST AS BIGINT) as BASELINE_COST", \
    	...
    	"CAST(MOVE_TYPE AS BIGINT) as MOVE_TYPE", \
    	"CAST(SCHED_DOW AS BIGINT) as SCHED_DOW", \
    	...
    	"CAST(COMPARTMENT_NO AS BIGINT) as COMPARTMENT_NO", \
    	"CAST(PACKAGING AS STRING) as PACKAGING", \
    	"CAST(ORDER_LOADING_SEQ AS BIGINT) as ORDER_LOADING_SEQ", \
    	...
    	"CAST(DUTY_AND_TAX AS BIGINT) as DUTY_AND_TAX", \
    	"CAST(DUTY_TAX_ACCT_NBR AS STRING) as DUTY_TAX_ACCT_NBR", \
    	"CAST(DUTY_TAX_PAYMENT_TYPE AS BIGINT) as DUTY_TAX_PAYMENT_TYPE", \
    	...
    	"CAST(LPN_CUBING_INDIC AS BIGINT) as LPN_CUBING_INDIC", \
    	"CAST(O_PHONE_NUMBER AS STRING) as O_PHONE_NUMBER", \
    	"CAST(ORDER_PRINT_DTTM AS TIMESTAMP) as ORDER_PRINT_DTTM", \
    	"CAST(PALLET_CUBING_INDIC AS BIGINT) as PALLET_CUBING_INDIC", \
    	...
    	"CAST(STAGE_INDIC AS BIGINT) as STAGE_INDIC", \
    	...
    	"CAST(WM_ORDER_STATUS AS BIGINT) as WM_ORDER_STATUS", \
    	...
    	"CAST(DEST_SHIP_THRU_FACILITY_ID AS BIGINT) as DEST_SHIP_THRU_FACILITY_ID", \
    	...
    	"CAST(IN_TRANSIT_ALLOCATION AS BIGINT) as IN_TRANSIT_ALLOCATION", \
    	"CAST(RELEASE_DESTINATION AS BIGINT) as RELEASE_DESTINATION", \
    	"CAST(TEMPLATE_ID AS BIGINT) as TEMPLATE_ID", \
    	"CAST(COD_AMOUNT AS BIGINT) as COD_AMOUNT", \
    	...
    	"CAST(DSG_HUB_LOCATION_ID AS BIGINT) as DSG_HUB_LOCATION_ID", \
    	"CAST(OVERRIDE_BILLING_METHOD AS BIGINT) as OVERRIDE_BILLING_METHOD", \
    	"CAST(PARENT_TYPE AS BIGINT) as PARENT_TYPE", \
    	...
    	"CAST(IS_ORDER_RECONCILED AS BIGINT) as IS_ORDER_RECONCILED", \
    	...
    	"CAST(DECLARED_VALUE AS BIGINT) as DECLARED_VALUE", \
    	...
    	"CAST(IS_ORIGINAL_ORDER AS BIGINT) as IS_ORIGINAL_ORDER", \
    	...
    	"CAST(TRANS_PLAN_OWNER AS BIGINT) as TRANS_PLAN_OWNER", \
    	...
    	"CAST(IS_D_POBOX AS BIGINT) as IS_D_POBOX", \
    	...
    	"CAST(SINGLE_UNIT_FLAG AS BIGINT) as SINGLE_UNIT_FLAG", \
    	"CAST(TOTAL_NBR_OF_UNITS AS BIGINT) as TOTAL_NBR_OF_UNITS", \
    	"CAST(IS_ROUTED AS BIGINT) as IS_ROUTED", \
    	...
    	"CAST(CHASE_ELIGIBLE AS BIGINT) as CHASE_ELIGIBLE", \
    	"CAST(SHIPPING_CHANNEL AS STRING) as SHIPPING_CHANNEL", \
    	"CAST(IS_GUARANTEED_DELIVERY AS BIGINT) as IS_GUARANTEED_DELIVERY", \
    	"CAST(FAILED_GUARANTEED_DELIVERY AS STRING) as FAILED_GUARANTEED_DELIVERY", \
    	"CAST(APPLY_LPNTYPE_FOR_ORDER AS BIGINT) as APPLY_LPNTYPE_FOR_ORDER", \
    	...
    	"CAST(BASELINE_LINEHAUL_COST AS BIGINT) as BASELINE_LINEHAUL_COST", \
    	"CAST(BASELINE_ACCESSORIAL_COST AS BIGINT) as BASELINE_ACCESSORIAL_COST", \
    	"CAST(BASELINE_SHIP_VIA AS STRING) as BASELINE_SHIP_VIA", \
    	"CAST(DELIVERY_CHANNEL_ID AS BIGINT) as DELIVERY_CHANNEL_ID", \
    	"CAST(ORDER_STREAM AS BIGINT) as ORDER_STREAM", \
    	"CAST(LINEHAUL_REVENUE AS BIGINT) as LINEHAUL_REVENUE", \
    	"CAST(ACCESSORIAL_REVENUE AS BIGINT) as ACCESSORIAL_REVENUE", \
    	"CAST(STOP_OFF_REVENUE AS BIGINT) as STOP_OFF_REVENUE", \
    	"CAST(REVENUE_LANE_ID AS BIGINT) as REVENUE_LANE_ID", \
    	"CAST(REVENUE_LANE_DETAIL_ID AS BIGINT) as REVENUE_LANE_DETAIL_ID", \
    	"CAST(MARGIN AS BIGINT) as MARGIN", \
    	"CAST(MARGIN_CURRENCY_CODE AS STRING) as MARGIN_CURRENCY_CODE", \
    	"CAST(CM_DISCOUNT_REVENUE AS BIGINT) as CM_DISCOUNT_REVENUE", \
    	"CAST(C_TMS_PLAN_ID AS BIGINT) as C_TMS_PLAN_ID", \
    	"CAST(LOAD_TSTMP_EXP AS TIMESTAMP) as LOAD_TSTMP" \
    )
    
    gu.overwriteDeltaPartition(Shortcut_to_WM_ORDERS_PRE, "DC_NBR", dcnbr, target_table_name)
