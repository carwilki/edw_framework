...
def m_WM_Pick_Locn_Dtl_PRE(dcnbr, env):
    ...
    "CAST(LOCN_SEQ_NBR AS INT) as LOCN_SEQ_NBR",
    ...
    "CAST(MAX_INVN_QTY AS DECIMAL(13,5)) as MAX_INVN_QTY",
    "CAST(MIN_INVN_QTY AS DECIMAL(13,5)) as MIN_INVN_QTY",
    ...
    "CAST(TO_BE_FILLD_CASES AS INT) as TO_BE_FILLD_CASES",
    "CAST(LANES AS STRING) as LANES",
    "CAST(STACKING AS STRING) as STACKING",
    "CAST(MIN_QTY_TO_RLS_HELD_RPLN AS DECIMAL(13,5)) as MIN_QTY_TO_RLS_HELD_RPLN",
    "CAST(MIN_CASES_TO_RLS_HELD_RPLN AS INT) as MIN_CASES_TO_RLS_HELD_RPLN",
    "CAST(TASK_RELEASED AS STRING) as TASK_RELEASED",
    "CAST(PACK_QTY AS DECIMAL(9,2)) as PACK_QTY",
    "CAST(PICK_LOCN_HDR_ID AS INT) as PICK_LOCN_HDR_ID",
    "CAST(WM_VERSION_ID AS INT) as WM_VERSION_ID",
    "CAST(ITEM_MASTER_ID AS INT) as ITEM_MASTER_ID",
    "CAST(ITEM_ID AS INT) as ITEM_ID",
    "CAST(PRE_ALLOCATED_QTY AS DECIMAL(13,4)) as PRE_ALLOCATED_QTY",
    "CAST(REPLEN_CONTROL AS STRING) as REPLEN_CONTROL",
    "CAST(STOP_QTY AS DECIMAL(13,4)) as STOP_QTY",
    "CAST(STOP_DTTM AS TIMESTAMP) as STOP_DTTM",
    "CAST(PICK_TO_ZERO_ACTION AS STRING) as PICK_TO_ZERO_ACTION",
    "CAST(UTIL_PERCENT AS DECIMAL(3,2)) as UTIL_PERCENT",
