...
Shortcut_to_WM_PUTAWAY_LOCK1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(LOCK_COUNTER1 AS SMALLINT) as LOCK_COUNTER",
...
Shortcut_to_WM_PUTAWAY_LOCK2.createOrReplaceTempView('WM_PUTAWAY_LOCK_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_PUTAWAY_LOCK_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_LOCN_ID = trg.WM_LOCN_ID )
