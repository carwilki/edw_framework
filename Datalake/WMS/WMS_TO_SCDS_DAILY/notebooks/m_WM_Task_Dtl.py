...
WM_TASK_DTL.LOCATION_ID,
WM_TASK_DTL.WM_TASK_DTL_ID,
WM_TASK_DTL.WM_CREATE_TSTMP,
WM_TASK_DTL.WM_MOD_TSTMP,
WM_TASK_DTL.LOAD_TSTMP
FROM WM_TASK_DTL
WHERE WM_TASK_DTL_ID IN (SELECT TASK_DTL_ID FROM WM_TASK_DTL_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_TASK_DTL_PRE.DC_NBR,
WM_TASK_DTL_PRE.TASK_DTL_ID,
WM_TASK_DTL_PRE.TASK_ID,
WM_TASK_DTL_PRE.TASK_SEQ_NBR,
WM_TASK_DTL_PRE.CNTR_NBR,
WM_TASK_DTL_PRE.INVN_TYPE,
WM_TASK_DTL_PRE.PROD_STAT,
WM_TASK_DTL_PRE.BATCH_NBR,
WM_TASK_DTL_PRE.SKU_ATTR_1,
WM_TASK_DTL_PRE.SKU_ATTR_2,
WM_TASK_DTL_PRE.SKU_ATTR_3,
WM_TASK_DTL_PRE.SKU_ATTR_4,
WM_TASK_DTL_PRE.SKU_ATTR_5,
WM_TASK_DTL_PRE.CNTRY_OF_ORGN,
WM_TASK_DTL_PRE.ALLOC_INVN_CODE,
WM_TASK_DTL_PRE.PULL_LOCN_ID,
WM_TASK_DTL_PRE.ALLOC_UOM_QTY,
WM_TASK_DTL_PRE.FULL_CNTR_ALLOCD,
WM_TASK_DTL_PRE.INVN_NEED_TYPE,
WM_TASK_DTL_PRE.TASK_PRTY,
WM_TASK_DTL_PRE.TASK_GENRTN_REF_CODE,
WM_TASK_DTL_PRE.TASK_GENRTN_REF_NBR,
WM_TASK_DTL_PRE.TASK_CMPL_REF_CODE,
WM_TASK_DTL_PRE.TASK_CMPL_REF_NBR,
WM_TASK_DTL_PRE.ERLST_START_DATE_TIME,
WM_TASK_DTL_PRE.LTST_START_DATE_TIME,
WM_TASK_DTL_PRE.LTST_CMPL_DATE_TIME,
WM_TASK_DTL_PRE.ALLOC_UOM,
WM_TASK_DTL_PRE.ORIG_REQMT,
WM_TASK_DTL_PRE.QTY_ALLOC,
WM_TASK_DTL_PRE.QTY_PULLD,
WM_TASK_DTL_PRE.DEST_LOCN_ID,
WM_TASK_DTL_PRE.DEST_LOCN_SEQ,
WM_TASK_DTL_PRE.STAT_CODE,
WM_TASK_DTL_PRE.TASK_TYPE,
WM_TASK_DTL_PRE.CURR_WORK_GRP,
WM_TASK_DTL_PRE.CURR_WORK_AREA,
WM_TASK_DTL_PRE.REPL_DIVRT_LOCN,
WM_TASK_DTL_PRE.PICK_SEQ_CODE,
WM_TASK_DTL_PRE.TASK_LOCN_SEQ,
WM_TASK_DTL_PRE.CREATE_DATE_TIME,
WM_TASK_DTL_PRE.MOD_DATE_TIME,
WM_TASK_DTL_PRE.USER_ID,
WM_TASK_DTL_PRE.PKT_CTRL_NBR,
WM_TASK_DTL_PRE.REQD_INVN_TYPE,
WM_TASK_DTL_PRE.REQD_PROD_STAT,
WM_TASK_DTL_PRE.REQD_BATCH_NBR,
WM_TASK_DTL_PRE.REQD_SKU_ATTR_1,
WM_TASK_DTL_PRE.REQD_SKU_ATTR_2,
WM_TASK_DTL_PRE.REQD_SKU_ATTR_3,
WM_TASK_DTL_PRE.REQD_SKU_ATTR_4,
WM_TASK_DTL_PRE.REQD_SKU_ATTR_5,
WM_TASK_DTL_PRE.REQD_CNTRY_OF_ORGN,
WM_TASK_DTL_PRE.PKT_SEQ_NBR,
WM_TASK_DTL_PRE.CARTON_NBR,
WM_TASK_DTL_PRE.CARTON_SEQ_NBR,
WM_TASK_DTL_PRE.PIKR_NBR,
WM_TASK_DTL_PRE.TASK_CMPL_REF_NBR_SEQ,
WM_TASK_DTL_PRE.ALLOC_INVN_DTL_ID,
WM_TASK_DTL_PRE.SUBSTITUTION_FLAG,
WM_TASK_DTL_PRE.NEXT_TASK_ID,
WM_TASK_DTL_PRE.NEXT_TASK_SEQ_NBR,
WM_TASK_DTL_PRE.NEXT_TASK_DESC,
WM_TASK_DTL_PRE.NEXT_TASK_TYPE,
WM_TASK_DTL_PRE.MISC_ALPHA_FIELD_1,
WM_TASK_DTL_PRE.MISC_ALPHA_FIELD_2,
WM_TASK_DTL_PRE.MISC_ALPHA_FIELD_3,
WM_TASK_DTL_PRE.VOCOLLECT_POSN,
WM_TASK_DTL_PRE.VOCOLLECT_SHORT_FLAG,
WM_TASK_DTL_PRE.PAGE_NBR,
WM_TASK_DTL_PRE.RSN_CODE,
WM_TASK_DTL_PRE.SLOT_NBR,
WM_TASK_DTL_PRE.SUBSLOT_NBR,
WM_TASK_DTL_PRE.CD_MASTER_ID,
WM_TASK_DTL_PRE.TASK_HDR_ID,
WM_TASK_DTL_PRE.WM_VERSION_ID,
WM_TASK_DTL_PRE.ITEM_ID,
WM_TASK_DTL_PRE.TC_ORDER_ID,
WM_TASK_DTL_PRE.LINE_ITEM_ID,
WM_TASK_DTL_PRE.TRANS_INVN_TYPE,
WM_TASK_DTL_PRE.TOTE_NBR,
WM_TASK_DTL_PRE.IS_CHASE_CREATED,
WM_TASK_DTL_PRE.RESOURCE_GROUP_ID,
WM_TASK_DTL_PRE.WORK_RESOURCE_ID,
WM_TASK_DTL_PRE.WORK_RELEASE_BATCH_NUMBER,
WM_TASK_DTL_PRE.ALLOCATION_KEY,
WM_TASK_DTL_PRE.DISTRIBUTION_KEY,
WM_TASK_DTL_PRE.LOAD_TSTMP
FROM WM_TASK_DTL_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
