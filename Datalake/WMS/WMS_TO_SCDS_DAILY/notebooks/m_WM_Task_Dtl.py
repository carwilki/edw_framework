...
Shortcut_to_WM_TASK_DTL_1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(TASK_DTL_ID AS BIGINT) as WM_TASK_DTL_ID", 
	"CAST(TASK_HDR_ID AS BIGINT) as WM_TASK_HDR_ID", 
	"CAST(TASK_ID AS BIGINT) as WM_TASK_ID", 
	"CAST(TASK_SEQ_NBR AS BIGINT) as WM_TASK_SEQ_NBR", 
	...
	"CAST(TRANS_INVN_TYPE AS BIGINT) as WM_TRANS_INVN_TYPE", 
	...
	"CAST(CARTON_SEQ_NBR AS BIGINT) as WM_CARTON_SEQ_NBR", 
	"CAST(PIKR_NBR AS BIGINT) as WM_PIKR_NBR", 
	"CAST(PKT_CTRL_NBR AS STRING) as WM_PKT_CTRL_NBR", 
	"CAST(PKT_SEQ_NBR AS BIGINT) as WM_PKT_SEQ_NBR", 
	"CAST(PICK_SEQ_CODE AS STRING) as WM_PICK_SEQ_CD", 
	"CAST(CNTRY_OF_ORGN AS STRING) as COUNTRY_OF_ORIGIN", 
	"CAST(ALLOC_INVN_CODE AS BIGINT) as WM_ALLOC_INVN_CD", 
	"CAST(CURR_WORK_AREA AS STRING) as CURR_WORK_AREA", 
	"CAST(CURR_WORK_GRP AS STRING) as WM_CURR_WORK_GRP", 
	"CAST(TASK_LOCN_SEQ AS BIGINT) as WM_TASK_LOCN_SEQ", 
	"CAST(SLOT_NBR AS BIGINT) as SLOT_NBR", 
	"CAST(SUBSLOT_NBR AS BIGINT) as SUB_SLOT_NBR", 
	...
	"CAST(DEST_LOCN_SEQ AS BIGINT) as WM_DEST_LOCN_SEQ", 
	"CAST(FULL_CNTR_ALLOCD AS BIGINT) as FULL_CNTR_ALLOCD_FLAG", 
	...
	"CAST(NEXT_TASK_SEQ_NBR AS BIGINT) as WM_NEXT_TASK_SEQ_NBR", 
	...
	"CAST(TASK_CMPL_REF_NBR_SEQ AS BIGINT) as WM_TASK_CMPL_REF_NBR_SEQ", 
	"CAST(ALLOC_INVN_DTL_ID AS BIGINT) as WM_ALLOC_INVN_DTL_ID", 
