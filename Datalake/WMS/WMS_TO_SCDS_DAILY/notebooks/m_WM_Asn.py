...
Shortcut_to_WM_ASN1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(ASN_ID AS DECIMAL(10BIGINT) as WM_ASN_ID",
	...
	"CAST(ASN_TYPE AS TINYINT) as WM_ASN_TYPE",
	"CAST(ASN_LEVEL AS SMALLINT) as WM_ASN_LEVEL",
	"CAST(ASN_PRIORITY AS TINYINT) as WM_ASN_PRIORITY",
	...
	"CAST(SHIPMENT_ID AS DECIMAL(10BIGINT) as WM_SHIPMENT_ID",
	...
	"CAST(ORIGINAL_ASN_ID AS DECIMAL(10BIGINT) as WM_ORIGINAL_ASN_ID",
	...
	"CAST(ORIGIN_FACILITY_ID AS INT) as WM_ORIGIN_FACILITY_ID",
	"CAST(DESTINATION_FACILITY_ALIAS_ID AS STRING) as WM_DESTINATION_FACILITY_ALIAS_ID",
	"CAST(DESTINATION_FACILITY_ID AS INT) as WM_DESTINATION_FACILITY_ID",
	"CAST(RETURN_REFERENCE_NUMBER AS STRING) as WM_RETURN_REFERENCE_NBR",
	"CAST(DELIVERY_STOP_SEQ AS SMALLINT) as WM_DELIVERY_STOP_SEQ",
	"CAST(RECEIPT_TYPE AS TINYINT) as WM_RECEIPT_TYPE",
	"CAST(RECEIPT_VARIANCE AS TINYINT) as WM_RECEIPT_VARIANCE",
	...
	"CAST(VERIFICATION_ATTEMPTED AS TINYINT) as VERIFICATION_ATTEMPTED_FLAG",
	...
	"CAST(FLOW_THRU_ALLOC_IN_PROG AS TINYINT) as FLOW_THRU_ALLOC_IN_PROG_FLAG",
	"CAST(FLOW_THROUGH_ALLOCATION_METHOD AS STRING) as WM_FLOW_THROUGH_ALLOCATION_METHOD",
	"CAST(FLOWTHROUGH_ALLOCATION_STATUS AS TINYINT) as WM_FLOW_THROUGH_ALLOCATION_STATUS",
	...
	"CAST(EQUIPMENT_CODE_ID AS INT) as WM_EQUIPMENT_CD_ID",
	...
	"CAST(TRACTOR_CARRIER_CODE_ID AS INT) as WM_TRACTOR_CARRIER_CD_ID",
	...
	"CAST(ASSIGNED_CARRIER_CODE_ID AS INT) as WM_ASSIGNED_CARRIER_CD_ID",
	...
	"CAST(DOCK_DOOR_ID AS DECIMAL(10BIGINT) as WM_DOCK_DOOR_ID",
	"CAST(MODE_ID AS INT) as WM_MODE_ID",
	"CAST(TRAILER_NUMBER AS STRING) as WM_TRAILER_NBR",
	"CAST(TRAILER_CLOSED AS TINYINT) as TRAILER_CLOSED_FLAG",
	...
	"CAST(FIRM_APPT_IND AS TINYINT) as FIRM_APPT_FLAG",
	"CAST(HAS_ALERTS AS TINYINT) as ALERTS_FLAG",
	"CAST(SYSTEM_ALLOCATED AS TINYINT) as SYSTEM_ALLOCATED_FLAG",
	"CAST(IS_COGI_GENERATED AS TINYINT) as COGI_GENERATED_FLAG",
	"CAST(SCHEDULE_APPT AS TINYINT) as WM_SCHEDULE_APPT_IND",
	"CAST(IS_WHSE_TRANSFER AS TINYINT) as WHSE_TRANSFER_FLAG",
	...
	"CAST(ALLOCATION_COMPLETED AS TINYINT) as ALLOCATION_COMPLETED_FLAG",
	"CAST(PALLET_FOOTPRINT AS STRING) as WM_PALLET_FOOTPRINT",
	"CAST(PRE_ALLOCATION_FIT_PERCENTAGE AS SMALLINT) as PRE_ALLOCATION_FIT_PCT",
	"CAST(QUALITY_AUDIT_PERCENT AS DECIMAL(5,2)) as QUALITY_AUDIT_PCT",
	"CAST(SHIPPED_LPN_COUNT AS INT) as WM_SHIPPED_LPN_CNT",
	"CAST(RECEIVED_LPN_COUNT AS INT) as WM_RECEIVED_LPN_CNT",
	...
	"CAST(HAS_IMPORT_ERROR AS TINYINT) as IMPORT_ERROR_FLAG",
	"CAST(HAS_SOFT_CHECK_ERROR AS TINYINT) as SOFT_CHECK_ERROR_FLAG",
	...
	"CAST(HIBERNATE_VERSION AS DECIMAL(10BIGINT) as WM_HIBERNATE_VERSION",
