...
def m_WM_Stop_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_STOP = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    Shortcut_to_WM_STOP_PRE = EXP_TRN.selectExpr( 
    	...
    	"CAST(WAVE_OPTION_LIST_ID AS BIGINT) as WAVE_OPTION_LIST_ID", 
    	"CAST(ARRIVAL_LATE_REASON_ID AS BIGINT) as ARRIVAL_LATE_REASON_ID", 
    	"CAST(DEPARTURE_LATE_REASON_ID AS BIGINT) as DEPARTURE_LATE_REASON_ID", 
    	"CAST(SIZE_UOM_ID AS BIGINT) as SIZE_UOM_ID", 
    	"CAST(DOCK_DISPATCH_CAP_ID AS BIGINT) as DOCK_DISPATCH_CAP_ID", 
    	"CAST(IS_APPT_REQD AS BIGINT) as IS_APPT_REQD", 
    	...
    	"CAST(STOP_TZ AS BIGINT) as STOP_TZ", 
    	"CAST(BILL_OF_LADING_NUMBER AS STRING) as BILL_OF_LADING_NUMBER", 
    	"CAST(DROP_HOOK_INDICATOR AS BIGINT) as DROP_HOOK_INDICATOR", 
    	...
    	"CAST(IS_ADDR_OVERRIDE AS BIGINT) as IS_ADDR_OVERRIDE", 
    	"CAST(IS_RECONSIGNED AS BIGINT) as IS_RECONSIGNED", 
    	"CAST(IS_EST_ARR_USER_DEFINED AS BIGINT) as IS_EST_ARR_USER_DEFINED", 
    	"CAST(IS_EST_DEP_USER_DEFINED AS BIGINT) as IS_EST_DEP_USER_DEFINED", 
    	...
    	"CAST(LOAD_CLOSED_INDICATOR AS BIGINT) as LOAD_CLOSED_INDICATOR", 
    	...
    	"CAST(ON_STATIC_ROUTE AS BIGINT) as ON_STATIC_ROUTE", 
    	...
    	"CAST(STOPOFF_REVENUE AS BIGINT) as STOPOFF_REVENUE", 
    	"CAST(CM_DISCOUNT_REVENUE AS BIGINT) as CM_DISCOUNT_REVENUE", 
    	"CAST(LOAD_TSTMP_EXP AS TIMESTAMP) as LOAD_TSTMP" 
    )
    
    gu.overwriteDeltaPartition(Shortcut_to_WM_STOP_PRE, "DC_NBR", dcnbr, target_table_name)
