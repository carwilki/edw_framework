...
Shortcut_to_WM_YARD = UPD_INS_UPD.selectExpr( 
	...
	"CAST(TIME_ZONE_ID AS BIGINT) as WM_TIME_ZONE_ID", 
	"CAST(DO_GENERATE_MOVE_TASK AS BIGINT) as GENERATE_MOVE_TASK_FLAG", 
	"CAST(DO_GENERATE_NEXT_EQUIP AS BIGINT) as GENERATE_NEXT_EQUIP_FLAG", 
	"CAST(IS_RANGE_TASKS AS BIGINT) as RANGE_TASKS_FLAG", 
	"CAST(IS_SEAL_TASK_TRGD AS BIGINT) as SEAL_TASK_TRGD_FLAG", 
	"CAST(DO_OVERRIDE_SYSTEM_TASKS AS BIGINT) as OVERRIDE_SYSTEM_TASKS_FLAG", 
	"CAST(IS_TASKING_ALLOWED AS BIGINT) as TASKING_ALLOWED_FLAG", 
	"CAST(LOCK_TRAILER_ON_MOVE_TO_DOOR AS BIGINT) as LOCK_TRAILER_ON_MOVE_TO_DOOR_FLAG", 
	...
	"CAST(MAX_EQUIPMENT_ALLOWED1 AS BIGINT) as MAX_EQUIPMENT_ALLOWED", 
	"CAST(UPPER_CHECKIN_TIME_MINS AS BIGINT) as UPPER_CHECK_IN_TIME_MINS", 
	"CAST(LOWER_CHECKIN_TIME_MINS AS BIGINT) as LOWER_CHECK_IN_TIME_MINS", 
	"CAST(FIXED_TIME_MINS1 AS BIGINT) as FIXED_TIME_MINS", 
	"CAST(THRESHOLD_PERCENT1 AS BIGINT) as THRESHOLD_PERCENT", 
	"CAST(MARK_FOR_DELETION1 AS BIGINT) as MARK_FOR_DELETION", 
...
try:
  ...
  executeMerge(Shortcut_to_WM_YARD.write.saveAsTable(f'{raw}.WM_YARD')
