...
Shortcut_to_WM_PICK_LOCN_DTL2 = UPD_UPDATE_INSERT.selectExpr( \
	...
	"CAST(LOCN_SEQ_NBR1 AS BIGINT) as WM_LOCN_SEQ_NBR", \
	"CAST(ITEM_MASTER_ID1 AS BIGINT) as WM_ITEM_MASTER_ID", \
	...
	"CAST(LTST_SKU_ASSIGN_O1 AS BIGINT) as WM_LTST_SKU_ASSIGN_FLAG", \
	...
	"CAST(TRIG_REPL_FOR_SKU_O1 AS BIGINT) as TRIG_REPL_FOR_SKU_FLAG", \
	"CAST(PRIM_LOCN_FOR_SKU_O1 AS BIGINT) as PRIM_LOCN_FOR_SKU_FLAG", \
	"CAST(LANES1 AS STRING) as WM_LANES", \
	"CAST(STACKING1 AS STRING) as WM_STACKING", \
	"CAST(TASK_RELEASED_O1 AS BIGINT) as WM_TASK_RELEASED_FLAG", \
	...
	"CAST(PRE_ALLOCATED_QTY2 AS BIGINT) as PRE_ALLOCATED_QTY", \
	"CAST(PACK_QTY2 AS BIGINT) as PACK_QTY", \
	"CAST(TO_BE_FILLD_CASES2 AS BIGINT) as TO_BE_FILLD_CASES", \
	"CAST(MAX_INVN_QTY2 AS BIGINT) as MAX_INVN_QTY", \
	"CAST(MIN_INVN_QTY2 AS BIGINT) as MIN_INVN_QTY", \
	...
	"CAST(MIN_QTY_TO_RLS_HELD_RPLN2 AS BIGINT) as MIN_QTY_TO_RLS_HELD_RPLN", \
	"CAST(MIN_CASES_TO_RLS_HELD_RPLN2 AS BIGINT) as MIN_CASES_TO_RLS_HELD_RPLN", \
	"CAST(STOP_QTY2 AS BIGINT) as STOP_QTY", \
	"CAST(STOP_DTTM1 AS TIMESTAMP) as STOP_TSTMP", \
	"CAST(UTIL_PERCENT2 AS BIGINT) as UTIL_PERCENT", \
	...
	"CAST(WM_VERSION_ID2 AS BIGINT) as WM_VERSION_ID", \
