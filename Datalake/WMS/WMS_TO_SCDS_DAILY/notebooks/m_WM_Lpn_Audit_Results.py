...
JNR_WM_LPN_AUDIT_RESULTS = SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS_temp.join(JNR_SITE_PROFILE_temp,[SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS_temp.SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS___LOCATION_ID == JNR_SITE_PROFILE_temp.JNR_SITE_PROFILE___LOCATION_ID, SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS_temp.SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS___WM_LPN_AUDIT_RESULTS_ID == JNR_SITE_PROFILE_temp.JNR_SITE_PROFILE___LPN_AUDIT_RESULTS_ID],'right_outer').selectExpr( \
	...
	"SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS___WM_CREATED_TSTMP as WM_CREATED_TSTMP", \
	...
	"SQ_Shortcut_to_WM_LPN_AUDIT_RESULTS___WM_LAST_UPDATED_TSTMP as WM_LAST_UPDATED_TSTMP", \
...
FIL_UNCHANGED_RECORDS = JNR_WM_LPN_AUDIT_RESULTS_temp.selectExpr( \
	...
	"JNR_WM_LPN_AUDIT_RESULTS___WM_CREATED_TSTMP as WM_CREATED_TSTMP", \
	...
	"JNR_WM_LPN_AUDIT_RESULTS___WM_LAST_UPDATED_TSTMP as WM_LAST_UPDATED_TSTMP", \
...
Shortcut_to_WM_LPN_AUDIT_RESULTS1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(LPN_AUDIT_RESULTS_ID AS BIGINT) as WM_LPN_AUDIT_RESULTS_ID", 
	...
	"CAST(AUDIT_TRANSACTION_ID AS BIGINT) as WM_AUDIT_TRANSACTION_ID", 
	"CAST(AUDIT_COUNT AS BIGINT) as AUDIT_CNT", 
	...
	"CAST(COUNT_QUANTITY AS BIGINT) as CNT_QTY", 
	"CAST(EXPECTED_QUANTITY AS BIGINT) as EXPECTED_QTY", 
