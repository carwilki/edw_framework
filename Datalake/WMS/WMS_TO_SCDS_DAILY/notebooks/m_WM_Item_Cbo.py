...
Shortcut_to_WM_ITEM_CBO1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(SIZE_SEQ AS DECIMAL(4,0)) as SIZE_SEQ",
	"CAST(COLOR_SEQ AS DECIMAL(4,0)) as COLOR_SEQ",
	"CAST(COLOR_DESC AS STRING) as COLOR_DESC",
	"CAST(ITEM_QUALITY_CODE AS DECIMAL(8,0)) as WM_ITEM_QUALITY_CD",
	"CAST(STD_BUNDL_QTY AS DECIMAL(9,2)) as STD_BUNDL_QTY",
	"CAST(MAX_NEST_NUMBER AS DECIMAL(4,0)) as MAX_NEST_NBR",
	...
	"CAST(VARIABLE_WEIGHT AS DECIMAL(2,0)) as VARIABLE_WEIGHT",
	...
	"CAST(DIMENSION_UOM_ID AS DECIMAL(8,0)) as WM_DIMENSION_UOM_ID",
	"CAST(WEIGHT_UOM_ID AS DECIMAL(9,0)) as WM_WEIGHT_UOM_ID",
	"CAST(VOLUME_UOM_ID AS DECIMAL(9,0)) as WM_VOLUME_UOM_ID",
	"CAST(DATABASE_QTY_UOM_ID AS DECIMAL(8,0)) as WM_DATABASE_QTY_UOM_ID",
	"CAST(DISPLAY_QTY_UOM_ID AS DECIMAL(8,0)) as WM_DISPLAY_QTY_UOM_ID",
	"CAST(MIN_SHIP_INNER_UOM_ID AS STRING) as WM_MIN_SHIP_INNER_UOM_ID",
	"CAST(BASE_STORAGE_UOM_ID AS DECIMAL(8,0)) as WM_BASE_STORAGE_UOM_ID",
	"CAST(STATUS_CODE AS DECIMAL(2,0)) as WM_ITEM_STATUS_CD",
	"CAST(PRICE_STATUS AS STRING) as WM_PRICE_STATUS",
	"CAST(CATCH_WEIGHT_ITEM AS DECIMAL(1,0)) as CATCH_WEIGHT_ITEM_FLAG",
	"CAST(COMMODITY_LEVEL_DESC AS STRING) as COMMODITY_LEVEL_DESC",
	"CAST(CHANNEL_TYPE_ID AS DECIMAL(9,0)) as WM_CHANNEL_TYPE_ID",
	...
	"CAST(PROTECTION_LEVEL_ID AS DECIMAL(8,0)) as WM_PROTECTION_LEVEL_ID",
	"CAST(COMMODITY_CLASS_ID AS DECIMAL(8,0)) as WM_COMMODITY_CLASS_ID",
	"CAST(COMMODITY_CODE_ID AS DECIMAL(12,0)) as WM_COMMODITY_CD_ID",
	"CAST(PRODUCT_CLASS_ID AS DECIMAL(8,0)) as WM_PRODUCT_CLASS_ID",
	"CAST(UN_NUMBER_ID AS DECIMAL(12,0)) as WM_UN_NBR_ID",
	"CAST(SCHEDULE_B_CODE_ID AS DECIMAL(8,0)) as WM_SCHEDULE_B_CD_ID",
	"CAST(STCC_CODE_ID AS DECIMAL(9,0)) as WM_STCC_CD_ID",
	"CAST(SITC_CODE_ID AS DECIMAL(9,0)) as WM_SITC_CD_ID",
	"CAST(URL AS STRING) as WM_URL",
	"CAST(ITEM_IMAGE_FILENAME AS STRING) as WM_ITEM_IMAGE_FILE_NAME",
	"CAST(STACKABLE_ITEM AS DECIMAL(1,0)) as STACKABLE_ITEM_FLAG",
	"CAST(SOLD_ONLINE AS DECIMAL(1,0)) as SOLD_ONLINE_FLAG",
	"CAST(SOLD_IN_STORES AS DECIMAL(1,0)) as SOLD_IN_STORES_FLAG",
	"CAST(PICKUP_AT_STORE AS DECIMAL(1,0)) as PICKUP_AT_STORE_FLAG",
	"CAST(SHIP_TO_STORE AS DECIMAL(1,0)) as SHIP_TO_STORE_FLAG",
	"CAST(IS_RETURNABLE AS DECIMAL(1,0)) as RETURNABLE_FLAG",
	"CAST(IS_EXCHANGEABLE AS DECIMAL(1,0)) as EXCHANGEABLE_FLAG",
	"CAST(RETURNABLE_AT_STORE AS DECIMAL(1,0)) as RETURNABLE_AT_STORE_FLAG",
	...
	"CAST(VERSION AS DECIMAL(12,0)) as WM_VERSION",
