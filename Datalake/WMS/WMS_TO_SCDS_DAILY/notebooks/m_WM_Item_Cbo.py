...
Shortcut_to_WM_ITEM_CBO1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(ITEM_QUALITY_CODE AS BIGINT) as WM_ITEM_QUALITY_CD", 
	"CAST(STD_BUNDL_QTY AS BIGINT) as STD_BUNDL_QTY", 
	"CAST(MAX_NEST_NUMBER AS BIGINT) as MAX_NEST_NBR", 
	...
	"CAST(DATABASE_QTY_UOM_ID AS BIGINT) as WM_DATABASE_QTY_UOM_ID", 
	"CAST(DISPLAY_QTY_UOM_ID AS BIGINT) as WM_DISPLAY_QTY_UOM_ID", 
	"CAST(MIN_SHIP_INNER_UOM_ID AS STRING) as WM_MIN_SHIP_INNER_UOM_ID", 
	"CAST(BASE_STORAGE_UOM_ID AS BIGINT) as WM_BASE_STORAGE_UOM_ID", 
	"CAST(STATUS_CODE AS BIGINT) as WM_ITEM_STATUS_CD", 
	"CAST(PRICE_STATUS AS STRING) as WM_PRICE_STATUS", 
	"CAST(CATCH_WEIGHT_ITEM AS BIGINT) as CATCH_WEIGHT_ITEM_FLAG", 
	"CAST(COMMODITY_LEVEL_DESC AS STRING) as COMMODITY_LEVEL_DESC", 
	"CAST(CHANNEL_TYPE_ID AS BIGINT) as WM_CHANNEL_TYPE_ID", 
	...
	"CAST(COMMODITY_CLASS_ID AS BIGINT) as WM_COMMODITY_CLASS_ID", 
	...
	"CAST(SCHEDULE_B_CODE_ID AS BIGINT) as WM_SCHEDULE_B_CD_ID", 
	"CAST(STCC_CODE_ID AS BIGINT) as WM_STCC_CD_ID", 
	"CAST(SITC_CODE_ID AS BIGINT) as WM_SITC_CD_ID", 
	"CAST(URL AS STRING) as WM_URL", 
	"CAST(ITEM_IMAGE_FILENAME AS STRING) as WM_ITEM_IMAGE_FILE_NAME", 
	"CAST(STACKABLE_ITEM AS BIGINT) as STACKABLE_ITEM_FLAG", 
	"CAST(SOLD_ONLINE AS BIGINT) as SOLD_ONLINE_FLAG", 
	"CAST(SOLD_IN_STORES AS BIGINT) as SOLD_IN_STORES_FLAG", 
	"CAST(PICKUP_AT_STORE AS BIGINT) as PICKUP_AT_STORE_FLAG", 
	"CAST(SHIP_TO_STORE AS BIGINT) as SHIP_TO_STORE_FLAG", 
	"CAST(IS_RETURNABLE AS BIGINT) as RETURNABLE_FLAG", 
	"CAST(IS_EXCHANGEABLE AS BIGINT) as EXCHANGEABLE_FLAG", 
	"CAST(RETURNABLE_AT_STORE AS BIGINT) as RETURNABLE_AT_STORE_FLAG", 
	"CAST(COMMERCE_ATTRIBUTE1 AS STRING) as COMMERCE_ATTR_1", 
	"CAST(COMMERCE_ATTRIBUTE2 AS STRING) as COMMERCE_ATTR_2", 
	"CAST(COMMERCE_NUM_ATTRIBUTE1 AS BIGINT) as COMMERCE_NUM_ATTR_1", 
	"CAST(COMMERCE_NUM_ATTRIBUTE2 AS BIGINT) as COMMERCE_NUM_ATTR_2", 
