...
def m_WM_Business_Partner_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_BUSINESS_PARTNER = jdbcOracleConnection(
        f"""SELECT
    ...
    SQ_Shortcut_to_BUSINESS_PARTNER_temp = SQ_Shortcut_to_BUSINESS_PARTNER.toDF(*["SQ_Shortcut_to_BUSINESS_PARTNER___" + col for col in SQ_Shortcut_to_BUSINESS_PARTNER.columns])
