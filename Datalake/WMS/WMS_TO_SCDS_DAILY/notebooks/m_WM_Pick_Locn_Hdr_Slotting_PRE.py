...
def m_WM_Pick_Locn_Hdr_Slotting_PRE(dcnbr, env):
    ...
    refine_table_name = "WM_PICK_LOCN_HDR_SLOTTING"
    ...
    SQ_Shortcut_to_PICK_LOCN_HDR_SLOTTING = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    Shortcut_to_WM_PICK_LOCN_HDR_SLOTTING_PRE = EXPTRANS.selectExpr( \
    	...
    	"CAST(ALLOW_EXPAND AS BIGINT) as ALLOW_EXPAND", \
    	"CAST(ALLOW_EXPAND_LFT AS BIGINT) as ALLOW_EXPAND_LFT", \
    	"CAST(ALLOW_EXPAND_LFT_OVR AS BIGINT) as ALLOW_EXPAND_LFT_OVR", \
    	"CAST(ALLOW_EXPAND_OVR AS BIGINT) as ALLOW_EXPAND_OVR", \
    	"CAST(ALLOW_EXPAND_RGT AS BIGINT) as ALLOW_EXPAND_RGT", \
    	"CAST(ALLOW_EXPAND_RGT_OVR AS BIGINT) as ALLOW_EXPAND_RGT_OVR", \
    ...
    gu.overwriteDeltaPartition(Shortcut_to_WM_PICK_LOCN_HDR_SLOTTING_PRE, "DC_NBR", dcnbr, target_table_name)
