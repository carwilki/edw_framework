...
Shortcut_to_WM_ORDER_LINE_ITEM1 = UPD_INS_UPD.selectExpr( \
	...
	"CAST(ORIGINAL_ORDERED_ITEM_ID AS BIGINT) as WM_ORIGINAL_ORDERED_ITEM_ID", \
	...
	"CAST(INTERNAL_ORDER_SEQ_NBR AS BIGINT) as WM_INTERNAL_ORDER_SEQ_NBR", \
	...
	"CAST(DO_DTL_STATUS AS BIGINT) as WM_DO_DTL_STATUS", \
	...
	"CAST(WAVE_PROC_TYPE AS BIGINT) as WM_WAVE_PROC_TYPE", \
	"CAST(LINE_TYPE AS STRING) as LINE_TYPE", \
	"CAST(REPL_PROC_TYPE AS BIGINT) as REPL_PROC_TYPE", \
	"CAST(o_REPL_WAVE_RUN AS BIGINT) as REPL_WAVE_RUN_FLAG", \
	...
	"CAST(WM_RECEIPT_ALLOCATED AS BIGINT) as RECEIPT_ALLOCATED_FLAG", \
	...
	"CAST(o_EMERGENCY_FLAG AS BIGINT) as EMERGENCY_FLAG", \
	"CAST(o_SINGLE_UNIT_FLAG AS BIGINT) as SINGLE_UNIT_FLAG", \
	"CAST(o_SERIAL_NUMBER_REQUIRED_FLAG AS BIGINT) as SERIAL_NBR_REQD_FLAG", \
	"CAST(IS_CHASE_CREATED_LINE AS BIGINT) as CHASE_CREATED_LINE_FLAG", \
	"CAST(IS_GIFT AS BIGINT) as GIFT_FLAG", \
	"CAST(o_PARTL_FILL AS BIGINT) as PARTIAL_FILL_FLAG", \
	"CAST(LOCKED AS BIGINT) as LOCKED_FLAG", \
	"CAST(o_CANCELLED_FLAG AS BIGINT) as CANCELLED_FLAG", \
	...
	"CAST(ALLOCATION_SOURCE AS BIGINT) as WM_ALLOCATION_SOURCE", \
	"CAST(ALLOC_LINE_ID AS BIGINT) as WM_ALLOC_LINE_ID", \
	...
	"CAST(UNIT_PRICE_AMOUNT AS BIGINT) as UNIT_PRICE_AMT", \
	...
	"CAST(SIZE1_VALUE AS BIGINT) as SIZE_1_VALUE", \
	"CAST(RECEIVED_SIZE1 AS BIGINT) as RECEIVED_SIZE_1", \
	"CAST(SHIPPED_SIZE1 AS BIGINT) as SHIPPED_SIZE_1", \
	"CAST(SIZE1_UOM_ID AS BIGINT) as WM_SIZE_1_UOM_ID", \
	"CAST(SIZE2_VALUE AS BIGINT) as SIZE_2_VALUE", \
	"CAST(RECEIVED_SIZE2 AS BIGINT) as RECEIVED_SIZE_2", \
	"CAST(SHIPPED_SIZE2 AS BIGINT) as SHIPPED_SIZE_2", \
	"CAST(SIZE2_UOM_ID AS BIGINT) as WM_SIZE_2_UOM_ID", \
...
Shortcut_to_WM_ORDER_LINE_ITEM1.write.saveAsTable(f'{raw}.WM_ORDER_LINE_ITEM')