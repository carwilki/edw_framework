...
def m_WM_Order_Status_PRE(dcnbr, env):
    ...
    refine_table_name = "WM_ORDER_STATUS"
    ...
    SQ_Shortcut_to_ORDER_STATUS = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    gu.overwriteDeltaPartition(Shortcut_to_WM_ORDER_STATUS_PRE, "DC_NBR", dcnbr, target_table_name)
