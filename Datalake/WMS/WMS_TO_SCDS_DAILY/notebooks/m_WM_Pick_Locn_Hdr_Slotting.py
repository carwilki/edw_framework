...
WM_PICK_LOCN_HDR_SLOTTING.LOCATION_ID,
WM_PICK_LOCN_HDR_SLOTTING.WM_PICK_LOCN_HDR_ID,
WM_PICK_LOCN_HDR_SLOTTING.WM_SLOTTING_GROUP,
WM_PICK_LOCN_HDR_SLOTTING.WM_SLOT_PRIORITY,
WM_PICK_LOCN_HDR_SLOTTING.WM_RACK_LEVEL_ID,
WM_PICK_LOCN_HDR_SLOTTING.WM_RACK_TYPE,
WM_PICK_LOCN_HDR_SLOTTING.MY_RANGE,
WM_PICK_LOCN_HDR_SLOTTING.MY_SNS,
WM_PICK_LOCN_HDR_SLOTTING.SIDE_OF_AISLE,
WM_PICK_LOCN_HDR_SLOTTING.LABEL_POS,
WM_PICK_LOCN_HDR_SLOTTING.LABEL_POS_OVR,
WM_PICK_LOCN_HDR_SLOTTING.DEPTH_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING.HT_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING.WIDTH_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING.WT_LIMIT_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING.OLD_REC_SLOT_WIDTH,
WM_PICK_LOCN_HDR_SLOTTING.RIGHT_SLOT,
WM_PICK_LOCN_HDR_SLOTTING.LEFT_SLOT,
WM_PICK_LOCN_HDR_SLOTTING.REACH_DIST,
WM_PICK_LOCN_HDR_SLOTTING.REACH_DIST_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING.ALLOW_EXPAND_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.ALLOW_EXPAND_LFT_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.ALLOW_EXPAND_LFT_OVR_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.ALLOW_EXPAND_OVR_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.ALLOW_EXPAND_RGT_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.ALLOW_EXPAND_RGT_OVR_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.MAX_HC_OVR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_HT_CLEAR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_LANE_WT,
WM_PICK_LOCN_HDR_SLOTTING.MAX_LANES,
WM_PICK_LOCN_HDR_SLOTTING.MAX_LN_OVR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_LW_OVR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_SC_OVR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_SIDE_CLEAR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_ST_OVR,
WM_PICK_LOCN_HDR_SLOTTING.MAX_STACK,
WM_PICK_LOCN_HDR_SLOTTING.LOCKED_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.PROCESSED_FLAG,
WM_PICK_LOCN_HDR_SLOTTING.RESERVED_1,
WM_PICK_LOCN_HDR_SLOTTING.RESERVED_2,
WM_PICK_LOCN_HDR_SLOTTING.RESERVED_3,
WM_PICK_LOCN_HDR_SLOTTING.RESERVED_4,
WM_PICK_LOCN_HDR_SLOTTING.WM_CREATED_SOURCE_TYPE,
WM_PICK_LOCN_HDR_SLOTTING.WM_CREATED_SOURCE,
WM_PICK_LOCN_HDR_SLOTTING.WM_CREATED_TSTMP,
WM_PICK_LOCN_HDR_SLOTTING.WM_LAST_UPDATED_SOURCE_TYPE,
WM_PICK_LOCN_HDR_SLOTTING.WM_LAST_UPDATED_SOURCE,
WM_PICK_LOCN_HDR_SLOTTING.WM_LAST_UPDATED_TSTMP,
WM_PICK_LOCN_HDR_SLOTTING.LOAD_TSTMP
FROM WM_PICK_LOCN_HDR_SLOTTING
WHERE WM_PICK_LOCN_HDR_ID IN (SELECT PICK_LOCN_HDR_ID FROM WM_PICK_LOCN_HDR_SLOTTING_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_PICK_LOCN_HDR_SLOTTING_PRE.DC_NBR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.PICK_LOCN_HDR_ID,
WM_PICK_LOCN_HDR_SLOTTING_PRE.ALLOW_EXPAND,
WM_PICK_LOCN_HDR_SLOTTING_PRE.ALLOW_EXPAND_LFT,
WM_PICK_LOCN_HDR_SLOTTING_PRE.ALLOW_EXPAND_LFT_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.ALLOW_EXPAND_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.ALLOW_EXPAND_RGT,
WM_PICK_LOCN_HDR_SLOTTING_PRE.ALLOW_EXPAND_RGT_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.DEPTH_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.HT_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LABEL_POS,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LABEL_POS_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LEFT_SLOT,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LOCKED,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_HC_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_HT_CLEAR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_LANE_WT,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_LANES,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_LN_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_LW_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_SC_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_SIDE_CLEAR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_ST_OVR,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MAX_STACK,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MY_RANGE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.MY_SNS,
WM_PICK_LOCN_HDR_SLOTTING_PRE.OLD_REC_SLOT_WIDTH,
WM_PICK_LOCN_HDR_SLOTTING_PRE.PROCESSED,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RACK_LEVEL_ID,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RACK_TYPE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.REACH_DIST,
WM_PICK_LOCN_HDR_SLOTTING_PRE.REACH_DIST_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RESERVED_1,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RESERVED_2,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RESERVED_3,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RESERVED_4,
WM_PICK_LOCN_HDR_SLOTTING_PRE.RIGHT_SLOT,
WM_PICK_LOCN_HDR_SLOTTING_PRE.SIDE_OF_AISLE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.SLOT_PRIORITY,
WM_PICK_LOCN_HDR_SLOTTING_PRE.WIDTH_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.WT_LIMIT_OVERRIDE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.CREATED_SOURCE_TYPE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.CREATED_SOURCE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.CREATED_DTTM,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LAST_UPDATED_SOURCE,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LAST_UPDATED_DTTM,
WM_PICK_LOCN_HDR_SLOTTING_PRE.SLOTTING_GROUP,
WM_PICK_LOCN_HDR_SLOTTING_PRE.LOAD_TSTMP
FROM WM_PICK_LOCN_HDR_SLOTTING_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
