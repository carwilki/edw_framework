...
Shortcut_to_WM_VEND_PERF_TRAN = UPD_INS_UPD.selectExpr(
	...
	"CAST(VEND_PERF_TRAN_ID AS INT) as WM_VEND_PERF_TRAN_ID",
	...
	"CAST(PO_HDR_ID AS INT) as WM_PO_HDR_ID",
	"CAST(PO_NBR AS STRING) as WM_PO_NBR",
	"CAST(CASE_HDR_ID AS INT) as WM_CASE_HDR_ID",
	"CAST(CASE_NBR AS STRING) as WM_CASE_NBR",
	"CAST(ASN_HDR_ID AS INT) as WM_ASN_HDR_ID",
	"CAST(ILM_APPT_NBR AS STRING) as WM_ILM_APPT_NBR",
	"CAST(ITEM_ID AS BIGINT) as WM_ITEM_ID",
	"CAST(LOAD_NBR AS STRING) as WM_LOAD_NBR",
	"CAST(STAT_CODE AS TINYINT) as WM_STAT_CD",
	"CAST(BILL_FLAG1 AS STRING) as BILL_FLAG",
	"CAST(QTY1 AS DECIMAL(13,5)) as QTY",
	"CAST(UOM1 AS STRING) as UOM",
	"CAST(SAMS1 AS DECIMAL(9,4)) as SAMS",
	"CAST(CHRG_AMT1 AS DECIMAL(9,2)) as CHRG_AMT",
