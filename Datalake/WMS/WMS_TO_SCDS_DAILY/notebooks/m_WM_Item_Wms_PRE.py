...
def m_WM_Item_Wms_PRE(dcnbr, env):
    ...
    FROM ITEM_WMS
    WHERE (trunc(ITEM_WMS.AUDIT_CREATED_DTTM) >= trunc(to_date('{Prev_Run_Dt}','MM/DD/YYYY HH24:MI:SS')) - 1) OR (trunc(ITEM_WMS.AUDIT_LAST_UPDATED_DTTM) >= trunc(to_date('{Prev_Run_Dt}','MM/DD/YYYY HH24:MI:SS')) - 1) AND 
