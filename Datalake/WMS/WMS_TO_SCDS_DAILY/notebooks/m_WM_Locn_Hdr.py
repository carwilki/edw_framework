...
WM_LOCN_HDR.LOCATION_ID,
WM_LOCN_HDR.WM_LOCN_HDR_ID,
WM_LOCN_HDR.WM_CREATED_TSTMP,
WM_LOCN_HDR.WM_LAST_UPDATED_TSTMP,
WM_LOCN_HDR.WM_CREATE_TSTMP,
WM_LOCN_HDR.WM_MOD_TSTMP,
WM_LOCN_HDR.LOAD_TSTMP
FROM WM_LOCN_HDR
WHERE WM_LOCN_HDR_ID IN (SELECT LOCN_HDR_ID FROM WM_LOCN_HDR_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_LOCN_HDR_PRE.DC_NBR,
WM_LOCN_HDR_PRE.LOCN_HDR_ID,
WM_LOCN_HDR_PRE.LOCN_ID,
WM_LOCN_HDR_PRE.WHSE,
WM_LOCN_HDR_PRE.LOCN_CLASS,
WM_LOCN_HDR_PRE.LOCN_BRCD,
WM_LOCN_HDR_PRE.AREA,
WM_LOCN_HDR_PRE.ZONE,
WM_LOCN_HDR_PRE.AISLE,
WM_LOCN_HDR_PRE.BAY,
WM_LOCN_HDR_PRE.LVL,
WM_LOCN_HDR_PRE.POSN,
WM_LOCN_HDR_PRE.DSP_LOCN,
WM_LOCN_HDR_PRE.LOCN_PICK_SEQ,
WM_LOCN_HDR_PRE.SKU_DEDCTN_TYPE,
WM_LOCN_HDR_PRE.SLOT_TYPE,
WM_LOCN_HDR_PRE.PUTWY_ZONE,
WM_LOCN_HDR_PRE.PULL_ZONE,
WM_LOCN_HDR_PRE.PICK_DETRM_ZONE,
WM_LOCN_HDR_PRE.LEN,
WM_LOCN_HDR_PRE.WIDTH,
WM_LOCN_HDR_PRE.HT,
WM_LOCN_HDR_PRE.X_COORD,
WM_LOCN_HDR_PRE.Y_COORD,
WM_LOCN_HDR_PRE.Z_COORD,
WM_LOCN_HDR_PRE.WORK_GRP,
WM_LOCN_HDR_PRE.WORK_AREA,
WM_LOCN_HDR_PRE.LAST_FROZN_DATE_TIME,
WM_LOCN_HDR_PRE.LAST_CNT_DATE_TIME,
WM_LOCN_HDR_PRE.CYCLE_CNT_PENDIN,
WM_LOCN_HDR_PRE.PRT_LABEL_FLAG,
WM_LOCN_HDR_PRE.TRAVEL_AISLE,
WM_LOCN_HDR_PRE.TRAVEL_ZONE,
WM_LOCN_HDR_PRE.STORAGE_UOM,
WM_LOCN_HDR_PRE.PICK_UOM,
WM_LOCN_HDR_PRE.CREATE_DATE_TIME,
WM_LOCN_HDR_PRE.MOD_DATE_TIME,
WM_LOCN_HDR_PRE.USER_ID,
WM_LOCN_HDR_PRE.SLOT_UNUSABLE,
WM_LOCN_HDR_PRE.CHECK_DIGIT,
WM_LOCN_HDR_PRE.VOCO_INTRNL_REVERSE_BRCD,
WM_LOCN_HDR_PRE.WM_VERSION_ID,
WM_LOCN_HDR_PRE.LOCN_PUTWY_SEQ,
WM_LOCN_HDR_PRE.LOCN_DYN_ASSGN_SEQ,
WM_LOCN_HDR_PRE.CREATED_DTTM,
WM_LOCN_HDR_PRE.LAST_UPDATED_DTTM,
WM_LOCN_HDR_PRE.FACILITY_ID
FROM WM_LOCN_HDR_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___CYCLE_CNT_PENDIN ) ) ) , 'Y','1' , '1','1','0' ) as o_CYCLE_CNT_PENDIN", \
	"FIL_UNCHANGED_RECORDS___PRT_LABEL_FLAG as PRT_LABEL_FLAG", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___PRT_LABEL_FLAG ) ) ) , 'Y','1' , '1','1','0' ) as o_PRT_LABEL_FLAG", \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___SLOT_UNUSABLE ) ) ) , 'Y','1' , '1','1','0' ) as o_SLOT_UNUSABLE", \
