...
Shortcut_to_WM_LOCN_HDR1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(o_CYCLE_CNT_PENDIN AS BIGINT) as CYCLE_CNT_PENDING_FLAG", 
	"CAST(o_PRT_LABEL_FLAG AS BIGINT) as PRT_LABEL_FLAG", 
	"CAST(o_SLOT_UNUSABLE AS BIGINT) as SLOT_UNUSABLE_FLAG", 
