...
Shortcut_to_WM_ASN_DETAIL1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(ASN_DETAIL_ID AS DECIMAL(10BIGINT) as WM_ASN_DETAIL_ID",
	...
	"CAST(ORDER_ID AS DECIMAL(10BIGINT) as WM_ORDER_ID",
	"CAST(ORDER_LINE_ITEM_ID AS DECIMAL(10BIGINT) as WM_ORDER_LINE_ITEM_ID",
	"CAST(PURCHASE_ORDERS_ID AS DECIMAL(10BIGINT) as WM_PURCHASE_ORDERS_ID",
	"CAST(PURCHASE_ORDERS_LINE_ITEM_ID AS DECIMAL(10BIGINT) as WM_PURCHASE_ORDERS_LINE_ITEM_ID",
	...
	"CAST(INVENTORY_SEGMENT_ID AS DECIMAL(12BIGINT) as WM_INVENTORY_SEGMENT_ID",
	...
	"CAST(QTY_UOM_ID AS DECIMAL(12BIGINT) as WM_QTY_UOM_ID",
