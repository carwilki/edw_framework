...
Shortcut_to_WM_ASN_STATUS1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(ASN_STATUS AS SMALLINT) as WM_ASN_STATUS",
...
#   refined_perf_table = "WM_ASN"
  ...
  logPrevRunDt("WM_ASN_STATUS", "WM_ASN_STATUS", "Completed", "N/A", f"{raw}.log_run_details")
except Exception as e:
  logPrevRunDt("WM_ASN_STATUS", "WM_ASN_STATUS","Failed",str(e), f"{raw}.log_run_details", )
  raise e