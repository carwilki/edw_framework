...
Shortcut_to_WM_SLOT_ITEM1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(PALLET_MOV AS  DECIMAL(13,4)) as PALLET_MOVEMENT", 
	"CAST(CASE_MOV AS  DECIMAL(13,4)) as CASE_MOVEMENT", 
	"CAST(INNER_MOV AS  DECIMAL(13,4)) as INNER_MOVEMENT", 
	"CAST(EACH_MOV AS  DECIMAL(13,4)) as EACH_MOVEMENT", 
	"CAST(BIN_MOV AS  DECIMAL(13,4)) as BIN_MOVEMENT", 
	"CAST(PALLET_INVEN AS  DECIMAL(13,4)) as PALLET_INVENTORY", 
	"CAST(CASE_INVEN AS  DECIMAL(13,4)) as CASE_INVENTORY", 
	"CAST(INNER_INVEN AS  DECIMAL(13,4)) as INNER_INVENTORY", 
	"CAST(EACH_INVEN AS  DECIMAL(13,4)) as EACH_INVENTORY", 
	"CAST(BIN_INVEN AS  DECIMAL(13,4)) as BIN_INVENTORY", 
