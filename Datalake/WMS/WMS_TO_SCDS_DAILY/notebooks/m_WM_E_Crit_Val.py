...
WM_E_CRIT_VAL_PRE.DC_NBR,
WM_E_CRIT_VAL_PRE.CRIT_VAL_ID,
WM_E_CRIT_VAL_PRE.CRIT_ID,
WM_E_CRIT_VAL_PRE.CRIT_VAL,
WM_E_CRIT_VAL_PRE.CREATE_DATE_TIME,
WM_E_CRIT_VAL_PRE.MOD_DATE_TIME,
WM_E_CRIT_VAL_PRE.USER_ID,
WM_E_CRIT_VAL_PRE.MISC_TXT_1,
WM_E_CRIT_VAL_PRE.MISC_TXT_2,
WM_E_CRIT_VAL_PRE.MISC_NUM_1,
WM_E_CRIT_VAL_PRE.MISC_NUM_2,
WM_E_CRIT_VAL_PRE.VERSION_ID
FROM WM_E_CRIT_VAL_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_E_CRIT_VAL.LOCATION_ID,
WM_E_CRIT_VAL.WM_CRIT_VAL_ID,
WM_E_CRIT_VAL.WM_CRIT_ID,
WM_E_CRIT_VAL.WM_CRIT_VAL,
WM_E_CRIT_VAL.MISC_TXT_1,
WM_E_CRIT_VAL.MISC_TXT_2,
WM_E_CRIT_VAL.MISC_NUM_1,
WM_E_CRIT_VAL.MISC_NUM_2,
WM_E_CRIT_VAL.WM_USER_ID,
WM_E_CRIT_VAL.WM_VERSION_ID,
WM_E_CRIT_VAL.WM_CREATE_TSTMP,
WM_E_CRIT_VAL.WM_MOD_TSTMP,
WM_E_CRIT_VAL.DELETE_FLAG,
WM_E_CRIT_VAL.LOAD_TSTMP
FROM WM_E_CRIT_VAL
