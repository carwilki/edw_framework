...
WM_LPN_SIZE_TYPE_PRE.DC_NBR,
WM_LPN_SIZE_TYPE_PRE.LPN_SIZE_TYPE_ID,
WM_LPN_SIZE_TYPE_PRE.LPN_DESC,
WM_LPN_SIZE_TYPE_PRE.LPN_SIZE_DESC,
WM_LPN_SIZE_TYPE_PRE.LPN_SIZE_TYPE,
WM_LPN_SIZE_TYPE_PRE.LPN_TYPE_ID,
WM_LPN_SIZE_TYPE_PRE.PKG_DESC,
WM_LPN_SIZE_TYPE_PRE.OVERSIZE_FLAG,
WM_LPN_SIZE_TYPE_PRE.LENGTH,
WM_LPN_SIZE_TYPE_PRE.WIDTH,
WM_LPN_SIZE_TYPE_PRE.HEIGHT,
WM_LPN_SIZE_TYPE_PRE.LPN_DIM_UOM,
WM_LPN_SIZE_TYPE_PRE.LPN_PER_TIER,
WM_LPN_SIZE_TYPE_PRE.TIER_PER_PALLET,
WM_LPN_SIZE_TYPE_PRE.PROC_ATTR_1,
WM_LPN_SIZE_TYPE_PRE.PROC_ATTR_2,
WM_LPN_SIZE_TYPE_PRE.PROC_ATTR_3,
WM_LPN_SIZE_TYPE_PRE.PROC_ATTR_4,
WM_LPN_SIZE_TYPE_PRE.PROC_ATTR_5,
WM_LPN_SIZE_TYPE_PRE.USER_ID,
WM_LPN_SIZE_TYPE_PRE.WM_VERSION_ID,
WM_LPN_SIZE_TYPE_PRE.CREATED_DTTM,
WM_LPN_SIZE_TYPE_PRE.LAST_UPDATED_DTTM,
WM_LPN_SIZE_TYPE_PRE.HIBERNATE_VERSION,
WM_LPN_SIZE_TYPE_PRE.TC_COMPANY_ID,
WM_LPN_SIZE_TYPE_PRE.MARK_FOR_DELETION,
WM_LPN_SIZE_TYPE_PRE.SHAPE_TYPE,
WM_LPN_SIZE_TYPE_PRE.IS_STACKABLE,
WM_LPN_SIZE_TYPE_PRE.STACK_RANK,
WM_LPN_SIZE_TYPE_PRE.STACK_POSITION,
WM_LPN_SIZE_TYPE_PRE.LOAD_BEARING_STRENGTH,
WM_LPN_SIZE_TYPE_PRE.FACILITY_ID,
WM_LPN_SIZE_TYPE_PRE.LOAD_TSTMP
FROM WM_LPN_SIZE_TYPE_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_LPN_SIZE_TYPE.LOCATION_ID,
WM_LPN_SIZE_TYPE.WM_LPN_SIZE_TYPE_ID,
WM_LPN_SIZE_TYPE.WM_LPN_TYPE_ID,
WM_LPN_SIZE_TYPE.WM_LPN_SIZE_TYPE,
WM_LPN_SIZE_TYPE.WM_LPN_SIZE_DESC,
WM_LPN_SIZE_TYPE.WM_LPN_DESC,
WM_LPN_SIZE_TYPE.WM_TC_COMPANY_ID,
WM_LPN_SIZE_TYPE.WM_FACILITY_ID,
WM_LPN_SIZE_TYPE.WM_PKG_DESC,
WM_LPN_SIZE_TYPE.OVERSIZE_FLAG,
WM_LPN_SIZE_TYPE.STACKABLE_FLAG,
WM_LPN_SIZE_TYPE.STACK_RANK,
WM_LPN_SIZE_TYPE.STACK_POSITION,
WM_LPN_SIZE_TYPE.LPN_PER_TIER,
WM_LPN_SIZE_TYPE.TIER_PER_PALLET,
WM_LPN_SIZE_TYPE.WM_SHAPE_TYPE,
WM_LPN_SIZE_TYPE.LOAD_BEARING_STRENGTH,
WM_LPN_SIZE_TYPE.WM_LPN_DIM_UOM,
WM_LPN_SIZE_TYPE.LENGTH,
WM_LPN_SIZE_TYPE.WIDTH,
WM_LPN_SIZE_TYPE.HEIGHT,
WM_LPN_SIZE_TYPE.PROCESS_ATTR_1,
WM_LPN_SIZE_TYPE.PROCESS_ATTR_2,
WM_LPN_SIZE_TYPE.PROCESS_ATTR_3,
WM_LPN_SIZE_TYPE.PROCESS_ATTR_4,
WM_LPN_SIZE_TYPE.PROCESS_ATTR_5,
WM_LPN_SIZE_TYPE.WM_USER_ID,
WM_LPN_SIZE_TYPE.WM_VERSION_ID,
WM_LPN_SIZE_TYPE.WM_HIBERNATE_VERSION,
WM_LPN_SIZE_TYPE.MARK_FOR_DELETION_FLAG,
WM_LPN_SIZE_TYPE.WM_CREATED_TSTMP,
WM_LPN_SIZE_TYPE.WM_LAST_UPDATED_TSTMP,
WM_LPN_SIZE_TYPE.LOAD_TSTMP
FROM WM_LPN_SIZE_TYPE
WHERE WM_LPN_SIZE_TYPE_ID IN
(SELECT LPN_SIZE_TYPE_ID FROM WM_LPN_SIZE_TYPE_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
UPD_INS_UPD = EXP_UPD_VALIDATOR_temp.selectExpr( \
	...
	.withColumn('pyspark_data_action', when(EXP_UPD_VALIDATOR.UPD_VALIDATOR ==(lit(1)) , lit(0)) .when(EXP_UPD_VALIDATOR.UPD_VALIDATOR ==(lit(2)) , lit(1)))
