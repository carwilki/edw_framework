...
def m_WM_Asn_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_ASN = gu.jdbcOracleConnection(
        f"""SELECT
                ASN.ASN_ID,
                ASN.TC_COMPANY_ID,
                ASN.TC_ASN_ID,
    ...
    SQ_Shortcut_to_ASN_temp = SQ_Shortcut_to_ASN.toDF(
        *["SQ_Shortcut_to_ASN___" + col for col in SQ_Shortcut_to_ASN.columns]
    )
    ...
    Shortcut_to_WM_ASN_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(DESTINATION_FACILITY_ID AS BIGINT) as DESTINATION_FACILITY_ID",
        ...
        "CAST(EQUIPMENT_CODE_ID AS BIGINT) as EQUIPMENT_CODE_ID",
        "CAST(ASSIGNED_CARRIER_CODE_ID AS BIGINT) as ASSIGNED_CARRIER_CODE_ID",
        "CAST(TOTAL_VOLUME AS BIGINT) as TOTAL_VOLUME",
        "CAST(VOLUME_UOM_ID_BASE AS BIGINT) as VOLUME_UOM_ID_BASE",
        "CAST(FIRM_APPT_IND AS BIGINT) as FIRM_APPT_IND",
        "CAST(TRACTOR_CARRIER_CODE_ID AS BIGINT) as TRACTOR_CARRIER_CODE_ID",
        ...
        "CAST(ASN_LEVEL AS BIGINT) as ASN_LEVEL",
        "CAST(RECEIPT_VARIANCE AS BIGINT) as RECEIPT_VARIANCE",
        ...
        "CAST(SYSTEM_ALLOCATED AS BIGINT) as SYSTEM_ALLOCATED",
        "CAST(IS_COGI_GENERATED AS BIGINT) as IS_COGI_GENERATED",
        "CAST(ASN_PRIORITY AS BIGINT) as ASN_PRIORITY",
        "CAST(SCHEDULE_APPT AS BIGINT) as SCHEDULE_APPT",
        ...
        "CAST(QUALITY_AUDIT_PERCENT AS BIGINT) as QUALITY_AUDIT_PERCENT",
        ...
        "CAST(PRE_ALLOCATION_FIT_PERCENTAGE AS BIGINT) as PRE_ALLOCATION_FIT_PERCENTAGE",
        "CAST(TRAILER_CLOSED AS BIGINT) as TRAILER_CLOSED",
    ...
    gu.overwriteDeltaPartition(
        Shortcut_to_WM_ASN_PRE, "DC_NBR", dcnbr, target_table_name
    )
    logger.info(
