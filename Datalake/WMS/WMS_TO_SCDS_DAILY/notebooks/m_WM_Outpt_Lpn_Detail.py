...
WM_OUTPT_LPN_DETAIL_PRE.DC_NBR,
WM_OUTPT_LPN_DETAIL_PRE.OUTPT_LPN_DETAIL_ID,
WM_OUTPT_LPN_DETAIL_PRE.ASSORT_NBR,
WM_OUTPT_LPN_DETAIL_PRE.BUSINESS_PARTNER,
WM_OUTPT_LPN_DETAIL_PRE.CONSUMPTION_PRIORITY_DTTM,
WM_OUTPT_LPN_DETAIL_PRE.CREATED_DTTM,
WM_OUTPT_LPN_DETAIL_PRE.CREATED_SOURCE,
WM_OUTPT_LPN_DETAIL_PRE.CREATED_SOURCE_TYPE,
WM_OUTPT_LPN_DETAIL_PRE.GTIN,
WM_OUTPT_LPN_DETAIL_PRE.INVC_BATCH_NBR,
WM_OUTPT_LPN_DETAIL_PRE.INVENTORY_TYPE,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_ATTR_1,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_ATTR_2,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_ATTR_3,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_ATTR_4,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_ATTR_5,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_ID,
WM_OUTPT_LPN_DETAIL_PRE.LAST_UPDATED_DTTM,
WM_OUTPT_LPN_DETAIL_PRE.LAST_UPDATED_SOURCE,
WM_OUTPT_LPN_DETAIL_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_OUTPT_LPN_DETAIL_PRE.LPN_DETAIL_ID,
WM_OUTPT_LPN_DETAIL_PRE.MANUFACTURED_DTTM,
WM_OUTPT_LPN_DETAIL_PRE.BATCH_NBR,
WM_OUTPT_LPN_DETAIL_PRE.MANUFACTURED_PLANT,
WM_OUTPT_LPN_DETAIL_PRE.CNTRY_OF_ORGN,
WM_OUTPT_LPN_DETAIL_PRE.PRODUCT_STATUS,
WM_OUTPT_LPN_DETAIL_PRE.PROC_DTTM,
WM_OUTPT_LPN_DETAIL_PRE.PROC_STAT_CODE,
WM_OUTPT_LPN_DETAIL_PRE.QTY_UOM,
WM_OUTPT_LPN_DETAIL_PRE.REC_PROC_INDIC,
WM_OUTPT_LPN_DETAIL_PRE.SIZE_VALUE,
WM_OUTPT_LPN_DETAIL_PRE.TC_COMPANY_ID,
WM_OUTPT_LPN_DETAIL_PRE.TC_LPN_ID,
WM_OUTPT_LPN_DETAIL_PRE.VERSION_NBR,
WM_OUTPT_LPN_DETAIL_PRE.DISTRIBUTION_ORDER_DTL_ID,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_COLOR,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_COLOR_SFX,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_SEASON,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_SEASON_YEAR,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_SECOND_DIM,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_SIZE_DESC,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_QUALITY,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_STYLE,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_STYLE_SFX,
WM_OUTPT_LPN_DETAIL_PRE.SIZE_RANGE_CODE,
WM_OUTPT_LPN_DETAIL_PRE.SIZE_REL_POSN_IN_TABLE,
WM_OUTPT_LPN_DETAIL_PRE.VENDOR_ITEM_NBR,
WM_OUTPT_LPN_DETAIL_PRE.MINOR_ORDER_NBR,
WM_OUTPT_LPN_DETAIL_PRE.MINOR_PO_NBR,
WM_OUTPT_LPN_DETAIL_PRE.ITEM_NAME,
WM_OUTPT_LPN_DETAIL_PRE.TC_ORDER_LINE_ID,
WM_OUTPT_LPN_DETAIL_PRE.DISTRO_NUMBER
FROM WM_OUTPT_LPN_DETAIL_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_OUTPT_LPN_DETAIL.LOCATION_ID,
WM_OUTPT_LPN_DETAIL.WM_OUTPT_LPN_DETAIL_ID,
WM_OUTPT_LPN_DETAIL.WM_CREATED_TSTMP,
WM_OUTPT_LPN_DETAIL.WM_LAST_UPDATED_TSTMP,
WM_OUTPT_LPN_DETAIL.LOAD_TSTMP
FROM WM_OUTPT_LPN_DETAIL
WHERE WM_OUTPT_LPN_DETAIL_ID IN (SELECT OUTPT_LPN_DETAIL_ID FROM WM_OUTPT_LPN_DETAIL_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
Shortcut_to_WM_OUTPT_LPN_DETAIL1.write.saveAsTable(f'{raw}.WM_OUTPT_LPN_DETAIL')