...
Shortcut_to_WM_WAVE_PARM_1 = UPD_INS_UPD.selectExpr( 
	"CAST(LOCATION_ID AS BIGINT) as LOCATION_ID", 
	"CAST(WAVE_PARM_ID AS BIGINT) as WM_WAVE_PARM_ID", 
	"CAST(WHSE AS STRING) as WM_WHSE", 
	"CAST(TC_COMPANY_ID AS BIGINT) as WM_TC_COMPANY_ID", 
	"CAST(WAVE_NBR AS STRING) as WM_WAVE_NBR", 
	"CAST(WAVE_DESC AS STRING) as WM_WAVE_DESC", 
	"CAST(WAVE_PROC_TYPE AS BIGINT) as WM_WAVE_PROC_TYPE", 
	"CAST(WAVE_PARM_TEMPLATE_ID AS BIGINT) as WM_WAVE_PARM_TEMPLATE_ID", 
	"CAST(PACK_WAVE_PARM_ID AS BIGINT) as WM_PACK_WAVE_PARM_ID", 
	"CAST(CAT_PARM_ID AS BIGINT) as WM_CAT_PARM_ID", 
	"CAST(CARTON_TYPE_EVENT_ID AS BIGINT) as WM_CARTON_TYPE_EVENT_ID", 
	"CAST(CHUTE_ASSIGN_TYPE_EVENT_ID AS BIGINT) as WM_CHUTE_ASSIGN_TYPE_EVENT_ID", 
	"CAST(LPN_BRK_ATTRIB_EVENT_ID AS BIGINT) as WM_LPN_BRK_ATTRIB_EVENT_ID", 
	"CAST(RETAIN_PALLET_ID AS BIGINT) as WM_RETAIN_PALLET_ID", 
	"CAST(PKT_CONSOL_PROF AS STRING) as WM_PKT_CONSOL_PROF", 
	"CAST(PKT_CONSOL_DETRM_TYPE AS STRING) as WM_PKT_CONSOL_DETRM_TYPE", 
	...
	"CAST(REC_TYPE AS STRING) as WM_REC_TYPE", 
	"CAST(FORCE_ALLOC_TYPE AS STRING) as WM_FORCE_ALLOC_TYPE", 
	"CAST(FORCE_PICK_LOCN_ASSIGN_TYPE AS STRING) as WM_FORCE_PICK_LOCN_ASSIGN_TYPE", 
	"CAST(BULK_PICK_ASSIGN_TYPE AS STRING) as WM_BULK_PICK_ASSIGN_TYPE", 
	"CAST(BULK_PICK_ZONE AS STRING) as WM_BULK_PICK_ZONE", 
	"CAST(DLVRY_WIN_RANGE_CODE AS STRING) as WM_DLVRY_WIN_RANGE_CD", 
	"CAST(DFLT_PLT_TYPE AS STRING) as WM_DFLT_PLT_TYPE", 
	"CAST(SKU_CNSTR AS STRING) as WM_SKU_CNSTR", 
	"CAST(SKU_SUB AS STRING) as WM_SKU_SUB", 
	"CAST(SHIP_VIA AS STRING) as WM_SHIP_VIA", 
	"CAST(SWC_NBR AS STRING) as WM_SWC_NBR", 
	"CAST(MANIF_NBR AS STRING) as WM_MANIF_NBR", 
	"CAST(BOL AS STRING) as WM_BOL", 
	"CAST(SHPMT_NBR AS STRING) as WM_SHPMT_NBR", 
	"CAST(DAY_OF_WEEK AS BIGINT) as DAY_OF_WEEK", 
	"CAST(SHIFT_NBR AS STRING) as SHIFT_NBR", 
	"CAST(SHIP_DATE_TIME AS TIMESTAMP) as SHIP_TSTMP", 
	"CAST(SCHED_DLVRY_DATE AS TIMESTAMP) as SCHED_DELIVERY_TSTMP", 
	"CAST(SCHED_WAVE AS STRING) as SCHED_WAVE", 
	"CAST(WAVE_STAT_DATE_TIME AS TIMESTAMP) as WAVE_STAT_TSTMP", 
	"CAST(WAVE_STAT_CODE AS BIGINT) as WM_WAVE_STAT_CD", 
	"CAST(WAVE_CMPL_STAT_CODE AS BIGINT) as WM_WAVE_CMPL_STAT_CD", 
	"CAST(PICK_STAT_CODE AS BIGINT) as WM_PICK_STAT_CD", 
	"CAST(PACK_STAT_CODE AS BIGINT) as WM_PACK_STAT_CD", 
	"CAST(REPL_STAT_CODE AS BIGINT) as WM_REPL_STAT_CD", 
	"CAST(INDUC_STAT_CODE AS BIGINT) as WM_INDUC_STAT_CD", 
	"CAST(FORCE_WPT AS BIGINT) as FORCE_WPT_FLAG", 
	"CAST(REPL_TRIG AS STRING) as REPL_TRIG", 
	"CAST(RTE_W_WAVE AS STRING) as RTE_W_WAVE", 
	"CAST(CHG_PKT_QTY AS STRING) as CHG_PKT_QTY", 
	"CAST(CARTON_BREAK_ON_AREA_CHG AS BIGINT) as CARTON_BREAK_ON_AREA_CHG_FLAG", 
	"CAST(CARTON_BREAK_ON_ZONE_CHG AS BIGINT) as CARTON_BREAK_ON_ZONE_CHG_FLAG", 
	"CAST(CARTON_BREAK_ON_AISLE_CHG AS BIGINT) as CARTON_BREAK_ON_AISLE_CHG_FLAG", 
	"CAST(PKT_CONSOL_REJECT_RULE AS STRING) as PKT_CONSOL_REJECT_RULE", 
	"CAST(ASSIGN_PRO_NBR AS STRING) as ASSIGN_PRO_NBR", 
	"CAST(SWC_NBR_FLAG AS BIGINT) as SWC_NBR_FLAG", 
	"CAST(MANIF_FLAG AS BIGINT) as MANIF_FLAG", 
	"CAST(BOL_FLAG AS BIGINT) as BOL_FLAG", 
	"CAST(SHPMT_FLAG AS BIGINT) as SHPMT_FLAG", 
	"CAST(CLEAR_SPUR_LOCN AS STRING) as CLEAR_SPUR_LOCN", 
	"CAST(SPUR AS STRING) as SPUR", 
	"CAST(XCEED_CAPCTY_FLAG AS BIGINT) as XCEED_CAPCTY_FLAG", 
	"CAST(CONSL_LOCN_CLEAR_METHD AS STRING) as CONSL_LOCN_CLEAR_METHD", 
	"CAST(PERP_PLT_POSN AS STRING) as PERP_PLT_POSN", 
	"CAST(USE_INBD_LPN_AS_OUTBD_LPN AS BIGINT) as USE_INBD_LPN_AS_OUTBD_LPN_FLAG", 
	"CAST(GRP_PKT_BY_SWC_NBR AS BIGINT) as GRP_PKT_BY_SWC_NBR_FLAG", 
	"CAST(PULL_ALL_SWC AS BIGINT) as PULL_ALL_SWC", 
	"CAST(ZONE_PICK_METHOD AS STRING) as ZONE_PICK_METHOD", 
	"CAST(WAVE_TYPE_INDIC AS STRING) as WAVE_TYPE_IND", 
	"CAST(REJECT_DISTRO_RULE AS BIGINT) as REJECT_DISTRO_RULE_FLAG", 
	"CAST(BULK_WAVE_BAL_FROM_ACTV AS BIGINT) as BULK_WAVE_BAL_FROM_ACTV_FLAG", 
	"CAST(PRT_CS_LABELS_W_WAVE AS BIGINT) as PRT_CS_LABELS_W_WAVE", 
	...
	"CAST(PACK_CMPL_W_WAVE AS BIGINT) as PACK_CMPL_W_WAVE_FLAG", 
	"CAST(DESEL_SNGL_FLAG AS BIGINT) as DESEL_SNGL_FLAG", 
	...
	"CAST(RESV_BAL AS BIGINT) as RESV_BAL_FLAG", 
	"CAST(RESV_BALANCE_INT AS BIGINT) as RESV_BALANCE_INT", 
	"CAST(ORDER_RND_FLAG AS BIGINT) as ORDER_ROUND_FLAG", 
	"CAST(ALLOC_REMAIN AS STRING) as ALLOC_REMAIN", 
	"CAST(MHE_FLAG AS BIGINT) as MHE_FLAG", 
	"CAST(MHE_ONE_SEND_FLAG AS BIGINT) as MHE_ONE_SEND_FLAG", 
	"CAST(MHE_PICK_DEST_LEVEL AS BIGINT) as MHE_PICK_DEST_LEVEL_FLAG", 
	"CAST(FORCE_SHIP_DATE_FLAG AS BIGINT) as FORCE_SHIP_DATE_FLAG", 
	"CAST(REPL_WAVE AS BIGINT) as REPL_WAVE_FLAG", 
	"CAST(RESEQ_ACTIV_LOC AS BIGINT) as RESEQ_ACTIV_LOC", 
	"CAST(CHASE_WAVE AS BIGINT) as CHASE_WAVE_FLAG", 
	"CAST(DEFAULT_QUEUE_PRTY AS BIGINT) as DEFAULT_QUEUE_PRTY", 
	"CAST(ALLOC_LOGGING AS BIGINT) as ALLOC_LOGGING", 
	"CAST(CARTON_BREAK_ON_LOCN_CLASS AS BIGINT) as CARTON_BREAK_ON_LOCN_CLASS_FLAG", 
	"CAST(DESELECT_UNALLOCATED_SINGLES AS BIGINT) as DESELECT_UNALLOCATED_SINGLES_FLAG", 
	"CAST(CUBING_ACTION_FOR_FAILED_ORDER AS BIGINT) as CUBING_ACTION_FOR_FAILED_ORDER_FLAG", 
	"CAST(IGNORE_SINGLES_PROCESSING AS BIGINT) as IGNORE_SINGLES_PROCESSING_FLAG", 
	"CAST(RELEASE_ALL_TASK AS BIGINT) as RELEASE_ALL_TASK_FLAG", 
	"CAST(HLD_RLS_FLAG AS BIGINT) as HOLD_RELEASE_FLAG", 
	"CAST(REPLEN_BUMP_UP AS BIGINT) as REPLENISHMENT_BUMP_UP_FLAG", 
	"CAST(ORDER_SEL_LOGGING AS BIGINT) as ORDER_SELECTION_LOGGING_LEVEL", 
	"CAST(AGG_LOGGING AS BIGINT) as AGG_LOGGING_LEVEL", 
	"CAST(CUB_LOGGING AS BIGINT) as CUBING_LOGGING_LEVEL", 
	"CAST(PCK_WAVE_LOGGING AS BIGINT) as PACK_WAVE_LOGGING_LEVEL", 
	"CAST(TSK_GEN_LOGGING AS BIGINT) as TASK_GEN_LOGGING_LEVEL", 
	"CAST(LABEL_PRNT_LOGGING AS BIGINT) as LABEL_PRINT_LOGGING_LEVEL", 
	"CAST(ORDER_SEQ_LOGGING AS BIGINT) as ORDER_SEQ_LOGGING", 
	"CAST(ORDER_CNSOL_LOGGING AS BIGINT) as ORDER_CONSOLIDATION_LOGGING_LEVEL", 
	"CAST(FORCE_ORDER_STREAMING AS BIGINT) as FORCE_ORDER_STREAMING_FLAG", 
	...
	"CAST(START_PICK_DATE_TIME AS TIMESTAMP) as START_PICK_TSTMP", 
	"CAST(END_PICK_DATE_TIME AS TIMESTAMP) as END_PICK_TSTMP", 
	"CAST(START_PACK_DATE_TIME AS TIMESTAMP) as START_PACK_TSTMP", 
	"CAST(END_PACK_DATE_TIME AS TIMESTAMP) as END_PACK_TSTMP", 
	"CAST(START_REPL_DATE_TIME AS TIMESTAMP) as START_REPL_TSTMP", 
	"CAST(END_REPL_DATE_TIME AS TIMESTAMP) as END_REPL_TSTMP", 
	"CAST(START_INDUC_DATE_TIME AS TIMESTAMP) as START_INDUC_TSTMP", 
	"CAST(END_INDUC_DATE_TIME AS TIMESTAMP) as END_INDUC_TSTMP", 
	"CAST(START_MISC_1_DATE_TIME AS TIMESTAMP) as START_MISC_1_TSTMP", 
	"CAST(END_MISC_1_DATE_TIME AS TIMESTAMP) as END_MISC_1_TSTMP", 
	"CAST(START_MISC_2_DATE_TIME AS TIMESTAMP) as START_MISC_2_TSTMP", 
	"CAST(END_MISC_2_DATE_TIME AS TIMESTAMP) as END_MISC_2_TSTMP", 
	"CAST(CMPLTD_DATE_TIME AS TIMESTAMP) as CMPLTD_TSTMP", 
	"CAST(MISC_STAT_CODE_1 AS BIGINT) as MISC_STAT_CD_1", 
	"CAST(MISC_STAT_CODE_2 AS BIGINT) as MISC_STAT_CD_2", 
...
try:
  ...
  executeMerge(Shortcut_to_WM_WAVE_PARM_1, refined_perf_table, primary_key)
