...
Shortcut_to_WM_WAVE_PARM_1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(WAVE_PARM_ID AS INT) as WM_WAVE_PARM_ID",
	...
	"CAST(WAVE_PARM_TEMPLATE_ID AS INT) as WM_WAVE_PARM_TEMPLATE_ID",
	"CAST(PACK_WAVE_PARM_ID AS INT) as WM_PACK_WAVE_PARM_ID",
	"CAST(CAT_PARM_ID AS INT) as WM_CAT_PARM_ID",
	"CAST(CARTON_TYPE_EVENT_ID AS INT) as WM_CARTON_TYPE_EVENT_ID",
	"CAST(CHUTE_ASSIGN_TYPE_EVENT_ID AS INT) as WM_CHUTE_ASSIGN_TYPE_EVENT_ID",
	"CAST(LPN_BRK_ATTRIB_EVENT_ID AS INT) as WM_LPN_BRK_ATTRIB_EVENT_ID",
	"CAST(RETAIN_PALLET_ID AS TINYINT) as WM_RETAIN_PALLET_ID",
	...
	"CAST(WAVE_STAT_CODE AS SMALLINT) as WM_WAVE_STAT_CD",
	"CAST(WAVE_CMPL_STAT_CODE AS SMALLINT) as WM_WAVE_CMPL_STAT_CD",
	"CAST(PICK_STAT_CODE AS SMALLINT) as WM_PICK_STAT_CD",
	"CAST(PACK_STAT_CODE AS SMALLINT) as WM_PACK_STAT_CD",
	"CAST(REPL_STAT_CODE AS SMALLINT) as WM_REPL_STAT_CD",
	"CAST(INDUC_STAT_CODE AS SMALLINT) as WM_INDUC_STAT_CD",
	"CAST(FORCE_WPT AS TINYINT) as FORCE_WPT_FLAG",
	"CAST(REPL_TRIG AS STRING) as REPL_TRIG",
	"CAST(RTE_W_WAVE AS STRING) as RTE_W_WAVE",
	"CAST(CHG_PKT_QTY AS STRING) as CHG_PKT_QTY",
	"CAST(CARTON_BREAK_ON_AREA_CHG AS TINYINT) as CARTON_BREAK_ON_AREA_CHG_FLAG",
	"CAST(CARTON_BREAK_ON_ZONE_CHG AS TINYINT) as CARTON_BREAK_ON_ZONE_CHG_FLAG",
	"CAST(CARTON_BREAK_ON_AISLE_CHG AS TINYINT) as CARTON_BREAK_ON_AISLE_CHG_FLAG",
	"CAST(PKT_CONSOL_REJECT_RULE AS STRING) as PKT_CONSOL_REJECT_RULE",
	"CAST(ASSIGN_PRO_NBR AS STRING) as ASSIGN_PRO_NBR",
	"CAST(SWC_NBR_FLAG AS TINYINT) as SWC_NBR_FLAG",
	"CAST(MANIF_FLAG AS TINYINT) as MANIF_FLAG",
	"CAST(BOL_FLAG AS TINYINT) as BOL_FLAG",
	"CAST(SHPMT_FLAG AS TINYINT) as SHPMT_FLAG",
	"CAST(CLEAR_SPUR_LOCN AS STRING) as CLEAR_SPUR_LOCN",
	"CAST(SPUR AS STRING) as SPUR",
	"CAST(XCEED_CAPCTY_FLAG AS TINYINT) as XCEED_CAPCTY_FLAG",
	"CAST(CONSL_LOCN_CLEAR_METHD AS STRING) as CONSL_LOCN_CLEAR_METHD",
	"CAST(PERP_PLT_POSN AS STRING) as PERP_PLT_POSN",
	"CAST(USE_INBD_LPN_AS_OUTBD_LPN AS TINYINT) as USE_INBD_LPN_AS_OUTBD_LPN_FLAG",
	"CAST(GRP_PKT_BY_SWC_NBR AS TINYINT) as GRP_PKT_BY_SWC_NBR_FLAG",
	"CAST(PULL_ALL_SWC AS TINYINT) as PULL_ALL_SWC",
	"CAST(ZONE_PICK_METHOD AS STRING) as ZONE_PICK_METHOD",
	"CAST(WAVE_TYPE_INDIC AS STRING) as WAVE_TYPE_IND",
	"CAST(REJECT_DISTRO_RULE AS TINYINT) as REJECT_DISTRO_RULE_FLAG",
	"CAST(BULK_WAVE_BAL_FROM_ACTV AS TINYINT) as BULK_WAVE_BAL_FROM_ACTV_FLAG",
	"CAST(PRT_CS_LABELS_W_WAVE AS TINYINT) as PRT_CS_LABELS_W_WAVE",
	...
	"CAST(PACK_CMPL_W_WAVE AS TINYINT) as PACK_CMPL_W_WAVE_FLAG",
	"CAST(DESEL_SNGL_FLAG AS TINYINT) as DESEL_SNGL_FLAG",
	"CAST(CONSOL_PLTZ_CARTONS_FLAG AS TINYINT) as CONSOL_PLTZ_CARTONS_FLAG",
	...
	"CAST(RESV_BAL AS TINYINT) as RESV_BAL_FLAG",
	"CAST(RESV_BALANCE_INT AS SMALLINT) as RESV_BALANCE_INT",
	"CAST(ORDER_RND_FLAG AS TINYINT) as ORDER_ROUND_FLAG",
	"CAST(ALLOC_REMAIN AS STRING) as ALLOC_REMAIN",
	"CAST(MHE_FLAG AS TINYINT) as MHE_FLAG",
	"CAST(MHE_ONE_SEND_FLAG AS TINYINT) as MHE_ONE_SEND_FLAG",
	"CAST(MHE_PICK_DEST_LEVEL AS TINYINT) as MHE_PICK_DEST_LEVEL_FLAG",
	"CAST(FORCE_SHIP_DATE_FLAG AS TINYINT) as FORCE_SHIP_DATE_FLAG",
	"CAST(REPL_WAVE AS TINYINT) as REPL_WAVE_FLAG",
	"CAST(RESEQ_ACTIV_LOC AS TINYINT) as RESEQ_ACTIV_LOC",
	"CAST(CHASE_WAVE AS TINYINT) as CHASE_WAVE_FLAG",
	"CAST(DEFAULT_QUEUE_PRTY AS SMALLINT) as DEFAULT_QUEUE_PRTY",
	"CAST(ALLOC_LOGGING AS TINYINT) as ALLOC_LOGGING",
	"CAST(CARTON_BREAK_ON_LOCN_CLASS AS TINYINT) as CARTON_BREAK_ON_LOCN_CLASS_FLAG",
	"CAST(DESELECT_UNALLOCATED_SINGLES AS TINYINT) as DESELECT_UNALLOCATED_SINGLES_FLAG",
	"CAST(CUBING_ACTION_FOR_FAILED_ORDER AS TINYINT) as CUBING_ACTION_FOR_FAILED_ORDER_FLAG",
	"CAST(IGNORE_SINGLES_PROCESSING AS TINYINT) as IGNORE_SINGLES_PROCESSING_FLAG",
	"CAST(RELEASE_ALL_TASK AS TINYINT) as RELEASE_ALL_TASK_FLAG",
	"CAST(HLD_RLS_FLAG AS TINYINT) as HOLD_RELEASE_FLAG",
	"CAST(REPLEN_BUMP_UP AS TINYINT) as REPLENISHMENT_BUMP_UP_FLAG",
	"CAST(ORDER_SEL_LOGGING AS TINYINT) as ORDER_SELECTION_LOGGING_LEVEL",
	"CAST(AGG_LOGGING AS TINYINT) as AGG_LOGGING_LEVEL",
	"CAST(CUB_LOGGING AS TINYINT) as CUBING_LOGGING_LEVEL",
	"CAST(PCK_WAVE_LOGGING AS TINYINT) as PACK_WAVE_LOGGING_LEVEL",
	"CAST(TSK_GEN_LOGGING AS TINYINT) as TASK_GEN_LOGGING_LEVEL",
	"CAST(LABEL_PRNT_LOGGING AS TINYINT) as LABEL_PRINT_LOGGING_LEVEL",
	"CAST(ORDER_SEQ_LOGGING AS TINYINT) as ORDER_SEQ_LOGGING",
	"CAST(ORDER_CNSOL_LOGGING AS TINYINT) as ORDER_CONSOLIDATION_LOGGING_LEVEL",
	"CAST(FORCE_ORDER_STREAMING AS TINYINT) as FORCE_ORDER_STREAMING_FLAG",
	...
	"CAST(MISC_STAT_CODE_1 AS SMALLINT) as MISC_STAT_CD_1",
	"CAST(MISC_STAT_CODE_2 AS SMALLINT) as MISC_STAT_CD_2",
