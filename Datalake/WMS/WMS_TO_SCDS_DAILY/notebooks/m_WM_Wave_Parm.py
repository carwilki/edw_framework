...
WM_WAVE_PARM_PRE.DC_NBR,
WM_WAVE_PARM_PRE.WAVE_PARM_ID,
WM_WAVE_PARM_PRE.WHSE,
WM_WAVE_PARM_PRE.DAY_OF_WEEK,
WM_WAVE_PARM_PRE.SHIFT_NBR,
WM_WAVE_PARM_PRE.REC_TYPE,
WM_WAVE_PARM_PRE.WAVE_NBR,
WM_WAVE_PARM_PRE.WAVE_DESC,
WM_WAVE_PARM_PRE.MAX_UNITS,
WM_WAVE_PARM_PRE.MAX_ORDERS,
WM_WAVE_PARM_PRE.WAVE_CMPL_STAT_CODE,
WM_WAVE_PARM_PRE.WAVE_STAT_CODE,
WM_WAVE_PARM_PRE.WAVE_STAT_DATE_TIME,
WM_WAVE_PARM_PRE.PICK_STAT_CODE,
WM_WAVE_PARM_PRE.PACK_STAT_CODE,
WM_WAVE_PARM_PRE.REPL_STAT_CODE,
WM_WAVE_PARM_PRE.INDUC_STAT_CODE,
WM_WAVE_PARM_PRE.MISC_STAT_CODE_1,
WM_WAVE_PARM_PRE.MISC_STAT_CODE_2,
WM_WAVE_PARM_PRE.SCHED_DLVRY_DATE,
WM_WAVE_PARM_PRE.SCHED_WAVE,
WM_WAVE_PARM_PRE.NBR_OF_PKTS,
WM_WAVE_PARM_PRE.NBR_OF_CARTONS,
WM_WAVE_PARM_PRE.NBR_OF_LOCN,
WM_WAVE_PARM_PRE.NBR_OF_CHUTE,
WM_WAVE_PARM_PRE.NBR_OF_PLT_POSN,
WM_WAVE_PARM_PRE.ASSIGN_PLT_POSN,
WM_WAVE_PARM_PRE.WAVE_PROC_TYPE,
WM_WAVE_PARM_PRE.WAVE_PARM_TEMPLATE_ID,
WM_WAVE_PARM_PRE.FORCE_WPT,
WM_WAVE_PARM_PRE.REPL_TRIG,
WM_WAVE_PARM_PRE.RTE_W_WAVE,
WM_WAVE_PARM_PRE.CHG_PKT_QTY,
WM_WAVE_PARM_PRE.LABEL_PRTR_REQSTR,
WM_WAVE_PARM_PRE.RPT_PRTR_REQSTR,
WM_WAVE_PARM_PRE.CARTON_BREAK_ON_AREA_CHG,
WM_WAVE_PARM_PRE.CARTON_BREAK_ON_ZONE_CHG,
WM_WAVE_PARM_PRE.CARTON_BREAK_ON_AISLE_CHG,
WM_WAVE_PARM_PRE.PKT_CONSOL_REJECT_RULE,
WM_WAVE_PARM_PRE.ASSIGN_PRO_NBR,
WM_WAVE_PARM_PRE.SHIP_VIA,
WM_WAVE_PARM_PRE.SWC_NBR,
WM_WAVE_PARM_PRE.MANIF_NBR,
WM_WAVE_PARM_PRE.BOL,
WM_WAVE_PARM_PRE.SHPMT_NBR,
WM_WAVE_PARM_PRE.SWC_NBR_FLAG,
WM_WAVE_PARM_PRE.MANIF_FLAG,
WM_WAVE_PARM_PRE.BOL_FLAG,
WM_WAVE_PARM_PRE.SHPMT_FLAG,
WM_WAVE_PARM_PRE.CLEAR_SPUR_LOCN,
WM_WAVE_PARM_PRE.SPUR,
WM_WAVE_PARM_PRE.XCEED_CAPCTY_FLAG,
WM_WAVE_PARM_PRE.FILL_CAPCTY_STRK,
WM_WAVE_PARM_PRE.CONSL_LOCN_CLEAR_METHD,
WM_WAVE_PARM_PRE.PERP_PLT_POSN,
WM_WAVE_PARM_PRE.NBR_OF_LABELS_PER_SPOOL,
WM_WAVE_PARM_PRE.NBR_OF_LABELS_PER_ROW,
WM_WAVE_PARM_PRE.PKT_CONSOL_PROF,
WM_WAVE_PARM_PRE.PKT_CONSOL_DETRM_TYPE,
WM_WAVE_PARM_PRE.SKU_CNSTR,
WM_WAVE_PARM_PRE.SKU_SUB,
WM_WAVE_PARM_PRE.USE_INBD_LPN_AS_OUTBD_LPN,
WM_WAVE_PARM_PRE.CARTON_TYPE,
WM_WAVE_PARM_PRE.NBR_OF_PIKRS_PAKRS,
WM_WAVE_PARM_PRE.AVG_PIKS_PER_PIKR,
WM_WAVE_PARM_PRE.AVG_TMU_PER_PIKR,
WM_WAVE_PARM_PRE.PICK_LOCN_ASSIGN_TYPE,
WM_WAVE_PARM_PRE.DIFF_PIKR_ON_AREA_CHG,
WM_WAVE_PARM_PRE.DIFF_PIKR_ON_ZONE_CHG,
WM_WAVE_PARM_PRE.DIFF_PIKR_ON_AISLE_CHG,
WM_WAVE_PARM_PRE.DIFF_PIKR_ON_BAY_CHG,
WM_WAVE_PARM_PRE.DIFF_PIKR_ON_LVL_CHG,
WM_WAVE_PARM_PRE.DIFF_PIKR_ON_POSN_CHG,
WM_WAVE_PARM_PRE.SAME_PIKR_FOR_AREA,
WM_WAVE_PARM_PRE.SAME_PIKR_FOR_ZONE,
WM_WAVE_PARM_PRE.SAME_PIKR_FOR_AISLE,
WM_WAVE_PARM_PRE.SAME_PIKR_FOR_BAY,
WM_WAVE_PARM_PRE.SAME_PIKR_FOR_LVL,
WM_WAVE_PARM_PRE.SAME_PIKR_FOR_POSN,
WM_WAVE_PARM_PRE.OK_TO_PICK,
WM_WAVE_PARM_PRE.OK_TO_PACK,
WM_WAVE_PARM_PRE.OK_TO_REPL,
WM_WAVE_PARM_PRE.OK_TO_INDUC,
WM_WAVE_PARM_PRE.OK_TO_MISC_1,
WM_WAVE_PARM_PRE.OK_TO_MISC_2,
WM_WAVE_PARM_PRE.START_PICK_DATE_TIME,
WM_WAVE_PARM_PRE.END_PICK_DATE_TIME,
WM_WAVE_PARM_PRE.START_PACK_DATE_TIME,
WM_WAVE_PARM_PRE.END_PACK_DATE_TIME,
WM_WAVE_PARM_PRE.START_REPL_DATE_TIME,
WM_WAVE_PARM_PRE.END_REPL_DATE_TIME,
WM_WAVE_PARM_PRE.START_INDUC_DATE_TIME,
WM_WAVE_PARM_PRE.END_INDUC_DATE_TIME,
WM_WAVE_PARM_PRE.START_MISC_1_DATE_TIME,
WM_WAVE_PARM_PRE.END_MISC_1_DATE_TIME,
WM_WAVE_PARM_PRE.START_MISC_2_DATE_TIME,
WM_WAVE_PARM_PRE.END_MISC_2_DATE_TIME,
WM_WAVE_PARM_PRE.CMPLTD_DATE_TIME,
WM_WAVE_PARM_PRE.GRP_PKT_BY_SWC_NBR,
WM_WAVE_PARM_PRE.PULL_ALL_SWC,
WM_WAVE_PARM_PRE.ZONE_PICK_METHOD,
WM_WAVE_PARM_PRE.WAVE_TYPE_INDIC,
WM_WAVE_PARM_PRE.REJECT_DISTRO_RULE,
WM_WAVE_PARM_PRE.RETAIL_MAX_UNITS,
WM_WAVE_PARM_PRE.RETAIL_UNIT_PCNT_OVER,
WM_WAVE_PARM_PRE.RETAIL_MAX_SKUS,
WM_WAVE_PARM_PRE.RETAIL_MAX_STORES,
WM_WAVE_PARM_PRE.RETAIL_MAX_ROUTES,
WM_WAVE_PARM_PRE.BULK_WAVE_BAL_FROM_ACTV,
WM_WAVE_PARM_PRE.PROC_ATTR_1,
WM_WAVE_PARM_PRE.PROC_ATTR_2,
WM_WAVE_PARM_PRE.PROC_ATTR_3,
WM_WAVE_PARM_PRE.PROC_ATTR_4,
WM_WAVE_PARM_PRE.PROC_ATTR_5,
WM_WAVE_PARM_PRE.SPL_INSTR_CODE_1,
WM_WAVE_PARM_PRE.SPL_INSTR_CODE_2,
WM_WAVE_PARM_PRE.SPL_INSTR_CODE_3,
WM_WAVE_PARM_PRE.SPL_INSTR_CODE_4,
WM_WAVE_PARM_PRE.SPL_INSTR_CODE_5,
WM_WAVE_PARM_PRE.CREATE_DATE_TIME,
WM_WAVE_PARM_PRE.MOD_DATE_TIME,
WM_WAVE_PARM_PRE.USER_ID,
WM_WAVE_PARM_PRE.PRT_CS_LABELS_W_WAVE,
WM_WAVE_PARM_PRE.CREATE_SHPMT,
WM_WAVE_PARM_PRE.CREATE_LOAD,
WM_WAVE_PARM_PRE.CHG_WO_QTY,
WM_WAVE_PARM_PRE.PACK_CMPL_W_WAVE,
WM_WAVE_PARM_PRE.DLVRY_WIN_RANGE_CODE,
WM_WAVE_PARM_PRE.DFLT_PLT_TYPE,
WM_WAVE_PARM_PRE.PACK_WAVE_PARM_ID,
WM_WAVE_PARM_PRE.CAT_PARM_ID,
WM_WAVE_PARM_PRE.DESEL_SNGL_FLAG,
WM_WAVE_PARM_PRE.ALLOC_TYPE,
WM_WAVE_PARM_PRE.FORCE_ALLOC_TYPE,
WM_WAVE_PARM_PRE.FORCE_PICK_LOCN_ASSIGN_TYPE,
WM_WAVE_PARM_PRE.BULK_PICK_ZONE,
WM_WAVE_PARM_PRE.CONSOL_PLTZ_CARTONS_FLAG,
WM_WAVE_PARM_PRE.ACTV_REPL_ORGN,
WM_WAVE_PARM_PRE.MAX_CARTONS,
WM_WAVE_PARM_PRE.MAX_PICK_WAVES,
WM_WAVE_PARM_PRE.HOLD_PRINT,
WM_WAVE_PARM_PRE.SUPPR_PR40_REPL,
WM_WAVE_PARM_PRE.COMB_4050_REPL,
WM_WAVE_PARM_PRE.SUPPR_PR60_REPL,
WM_WAVE_PARM_PRE.LOAD_PLAN,
WM_WAVE_PARM_PRE.ASSIGN_NEW_LOAD,
WM_WAVE_PARM_PRE.RESV_BAL,
WM_WAVE_PARM_PRE.RESV_BALANCE_INT,
WM_WAVE_PARM_PRE.ORDER_RND_FLAG,
WM_WAVE_PARM_PRE.ALLOC_REMAIN,
WM_WAVE_PARM_PRE.MHE_FLAG,
WM_WAVE_PARM_PRE.MHE_ONE_SEND_FLAG,
WM_WAVE_PARM_PRE.MHE_PICK_DEST_LEVEL,
WM_WAVE_PARM_PRE.SHIP_DATE_TIME,
WM_WAVE_PARM_PRE.COLLATE_PRTR_REQSTR,
WM_WAVE_PARM_PRE.MAX_DYNAMIC_LOCN_OPTN,
WM_WAVE_PARM_PRE.FORCE_SHIP_DATE_FLAG,
WM_WAVE_PARM_PRE.MAX_WT,
WM_WAVE_PARM_PRE.MAX_VOL,
WM_WAVE_PARM_PRE.BULK_PICK_ASSIGN_TYPE,
WM_WAVE_PARM_PRE.REPL_WAVE,
WM_WAVE_PARM_PRE.RESEQ_ACTIV_LOC,
WM_WAVE_PARM_PRE.VOCO_GRP_CARTONS_TO_TASK,
WM_WAVE_PARM_PRE.VOCO_MAX_CARTON_ON_TASK,
WM_WAVE_PARM_PRE.WM_VERSION_ID,
WM_WAVE_PARM_PRE.TC_COMPANY_ID,
WM_WAVE_PARM_PRE.MAX_ORDER_LINES,
WM_WAVE_PARM_PRE.CHASE_WAVE,
WM_WAVE_PARM_PRE.DEFAULT_QUEUE_PRTY,
WM_WAVE_PARM_PRE.ALLOC_LOGGING,
WM_WAVE_PARM_PRE.CREATED_DTTM,
WM_WAVE_PARM_PRE.LAST_UPDATED_DTTM,
WM_WAVE_PARM_PRE.CARTON_BREAK_ON_LOCN_CLASS,
WM_WAVE_PARM_PRE.DESELECT_UNALLOCATED_SINGLES,
WM_WAVE_PARM_PRE.CARTON_TYPE_EVENT_ID,
WM_WAVE_PARM_PRE.CHUTE_ASSIGN_TYPE_EVENT_ID,
WM_WAVE_PARM_PRE.LPN_BRK_ATTRIB_EVENT_ID,
WM_WAVE_PARM_PRE.IGNORE_SINGLES_PROCESSING,
WM_WAVE_PARM_PRE.HLD_RLS_FLAG,
WM_WAVE_PARM_PRE.MAX_NBR_PACK_WAVES_TO_RLS,
WM_WAVE_PARM_PRE.REPLEN_BUMP_UP,
WM_WAVE_PARM_PRE.RETAIN_PALLET_ID,
WM_WAVE_PARM_PRE.ORDER_SEL_LOGGING,
WM_WAVE_PARM_PRE.AGG_LOGGING,
WM_WAVE_PARM_PRE.CUB_LOGGING,
WM_WAVE_PARM_PRE.PCK_WAVE_LOGGING,
WM_WAVE_PARM_PRE.TSK_GEN_LOGGING,
WM_WAVE_PARM_PRE.LABEL_PRNT_LOGGING,
WM_WAVE_PARM_PRE.ORDER_SEQ_LOGGING,
WM_WAVE_PARM_PRE.ORDER_CNSOL_LOGGING,
WM_WAVE_PARM_PRE.RELEASE_ALL_TASK,
WM_WAVE_PARM_PRE.FORCE_ORDER_STREAMING,
WM_WAVE_PARM_PRE.CUBING_ACTION_FOR_FAILED_ORDER,
WM_WAVE_PARM_PRE.NBR_ALLOCATION_THREAD,
WM_WAVE_PARM_PRE.LOAD_TSTMP
FROM WM_WAVE_PARM_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_WAVE_PARM.LOCATION_ID,
WM_WAVE_PARM.WM_WAVE_PARM_ID,
WM_WAVE_PARM.WM_CREATED_TSTMP,
WM_WAVE_PARM.WM_LAST_UPDATED_TSTMP,
WM_WAVE_PARM.WM_CREATE_TSTMP,
WM_WAVE_PARM.WM_MOD_TSTMP,
WM_WAVE_PARM.LOAD_TSTMP
FROM WM_WAVE_PARM
WHERE WM_WAVE_PARM_ID IN (SELECT WAVE_PARM_ID FROM WM_WAVE_PARM_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
