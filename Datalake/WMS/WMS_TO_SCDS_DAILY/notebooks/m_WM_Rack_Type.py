...
Shortcut_to_WM_RACK_TYPE1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(FIX_LABELS1 AS BIGINT) as FIX_LABELS", 
	"CAST(MOVABLE_LABEL1 AS BIGINT) as MOVABLE_LABEL", 
	"CAST(LABEL_WID1 AS BIGINT) as LABEL_WID", 
	"CAST(OVERLAP_DIST1 AS BIGINT) as OVERLAP_DIST", 
	"CAST(HN_CONSIDER1 AS BIGINT) as HN_CONSIDER", 
	"CAST(UPRIGHT_THICKNESS1 AS BIGINT) as UPRIGHT_THICKNESS", 
	"CAST(FUNCTION_TYPE1 AS BIGINT) as FUNCTION_TYPE", 
	"CAST(OVERSTOCK_CONSIDER1 AS BIGINT) as OVERSTOCK_CONSIDER", 
	"CAST(USE_3D_SLOT1 AS BIGINT) as USE_3D_SLOT", 
	"CAST(WEEKS_IN_SLOT_CONSTRAINT1 AS BIGINT) as WEEKS_IN_SLOT_CONSTRAINT", 
	"CAST(NUM_OF_BAYS_AVAIL1 AS BIGINT) as NUM_OF_BAYS_AVAIL", 
	"CAST(WEEK_IN_SLOT1 AS BIGINT) as WEEK_IN_SLOT", 
	"CAST(PARENT_BT1 AS BIGINT) as PARENT_BT", 
	"CAST(WT_LIMIT1 AS BIGINT) as WT_LIMIT", 
	"CAST(HT1 AS BIGINT) as HT", 
	"CAST(WIDTH1 AS BIGINT) as WIDTH", 
	"CAST(DEPTH1 AS BIGINT) as DEPTH", 
	"CAST(CASE_HT_MIN1 AS BIGINT) as CASE_HT_MIN", 
	"CAST(CASE_HT_MAX1 AS BIGINT) as CASE_HT_MAX", 
	"CAST(CASE_LEN_MIN2 AS BIGINT) as CASE_LEN_MIN", 
	"CAST(CASE_LEN_MAX2 AS BIGINT) as CASE_LEN_MAX", 
	"CAST(CASE_WID_MIN2 AS BIGINT) as CASE_WID_MIN", 
	"CAST(CASE_WID_MAX2 AS BIGINT) as CASE_WID_MAX", 
	"CAST(CASE_WT_MIN2 AS BIGINT) as CASE_WT_MIN", 
	"CAST(CASE_WT_MAX2 AS BIGINT) as CASE_WT_MAX", 
	"CAST(CASE_CUBE_MIN2 AS BIGINT) as CASE_CUBE_MIN", 
	"CAST(CASE_CUBE_MAX2 AS BIGINT) as CASE_CUBE_MAX", 
	"CAST(CASE_INVEN_MIN2 AS BIGINT) as CASE_INVEN_MIN", 
	"CAST(CASE_INVEN_MAX2 AS BIGINT) as CASE_INVEN_MAX", 
	"CAST(CASE_MOVE_MIN2 AS BIGINT) as CASE_MOVE_MIN", 
	"CAST(CASE_MOVE_MAX2 AS BIGINT) as CASE_MOVE_MAX", 
	"CAST(CASE_HITS_MIN2 AS BIGINT) as CASE_HITS_MIN", 
	"CAST(CASE_HITS_MAX2 AS BIGINT) as CASE_HITS_MAX", 
	"CAST(INNER_HT_MIN2 AS BIGINT) as INNER_HT_MIN", 
	"CAST(INNER_HT_MAX2 AS BIGINT) as INNER_HT_MAX", 
	"CAST(INNER_LEN_MIN2 AS BIGINT) as INNER_LEN_MIN", 
	"CAST(INNER_LEN_MAX2 AS BIGINT) as INNER_LEN_MAX", 
	"CAST(INNER_WID_MIN2 AS BIGINT) as INNER_WID_MIN", 
	"CAST(INNER_WID_MAX2 AS BIGINT) as INNER_WID_MAX", 
	"CAST(INNER_WT_MIN2 AS BIGINT) as INNER_WT_MIN", 
	"CAST(INNER_WT_MAX2 AS BIGINT) as INNER_WT_MAX", 
	"CAST(INNER_CUBE_MIN2 AS BIGINT) as INNER_CUBE_MIN", 
	"CAST(INNER_CUBE_MAX2 AS BIGINT) as INNER_CUBE_MAX", 
	"CAST(EACH_HT_MIN2 AS BIGINT) as EACH_HT_MIN", 
	"CAST(EACH_HT_MAX2 AS BIGINT) as EACH_HT_MAX", 
	"CAST(EACH_LEN_MIN2 AS BIGINT) as EACH_LEN_MIN", 
	"CAST(EACH_LEN_MAX2 AS BIGINT) as EACH_LEN_MAX", 
	"CAST(EACH_WID_MIN2 AS BIGINT) as EACH_WID_MIN", 
	"CAST(EACH_WID_MAX2 AS BIGINT) as EACH_WID_MAX", 
	"CAST(EACH_WT_MIN2 AS BIGINT) as EACH_WT_MIN", 
	"CAST(EACH_WT_MAX2 AS BIGINT) as EACH_WT_MAX", 
	"CAST(EACH_CUBE_MIN2 AS BIGINT) as EACH_CUBE_MIN", 
	"CAST(EACH_CUBE_MAX1 AS BIGINT) as EACH_CUBE_MAX", 
	"CAST(PALLET_INVEN_MIN1 AS BIGINT) as PALLET_INVEN_MIN", 
	"CAST(PALLET_INVEN_MAX1 AS BIGINT) as PALLET_INVEN_MAX", 
	"CAST(CUBE_MOVE_MIN1 AS BIGINT) as CUBE_MOVE_MIN", 
	"CAST(CUBE_MOVE_MAX1 AS BIGINT) as CUBE_MOVE_MAX", 
	"CAST(CUBE_HITS_MIN1 AS BIGINT) as CUBE_HITS_MIN", 
	"CAST(CUBE_HITS_MAX1 AS BIGINT) as CUBE_HITS_MAX", 
	"CAST(CUBE_INVEN_MIN1 AS BIGINT) as CUBE_INVEN_MIN", 
	"CAST(CUBE_INVEN_MAX1 AS BIGINT) as CUBE_INVEN_MAX", 
	"CAST(VISC_MIN1 AS BIGINT) as VISC_MIN", 
	"CAST(VISC_MAX1 AS BIGINT) as VISC_MAX", 
	"CAST(FILL_PERCENT_MIN1 AS BIGINT) as FILL_PERCENT_MIN", 
	"CAST(FILL_PERCENT_MAX1 AS BIGINT) as FILL_PERCENT_MAX", 
