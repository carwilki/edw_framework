...
def m_WM_Equipment_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_EQUIPMENT_PRE = EXPTRANS.selectExpr( \
        ...
        "CAST(DIM01_VALUE AS BIGINT) as DIM01_VALUE", \
        "CAST(DIM01_STANDARD_UOM AS BIGINT) as DIM01_STANDARD_UOM", \
        "CAST(DIM02_VALUE AS BIGINT) as DIM02_VALUE", \
        "CAST(DIM02_STANDARD_UOM AS BIGINT) as DIM02_STANDARD_UOM", \
        "CAST(DIM03_VALUE AS BIGINT) as DIM03_VALUE", \
        "CAST(DIM03_STANDARD_UOM AS BIGINT) as DIM03_STANDARD_UOM", \
        "CAST(VOLUME_CALC_VALUE AS BIGINT) as VOLUME_CALC_VALUE", \
        "CAST(VOLUME_CALC_STANDARD_UOM AS BIGINT) as VOLUME_CALC_STANDARD_UOM", \
        "CAST(WEIGHT_EMPTY_VALUE AS BIGINT) as WEIGHT_EMPTY_VALUE", \
        "CAST(WEIGHT_EMPTY_STANDARD_UOM AS BIGINT) as WEIGHT_EMPTY_STANDARD_UOM", \
        "CAST(EQUIPMENT_TYPE AS BIGINT) as EQUIPMENT_TYPE", \
        "CAST(EQUIP_DW_HEIGHT_VALUE AS BIGINT) as EQUIP_DW_HEIGHT_VALUE", \
        "CAST(EQUIP_DW_HEIGHT_STANDARD_UOM AS BIGINT) as EQUIP_DW_HEIGHT_STANDARD_UOM", \
        "CAST(TRAILER_TYPE AS BIGINT) as TRAILER_TYPE", \
        "CAST(OWNERSHIP_TYPE AS BIGINT) as OWNERSHIP_TYPE", \
        "CAST(NUMBER_OF_AXLES AS BIGINT) as NUMBER_OF_AXLES", \
        ...
        "CAST(WEIGHT_VALUE AS BIGINT) as WEIGHT_VALUE", \
        "CAST(WEIGHT_STANDARD_UOM AS BIGINT) as WEIGHT_STANDARD_UOM", \
        "CAST(EQUIP_HEIGHT_VALUE AS BIGINT) as EQUIP_HEIGHT_VALUE", \
        "CAST(EQUIP_HEIGHT_STANDARD_UOM AS BIGINT) as EQUIP_HEIGHT_STANDARD_UOM", \
        "CAST(IS_ALLOW_TRAILER_SWAPPING AS BIGINT) as IS_ALLOW_TRAILER_SWAPPING", \
        "CAST(IS_TANDEM_CAPABLE AS BIGINT) as IS_TANDEM_CAPABLE", \
        "CAST(MASTER_EQUIPMENT_ID AS BIGINT) as MASTER_EQUIPMENT_ID", \
        "CAST(WEIGHT_EMPTY_SIZE_UOM_ID AS BIGINT) as WEIGHT_EMPTY_SIZE_UOM_ID", \
        "CAST(PLATED_WEIGHT_SIZE_UOM_ID AS BIGINT) as PLATED_WEIGHT_SIZE_UOM_ID", \
        "CAST(BACKIN_TIME AS BIGINT) as BACKIN_TIME", \
        "CAST(BACKOUT_TIME AS BIGINT) as BACKOUT_TIME", \
        "CAST(FLOOR_SPACE_VALUE AS BIGINT) as FLOOR_SPACE_VALUE", \
        "CAST(FLOOR_SPACE_SIZE_UOM_ID AS BIGINT) as FLOOR_SPACE_SIZE_UOM_ID", \
