...
def m_WM_Equipment_Instance_PRE(dcnbr, env):
    ...
    refine_table_name = "EQUIPMENT_INSTANCE"
    ...
    SQ_Shortcut_to_EQUIPMENT_INSTANCE = gu.jdbcOracleConnection(
        f"""SELECT
    ...
    SQ_Shortcut_to_EQUIPMENT_INSTANCE_temp = SQ_Shortcut_to_EQUIPMENT_INSTANCE.toDF(
        *[
            "SQ_Shortcut_to_EQUIPMENT_INSTANCE___" + col
            for col in SQ_Shortcut_to_EQUIPMENT_INSTANCE.columns
        ]
    )
    ...
    gu.overwriteDeltaPartition(
        Shortcut_to_WM_EQUIPMENT_INSTANCE_PRE, "DC_NBR", dcnbr, target_table_name
    )
    logger.info(
