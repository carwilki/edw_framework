...
def m_WM_Equipment_Instance_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_EQUIPMENT_INSTANCE_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(EQUIP_INST_STATUS AS SMALLINT) as EQUIP_INST_STATUS",
        "CAST(CONDITION_TYPE AS SMALLINT) as CONDITION_TYPE",
        "CAST(DESCRIPTION AS STRING) as DESCRIPTION",
        "CAST(IS_LOCKED AS SMALLINT) as IS_LOCKED",
        ...
        "CAST(EQUIP_DOOR_TYPE AS SMALLINT) as EQUIP_DOOR_TYPE",
        ...
        "CAST(CURRENT_APPOINTMENT_ID AS INT) as CURRENT_APPOINTMENT_ID",
        ...
        "CAST(DISPATCH_STATUS AS SMALLINT) as DISPATCH_STATUS",
        "CAST(HOME_DOMICILE_FACILITY_ID AS INT) as HOME_DOMICILE_FACILITY_ID",
        "CAST(HOME_DOMICILE_FAC_ALIAS_ID AS STRING) as HOME_DOMICILE_FAC_ALIAS_ID",
        "CAST(CURRENT_FACILITY_ID AS INT) as CURRENT_FACILITY_ID",
        ...
        "CAST(NEXT_AVAIL_FACILITY_ID AS INT) as NEXT_AVAIL_FACILITY_ID",
        "CAST(IS_OBC_ONBOARD AS SMALLINT) as IS_OBC_ONBOARD",
        "CAST(IS_NON_SMOKING AS SMALLINT) as IS_NON_SMOKING",
        "CAST(HAS_NIGHT_HEATER AS SMALLINT) as HAS_NIGHT_HEATER",
        "CAST(IS_RIGID AS SMALLINT) as IS_RIGID",
        "CAST(RIGID_EQUIPMENT_ID AS BIGINT) as RIGID_EQUIPMENT_ID",
        "CAST(SLEEPER_TYPE AS SMALLINT) as SLEEPER_TYPE",
        "CAST(ZONE_FACILITY_ID AS BIGINT) as ZONE_FACILITY_ID",
        "CAST(ZONE_FACILITY_ALIAS_ID AS STRING) as ZONE_FACILITY_ALIAS_ID",
        "CAST(ZONE_TYPE AS SMALLINT) as ZONE_TYPE",
        ...
        "CAST(MAINTENANCE_FREQUENCY_WEEKS AS INT) as MAINTENANCE_FREQUENCY_WEEKS",
        ...
        "CAST(HAS_ALERTS AS SMALLINT) as HAS_ALERTS",
        "CAST(LAST_KNOWN_DTTM AS TIMESTAMP) as LAST_KNOWN_DTTM",
        "CAST(HAS_IMPORT_ERROR AS SMALLINT) as HAS_IMPORT_ERROR",
        "CAST(HAS_SOFT_CHECK_ERROR AS SMALLINT) as HAS_SOFT_CHECK_ERROR",
        "CAST(LAST_KNOWN_FACILITY_ID AS INT) as LAST_KNOWN_FACILITY_ID",
        ...
        "CAST(IS_TANDEM_LEAD AS SMALLINT) as IS_TANDEM_LEAD",
        ...
        "CAST(USR_ENT_NEXT_AVAIL_FACILITY_ID AS INT) as USR_ENT_NEXT_AVAIL_FACILITY_ID",
        ...
        "CAST(IS_LABOR AS TINYINT) as IS_LABOR",
