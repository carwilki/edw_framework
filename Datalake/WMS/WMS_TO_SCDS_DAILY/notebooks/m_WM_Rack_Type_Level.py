...
Shortcut_to_WM_RACK_TYPE_LEVEL1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(LEVEL_WT_LIMIT2 AS BIGINT) as LEVEL_WT_LIMIT", 
	"CAST(LEVEL_HT2 AS BIGINT) as LEVEL_HT", 
	"CAST(LEVEL_WIDTH2 AS BIGINT) as LEVEL_WIDTH", 
	"CAST(LEVEL_DEPTH2 AS BIGINT) as LEVEL_DEPTH", 
	"CAST(USE_LEV_MAP_STR1 AS BIGINT) as USE_LEV_MAP_STR_FLAG", 
	"CAST(LEV_MAP_STR2 AS STRING) as LEV_MAP_STR", 
	"CAST(USE_POS_MAP_STR1 AS BIGINT) as USE_POS_MAP_STR_FLAG", 
	"CAST(POS_MAP_STR2 AS STRING) as POS_MAP_STR", 
	"CAST(NBR_OF_SLOTS2 AS BIGINT) as NBR_OF_SLOTS", 
	"CAST(SLOT_WT_LIMIT2 AS BIGINT) as SLOT_WT_LIMIT", 
	"CAST(MIN_SL_WIDTH2 AS BIGINT) as MIN_SL_WIDTH", 
	"CAST(MIN_ITEM_WIDTH2 AS BIGINT) as MIN_ITEM_WIDTH", 
	...
	"CAST(COST_TO_PICK2 AS BIGINT) as COST_TO_PICK", 
	"CAST(MAX_LANE_WT2 AS BIGINT) as MAX_LANE_WT", 
	"CAST(HT_CLEARANCE2 AS BIGINT) as HT_CLEARANCE", 
	"CAST(SIDE_CLEAR2 AS BIGINT) as SIDE_CLEAR", 
	"CAST(MAX_STACKING2 AS BIGINT) as MAX_STACKING", 
	"CAST(MAX_LANES2 AS BIGINT) as MAX_LANES", 
	"CAST(GUIDE_WIDTH2 AS BIGINT) as GUIDE_WIDTH", 
	"CAST(LANE_GUIDES2 AS BIGINT) as LANE_GUIDES", 
	"CAST(SLOT_GUIDES2 AS BIGINT) as SLOT_GUIDES", 
	"CAST(MOVE_GUIDES2 AS BIGINT) as MOVE_GUIDES", 
	"CAST(USE_FULL_WID1 AS BIGINT) as USE_FULL_WID_FLAG", 
	"CAST(SHELF_THICKNESS2 AS BIGINT) as SHELF_THICKNESS", 
	"CAST(LABEL_POS2 AS BIGINT) as LABEL_POS", 
	"CAST(MAX_PICK_HT2 AS BIGINT) as MAX_PICK_HT", 
	"CAST(MAX_SL_WID2 AS BIGINT) as MAX_SL_WID", 
	"CAST(ONE_FACING_PER_DSW1 AS BIGINT) as ONE_FACING_PER_DSW_FLAG", 
	"CAST(USE_INCREMENT1 AS BIGINT) as USE_INCREMENT_FLAG", 
	"CAST(WIDTH_INCREMENT2 AS BIGINT) as WIDTH_INCREMENT", 
	"CAST(USE_VERT_DIV1 AS BIGINT) as USE_VERT_DIV_FLAG", 
	"CAST(VERT_DIV_HT2 AS BIGINT) as VERT_DIV_HT", 
	"CAST(MIN_CHANNEL_WID2 AS BIGINT) as MIN_CHANNEL_WID", 
	"CAST(MAX_CHANNEL_WID2 AS BIGINT) as MAX_CHANNEL_WID", 
	"CAST(MAX_CHANNEL_WT2 AS BIGINT) as MAX_CHANNEL_WT", 
	"CAST(MAX_ADJ_SLOTS2 AS BIGINT) as MAX_ADJ_SLOTS", 
	"CAST(MAX_EJECTOR_WT2 AS BIGINT) as MAX_EJECTOR_WT", 
	"CAST(AFRAME_ROTATE2 AS BIGINT) as AFRAME_ROTATE", 
	"CAST(AFRAME_MIN_HT2 AS BIGINT) as AFRAME_MIN_HT", 
	"CAST(AFRAME_MAX_HT2 AS BIGINT) as AFRAME_MAX_HT", 
	"CAST(AFRAME_MIN_LEN2 AS BIGINT) as AFRAME_MIN_LEN", 
	"CAST(AFRAME_MAX_LEN2 AS BIGINT) as AFRAME_MAX_LEN", 
	"CAST(AFRAME_MIN_WID2 AS BIGINT) as AFRAME_MIN_WID", 
	"CAST(AFRAME_MAX_WID2 AS BIGINT) as AFRAME_MAX_WID", 
	"CAST(AFRAME_MIN_WT2 AS BIGINT) as AFRAME_MIN_WT", 
	"CAST(AFRAME_MAX_WT2 AS BIGINT) as AFRAME_MAX_WT", 
	"CAST(REACH_DIST2 AS BIGINT) as REACH_DIST", 
	"CAST(MOVE_GUIDES_RGT2 AS BIGINT) as MOVE_GUIDES_RGT", 
	"CAST(MOVE_GUIDES_LFT2 AS BIGINT) as MOVE_GUIDES_LFT", 
