...
Shortcut_to_WM_E_MSRMNT_RULE_CONDITION2.createOrReplaceTempView('WM_E_MSRMNT_RULE_CONDITION_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_E_MSRMNT_RULE_CONDITION_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_MSRMNT_ID = trg.WM_MSRMNT_ID AND src.WM_RULE_NBR = trg.WM_RULE_NBR AND src.RULE_SEQ_NBR = trg.RULE_SEQ_NBR)
...
Shortcut_to_WM_E_MSRMNT_RULE_CONDITION1 = UPD_INSERT_UPDATE.selectExpr(
	...
	"CAST(RULE_SEQ_NBR1 AS INT) as RULE_SEQ_NBR",
