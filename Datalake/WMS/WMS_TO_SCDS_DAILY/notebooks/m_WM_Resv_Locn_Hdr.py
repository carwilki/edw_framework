...
WM_RESV_LOCN_HDR_PRE.DC_NBR,
WM_RESV_LOCN_HDR_PRE.RESV_LOCN_HDR_ID,
WM_RESV_LOCN_HDR_PRE.LOCN_ID,
WM_RESV_LOCN_HDR_PRE.LOCN_SIZE_TYPE,
WM_RESV_LOCN_HDR_PRE.LOCN_PUTAWAY_LOCK,
WM_RESV_LOCN_HDR_PRE.INVN_LOCK_CODE,
WM_RESV_LOCN_HDR_PRE.CURR_WT,
WM_RESV_LOCN_HDR_PRE.DIRCT_WT,
WM_RESV_LOCN_HDR_PRE.MAX_WT,
WM_RESV_LOCN_HDR_PRE.CURR_VOL,
WM_RESV_LOCN_HDR_PRE.DIRCT_VOL,
WM_RESV_LOCN_HDR_PRE.MAX_VOL,
WM_RESV_LOCN_HDR_PRE.CURR_UOM_QTY,
WM_RESV_LOCN_HDR_PRE.DIRCT_UOM_QTY,
WM_RESV_LOCN_HDR_PRE.MAX_UOM_QTY,
WM_RESV_LOCN_HDR_PRE.CREATE_DATE_TIME,
WM_RESV_LOCN_HDR_PRE.MOD_DATE_TIME,
WM_RESV_LOCN_HDR_PRE.USER_ID,
WM_RESV_LOCN_HDR_PRE.DEDCTN_BATCH_NBR,
WM_RESV_LOCN_HDR_PRE.DEDCTN_PACK_QTY,
WM_RESV_LOCN_HDR_PRE.PACK_ZONE,
WM_RESV_LOCN_HDR_PRE.SORT_LOCN_FLAG,
WM_RESV_LOCN_HDR_PRE.INBD_STAGING_FLAG,
WM_RESV_LOCN_HDR_PRE.WM_VERSION_ID,
WM_RESV_LOCN_HDR_PRE.DEDCTN_ITEM_ID,
WM_RESV_LOCN_HDR_PRE.LOCN_HDR_ID,
WM_RESV_LOCN_HDR_PRE.LOAD_TSTMP
FROM WM_RESV_LOCN_HDR_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_RESV_LOCN_HDR.LOCATION_ID,
WM_RESV_LOCN_HDR.WM_RESV_LOCN_HDR_ID,
WM_RESV_LOCN_HDR.WM_LOCN_ID,
WM_RESV_LOCN_HDR.WM_LOCN_HDR_ID,
WM_RESV_LOCN_HDR.WM_LOCN_PUTAWAY_LOCK,
WM_RESV_LOCN_HDR.WM_LOCN_SIZE_TYPE,
WM_RESV_LOCN_HDR.WM_INVN_LOCK_CD,
WM_RESV_LOCN_HDR.WM_PACK_ZONE,
WM_RESV_LOCN_HDR.SORT_LOCN_FLAG,
WM_RESV_LOCN_HDR.INBD_STAGING_FLAG,
WM_RESV_LOCN_HDR.WM_DEDCTN_BATCH_NBR,
WM_RESV_LOCN_HDR.WM_DEDCTN_ITEM_ID,
WM_RESV_LOCN_HDR.DEDCTN_PACK_QTY,
WM_RESV_LOCN_HDR.CURR_WT,
WM_RESV_LOCN_HDR.CURR_VOL,
WM_RESV_LOCN_HDR.CURR_UOM_QTY,
WM_RESV_LOCN_HDR.DIRCT_WT,
WM_RESV_LOCN_HDR.DIRCT_VOL,
WM_RESV_LOCN_HDR.DIRCT_UOM_QTY,
WM_RESV_LOCN_HDR.MAX_WT,
WM_RESV_LOCN_HDR.MAX_VOL,
WM_RESV_LOCN_HDR.MAX_UOM_QTY,
WM_RESV_LOCN_HDR.WM_USER_ID,
WM_RESV_LOCN_HDR.WM_VERSION_ID,
WM_RESV_LOCN_HDR.WM_CREATE_TSTMP,
WM_RESV_LOCN_HDR.WM_MOD_TSTMP,
WM_RESV_LOCN_HDR.DELETE_FLAG,
WM_RESV_LOCN_HDR.UPDATE_TSTMP,
WM_RESV_LOCN_HDR.LOAD_TSTMP
FROM WM_RESV_LOCN_HDR
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( 
	...
	"IF (FIL_UNCHANGED_RECORDS___RESV_LOCN_HDR_ID IS NOT NULL AND FIL_UNCHANGED_RECORDS___WM_RESV_LOCN_HDR_ID IS NULL, 'INSERT', IF (FIL_UNCHANGED_RECORDS___RESV_LOCN_HDR_ID IS NULL AND FIL_UNCHANGED_RECORDS___WM_RESV_LOCN_HDR_ID IS NOT NULL AND ( FIL_UNCHANGED_RECORDS___v_WM_CREATE_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_RECORDS___v_WM_MOD_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) ), 'DELETE', IF (FIL_UNCHANGED_RECORDS___RESV_LOCN_HDR_ID IS NOT NULL AND FIL_UNCHANGED_RECORDS___WM_RESV_LOCN_HDR_ID IS NOT NULL AND ( FIL_UNCHANGED_RECORDS___v_WM_CREATE_TSTMP <> FIL_UNCHANGED_RECORDS___v_CREATE_DATE_TIME OR FIL_UNCHANGED_RECORDS___v_WM_MOD_TSTMP <> FIL_UNCHANGED_RECORDS___v_MOD_DATE_TIME ), 'UPDATE', NULL))) as o_UPDATE_VALIDATOR"
)
...
Shortcut_to_WM_RESV_LOCN_HDR = UPD_INSERT_UPDATE.selectExpr( 
	...
	"CAST(RESV_LOCN_HDR_ID1 AS BIGINT) as WM_RESV_LOCN_HDR_ID", 
	"CAST(LOCN_ID1 AS STRING) as WM_LOCN_ID", 
	"CAST(LOCN_HDR_ID1 AS BIGINT) as WM_LOCN_HDR_ID", 
	...
	"CAST(SORT_LOCN_FLAG1 AS BIGINT) as SORT_LOCN_FLAG", 
	"CAST(INBD_STAGING_FLAG1 AS BIGINT) as INBD_STAGING_FLAG", 
	"CAST(DEDCTN_BATCH_NBR1 AS STRING) as WM_DEDCTN_BATCH_NBR", 
	"CAST(DEDCTN_ITEM_ID1 AS BIGINT) as WM_DEDCTN_ITEM_ID", 
	"CAST(DEDCTN_PACK_QTY1 AS BIGINT) as DEDCTN_PACK_QTY", 
	"CAST(CURR_WT1 AS BIGINT) as CURR_WT", 
	"CAST(CURR_VOL1 AS BIGINT) as CURR_VOL", 
	"CAST(CURR_UOM_QTY1 AS BIGINT) as CURR_UOM_QTY", 
	"CAST(DIRCT_WT1 AS BIGINT) as DIRCT_WT", 
	"CAST(DIRCT_VOL1 AS BIGINT) as DIRCT_VOL", 
	"CAST(DIRCT_UOM_QTY1 AS BIGINT) as DIRCT_UOM_QTY", 
	"CAST(MAX_WT1 AS BIGINT) as MAX_WT", 
	"CAST(MAX_VOL1 AS BIGINT) as MAX_VOL", 
	"CAST(MAX_UOM_QTY1 AS BIGINT) as MAX_UOM_QTY", 
...
Shortcut_to_WM_RESV_LOCN_HDR.write.saveAsTable(f'{raw}.WM_RESV_LOCN_HDR')