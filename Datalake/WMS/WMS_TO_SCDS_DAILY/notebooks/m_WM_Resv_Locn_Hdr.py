...
Shortcut_to_WM_RESV_LOCN_HDR2.createOrReplaceTempView('WM_RESV_LOCN_HDR_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_RESV_LOCN_HDR_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_RESV_LOCN_HDR_ID = trg.WM_RESV_LOCN_HDR_ID )
