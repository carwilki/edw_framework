...
def m_WM_User_Profile_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_USER_PROFILE_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(USER_PROFILE_ID AS INT) as USER_PROFILE_ID",
        ...
        "CAST(RF_MENU_ID AS INT) as RF_MENU_ID",
        ...
        "CAST(VOCOLLECT_WORK_TYPE AS TINYINT) as VOCOLLECT_WORK_TYPE",
        ...
        "CAST(SECURITY_CONTEXT_ID AS INT) as SECURITY_CONTEXT_ID",
        ...
        "CAST(CLS_TIMEZONE_ID AS INT) as CLS_TIMEZONE_ID",
        "CAST(DAL_CONNECTION_STRING AS STRING) as DAL_CONNECTION_STRING",
        "CAST(WM_VERSION_ID AS INT) as WM_VERSION_ID",
        "CAST(USER_SECURITY_CONTEXT_ID AS INT) as USER_SECURITY_CONTEXT_ID",
        ...
        "CAST(SCREEN_TYPE_ID AS SMALLINT) as SCREEN_TYPE_ID",
