...
Shortcut_to_WM_SEC_USER = UPD_INS_UPD.selectExpr(
	...
	"CAST(SEC_USER_ID AS INT) as WM_SEC_USER_ID",
	...
	"CAST(SEC_POLICY_SET_ID AS INT) as WM_SEC_POLICY_SET_ID",
	...
	"CAST(GRACE_LOGINS1 AS INT) as GRACE_LOGINS",
	"CAST(LOCKED_OUT_EXPIRATION AS TIMESTAMP) as LOCKED_OUT_EXP_TSTMP",
	"CAST(FAILED_LOGIN_ATTEMPTS1 AS INT) as FAILED_LOGIN_ATTEMPTS",
