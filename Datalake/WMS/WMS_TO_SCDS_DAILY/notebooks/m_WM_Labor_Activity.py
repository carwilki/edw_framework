...
Shortcut_to_WM_LABOR_ACTIVITY1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(PERMISSION_ID1 AS BIGINT) as WM_PERMISSION_ID", 
	"CAST(COMPANY_ID1 AS BIGINT) as WM_COMPANY_ID", 
	"CAST(AIL_ACT1 AS STRING) as WM_AIL_ACTIVITY_FLAG", 
	"CAST(PROMPT_LOCN1 AS BIGINT) as WM_PROMPT_LOCN_FLAG", 
	"CAST(DISPL_EPP1 AS BIGINT) as WM_DISPLAY_EPP_FLAG", 
	"CAST(INCLD_TRVL1 AS BIGINT) as WM_INCLUDE_TRAVEL_FLAG", 
	...
	"CAST(LAST_UPDATED_SOURCE_TYPE1 AS BIGINT) as LAST_UPDATED_SOURCE_TYPE", 
