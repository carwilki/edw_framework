...
Shortcut_to_WM_LABOR_ACTIVITY2.createOrReplaceTempView('WM_LABOR_ACTIVITY_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_LABOR_ACTIVITY_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_LABOR_ACTIVITY_ID = trg.WM_LABOR_ACTIVITY_ID )
...
Shortcut_to_WM_LABOR_ACTIVITY1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(PERMISSION_ID1 AS INT) as WM_PERMISSION_ID",
	"CAST(COMPANY_ID1 AS INT) as WM_COMPANY_ID",
	"CAST(AIL_ACT1 AS STRING) as WM_AIL_ACTIVITY_FLAG",
	"CAST(PROMPT_LOCN1 AS TINYINT) as WM_PROMPT_LOCN_FLAG",
	"CAST(DISPL_EPP1 AS TINYINT) as WM_DISPLAY_EPP_FLAG",
	"CAST(INCLD_TRVL1 AS TINYINT) as WM_INCLUDE_TRAVEL_FLAG",
	...
	"CAST(LAST_UPDATED_SOURCE_TYPE1 AS TINYINT) as LAST_UPDATED_SOURCE_TYPE",
