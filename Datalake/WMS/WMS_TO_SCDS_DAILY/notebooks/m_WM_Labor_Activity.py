...
WM_LABOR_ACTIVITY_PRE.DC_NBR,
WM_LABOR_ACTIVITY_PRE.LABOR_ACTIVITY_ID,
WM_LABOR_ACTIVITY_PRE.NAME,
WM_LABOR_ACTIVITY_PRE.DESCRIPTION,
WM_LABOR_ACTIVITY_PRE.AIL_ACT,
WM_LABOR_ACTIVITY_PRE.ACT_TYPE,
WM_LABOR_ACTIVITY_PRE.CREATED_SOURCE_TYPE,
WM_LABOR_ACTIVITY_PRE.CREATED_SOURCE,
WM_LABOR_ACTIVITY_PRE.CREATED_DTTM,
WM_LABOR_ACTIVITY_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_LABOR_ACTIVITY_PRE.LAST_UPDATED_SOURCE,
WM_LABOR_ACTIVITY_PRE.LAST_UPDATED_DTTM,
WM_LABOR_ACTIVITY_PRE.HIBERNATE_VERSION,
WM_LABOR_ACTIVITY_PRE.PROMPT_LOCN,
WM_LABOR_ACTIVITY_PRE.DISPL_EPP,
WM_LABOR_ACTIVITY_PRE.INCLD_TRVL,
WM_LABOR_ACTIVITY_PRE.CRIT_RULE_TYPE,
WM_LABOR_ACTIVITY_PRE.PERMISSION_ID,
WM_LABOR_ACTIVITY_PRE.COMPANY_ID,
WM_LABOR_ACTIVITY_PRE.LOAD_TSTMP
FROM WM_LABOR_ACTIVITY_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_LABOR_ACTIVITY.LOCATION_ID,
WM_LABOR_ACTIVITY.WM_LABOR_ACTIVITY_ID,
WM_LABOR_ACTIVITY.WM_LABOR_ACTIVITY_NAME,
WM_LABOR_ACTIVITY.WM_LABOR_ACTIVITY_DESC,
WM_LABOR_ACTIVITY.WM_ACTIVITY_TYPE,
WM_LABOR_ACTIVITY.WM_CRIT_RULE_TYPE,
WM_LABOR_ACTIVITY.WM_PERMISSION_ID,
WM_LABOR_ACTIVITY.WM_COMPANY_ID,
WM_LABOR_ACTIVITY.WM_AIL_ACTIVITY_FLAG,
WM_LABOR_ACTIVITY.WM_PROMPT_LOCN_FLAG,
WM_LABOR_ACTIVITY.WM_DISPLAY_EPP_FLAG,
WM_LABOR_ACTIVITY.WM_INCLUDE_TRAVEL_FLAG,
WM_LABOR_ACTIVITY.WM_HIBERNATE_VERSION,
WM_LABOR_ACTIVITY.WM_CREATED_SOURCE_TYPE,
WM_LABOR_ACTIVITY.WM_CREATED_SOURCE,
WM_LABOR_ACTIVITY.WM_CREATED_TSTMP,
WM_LABOR_ACTIVITY.LAST_UPDATED_SOURCE_TYPE,
WM_LABOR_ACTIVITY.LAST_UPDATED_SOURCE,
WM_LABOR_ACTIVITY.WM_LAST_UPDATED_TSTMP,
WM_LABOR_ACTIVITY.DELETE_FLAG,
WM_LABOR_ACTIVITY.UPDATE_TSTMP,
WM_LABOR_ACTIVITY.LOAD_TSTMP
FROM WM_LABOR_ACTIVITY
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_REC_temp.selectExpr( \
	...
	"IF (FIL_UNCHANGED_REC___LABOR_ACTIVITY_ID IS NOT NULL AND FIL_UNCHANGED_REC___WM_LABOR_ACTIVITY_ID IS NULL, 'INSERT', IF (FIL_UNCHANGED_REC___LABOR_ACTIVITY_ID IS NULL AND FIL_UNCHANGED_REC___WM_LABOR_ACTIVITY_ID IS NOT NULL AND ( FIL_UNCHANGED_REC___v_WM_CREATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_REC___v_WM_LAST_UPDATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) ), 'DELETE', IF (FIL_UNCHANGED_REC___LABOR_ACTIVITY_ID IS NOT NULL AND FIL_UNCHANGED_REC___WM_LABOR_ACTIVITY_ID IS NOT NULL AND ( FIL_UNCHANGED_REC___v_WM_CREATED_TSTMP <> FIL_UNCHANGED_REC___v_CREATED_DTTM OR FIL_UNCHANGED_REC___v_WM_LAST_UPDATED_TSTMP <> FIL_UNCHANGED_REC___v_LAST_UPDATED_DTTM ), 'UPDATE', NULL))) as o_UPD_VALIDATOR" \
)
