...
WM_OUTPT_ORDERS.LOCATION_ID,
WM_OUTPT_ORDERS.WM_OUTPT_ORDERS_ID,
WM_OUTPT_ORDERS.WM_CREATED_TSTMP,
WM_OUTPT_ORDERS.WM_LAST_UPDATED_TSTMP,
WM_OUTPT_ORDERS.LOAD_TSTMP
FROM WM_OUTPT_ORDERS
WHERE WM_OUTPT_ORDERS_ID IN (SELECT OUTPT_ORDERS_ID FROM WM_OUTPT_ORDERS_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_OUTPT_ORDERS_PRE.DC_NBR,
WM_OUTPT_ORDERS_PRE.OUTPT_ORDERS_ID,
WM_OUTPT_ORDERS_PRE.ACCT_RCVBL_ACCT_NBR,
WM_OUTPT_ORDERS_PRE.ACCT_RCVBL_CODE,
WM_OUTPT_ORDERS_PRE.ADDR_CODE,
WM_OUTPT_ORDERS_PRE.BACKORDERED_QUANTITY,
WM_OUTPT_ORDERS_PRE.BATCH_CTRL_NBR,
WM_OUTPT_ORDERS_PRE.BILLING_METHOD,
WM_OUTPT_ORDERS_PRE.BILL_ACCT_NBR,
WM_OUTPT_ORDERS_PRE.BILL_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.BILL_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.BILL_OF_LADING_NUMBER,
WM_OUTPT_ORDERS_PRE.BILL_TO_ADDRESS_1,
WM_OUTPT_ORDERS_PRE.BILL_TO_ADDRESS_2,
WM_OUTPT_ORDERS_PRE.BILL_TO_ADDRESS_3,
WM_OUTPT_ORDERS_PRE.BILL_TO_CITY,
WM_OUTPT_ORDERS_PRE.BILL_TO_CONTACT,
WM_OUTPT_ORDERS_PRE.BILL_TO_CONTACT_NAME,
WM_OUTPT_ORDERS_PRE.BILL_TO_COUNTRY_CODE,
WM_OUTPT_ORDERS_PRE.BILL_TO_COUNTY,
WM_OUTPT_ORDERS_PRE.BILL_TO_EMAIL,
WM_OUTPT_ORDERS_PRE.BILL_TO_FACILITY_NAME,
WM_OUTPT_ORDERS_PRE.BILL_TO_FAX_NUMBER,
WM_OUTPT_ORDERS_PRE.BILL_TO_NAME,
WM_OUTPT_ORDERS_PRE.BILL_TO_PHONE_NUMBER,
WM_OUTPT_ORDERS_PRE.BILL_TO_POSTAL_CODE,
WM_OUTPT_ORDERS_PRE.BILL_TO_STATE_PROV,
WM_OUTPT_ORDERS_PRE.BILL_TO_TITLE,
WM_OUTPT_ORDERS_PRE.BOL_BREAK_ATTR,
WM_OUTPT_ORDERS_PRE.BOL_TYPE,
WM_OUTPT_ORDERS_PRE.BUSINESS_PARTNER,
WM_OUTPT_ORDERS_PRE.CREATED_DTTM,
WM_OUTPT_ORDERS_PRE.CREATED_SOURCE,
WM_OUTPT_ORDERS_PRE.CREATED_SOURCE_TYPE,
WM_OUTPT_ORDERS_PRE.CURRENCY,
WM_OUTPT_ORDERS_PRE.D_ADDRESS_1,
WM_OUTPT_ORDERS_PRE.D_ADDRESS_2,
WM_OUTPT_ORDERS_PRE.D_ADDRESS_3,
WM_OUTPT_ORDERS_PRE.D_CITY,
WM_OUTPT_ORDERS_PRE.D_CONTACT,
WM_OUTPT_ORDERS_PRE.D_COUNTRY_CODE,
WM_OUTPT_ORDERS_PRE.D_COUNTY,
WM_OUTPT_ORDERS_PRE.D_DOCK_DOOR_ID,
WM_OUTPT_ORDERS_PRE.D_DOCK_ID,
WM_OUTPT_ORDERS_PRE.D_EMAIL,
WM_OUTPT_ORDERS_PRE.D_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.D_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.D_FACILITY_NAME,
WM_OUTPT_ORDERS_PRE.D_FAX_NUMBER,
WM_OUTPT_ORDERS_PRE.D_NAME,
WM_OUTPT_ORDERS_PRE.D_PHONE_NUMBER,
WM_OUTPT_ORDERS_PRE.D_POSTAL_CODE,
WM_OUTPT_ORDERS_PRE.D_STATE_PROV,
WM_OUTPT_ORDERS_PRE.DC_CTR_NBR,
WM_OUTPT_ORDERS_PRE.DELIVERY_START_DTTM,
WM_OUTPT_ORDERS_PRE.DISTRIBUTION_SHIP_VIA,
WM_OUTPT_ORDERS_PRE.DO_TYPE,
WM_OUTPT_ORDERS_PRE.ORIGINAL_SHIP_VIA,
WM_OUTPT_ORDERS_PRE.EXT_PURCHASE_ORDER,
WM_OUTPT_ORDERS_PRE.FREIGHT_CLASS,
WM_OUTPT_ORDERS_PRE.FREIGHT_FORWARDER_ACCT_NBR,
WM_OUTPT_ORDERS_PRE.GLOBAL_LOCN_NBR,
WM_OUTPT_ORDERS_PRE.HANDLING_CHARGES,
WM_OUTPT_ORDERS_PRE.INCOTERM_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.INCOTERM_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.INCOTERM_ID,
WM_OUTPT_ORDERS_PRE.INCOTERM_LOC_AVA_DTTM,
WM_OUTPT_ORDERS_PRE.INCOTERM_LOC_AVA_TIME_ZONE_ID,
WM_OUTPT_ORDERS_PRE.INCOTERM_NAME,
WM_OUTPT_ORDERS_PRE.INSUR_CHRG,
WM_OUTPT_ORDERS_PRE.INVC_BATCH_NBR,
WM_OUTPT_ORDERS_PRE.IS_BACK_ORDERED,
WM_OUTPT_ORDERS_PRE.LAST_UPDATED_DTTM,
WM_OUTPT_ORDERS_PRE.LAST_UPDATED_SOURCE,
WM_OUTPT_ORDERS_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_OUTPT_ORDERS_PRE.MAJOR_MINOR_ORDER,
WM_OUTPT_ORDERS_PRE.MAJOR_ORDER_CTRL_NBR,
WM_OUTPT_ORDERS_PRE.MAJOR_ORDER_GRP_ATTR,
WM_OUTPT_ORDERS_PRE.MANIFEST_ID,
WM_OUTPT_ORDERS_PRE.MERCHANDIZING_DEPARTMENT,
WM_OUTPT_ORDERS_PRE.MISC_CHARGES,
WM_OUTPT_ORDERS_PRE.MONETARY_VALUE,
WM_OUTPT_ORDERS_PRE.MOVEMENT_OPTION,
WM_OUTPT_ORDERS_PRE.MV_CURRENCY,
WM_OUTPT_ORDERS_PRE.NON_MACHINEABLE,
WM_OUTPT_ORDERS_PRE.O_ADDRESS_1,
WM_OUTPT_ORDERS_PRE.O_ADDRESS_2,
WM_OUTPT_ORDERS_PRE.O_ADDRESS_3,
WM_OUTPT_ORDERS_PRE.O_CITY,
WM_OUTPT_ORDERS_PRE.O_CONTACT,
WM_OUTPT_ORDERS_PRE.O_COUNTRY_CODE,
WM_OUTPT_ORDERS_PRE.O_COUNTY,
WM_OUTPT_ORDERS_PRE.O_DOCK_DOOR_ID,
WM_OUTPT_ORDERS_PRE.O_DOCK_ID,
WM_OUTPT_ORDERS_PRE.O_EMAIL,
WM_OUTPT_ORDERS_PRE.O_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.O_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.O_FACILITY_NAME,
WM_OUTPT_ORDERS_PRE.O_FAX_NUMBER,
WM_OUTPT_ORDERS_PRE.O_POSTAL_CODE,
WM_OUTPT_ORDERS_PRE.O_STATE_PROV,
WM_OUTPT_ORDERS_PRE.ORDER_DATE_DTTM,
WM_OUTPT_ORDERS_PRE.ORDER_WEIGHT,
WM_OUTPT_ORDERS_PRE.ORG_SHIP_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.ORG_SHIP_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.ORIGINAL_ASSIGNED_SHIP_VIA,
WM_OUTPT_ORDERS_PRE.ORIGIN_SHIP_THRU_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.ORIGIN_SHIP_THRU_FAC_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.PICKUP_END_DTTM,
WM_OUTPT_ORDERS_PRE.PICKUP_START_DTTM,
WM_OUTPT_ORDERS_PRE.PLANNED_SHIP_DATE,
WM_OUTPT_ORDERS_PRE.PRE_PACK_FLAG,
WM_OUTPT_ORDERS_PRE.PRIORITY,
WM_OUTPT_ORDERS_PRE.PRO_NUMBER,
WM_OUTPT_ORDERS_PRE.PROC_DTTM,
WM_OUTPT_ORDERS_PRE.PROC_STAT_CODE,
WM_OUTPT_ORDERS_PRE.REC_XPANS_FIELD,
WM_OUTPT_ORDERS_PRE.RTE_ID,
WM_OUTPT_ORDERS_PRE.RTE_SHIPMENT_SEQ,
WM_OUTPT_ORDERS_PRE.SCHED_DELIVERY_DTTM,
WM_OUTPT_ORDERS_PRE.SHIPMENT_ID,
WM_OUTPT_ORDERS_PRE.SHIP_DATE,
WM_OUTPT_ORDERS_PRE.SHIP_GROUP_ID,
WM_OUTPT_ORDERS_PRE.SHIP_GROUP_SEQUENCE,
WM_OUTPT_ORDERS_PRE.SHPNG_CHRG,
WM_OUTPT_ORDERS_PRE.ORDER_STATUS,
WM_OUTPT_ORDERS_PRE.DO_STATUS,
WM_OUTPT_ORDERS_PRE.STORE_NBR,
WM_OUTPT_ORDERS_PRE.STORE_TYPE,
WM_OUTPT_ORDERS_PRE.TAX_CHARGES,
WM_OUTPT_ORDERS_PRE.TC_COMPANY_ID,
WM_OUTPT_ORDERS_PRE.TC_ORDER_ID,
WM_OUTPT_ORDERS_PRE.TC_SHIPMENT_ID,
WM_OUTPT_ORDERS_PRE.TOTAL_NBR_OF_LPN,
WM_OUTPT_ORDERS_PRE.TOTAL_NBR_OF_PLT,
WM_OUTPT_ORDERS_PRE.TOTAL_NBR_OF_UNITS,
WM_OUTPT_ORDERS_PRE.VERSION_NBR,
WM_OUTPT_ORDERS_PRE.LINE_HAUL_SHIP_VIA,
WM_OUTPT_ORDERS_PRE.PLAN_D_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.PLAN_D_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.PLAN_LEG_D_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.PLAN_LEG_D_ID,
WM_OUTPT_ORDERS_PRE.PLAN_LEG_O_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.PLAN_LEG_O_ID,
WM_OUTPT_ORDERS_PRE.PLAN_O_FACILITY_ALIAS_ID,
WM_OUTPT_ORDERS_PRE.PLAN_O_FACILITY_ID,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_1,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_10,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_2,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_3,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_4,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_5,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_6,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_7,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_8,
WM_OUTPT_ORDERS_PRE.SPL_INSTR_CODE_9,
WM_OUTPT_ORDERS_PRE.PRE_BILL_STATUS,
WM_OUTPT_ORDERS_PRE.PRTL_SHIP_CONF_FLAG,
WM_OUTPT_ORDERS_PRE.PRTL_SHIP_CONF_STATUS,
WM_OUTPT_ORDERS_PRE.PRE_BILLED_FLAG,
WM_OUTPT_ORDERS_PRE.TAX_ID,
WM_OUTPT_ORDERS_PRE.ALLOW_PRE_BILLING,
WM_OUTPT_ORDERS_PRE.O_PHONE_NUMBER,
WM_OUTPT_ORDERS_PRE.PURCHASE_ORDER_NBR,
WM_OUTPT_ORDERS_PRE.MARK_FOR,
WM_OUTPT_ORDERS_PRE.DISTRO_NUMBER,
WM_OUTPT_ORDERS_PRE.REF_SHIPMENT_NBR,
WM_OUTPT_ORDERS_PRE.REF_STOP_SEQ,
WM_OUTPT_ORDERS_PRE.PO_TYPE_ATTR,
WM_OUTPT_ORDERS_PRE.DSG_SHIP_VIA,
WM_OUTPT_ORDERS_PRE.LOAD_TSTMP
FROM WM_OUTPT_ORDERS_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
