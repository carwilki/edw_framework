...
UPD_INS_UPD = EXP_EVALUATE_temp.selectExpr( \
	...
	.withColumn('pyspark_data_action', when((col('in_WM_OUTPT_ORDERS_ID').isNull()) ,(lit(0))).otherwise(lit(1)))
...
Shortcut_to_WM_OUTPT_ORDERS = UPD_INS_UPD.selectExpr(
	...
	"CAST(DO_TYPE AS SMALLINT) as WM_DO_TYPE",
	...
	"CAST(SHIP_GROUP_SEQUENCE AS SMALLINT) as SHIP_GROUP_SEQ",
	...
	"CAST(BILLING_METHOD AS SMALLINT) as WM_BILLING_METHOD",
	"CAST(ALLOW_PRE_BILLING AS TINYINT) as ALLOW_PRE_BILLING_FLAG",
	"CAST(PRE_BILLED_FLAG AS TINYINT) as PRE_BILLED_FLAG",
	"CAST(PRE_BILL_STATUS AS SMALLINT) as WM_PRE_BILL_STATUS",
	"CAST(PRTL_SHIP_CONF_FLAG AS TINYINT) as PRTL_SHIP_CONF_FLAG",
	"CAST(PRTL_SHIP_CONF_STATUS AS INT) as WM_PRTL_SHIP_CONF_STATUS",
	...
	"CAST(PLAN_LEG_D_ID AS INT) as WM_PLAN_LEG_D_ID",
	"CAST(PLAN_LEG_O_ALIAS_ID AS STRING) as WM_PLAN_LEG_O_ALIAS_ID",
	"CAST(PLAN_LEG_O_ID AS INT) as WM_PLAN_LEG_O_ID",
	...
	"CAST(BACKORDERED_QUANTITY AS DECIMAL(13,2)) as BACK_ORDERED_QTY",
	"CAST(ORDER_WEIGHT AS DECIMAL(13,4)) as ORDER_WEIGHT",
	"CAST(MONETARY_VALUE AS DECIMAL(16,4)) as MONETARY_VALUE",
	"CAST(TAX_CHARGES AS DECIMAL(13,4)) as TAX_CHARGES_AMT",
	"CAST(SHPNG_CHRG AS DECIMAL(11,2)) as SHIPPING_CHARGES_AMT",
	"CAST(HANDLING_CHARGES AS DECIMAL(13,4)) as HANDLING_CHARGES_AMT",
	"CAST(INSUR_CHRG AS DECIMAL(11,2)) as INSURANCE_CHARGES_AMT",
	"CAST(MISC_CHARGES AS DECIMAL(13,4)) as MISC_CHARGES_AMT",
