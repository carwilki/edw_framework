...
WM_OUTPT_LPN_PRE.DC_NBR,
WM_OUTPT_LPN_PRE.OUTPT_LPN_ID,
WM_OUTPT_LPN_PRE.ACTUAL_CHARGE,
WM_OUTPT_LPN_PRE.ACTUAL_CHARGE_CURRENCY,
WM_OUTPT_LPN_PRE.ACTUAL_MONETARY_VALUE,
WM_OUTPT_LPN_PRE.ACTUAL_VOLUME,
WM_OUTPT_LPN_PRE.ADDNL_OPTION_CHARGE,
WM_OUTPT_LPN_PRE.ADDNL_OPTION_CHARGE_CURRENCY,
WM_OUTPT_LPN_PRE.ADF_TRANSMIT_FLAG,
WM_OUTPT_LPN_PRE.AUDITOR_USERID,
WM_OUTPT_LPN_PRE.BASE_CHARGE,
WM_OUTPT_LPN_PRE.BASE_CHARGE_CURRENCY,
WM_OUTPT_LPN_PRE.BILL_OF_LADING_NUMBER,
WM_OUTPT_LPN_PRE.C_FACILITY_ALIAS_ID,
WM_OUTPT_LPN_PRE.COD_AMOUNT,
WM_OUTPT_LPN_PRE.COD_PAYMENT_METHOD,
WM_OUTPT_LPN_PRE.CONTAINER_SIZE,
WM_OUTPT_LPN_PRE.CONTAINER_TYPE,
WM_OUTPT_LPN_PRE.CREATED_DTTM,
WM_OUTPT_LPN_PRE.CREATED_SOURCE,
WM_OUTPT_LPN_PRE.CREATED_SOURCE_TYPE,
WM_OUTPT_LPN_PRE.DECLARED_MONETARY_VALUE,
WM_OUTPT_LPN_PRE.DIST_CHARGE,
WM_OUTPT_LPN_PRE.DIST_CHARGE_CURRENCY,
WM_OUTPT_LPN_PRE.EPC_MATCH_FLAG,
WM_OUTPT_LPN_PRE.ESTIMATED_WEIGHT,
WM_OUTPT_LPN_PRE.FINAL_DEST_FACILITY_ALIAS_ID,
WM_OUTPT_LPN_PRE.FREIGHT_CHARGE,
WM_OUTPT_LPN_PRE.FREIGHT_CHARGE_CURRENCY,
WM_OUTPT_LPN_PRE.INSUR_CHARGE,
WM_OUTPT_LPN_PRE.INSUR_CHARGE_CURRENCY,
WM_OUTPT_LPN_PRE.INVC_BATCH_NBR,
WM_OUTPT_LPN_PRE.LAST_UPDATED_DTTM,
WM_OUTPT_LPN_PRE.LOADED_DTTM,
WM_OUTPT_LPN_PRE.LOADED_POSN,
WM_OUTPT_LPN_PRE.LPN_EPC,
WM_OUTPT_LPN_PRE.LPN_NBR_X_OF_Y,
WM_OUTPT_LPN_PRE.MANIFEST_NBR,
WM_OUTPT_LPN_PRE.MASTER_BOL_NBR,
WM_OUTPT_LPN_PRE.MISC_INSTR_CODE_1,
WM_OUTPT_LPN_PRE.MISC_INSTR_CODE_2,
WM_OUTPT_LPN_PRE.MISC_INSTR_CODE_3,
WM_OUTPT_LPN_PRE.MISC_INSTR_CODE_4,
WM_OUTPT_LPN_PRE.MISC_INSTR_CODE_5,
WM_OUTPT_LPN_PRE.MISC_NUM_1,
WM_OUTPT_LPN_PRE.MISC_NUM_2,
WM_OUTPT_LPN_PRE.NON_INVENTORY_LPN_FLAG,
WM_OUTPT_LPN_PRE.NON_MACHINEABLE,
WM_OUTPT_LPN_PRE.PACKAGE_DESCRIPTION,
WM_OUTPT_LPN_PRE.PACKER_USERID,
WM_OUTPT_LPN_PRE.PALLET_EPC,
WM_OUTPT_LPN_PRE.PALLET_MASTER_LPN_FLAG,
WM_OUTPT_LPN_PRE.PARCEL_SERVICE_MODE,
WM_OUTPT_LPN_PRE.PARCEL_SHIPMENT_NBR,
WM_OUTPT_LPN_PRE.PICKER_USERID,
WM_OUTPT_LPN_PRE.PRE_BULK_ADD_OPT_CHR,
WM_OUTPT_LPN_PRE.PRE_BULK_ADD_OPT_CHR_CURRENCY,
WM_OUTPT_LPN_PRE.PRE_BULK_BASE_CHARGE,
WM_OUTPT_LPN_PRE.PROC_DTTM,
WM_OUTPT_LPN_PRE.PROC_STAT_CODE,
WM_OUTPT_LPN_PRE.QTY_UOM,
WM_OUTPT_LPN_PRE.RATE_ZONE,
WM_OUTPT_LPN_PRE.RATED_WEIGHT,
WM_OUTPT_LPN_PRE.RATED_WEIGHT_UOM,
WM_OUTPT_LPN_PRE.SERVICE_LEVEL,
WM_OUTPT_LPN_PRE.SHIP_VIA,
WM_OUTPT_LPN_PRE.SHIPPED_DTTM,
WM_OUTPT_LPN_PRE.STATIC_ROUTE_ID,
WM_OUTPT_LPN_PRE.TC_COMPANY_ID,
WM_OUTPT_LPN_PRE.TC_LPN_ID,
WM_OUTPT_LPN_PRE.TC_ORDER_ID,
WM_OUTPT_LPN_PRE.TC_PARENT_LPN_ID,
WM_OUTPT_LPN_PRE.TC_SHIPMENT_ID,
WM_OUTPT_LPN_PRE.TOTAL_LPN_QTY,
WM_OUTPT_LPN_PRE.TRACKING_NBR,
WM_OUTPT_LPN_PRE.ALT_TRACKING_NBR,
WM_OUTPT_LPN_PRE.VERSION_NBR,
WM_OUTPT_LPN_PRE.VOLUME_UOM,
WM_OUTPT_LPN_PRE.WEIGHT,
WM_OUTPT_LPN_PRE.WEIGHT_UOM,
WM_OUTPT_LPN_PRE.LOAD_SEQUENCE,
WM_OUTPT_LPN_PRE.TC_PURCHASE_ORDER_ID,
WM_OUTPT_LPN_PRE.RETURN_TRACKING_NBR,
WM_OUTPT_LPN_PRE.XREF_OLPN,
WM_OUTPT_LPN_PRE.RETURN_REFERENCE_NUMBER,
WM_OUTPT_LPN_PRE.EPI_PACKAGE_ID,
WM_OUTPT_LPN_PRE.EPI_SHIPMENT_ID,
WM_OUTPT_LPN_PRE.REF_FIELD_2,
WM_OUTPT_LPN_PRE.REF_FIELD_3,
WM_OUTPT_LPN_PRE.REF_FIELD_4,
WM_OUTPT_LPN_PRE.REF_FIELD_5,
WM_OUTPT_LPN_PRE.REF_FIELD_6,
WM_OUTPT_LPN_PRE.REF_FIELD_7,
WM_OUTPT_LPN_PRE.REF_FIELD_8,
WM_OUTPT_LPN_PRE.REF_FIELD_9,
WM_OUTPT_LPN_PRE.REF_FIELD_10,
WM_OUTPT_LPN_PRE.REF_FIELD_1
FROM WM_OUTPT_LPN_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_OUTPT_LPN.LOCATION_ID,
WM_OUTPT_LPN.WM_OUTPT_LPN_ID,
WM_OUTPT_LPN.WM_CREATED_TSTMP,
WM_OUTPT_LPN.WM_LAST_UPDATED_TSTMP,
WM_OUTPT_LPN.LOAD_TSTMP
FROM WM_OUTPT_LPN
WHERE WM_OUTPT_LPN_ID IN (SELECT OUTPT_LPN_ID FROM WM_OUTPT_LPN_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
	...
	"decode ( ltrim ( rtrim ( upper ( FIL_UNCHANGED_RECORDS___ADF_TRANSMIT_FLAG ) ) ) , '1','1' , 'Y','1','0' ) as ADF_TRANSMIT_FLAG_EXP", \
	...
	"decode ( ltrim ( rtrim ( upper ( FIL_UNCHANGED_RECORDS___EPC_MATCH_FLAG ) ) ) , '1','1' , 'Y','1','0' ) as EPC_MATCH_FLAG_EXP", \
...
Shortcut_to_WM_OUTPT_LPN1 = UPD_INS_UPD.selectExpr( \
	...
	"CAST(LOAD_SEQUENCE AS BIGINT) as LOAD_SEQ", \
	...
	"CAST(LPN_NBR_X_OF_Y AS BIGINT) as WM_LPN_NBR_X_OF_Y", \
	...
	"CAST(ADF_TRANSMIT_FLAG AS BIGINT) as ADF_TRANSMIT_FLAG", \
	...
	"CAST(COD_PAYMENT_METHOD AS BIGINT) as WM_COD_PAYMENT_METHOD", \
...
Shortcut_to_WM_OUTPT_LPN1.write.saveAsTable(f'{raw}.WM_OUTPT_LPN')