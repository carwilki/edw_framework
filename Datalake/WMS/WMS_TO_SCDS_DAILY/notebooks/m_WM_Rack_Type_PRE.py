...
def m_WM_Rack_Type_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_RACK_TYPE_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(HT AS DECIMAL(13,4)) as HT",
        "CAST(WIDTH AS DECIMAL(13,4)) as WIDTH",
        "CAST(DEPTH AS DECIMAL(13,4)) as DEPTH",
        "CAST(RACK_CLASS AS BIGINT) as RACK_CLASS",
        "CAST(FIX_LABELS AS TINYINT) as FIX_LABELS",
        "CAST(LABEL_WID AS DECIMAL(13,4)) as LABEL_WID",
        "CAST(OVERLAP_DIST AS DECIMAL(13,4)) as OVERLAP_DIST",
        "CAST(MOVABLE_LABEL AS TINYINT) as MOVABLE_LABEL",
        "CAST(HN_CONSIDER AS TINYINT) as HN_CONSIDER",
        "CAST(CASE_HT_MAX AS DECIMAL(13,4)) as CASE_HT_MAX",
        "CAST(CASE_LEN_MAX AS DECIMAL(13,4)) as CASE_LEN_MAX",
        "CAST(CASE_WID_MAX AS DECIMAL(13,4)) as CASE_WID_MAX",
        "CAST(CASE_WT_MAX AS DECIMAL(13,4)) as CASE_WT_MAX",
        "CAST(CASE_CUBE_MAX AS DECIMAL(13,4)) as CASE_CUBE_MAX",
        "CAST(INNER_HT_MAX AS DECIMAL(13,4)) as INNER_HT_MAX",
        "CAST(INNER_LEN_MAX AS DECIMAL(13,4)) as INNER_LEN_MAX",
        "CAST(INNER_WID_MAX AS DECIMAL(13,4)) as INNER_WID_MAX",
        "CAST(INNER_WT_MAX AS DECIMAL(13,4)) as INNER_WT_MAX",
        "CAST(INNER_CUBE_MAX AS DECIMAL(13,4)) as INNER_CUBE_MAX",
        "CAST(EACH_HT_MAX AS DECIMAL(13,4)) as EACH_HT_MAX",
        "CAST(EACH_LEN_MAX AS DECIMAL(13,4)) as EACH_LEN_MAX",
        "CAST(EACH_WID_MAX AS DECIMAL(13,4)) as EACH_WID_MAX",
        "CAST(EACH_WT_MAX AS DECIMAL(13,4)) as EACH_WT_MAX",
        "CAST(EACH_CUBE_MAX AS DECIMAL(13,4)) as EACH_CUBE_MAX",
        "CAST(PALLET_INVEN_MAX AS DECIMAL(13,4)) as PALLET_INVEN_MAX",
        "CAST(PALLET_INVEN_MIN AS DECIMAL(13,4)) as PALLET_INVEN_MIN",
        "CAST(CASE_INVEN_MAX AS DECIMAL(13,4)) as CASE_INVEN_MAX",
        "CAST(CASE_INVEN_MIN AS DECIMAL(13,4)) as CASE_INVEN_MIN",
        "CAST(CASE_MOVE_MAX AS DECIMAL(13,4)) as CASE_MOVE_MAX",
        "CAST(CASE_MOVE_MIN AS DECIMAL(13,4)) as CASE_MOVE_MIN",
        "CAST(CUBE_MOVE_MAX AS DECIMAL(13,4)) as CUBE_MOVE_MAX",
        "CAST(CUBE_MOVE_MIN AS DECIMAL(13,4)) as CUBE_MOVE_MIN",
        "CAST(CASE_HITS_MAX AS DECIMAL(13,4)) as CASE_HITS_MAX",
        "CAST(CASE_HITS_MIN AS DECIMAL(13,4)) as CASE_HITS_MIN",
        "CAST(CUBE_HITS_MAX AS DECIMAL(13,4)) as CUBE_HITS_MAX",
        "CAST(CUBE_HITS_MIN AS DECIMAL(13,4)) as CUBE_HITS_MIN",
        "CAST(CASE_HT_MIN AS DECIMAL(13,4)) as CASE_HT_MIN",
        "CAST(CASE_LEN_MIN AS DECIMAL(13,4)) as CASE_LEN_MIN",
        "CAST(CASE_WID_MIN AS DECIMAL(13,4)) as CASE_WID_MIN",
        "CAST(CASE_WT_MIN AS DECIMAL(13,4)) as CASE_WT_MIN",
        "CAST(CASE_CUBE_MIN AS DECIMAL(13,4)) as CASE_CUBE_MIN",
        "CAST(INNER_HT_MIN AS DECIMAL(13,4)) as INNER_HT_MIN",
        "CAST(INNER_LEN_MIN AS DECIMAL(13,4)) as INNER_LEN_MIN",
        "CAST(INNER_WID_MIN AS DECIMAL(13,4)) as INNER_WID_MIN",
        "CAST(INNER_WT_MIN AS DECIMAL(13,4)) as INNER_WT_MIN",
        "CAST(INNER_CUBE_MIN AS DECIMAL(13,4)) as INNER_CUBE_MIN",
        "CAST(EACH_HT_MIN AS DECIMAL(13,4)) as EACH_HT_MIN",
        "CAST(EACH_LEN_MIN AS DECIMAL(13,4)) as EACH_LEN_MIN",
        "CAST(EACH_WID_MIN AS DECIMAL(13,4)) as EACH_WID_MIN",
        "CAST(EACH_WT_MIN AS DECIMAL(13,4)) as EACH_WT_MIN",
        "CAST(EACH_CUBE_MIN AS DECIMAL(13,4)) as EACH_CUBE_MIN",
        "CAST(CUBE_INVEN_MIN AS DECIMAL(13,4)) as CUBE_INVEN_MIN",
        "CAST(CUBE_INVEN_MAX AS DECIMAL(13,4)) as CUBE_INVEN_MAX",
        "CAST(WEEK_IN_SLOT AS DECIMAL(13,4)) as WEEK_IN_SLOT",
        "CAST(REF_LEVEL_ID AS BIGINT) as REF_LEVEL_ID",
        "CAST(VISC_MIN AS DECIMAL(13,4)) as VISC_MIN",
        "CAST(VISC_MAX AS DECIMAL(13,4)) as VISC_MAX",
        "CAST(FILL_PERCENT_MIN AS DECIMAL(5,2)) as FILL_PERCENT_MIN",
        "CAST(FILL_PERCENT_MAX AS DECIMAL(5,2)) as FILL_PERCENT_MAX",
        "CAST(UPRIGHT_THICKNESS AS DECIMAL(9,4)) as UPRIGHT_THICKNESS",
        ...
        "CAST(FUNCTION_TYPE AS SMALLINT) as FUNCTION_TYPE",
        "CAST(OVERSTOCK_CONSIDER AS TINYINT) as OVERSTOCK_CONSIDER",
        "CAST(USE_3D_SLOT AS TINYINT) as USE_3D_SLOT",
        "CAST(WEEKS_IN_SLOT_CONSTRAINT AS TINYINT) as WEEKS_IN_SLOT_CONSTRAINT",
        "CAST(NUM_OF_BAYS_AVAIL AS DECIMAL(13,4)) as NUM_OF_BAYS_AVAIL",
