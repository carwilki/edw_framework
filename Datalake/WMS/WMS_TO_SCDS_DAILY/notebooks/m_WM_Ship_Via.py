...
Shortcut_to_WM_SHIP_VIA = UPD_INS_UPD.selectExpr( 
	...
	"CAST(SHIP_VIA_ID AS BIGINT) as WM_SHIP_VIA_ID", 
	...
	"CAST(EXECUTION_LEVEL_ID AS BIGINT) as WM_EXECUTION_LEVEL_ID", 
	"CAST(MOT_ID AS BIGINT) as WM_MOT_ID", 
	"CAST(IS_TRACKING_NBR_REQ AS BIGINT) as TRACKING_NBR_REQ_FLAG", 
	...
	"CAST(INS_COVER_TYPE_ID AS BIGINT) as WM_INS_COVER_TYPE_ID", 
	"CAST(BILL_SHIP_VIA_ID AS BIGINT) as WM_BILL_SHIP_VIA_ID", 
	...
	"CAST(MIN_DECLARED_VALUE1 AS BIGINT) as MIN_DECLARED_VALUE", 
	"CAST(MAX_DECLARED_VALUE1 AS BIGINT) as MAX_DECLARED_VALUE", 
	"CAST(DECLARED_VALUE_CURRENCY1 AS STRING) as DECLARED_VALUE_CURRENCY", 
	"CAST(MARKED_FOR_DELETION1 AS BIGINT) as MARK_FOR_DELETION_FLAG", 
