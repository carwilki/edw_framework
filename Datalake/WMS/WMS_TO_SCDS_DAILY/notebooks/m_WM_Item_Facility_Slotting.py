...
Shortcut_to_WM_ITEM_FACILITY_SLOTTING1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(ITEM_FACILITY_MAPPING_ID1 AS BIGINT) as WM_ITEM_FACILITY_MAPPING_ID", 
	"CAST(ITEM_ID1 AS BIGINT) as WM_ITEM_ID", 
	...
	"CAST(AFRAME_HT1 AS BIGINT) as AFRAME_HT", 
	"CAST(AFRAME_LEN1 AS BIGINT) as AFRAME_LEN", 
	"CAST(AFRAME_WID1 AS BIGINT) as AFRAME_WID", 
	"CAST(AFRAME_WT1 AS BIGINT) as AFRAME_WT", 
	"CAST(AFRAME_ALLOW1 AS BIGINT) as AFRAME_ALLOW_FLAG", 
	"CAST(ALLOW_SLU1 AS BIGINT) as ALLOW_SLU", 
	"CAST(ALLOW_SU1 AS BIGINT) as ALLOW_SU", 
	"CAST(ALLOW_RESERVE1 AS BIGINT) as ALLOW_RESERVE", 
	"CAST(PALPAT_RESERVE1 AS BIGINT) as PALPAT_RESERVE", 
	"CAST(THREE_D_CALC_DONE1 AS BIGINT) as THREE_D_CALC_DONE", 
	...
	"CAST(HEIGHT_CAN_BORROW1 AS BIGINT) as HEIGHT_CAN_BORROW_FLAG", 
	"CAST(LENGTH_CAN_BORROW1 AS BIGINT) as LENGTH_CAN_BORROW_FLAG", 
	"CAST(WIDTH_CAN_BORROW1 AS BIGINT) as WIDTH_CAN_BORROW_FLAG", 
	"CAST(WEIGHT_CAN_BORROW1 AS BIGINT) as WEIGHT_CAN_BORROW_FLAG", 
	"CAST(VEND_PACK_CAN_BORROW1 AS BIGINT) as VEND_PACK_CAN_BORROW_FLAG", 
	"CAST(INNER_PACK_CAN_BORROW1 AS BIGINT) as INNER_PACK_CAN_BORROW_FLAG", 
	"CAST(TI_CAN_BORROW1 AS BIGINT) as TI_CAN_BORROW_FLAG", 
	"CAST(HI_CAN_BORROW1 AS BIGINT) as HI_CAN_BORROW_FLAG", 
	"CAST(QTY_PER_GRAB_CAN_BORROW1 AS BIGINT) as QTY_PER_GRAB_CAN_BORROW_FLAG", 
	"CAST(HAND_ATTR_CAN_BORROW1 AS BIGINT) as HAND_ATTR_CAN_BORROW_FLAG", 
	"CAST(FAM_GRP_CAN_BORROW1 AS BIGINT) as FAM_GRP_CAN_BORROW_FLAG", 
	"CAST(COMMODITY_CAN_BORROW1 AS BIGINT) as COMMODITY_CAN_BORROW_FLAG", 
	"CAST(CRUSHABILITY_CAN_BORROW1 AS BIGINT) as CRUSHABILITY_CAN_BORROW_FLAG", 
	"CAST(HAZARD_CAN_BORROW1 AS BIGINT) as HAZARD_CAN_BORROW_FLAG", 
	"CAST(VEND_CODE_CAN_BORROW1 AS BIGINT) as VEND_CODE_CAN_BORROW_FLAG", 
	"CAST(HEIGHT_BORROWED1 AS BIGINT) as HEIGHT_BORROWED_FLAG", 
	"CAST(LENGTH_BORROWED1 AS BIGINT) as LENGTH_BORROWED_FLAG", 
	"CAST(WIDTH_BORROWED1 AS BIGINT) as WIDTH_BORROWED_FLAG", 
	"CAST(WEIGHT_BORROWED1 AS BIGINT) as WEIGHT_BORROWED_FLAG", 
	"CAST(VEND_PACK_BORROWED1 AS BIGINT) as VEND_PACK_BORROWED_FLAG", 
	"CAST(INNER_PACK_BORROWED1 AS BIGINT) as INNER_PACK_BORROWED_FLAG", 
	"CAST(TI_BORROWED1 AS BIGINT) as TI_BORROWED_FLAG", 
	"CAST(HI_BORROWED1 AS BIGINT) as HI_BORROWED_FLAG", 
	"CAST(QTY_PER_GRAB_BORROWED1 AS BIGINT) as QTY_PER_GRAB_BORROWED_FLAG", 
	"CAST(HAND_ATTR_BORROWED1 AS BIGINT) as HAND_ATTR_BORROWED_FLAG", 
	"CAST(FAM_GRP_BORROWED1 AS BIGINT) as FAM_GRP_BORROWED_FLAG", 
	"CAST(COMMODITY_BORROWED1 AS BIGINT) as COMMODITY_BORROWED_FLAG", 
	"CAST(CRUSHABILITY_BORROWED1 AS BIGINT) as CRUSHABILITY_BORROWED_FLAG", 
	"CAST(HAZARD_BORROWED1 AS BIGINT) as HAZARD_BORROWED_FLAG", 
	"CAST(VEND_CODE_BORROWED1 AS BIGINT) as VEND_CODE_BORROWED_FLAG", 
	"CAST(ITEM_NUM_11 AS BIGINT) as ITEM_NUM_1", 
	"CAST(ITEM_NUM_21 AS BIGINT) as ITEM_NUM_2", 
	"CAST(ITEM_NUM_31 AS BIGINT) as ITEM_NUM_3", 
	"CAST(ITEM_NUM_41 AS BIGINT) as ITEM_NUM_4", 
	"CAST(ITEM_NUM_51 AS BIGINT) as ITEM_NUM_5", 
	...
	"CAST(MISC1_BORROWED1 AS BIGINT) as MISC_1_BORROWED_FLAG", 
	"CAST(MISC2_BORROWED1 AS BIGINT) as MISC_2_BORROWED_FLAG", 
	"CAST(MISC3_BORROWED1 AS BIGINT) as MISC_3_BORROWED_FLAG", 
	"CAST(MISC4_BORROWED1 AS BIGINT) as MISC_4_BORROWED_FLAG", 
	"CAST(MISC5_BORROWED1 AS BIGINT) as MISC_5_BORROWED_FLAG", 
	"CAST(MISC6_BORROWED1 AS BIGINT) as MISC_6_BORROWED_FLAG", 
	"CAST(MISC1_CAN_BORROW1 AS BIGINT) as MISC_1_CAN_BORROW_FLAG", 
	"CAST(MISC2_CAN_BORROW1 AS BIGINT) as MISC_2_CAN_BORROW_FLAG", 
	"CAST(MISC3_CAN_BORROW1 AS BIGINT) as MISC_3_CAN_BORROW_FLAG", 
	"CAST(MISC4_CAN_BORROW1 AS BIGINT) as MISC_4_CAN_BORROW_FLAG", 
	"CAST(MISC5_CAN_BORROW1 AS BIGINT) as MISC_5_CAN_BORROW_FLAG", 
	"CAST(MISC6_CAN_BORROW1 AS BIGINT) as MISC_6_CAN_BORROW_FLAG", 
	"CAST(DISCONT1 AS BIGINT) as DISCONTINUED_FLAG", 
	"CAST(MANUAL1 AS BIGINT) as MANUAL_FLAG", 
	"CAST(IS_NEW1 AS BIGINT) as NEW_FLAG", 
	"CAST(PROCESSED1 AS BIGINT) as PROCESSED_FLAG", 
