...
RTR_DELETE_DELETE = EXP_UPD_VALIDATOR.selectExpr( \
	...
	"EXP_UPD_VALIDATOR as o_UPD_VALIDATOR" ,\
      "sys_row_id as sysrow_id") \
...
Shortcut_to_WM_ITEM_FACILITY_SLOTTING1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(ITEM_FACILITY_MAPPING_ID1 AS DECIMAL(9,0)) as WM_ITEM_FACILITY_MAPPING_ID",
	"CAST(ITEM_ID1 AS DECIMAL(9,0)) as WM_ITEM_ID",
	...
	"CAST(UNIT_MEAS1 AS DECIMAL(10,0)) as UNIT_MEASURE",
	"CAST(EACH_PER_BIN1 AS DECIMAL(10,0)) as EACH_PER_BIN",
	"CAST(NUM_UNITS_PER_BIN1 AS DECIMAL(10,0)) as NBR_UNITS_PER_BIN",
	"CAST(INN_PER_CS1 AS DECIMAL(10,0)) as INN_PER_CS",
	"CAST(MAX_SLOTS1 AS DECIMAL(10,0)) as MAX_SLOTS",
	"CAST(MAX_PALLET_STACKING1 AS DECIMAL(10,0)) as MAX_PALLET_STACKING",
	"CAST(MAX_STACKING1 AS DECIMAL(10,0)) as MAX_STACKING",
	"CAST(MAX_LANES1 AS DECIMAL(10,0)) as MAX_LANES",
	"CAST(RESERVE_RACK_TYPE_ID1 AS DECIMAL(10,0)) as WM_RESERVE_RACK_TYPE_ID",
	...
	"CAST(AFRAME_ALLOW1 AS DECIMAL(1,0)) as AFRAME_ALLOW_FLAG",
	"CAST(ALLOW_SLU1 AS DECIMAL(10,0)) as ALLOW_SLU",
	"CAST(ALLOW_SU1 AS DECIMAL(10,0)) as ALLOW_SU",
	"CAST(ALLOW_RESERVE1 AS DECIMAL(10,0)) as ALLOW_RESERVE",
	"CAST(PALPAT_RESERVE1 AS DECIMAL(3,0)) as PALPAT_RESERVE",
	"CAST(THREE_D_CALC_DONE1 AS DECIMAL(1,0)) as THREE_D_CALC_DONE",
	"CAST(PROP_BORROWING_OBJECT1 AS DECIMAL(10,0)) as PROP_BORROWING_OBJECT",
	"CAST(PROP_BORROWING_SPECIFIC1 AS DECIMAL(19,0)) as PROP_BORROWING_SPECIFIC",
	"CAST(HEIGHT_CAN_BORROW1 AS DECIMAL(1,0)) as HEIGHT_CAN_BORROW_FLAG",
	"CAST(LENGTH_CAN_BORROW1 AS DECIMAL(1,0)) as LENGTH_CAN_BORROW_FLAG",
	"CAST(WIDTH_CAN_BORROW1 AS DECIMAL(1,0)) as WIDTH_CAN_BORROW_FLAG",
	"CAST(WEIGHT_CAN_BORROW1 AS DECIMAL(1,0)) as WEIGHT_CAN_BORROW_FLAG",
	"CAST(VEND_PACK_CAN_BORROW1 AS DECIMAL(1,0)) as VEND_PACK_CAN_BORROW_FLAG",
	"CAST(INNER_PACK_CAN_BORROW1 AS DECIMAL(1,0)) as INNER_PACK_CAN_BORROW_FLAG",
	"CAST(TI_CAN_BORROW1 AS DECIMAL(1,0)) as TI_CAN_BORROW_FLAG",
	"CAST(HI_CAN_BORROW1 AS DECIMAL(1,0)) as HI_CAN_BORROW_FLAG",
	"CAST(QTY_PER_GRAB_CAN_BORROW1 AS DECIMAL(1,0)) as QTY_PER_GRAB_CAN_BORROW_FLAG",
	"CAST(HAND_ATTR_CAN_BORROW1 AS DECIMAL(1,0)) as HAND_ATTR_CAN_BORROW_FLAG",
	"CAST(FAM_GRP_CAN_BORROW1 AS DECIMAL(1,0)) as FAM_GRP_CAN_BORROW_FLAG",
	"CAST(COMMODITY_CAN_BORROW1 AS DECIMAL(1,0)) as COMMODITY_CAN_BORROW_FLAG",
	"CAST(CRUSHABILITY_CAN_BORROW1 AS DECIMAL(1,0)) as CRUSHABILITY_CAN_BORROW_FLAG",
	"CAST(HAZARD_CAN_BORROW1 AS DECIMAL(1,0)) as HAZARD_CAN_BORROW_FLAG",
	"CAST(VEND_CODE_CAN_BORROW1 AS DECIMAL(1,0)) as VEND_CODE_CAN_BORROW_FLAG",
	"CAST(HEIGHT_BORROWED1 AS DECIMAL(1,0)) as HEIGHT_BORROWED_FLAG",
	"CAST(LENGTH_BORROWED1 AS DECIMAL(1,0)) as LENGTH_BORROWED_FLAG",
	"CAST(WIDTH_BORROWED1 AS DECIMAL(1,0)) as WIDTH_BORROWED_FLAG",
	"CAST(WEIGHT_BORROWED1 AS DECIMAL(1,0)) as WEIGHT_BORROWED_FLAG",
	"CAST(VEND_PACK_BORROWED1 AS DECIMAL(1,0)) as VEND_PACK_BORROWED_FLAG",
	"CAST(INNER_PACK_BORROWED1 AS DECIMAL(1,0)) as INNER_PACK_BORROWED_FLAG",
	"CAST(TI_BORROWED1 AS DECIMAL(1,0)) as TI_BORROWED_FLAG",
	"CAST(HI_BORROWED1 AS DECIMAL(1,0)) as HI_BORROWED_FLAG",
	"CAST(QTY_PER_GRAB_BORROWED1 AS DECIMAL(1,0)) as QTY_PER_GRAB_BORROWED_FLAG",
	"CAST(HAND_ATTR_BORROWED1 AS DECIMAL(1,0)) as HAND_ATTR_BORROWED_FLAG",
	"CAST(FAM_GRP_BORROWED1 AS DECIMAL(1,0)) as FAM_GRP_BORROWED_FLAG",
	"CAST(COMMODITY_BORROWED1 AS DECIMAL(1,0)) as COMMODITY_BORROWED_FLAG",
	"CAST(CRUSHABILITY_BORROWED1 AS DECIMAL(1,0)) as CRUSHABILITY_BORROWED_FLAG",
	"CAST(HAZARD_BORROWED1 AS DECIMAL(1,0)) as HAZARD_BORROWED_FLAG",
	"CAST(VEND_CODE_BORROWED1 AS DECIMAL(1,0)) as VEND_CODE_BORROWED_FLAG",
	...
	"CAST(RESERVED_31 AS DECIMAL(10,0)) as RESERVED_3",
	"CAST(RESERVED_41 AS DECIMAL(10,0)) as RESERVED_4",
	"CAST(MISC1_BORROWED1 AS DECIMAL(1,0)) as MISC_1_BORROWED_FLAG",
	"CAST(MISC2_BORROWED1 AS DECIMAL(1,0)) as MISC_2_BORROWED_FLAG",
	"CAST(MISC3_BORROWED1 AS DECIMAL(1,0)) as MISC_3_BORROWED_FLAG",
	"CAST(MISC4_BORROWED1 AS DECIMAL(1,0)) as MISC_4_BORROWED_FLAG",
	"CAST(MISC5_BORROWED1 AS DECIMAL(1,0)) as MISC_5_BORROWED_FLAG",
	"CAST(MISC6_BORROWED1 AS DECIMAL(1,0)) as MISC_6_BORROWED_FLAG",
	"CAST(MISC1_CAN_BORROW1 AS DECIMAL(1,0)) as MISC_1_CAN_BORROW_FLAG",
	"CAST(MISC2_CAN_BORROW1 AS DECIMAL(1,0)) as MISC_2_CAN_BORROW_FLAG",
	"CAST(MISC3_CAN_BORROW1 AS DECIMAL(1,0)) as MISC_3_CAN_BORROW_FLAG",
	"CAST(MISC4_CAN_BORROW1 AS DECIMAL(1,0)) as MISC_4_CAN_BORROW_FLAG",
	"CAST(MISC5_CAN_BORROW1 AS DECIMAL(1,0)) as MISC_5_CAN_BORROW_FLAG",
	"CAST(MISC6_CAN_BORROW1 AS DECIMAL(1,0)) as MISC_6_CAN_BORROW_FLAG",
	"CAST(DISCONT1 AS DECIMAL(1,0)) as DISCONTINUED_FLAG",
	"CAST(MANUAL1 AS DECIMAL(1,0)) as MANUAL_FLAG",
	"CAST(IS_NEW1 AS DECIMAL(1,0)) as NEW_FLAG",
	"CAST(PROCESSED1 AS DECIMAL(1,0)) as PROCESSED_FLAG",
