...
Shortcut_to_WM_ITEM_FACILITY_SLOTTING2.createOrReplaceTempView('WM_ITEM_FACILITY_SLOTTING_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_ITEM_FACILITY_SLOTTING_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_ITEM_FACILITY_MAPPING_ID = trg.WM_ITEM_FACILITY_MAPPING_ID )
