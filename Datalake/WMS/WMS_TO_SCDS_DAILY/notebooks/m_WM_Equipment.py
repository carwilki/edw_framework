...
Shortcut_to_WM_EQUIPMENT1 = UPS_INS_UPD.selectExpr( 
	...
	"CAST(EQUIPMENT_TYPE AS BIGINT) as WM_EQUIPMENT_TYPE_ID", 
	"CAST(SHAPE_TYPE AS BIGINT) as WM_SHAPE_TYPE", 
	"CAST(TRAILER_TYPE AS BIGINT) as WM_TRAILER_TYPE_ID", 
	"CAST(OWNERSHIP_TYPE AS BIGINT) as WM_OWNERSHIP_TYPE_ID", 
	"CAST(TAX_BAND_NAME AS STRING) as TAX_BAND_NAME", 
	"CAST(BACKIN_TIME AS BIGINT) as BACK_IN_TIME", 
	"CAST(BACKOUT_TIME AS BIGINT) as BACK_OUT_TIME", 
	...
	"CAST(IS_ALLOW_TRAILER_SWAPPING AS BIGINT) as ALLOW_TRAILER_SWAPPING_FLAG", 
	"CAST(IS_TANDEM_CAPABLE AS BIGINT) as TANDEM_CAPABLE_FLAG", 
	"CAST(VOLUME_CALC_VALUE AS BIGINT) as WM_VOLUME_CALC_VALUE", 
	"CAST(VOLUME_CALC_STANDARD_UOM AS BIGINT) as WM_VOLUME_CALC_STANDARD_UOM_ID", 
	"CAST(WEIGHT_EMPTY_VALUE AS BIGINT) as WM_WEIGHT_EMPTY_VALUE", 
	"CAST(WEIGHT_EMPTY_STANDARD_UOM AS BIGINT) as WM_WEIGHT_EMPTY_STANDARD_UOM_ID", 
	"CAST(WEIGHT_EMPTY_SIZE_UOM_ID AS BIGINT) as WM_WEIGHT_EMPTY_SIZE_UOM_ID", 
	"CAST(PLATED_WEIGHT AS BIGINT) as WM_PLATED_WEIGHT", 
	"CAST(PLATED_WEIGHT_SIZE_UOM_ID AS BIGINT) as WM_PLATED_WEIGHT_SIZE_UOM_ID", 
	"CAST(WEIGHT_VALUE AS BIGINT) as WM_WEIGHT_VALUE", 
	"CAST(WEIGHT_STANDARD_UOM AS BIGINT) as WM_WEIGHT_STANDARD_UOM_ID", 
	"CAST(EQUIP_DW_HEIGHT_VALUE AS BIGINT) as WM_EQUIP_DW_HEIGHT_VALUE", 
	"CAST(EQUIP_DW_HEIGHT_STANDARD_UOM AS BIGINT) as WM_EQUIP_DW_HEIGHT_STANDARD_UOM_ID", 
	"CAST(EQUIP_HEIGHT_VALUE AS BIGINT) as WM_EQUIP_HEIGHT_VALUE", 
	"CAST(EQUIP_HEIGHT_STANDARD_UOM AS BIGINT) as WM_EQUIP_HEIGHT_STANDARD_UOM_ID", 
	"CAST(FLOOR_SPACE_VALUE AS BIGINT) as WM_FLOOR_SPACE_VALUE", 
	"CAST(FLOOR_SPACE_SIZE_UOM_ID AS BIGINT) as WM_FLOOR_SPACE_SIZE_UOM_ID", 
	"CAST(DIM01_VALUE AS BIGINT) as WM_DIM_01_VALUE", 
	"CAST(DIM01_STANDARD_UOM AS BIGINT) as WM_DIM_01_STANDARD_UOM_ID", 
	"CAST(DIM02_VALUE AS BIGINT) as WM_DIM_02_VALUE", 
	"CAST(DIM02_STANDARD_UOM AS BIGINT) as WM_DIM_02_STANDARD_UOM_ID", 
	"CAST(DIM03_VALUE AS BIGINT) as WM_DIM_03_VALUE", 
	"CAST(DIM03_STANDARD_UOM AS BIGINT) as WM_DIM_03_STANDARD_UOM_ID", 
