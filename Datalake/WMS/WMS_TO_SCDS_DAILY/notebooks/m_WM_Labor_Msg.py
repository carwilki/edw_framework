...
Shortcut_to_WM_LABOR_MSG1 = UPD_VALIDATE.selectExpr(
	...
	"CAST(STATUS AS INT) as WM_LABOR_MSG_STATUS",
	"CAST(MSG_STAT_CODE AS SMALLINT) as WM_MSG_STAT_CD",
	...
	"CAST(MONITOR_SMRY_ID AS INT) as WM_MONITOR_SMRY_ID",
	"CAST(HAS_MONITOR_MSG AS TINYINT) as HAS_MONITOR_MSG_FLAG",
	"CAST(RESEND_TRAN_EXP AS STRING) as RESEND_TRAN_FLAG",
	"CAST(REQ_SAM_REPLY_EXP AS STRING) as REQ_SAM_REPLY_FLAG",
	"CAST(CONFLICT_FLAG_EXP AS TINYINT) as CONFLICT_FLAG",
