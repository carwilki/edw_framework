...
Shortcut_to_WM_LABOR_MSG1 = UPD_VALIDATE.selectExpr( 
	...
	"CAST(STATUS AS BIGINT) as WM_LABOR_MSG_STATUS", 
	"CAST(MSG_STAT_CODE AS BIGINT) as WM_MSG_STAT_CD", 
	...
	"CAST(TRAN_DATA_ELS_TRAN_ID AS BIGINT) as WM_TRAN_DATA_ELS_TRAN_ID", 
	...
	"CAST(MONITOR_SMRY_ID AS BIGINT) as WM_MONITOR_SMRY_ID", 
	"CAST(HAS_MONITOR_MSG AS BIGINT) as HAS_MONITOR_MSG_FLAG", 
	"CAST(RESEND_TRAN_EXP AS STRING) as RESEND_TRAN_FLAG", 
	"CAST(REQ_SAM_REPLY_EXP AS STRING) as REQ_SAM_REPLY_FLAG", 
	"CAST(CONFLICT_FLAG_EXP AS BIGINT) as CONFLICT_FLAG", 
	...
	"CAST(ADJ_REF_TRAN_NBR AS BIGINT) as WM_ADJ_REF_TRAN_NBR", 
