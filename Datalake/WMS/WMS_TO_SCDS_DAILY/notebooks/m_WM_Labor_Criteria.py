...
WM_LABOR_CRITERIA_PRE.DC_NBR,
WM_LABOR_CRITERIA_PRE.CRIT_ID,
WM_LABOR_CRITERIA_PRE.CRIT_CODE,
WM_LABOR_CRITERIA_PRE.DESCRIPTION,
WM_LABOR_CRITERIA_PRE.RULE_FILTER,
WM_LABOR_CRITERIA_PRE.DATA_TYPE,
WM_LABOR_CRITERIA_PRE.DATA_SIZE,
WM_LABOR_CRITERIA_PRE.HIBERNATE_VERSION,
WM_LABOR_CRITERIA_PRE.CREATED_SOURCE_TYPE,
WM_LABOR_CRITERIA_PRE.CREATED_SOURCE,
WM_LABOR_CRITERIA_PRE.CREATED_DTTM,
WM_LABOR_CRITERIA_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_LABOR_CRITERIA_PRE.LAST_UPDATED_SOURCE,
...
WM_LABOR_CRITERIA.LOCATION_ID,
WM_LABOR_CRITERIA.WM_CRIT_ID,
WM_LABOR_CRITERIA.WM_CRIT_CD,
WM_LABOR_CRITERIA.WM_CRIT_DESC,
WM_LABOR_CRITERIA.RULE_FILTER_FLAG,
WM_LABOR_CRITERIA.DATA_TYPE,
WM_LABOR_CRITERIA.DATA_SIZE,
WM_LABOR_CRITERIA.WM_COMPANY_ID,
WM_LABOR_CRITERIA.WM_HIBERNATE_VERSION,
WM_LABOR_CRITERIA.WM_CREATED_SOURCE_TYPE,
WM_LABOR_CRITERIA.WM_CREATED_SOURCE,
WM_LABOR_CRITERIA.WM_CREATED_TSTMP,
WM_LABOR_CRITERIA.WM_LAST_UPDATED_SOURCE_TYPE,
WM_LABOR_CRITERIA.WM_LAST_UPDATED_SOURCE,
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_REC_temp.selectExpr( \
	...
	"FIL_UNCHANGED_REC___RULE_FILTER as RULE_FILTER", \
	...
	"FIL_UNCHANGED_REC___DELETE_FLAG as in_DELETE_FLAG", \
	"FIL_UNCHANGED_REC___in_LOAD_TSTMP as in_LOAD_TSTMP").selectExpr( \
	"FIL_UNCHANGED_REC___sys_row_id as sys_row_id", \
	"FIL_UNCHANGED_REC___LOCATION_ID as LOCATION_ID", \
	"FIL_UNCHANGED_REC___CRIT_ID as CRIT_ID", \
	"FIL_UNCHANGED_REC___CRIT_CODE as CRIT_CODE", \
	"FIL_UNCHANGED_REC___DESCRIPTION as DESCRIPTION", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_REC___RULE_FILTER ) ) ) , 'Y','1' , '1','1','0' ) as o_RULE_FILTER", \
	"FIL_UNCHANGED_REC___DATA_TYPE as DATA_TYPE", \
	"FIL_UNCHANGED_REC___DATA_SIZE as DATA_SIZE", \
	"FIL_UNCHANGED_REC___HIBERNATE_VERSION as HIBERNATE_VERSION", \
	"FIL_UNCHANGED_REC___CREATED_SOURCE_TYPE as CREATED_SOURCE_TYPE", \
...
RTR_DELETE_DELETE = EXP_UPD_VALIDATOR.selectExpr( \
	...
	"EXP_UPD_VALIDATOR.CRIT_ID as CRIT_ID", \
	"EXP_UPD_VALIDATOR.CRIT_CODE as CRIT_CODE", \
	"EXP_UPD_VALIDATOR.DESCRIPTION as DESCRIPTION", \
	"EXP_UPD_VALIDATOR.o_RULE_FILTER as RULE_FILTER", \
	"EXP_UPD_VALIDATOR.DATA_TYPE as DATA_TYPE", \
	"EXP_UPD_VALIDATOR.DATA_SIZE as DATA_SIZE", \
	"EXP_UPD_VALIDATOR.HIBERNATE_VERSION as HIBERNATE_VERSION", \
	"EXP_UPD_VALIDATOR.CREATED_SOURCE_TYPE as CREATED_SOURCE_TYPE", \
	"EXP_UPD_VALIDATOR.CREATED_SOURCE as CREATED_SOURCE", \
	"EXP_UPD_VALIDATOR.CREATED_DTTM as CREATED_DTTM", \
	"EXP_UPD_VALIDATOR.LAST_UPDATED_SOURCE_TYPE as LAST_UPDATED_SOURCE_TYPE", \
	...
	"EXP_UPD_VALIDATOR.WM_CRIT_ID as WM_CRIT_ID", \
	"EXP_UPD_VALIDATOR.WM_CRIT_CD as WM_CRIT_CD", \
	"EXP_UPD_VALIDATOR.WM_CRIT_DESC as WM_CRIT_DESC", \
	"EXP_UPD_VALIDATOR.RULE_FILTER_FLAG as RULE_FILTER_FLAG", \
	"EXP_UPD_VALIDATOR.in_DATA_TYPE as in_DATA_TYPE", \
	"EXP_UPD_VALIDATOR.in_DATA_SIZE as in_DATA_SIZE", \
	"EXP_UPD_VALIDATOR.WM_COMPANY_ID as WM_COMPANY_ID", \
	"EXP_UPD_VALIDATOR.WM_HIBERNATE_VERSION as WM_HIBERNATE_VERSION", \
	"EXP_UPD_VALIDATOR.WM_CREATED_SOURCE_TYPE as WM_CREATED_SOURCE_TYPE", \
	"EXP_UPD_VALIDATOR.WM_CREATED_SOURCE as WM_CREATED_SOURCE", \
	"EXP_UPD_VALIDATOR.WM_CREATED_TSTMP as WM_CREATED_TSTMP", \
	"EXP_UPD_VALIDATOR.WM_LAST_UPDATED_SOURCE_TYPE as WM_LAST_UPDATED_SOURCE_TYPE", \
	"EXP_UPD_VALIDATOR.WM_LAST_UPDATED_SOURCE as WM_LAST_UPDATED_SOURCE", \
