...
RTR_DELETE_INSERT_UPDATE = EXP_UPD_VALIDATOR.selectExpr( \
	...
	"EXP_UPD_VALIDATOR.LOAD_TSTMP as LOAD_TSTMP", \
	"EXP_UPD_VALIDATOR.DELETE_FLAG as DELETE_FLAG", \
	"EXP_UPD_VALIDATOR.o_UPDATE_VALIDATOR as o_UPD_VALIDATOR",\
      "sys_row_id as sys_row_id") \
	.withColumn('in_DELETE_FLAG', lit(None)) \
	.withColumn('in_LOAD_TSTMP', lit(None)) \
	.select(col('sys_row_id'), \
...
Shortcut_to_WM_LABOR_CRITERIA1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(CRIT_ID1 AS DECIMAL(9,0)) as WM_CRIT_ID",
	"CAST(CRIT_CODE1 AS STRING) as WM_CRIT_CD",
	"CAST(DESCRIPTION1 AS STRING) as WM_CRIT_DESC",
	"CAST(RULE_FILTER1 AS DECIMAL(1,0)) as RULE_FILTER_FLAG",
	"CAST(DATA_TYPE1 AS STRING) as DATA_TYPE",
	"CAST(DATA_SIZE1 AS DECIMAL(9,0)) as DATA_SIZE",
	...
	"CAST(LAST_UPDATED_SOURCE_TYPE1 AS DECIMAL(2,0)) as WM_LAST_UPDATED_SOURCE_TYPE",
