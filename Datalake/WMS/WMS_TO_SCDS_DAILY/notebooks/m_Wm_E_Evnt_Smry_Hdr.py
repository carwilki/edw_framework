...
Shortcut_to_WM_E_EVNT_SMRY_HDR11 = UPD_INS_UPD_DEL.selectExpr( 
	...
	"CAST(TEAM_STD_SMRY_ID1 AS BIGINT) as WM_TEAM_STD_SMRY_ID", 
	"CAST(TEAM_CODE1 AS STRING) as WM_TEAM_CD", 
	"CAST(TEAM_BEGIN_TIME1 AS TIMESTAMP) as TEAM_BEGIN_TSTMP", 
	"CAST(PROC_ZONE_ID1 AS BIGINT) as WM_PROC_ZONE_ID", 
	...
	"CAST(TEAM_CHG_ID1 AS BIGINT) as WM_TEAM_CHG_ID", 
	"CAST(VHCL_TYPE1 AS STRING) as VHCL_TYPE", 
	"CAST(CONSOL_EVNT_TIME1 AS BIGINT) as CONSOL_EVNT_TIME", 
	"CAST(ACTL_TIME1 AS BIGINT) as ACTL_TIME", 
	"CAST(STD_TIME_ALLOW1 AS BIGINT) as STD_TIME_ALLOW", 
	"CAST(EMP_PERF_ALLOW1 AS BIGINT) as EMP_PERF_ALLOW", 
	"CAST(PERF_ADJ_AMT1 AS BIGINT) as PERF_ADJ_AMT", 
	"CAST(SCHED_ADJ_AMT1 AS BIGINT) as SCHED_ADJ_AMT", 
	"CAST(SCHED_UNITS_QTY1 AS BIGINT) as SCHED_UNITS_QTY", 
	"CAST(TMU_RECALC_COUNT1 AS BIGINT) as TMU_RECALC_CNT", 
	"CAST(TOTAL_WEIGHT1 AS BIGINT) as TOTAL_WEIGHT", 
	"CAST(PAID_BRK_OVERLAP1 AS BIGINT) as PAID_BRK_OVERLAP", 
	"CAST(UNPAID_BRK_OVERLAP1 AS BIGINT) as UNPAID_BRK_OVERLAP", 
	"CAST(THRUPUT_GOAL1 AS BIGINT) as THRUPUT_GOAL", 
	"CAST(THRUPUT_MIN1 AS BIGINT) as THRUPUT_MIN", 
	"CAST(DISPLAY_UOM1 AS STRING) as DISPLAY_UOM", 
	"CAST(DISPLAY_UOM_QTY1 AS BIGINT) as DISPLAY_UOM_QTY", 
	"CAST(UNIT_MIN1 AS BIGINT) as UNIT_MIN", 
	"CAST(ERROR_CNT1 AS BIGINT) as ERROR_CNT", 
