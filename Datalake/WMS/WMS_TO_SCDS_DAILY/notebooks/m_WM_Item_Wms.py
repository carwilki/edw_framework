...
Shortcut_to_WM_ITEM_WMS1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(SLOTTING_OPT_STAT_CODE AS BIGINT) as WM_SLOTTING_OPT_STAT_CD", 
	...
	"CAST(PROMPT_FOR_VENDOR_ITEM_NBR AS BIGINT) as PROMPT_FOR_VENDOR_ITEM_NBR_FLAG", 
	"CAST(PROMPT_PACK_QTY AS BIGINT) as PROMPT_PACK_QTY_FLAG", 
	"CAST(CONVEY_FLAG AS BIGINT) as CONVEY_FLAG", 
	"CAST(MINOR_SRL_NBR_REQ AS BIGINT) as MINOR_SRL_NBR_REQ_FLAG", 
	"CAST(DUP_SRL_NBR_FLAG AS BIGINT) as DUP_SRL_NBR_FLAG", 
	"CAST(ALLOW_RCPT_OLDER_ITEM AS BIGINT) as ALLOW_RCPT_OLDER_ITEM_FLAG", 
	"CAST(BASE_INCUB_FLAG AS BIGINT) as BASE_INCUB_FLAG", 
	"CAST(CODE_DATE_PROMPT_METHOD_FLAG AS STRING) as CD_DT_PROMPT_METHOD_FLAG", 
	"CAST(TOP_SHELF_ELIGIBLE AS BIGINT) as TOP_SHELF_ELIGIBLE_FLAG", 
	"CAST(PREF_CRITERIA_FLAG AS STRING) as PREF_CRITERIA_FLAG", 
	"CAST(PRODUCER_FLAG AS STRING) as PRODUCER_FLAG", 
	"CAST(SRL_NBR_REQD AS BIGINT) as SRL_NBR_REQD_FLAG", 
	"CAST(MFG_DATE_REQD AS BIGINT) as MFG_DATE_REQD_FLAG", 
	"CAST(XPIRE_DATE_REQD AS BIGINT) as XPIRE_DATE_REQD_FLAG", 
	"CAST(SHIP_BY_DATE_REQD AS BIGINT) as SHIP_BY_DATE_REQD_FLAG", 
	"CAST(ITEM_ATTR_REQD AS BIGINT) as ITEM_ATTR_REQD_FLAG", 
	"CAST(BATCH_REQD AS BIGINT) as BATCH_REQD_FLAG", 
	"CAST(PROD_STAT_REQD AS BIGINT) as PROD_STAT_REQD_FLAG", 
	"CAST(CNTRY_OF_ORGN_REQD AS BIGINT) as COUNTRY_OF_ORIGIN_REQD_FLAG", 
	"CAST(NET_COST_FLAG AS STRING) as NET_COST_FLAG", 
	"CAST(PRICE_TIX_AVAIL AS BIGINT) as PRICE_TIX_AVAIL_FLAG", 
	"CAST(UNIT_PRICE AS BIGINT) as WM_UNIT_PRICE", 
	"CAST(RETAIL_PRICE AS BIGINT) as WM_RETAIL_PRICE", 
	...
	"CAST(MV_SIZE_UOM AS BIGINT) as WM_MV_SIZE_UOM_ID", 
	"CAST(HNDL_ATTR_ACT_UOM_ID AS BIGINT) as WM_HNDL_ATTR_ACT_UOM_ID", 
	"CAST(HNDL_ATTR_CASE_PICK_UOM_ID AS BIGINT) as WM_HNDL_ATTR_CASE_PICK_UOM_ID", 
