...
FIL_UNCHANGED_REC = JNR_WM_ITEM_WMS_temp.selectExpr( \
    ...
    .filter("in_WM_ITEM_ID is Null OR ( in_WM_ITEM_ID is NOT Null AND \
...
Shortcut_to_WM_ITEM_WMS1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(VENDOR_MASTER_ID AS INT) as WM_VENDOR_MASTER_ID",
	...
	"CAST(SLOTTING_OPT_STAT_CODE AS SMALLINT) as WM_SLOTTING_OPT_STAT_CD",
	...
	"CAST(PROMPT_FOR_VENDOR_ITEM_NBR AS TINYINT) as PROMPT_FOR_VENDOR_ITEM_NBR_FLAG",
	"CAST(PROMPT_PACK_QTY AS TINYINT) as PROMPT_PACK_QTY_FLAG",
	"CAST(CONVEY_FLAG AS TINYINT) as CONVEY_FLAG",
	"CAST(MINOR_SRL_NBR_REQ AS TINYINT) as MINOR_SRL_NBR_REQ_FLAG",
	"CAST(DUP_SRL_NBR_FLAG AS TINYINT) as DUP_SRL_NBR_FLAG",
	"CAST(ALLOW_RCPT_OLDER_ITEM AS TINYINT) as ALLOW_RCPT_OLDER_ITEM_FLAG",
	"CAST(BASE_INCUB_FLAG AS TINYINT) as BASE_INCUB_FLAG",
	"CAST(CODE_DATE_PROMPT_METHOD_FLAG AS STRING) as CD_DT_PROMPT_METHOD_FLAG",
	"CAST(TOP_SHELF_ELIGIBLE AS TINYINT) as TOP_SHELF_ELIGIBLE_FLAG",
	"CAST(PREF_CRITERIA_FLAG AS STRING) as PREF_CRITERIA_FLAG",
	"CAST(PRODUCER_FLAG AS STRING) as PRODUCER_FLAG",
	"CAST(SRL_NBR_REQD AS TINYINT) as SRL_NBR_REQD_FLAG",
	"CAST(MFG_DATE_REQD AS TINYINT) as MFG_DATE_REQD_FLAG",
	"CAST(XPIRE_DATE_REQD AS TINYINT) as XPIRE_DATE_REQD_FLAG",
	"CAST(SHIP_BY_DATE_REQD AS TINYINT) as SHIP_BY_DATE_REQD_FLAG",
	"CAST(ITEM_ATTR_REQD AS TINYINT) as ITEM_ATTR_REQD_FLAG",
	"CAST(BATCH_REQD AS TINYINT) as BATCH_REQD_FLAG",
	"CAST(PROD_STAT_REQD AS TINYINT) as PROD_STAT_REQD_FLAG",
	"CAST(CNTRY_OF_ORGN_REQD AS TINYINT) as COUNTRY_OF_ORIGIN_REQD_FLAG",
	...
	"CAST(MV_SIZE_UOM AS INT) as WM_MV_SIZE_UOM_ID",
	"CAST(HNDL_ATTR_ACT_UOM_ID AS INT) as WM_HNDL_ATTR_ACT_UOM_ID",
	"CAST(HNDL_ATTR_CASE_PICK_UOM_ID AS INT) as WM_HNDL_ATTR_CASE_PICK_UOM_ID",
