...
Shortcut_to_WM_ILM_YARD_ACTIVITY = UPD_INS_UPD.selectExpr( 
	...
	"CAST(ACTIVITY_ID AS BIGINT) as WM_ACTIVITY_ID", 
	...
	"CAST(LOCATION_ID AS BIGINT) as WM_LOCATION_ID", 
	"CAST(ACTIVITY_TYPE AS BIGINT) as WM_ACTIVITY_TYPE_ID", 
	...
	"CAST(EQUIPMENT_ID1 AS BIGINT) as WM_EQUIPMENT_ID_1", 
	"CAST(EQUIPMENT_ID2 AS BIGINT) as WM_EQUIPMENT_ID_2", 
	"CAST(EQUIP_INS_STATUS AS BIGINT) as WM_EQUIP_INS_STATUS_ID", 
