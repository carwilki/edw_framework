...
FROM WM_ILM_YARD_ACTIVITY
WHERE WM_ACTIVITY_ID IN ( SELECT ACTIVITY_ID FROM WM_ILM_YARD_ACTIVITY_PRE )""").withColumn("sys_row_id", monotonically_increasing_id())
...
FROM WM_ILM_YARD_ACTIVITY_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
