...
Shortcut_to_WM_LABOR_MSG_CRIT1 = UPD_VALIDATE.selectExpr(
	...
	"CAST(LABOR_MSG_CRIT_ID AS DECIMAL(20,0)) as WM_LABOR_MSG_CRIT_ID",
	...
	"CAST(CRIT_SEQ_NBR AS DECIMAL(9,0)) as CRIT_SEQ_NBR",
	...
	"CAST(LAST_UPDATED_SOURCE_TYPE AS DECIMAL(4,0)) as LAST_UPDATED_SOURCE_TYPE",
