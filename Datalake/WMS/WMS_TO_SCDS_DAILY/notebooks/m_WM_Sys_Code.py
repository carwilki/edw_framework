...
Shortcut_to_WM_SYS_CODE1.createOrReplaceTempView('WM_SYS_CODE_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_SYS_CODE_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_REC_TYPE = trg.WM_REC_TYPE AND src.WM_CD_TYPE = trg.WM_CD_TYPE AND src.WM_CD_ID = trg.WM_CD_ID )
