...
WM_E_LABOR_TYPE_CODE_PRE.DC_NBR,
WM_E_LABOR_TYPE_CODE_PRE.LABOR_TYPE_ID,
WM_E_LABOR_TYPE_CODE_PRE.LABOR_TYPE_CODE,
WM_E_LABOR_TYPE_CODE_PRE.DESCRIPTION,
WM_E_LABOR_TYPE_CODE_PRE.USER_ID,
WM_E_LABOR_TYPE_CODE_PRE.CREATE_DATE_TIME,
WM_E_LABOR_TYPE_CODE_PRE.MOD_DATE_TIME,
WM_E_LABOR_TYPE_CODE_PRE.MISC_TXT_1,
WM_E_LABOR_TYPE_CODE_PRE.MISC_TXT_2,
WM_E_LABOR_TYPE_CODE_PRE.MISC_NUM_1,
WM_E_LABOR_TYPE_CODE_PRE.MISC_NUM_2,
WM_E_LABOR_TYPE_CODE_PRE.VERSION_ID,
WM_E_LABOR_TYPE_CODE_PRE.SPVSR_AUTH_REQUIRED,
WM_E_LABOR_TYPE_CODE_PRE.CREATED_DTTM,
WM_E_LABOR_TYPE_CODE_PRE.LAST_UPDATED_DTTM
FROM WM_E_LABOR_TYPE_CODE_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_E_LABOR_TYPE_CODE.LOCATION_ID,
WM_E_LABOR_TYPE_CODE.WM_LABOR_TYPE_ID,
WM_E_LABOR_TYPE_CODE.WM_LABOR_TYPE_CD,
WM_E_LABOR_TYPE_CODE.WM_LABOR_TYPE_DESC,
WM_E_LABOR_TYPE_CODE.SPVSR_AUTH_REQUIRED_FLAG,
WM_E_LABOR_TYPE_CODE.MISC_TXT_1,
WM_E_LABOR_TYPE_CODE.MISC_TXT_2,
WM_E_LABOR_TYPE_CODE.MISC_NUM_1,
WM_E_LABOR_TYPE_CODE.MISC_NUM_2,
WM_E_LABOR_TYPE_CODE.WM_USER_ID,
WM_E_LABOR_TYPE_CODE.WM_VERSION_ID,
WM_E_LABOR_TYPE_CODE.WM_CREATE_TSTMP,
WM_E_LABOR_TYPE_CODE.WM_MOD_TSTMP,
WM_E_LABOR_TYPE_CODE.WM_CREATED_TSTMP,
WM_E_LABOR_TYPE_CODE.WM_LAST_UPDATED_TSTMP,
WM_E_LABOR_TYPE_CODE.DELETE_FLAG,
WM_E_LABOR_TYPE_CODE.LOAD_TSTMP
FROM WM_E_LABOR_TYPE_CODE
...
EXP_OUTPUT_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___SPVSR_AUTH_REQUIRED ) ) ) , 'Y','1' , '1','1','0' ) as o_SPVSR_AUTH_REQUIRED", \
	...
	"IF (FIL_UNCHANGED_RECORDS___LABOR_TYPE_ID IS NOT NULL AND FIL_UNCHANGED_RECORDS___i_WM_LABOR_TYPE_ID IS NULL, 'INSERT', IF (FIL_UNCHANGED_RECORDS___LABOR_TYPE_ID IS NULL AND FIL_UNCHANGED_RECORDS___i_WM_LABOR_TYPE_ID IS NOT NULL AND ( FIL_UNCHANGED_RECORDS___v_i_WM_CREATE_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_RECORDS___v_i_WM_MOD_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_RECORDS___v_i_WM_CREATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_RECORDS___v_i_WM_LAST_UPDATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) ), 'DELETE', IF (FIL_UNCHANGED_RECORDS___LABOR_TYPE_ID IS NOT NULL AND FIL_UNCHANGED_RECORDS___i_WM_LABOR_TYPE_ID IS NOT NULL AND ( FIL_UNCHANGED_RECORDS___v_i_WM_CREATE_TSTMP <> FIL_UNCHANGED_RECORDS___v_CREATE_DATE_TIME OR FIL_UNCHANGED_RECORDS___v_i_WM_MOD_TSTMP <> FIL_UNCHANGED_RECORDS___v_MOD_DATE_TIME OR FIL_UNCHANGED_RECORDS___v_i_WM_CREATED_TSTMP <> FIL_UNCHANGED_RECORDS___v_CREATED_DTTM OR FIL_UNCHANGED_RECORDS___v_i_WM_LAST_UPDATED_TSTMP <> FIL_UNCHANGED_RECORDS___v_LAST_UPDATED_DTTM ), 'UPDATE', NULL))) as o_UPDATE_VALIDATOR" \
)
...
RTR_INS_UPD_DEL_DELETE = EXP_OUTPUT_VALIDATOR.selectExpr( \
	...
	"EXP_OUTPUT_VALIDATOR.LABOR_TYPE_ID as LABOR_TYPE_ID", \
	"EXP_OUTPUT_VALIDATOR.LABOR_TYPE_CODE as LABOR_TYPE_CODE", \
	...
	"EXP_OUTPUT_VALIDATOR.o_SPVSR_AUTH_REQUIRED as SPVSR_AUTH_REQUIRED", \
	"EXP_OUTPUT_VALIDATOR.CREATED_DTTM as CREATED_DTTM", \
	"EXP_OUTPUT_VALIDATOR.LAST_UPDATED_DTTM as LAST_UPDATED_DTTM", \
	"EXP_OUTPUT_VALIDATOR.i_LOCATION_ID1 as i_LOCATION_ID1", \
	"EXP_OUTPUT_VALIDATOR.i_WM_LABOR_TYPE_ID as i_WM_LABOR_TYPE_ID", \
	"EXP_OUTPUT_VALIDATOR.i_WM_LABOR_TYPE_CD as i_WM_LABOR_TYPE_CD", \
	"EXP_OUTPUT_VALIDATOR.i_WM_LABOR_TYPE_DESC as i_WM_LABOR_TYPE_DESC", \
	"EXP_OUTPUT_VALIDATOR.i_SPVSR_AUTH_REQUIRED_FLAG as i_SPVSR_AUTH_REQUIRED_FLAG", \
	...
	"EXP_OUTPUT_VALIDATOR.i_WM_CREATED_TSTMP as i_WM_CREATED_TSTMP", \
	"EXP_OUTPUT_VALIDATOR.i_WM_LAST_UPDATED_TSTMP as i_WM_LAST_UPDATED_TSTMP", \
