...
def m_WM_Slot_Item_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_SLOT_ITEM_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(BORROWING_SPECIFIC AS DECIMAL(19,0)) as BORROWING_SPECIFIC",
        ...
        "CAST(GAVE_HIST_TO AS DECIMAL(19,0)) as GAVE_HIST_TO",
        ...
        "CAST(ADJ_GRP_ID AS DECIMAL(19,0)) as ADJ_GRP_ID",
