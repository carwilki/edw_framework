...
def m_WM_Slot_Item_PRE(dcnbr, env):
    ...
    refine_table_name = "WM_SLOT_ITEM"
    ...
    SQ_Shortcut_to_SLOT_ITEM = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    Shortcut_to_WM_SLOT_ITEM_PRE = EXPTRANS.selectExpr( 
    	...
    	"CAST(SLOT_LOCKED AS BIGINT) as SLOT_LOCKED", 
    	"CAST(PRIMARY_MOVE AS BIGINT) as PRIMARY_MOVE", 
    	...
    	"CAST(IGN_FOR_RESLOT AS BIGINT) as IGN_FOR_RESLOT", 
    	"CAST(REC_LANES AS BIGINT) as REC_LANES", 
    	"CAST(REC_STACKING AS BIGINT) as REC_STACKING", 
    	"CAST(PALLET_MOV AS BIGINT) as PALLET_MOV", 
    	"CAST(CASE_MOV AS BIGINT) as CASE_MOV", 
    	"CAST(INNER_MOV AS BIGINT) as INNER_MOV", 
    	"CAST(EACH_MOV AS BIGINT) as EACH_MOV", 
    	"CAST(BIN_MOV AS BIGINT) as BIN_MOV", 
    	"CAST(PALLET_INVEN AS BIGINT) as PALLET_INVEN", 
    	"CAST(CASE_INVEN AS BIGINT) as CASE_INVEN", 
    	"CAST(INNER_INVEN AS BIGINT) as INNER_INVEN", 
    	"CAST(EACH_INVEN AS BIGINT) as EACH_INVEN", 
    	"CAST(BIN_INVEN AS BIGINT) as BIN_INVEN", 
    	...
    	"CAST(LEGAL_FIT AS BIGINT) as LEGAL_FIT", 
    	"CAST(SCORE_DIRTY AS BIGINT) as SCORE_DIRTY", 
    	"CAST(USE_ESTIMATED_HIST AS BIGINT) as USE_ESTIMATED_HIST", 
    	...
    	"CAST(EST_MVMT_CAN_BORROW AS BIGINT) as EST_MVMT_CAN_BORROW", 
    	"CAST(EST_HITS_CAN_BORROW AS BIGINT) as EST_HITS_CAN_BORROW", 
    	"CAST(PLB_SCORE AS BIGINT) as PLB_SCORE", 
    	"CAST(MULT_LOC_GRP AS STRING) as MULT_LOC_GRP", 
    	"CAST(DELETE_MULT AS BIGINT) as DELETE_MULT", 
    	"CAST(GAVE_HIST_TO AS BIGINT) as GAVE_HIST_TO", 
    	"CAST(ABW_TEMP_TAG AS STRING) as ABW_TEMP_TAG", 
    	"CAST(FORECAST_BORROWED AS BIGINT) as FORECAST_BORROWED", 
    	"CAST(NUM_VERT_DIV AS BIGINT) as NUM_VERT_DIV", 
    	"CAST(REPLEN_GROUP AS STRING) as REPLEN_GROUP", 
    	"CAST(ADDED_FOR_MLM AS BIGINT) as ADDED_FOR_MLM", 
    ...
    gu.overwriteDeltaPartition(Shortcut_to_WM_SLOT_ITEM_PRE, "DC_NBR", dcnbr, target_table_name)
