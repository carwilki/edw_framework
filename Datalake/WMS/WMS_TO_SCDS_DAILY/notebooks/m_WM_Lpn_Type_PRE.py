...
def m_WM_Lpn_Type_PRE(dcnbr, env):
    ...
    SQ_Shortcut_to_LPN_TYPE = gu.jdbcOracleConnection(query, username, password, connection_string).withColumn("sys_row_id", monotonically_increasing_id())
    ...
    gu.overwriteDeltaPartition(Shortcut_to_WM_LPN_TYPE_PRE, "DC_NBR", dcnbr, target_table_name)
