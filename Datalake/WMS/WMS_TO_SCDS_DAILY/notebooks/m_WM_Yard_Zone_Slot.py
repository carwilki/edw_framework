...
Shortcut_to_WM_YARD_ZONE_SLOT1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(YARD_ZONE_SLOT_STATUS1 AS BIGINT) as WM_YARD_ZONE_SLOT_STATUS", 
	"CAST(LOCN_ID1 AS STRING) as WM_LOCN_ID", 
	"CAST(X_COORDINATE1 AS BIGINT) as X_COORDINATE", 
	"CAST(Y_COORDINATE1 AS BIGINT) as Y_COORDINATE", 
	"CAST(Z_COORDINATE1 AS BIGINT) as Z_COORDINATE", 
	"CAST(MAX_CAPACITY1 AS BIGINT) as MAX_CAPACITY", 
	"CAST(USED_CAPACITY1 AS BIGINT) as USED_CAPACITY", 
	"CAST(IS_GUARD_HOUSE1 AS BIGINT) as GUARD_HOUSE_FLAG", 
	"CAST(IS_THRESHOLD_GUARD_HOUSE1 AS BIGINT) as THRESHOLD_GUARD_HOUSE_FLAG", 
