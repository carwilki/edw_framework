...
WM_YARD_ZONE_SLOT_PRE.DC_NBR,
WM_YARD_ZONE_SLOT_PRE.YARD_ID,
WM_YARD_ZONE_SLOT_PRE.YARD_ZONE_ID,
WM_YARD_ZONE_SLOT_PRE.YARD_ZONE_SLOT_ID,
WM_YARD_ZONE_SLOT_PRE.YARD_ZONE_SLOT_NAME,
WM_YARD_ZONE_SLOT_PRE.YARD_ZONE_SLOT_STATUS,
WM_YARD_ZONE_SLOT_PRE.X_COORDINATE,
WM_YARD_ZONE_SLOT_PRE.Y_COORDINATE,
WM_YARD_ZONE_SLOT_PRE.Z_COORDINATE,
WM_YARD_ZONE_SLOT_PRE.MAX_CAPACITY,
WM_YARD_ZONE_SLOT_PRE.USED_CAPACITY,
WM_YARD_ZONE_SLOT_PRE.MARK_FOR_DELETION,
WM_YARD_ZONE_SLOT_PRE.IS_GUARD_HOUSE,
WM_YARD_ZONE_SLOT_PRE.IS_THRESHOLD_GUARD_HOUSE,
WM_YARD_ZONE_SLOT_PRE.CREATED_DTTM,
WM_YARD_ZONE_SLOT_PRE.LAST_UPDATED_DTTM,
WM_YARD_ZONE_SLOT_PRE.LOCN_ID,
WM_YARD_ZONE_SLOT_PRE.CREATED_SOURCE,
WM_YARD_ZONE_SLOT_PRE.CREATED_SOURCE_TYPE,
WM_YARD_ZONE_SLOT_PRE.LAST_UPDATED_SOURCE,
WM_YARD_ZONE_SLOT_PRE.LAST_UPDATED_SOURCE_TYPE
FROM WM_YARD_ZONE_SLOT_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_YARD_ZONE_SLOT.LOCATION_ID,
WM_YARD_ZONE_SLOT.WM_YARD_ID,
WM_YARD_ZONE_SLOT.WM_YARD_ZONE_ID,
WM_YARD_ZONE_SLOT.WM_YARD_ZONE_SLOT_ID,
WM_YARD_ZONE_SLOT.WM_YARD_ZONE_SLOT_NAME,
WM_YARD_ZONE_SLOT.WM_YARD_ZONE_SLOT_STATUS,
WM_YARD_ZONE_SLOT.WM_LOCN_ID,
WM_YARD_ZONE_SLOT.X_COORDINATE,
WM_YARD_ZONE_SLOT.Y_COORDINATE,
WM_YARD_ZONE_SLOT.Z_COORDINATE,
WM_YARD_ZONE_SLOT.MAX_CAPACITY,
WM_YARD_ZONE_SLOT.USED_CAPACITY,
WM_YARD_ZONE_SLOT.GUARD_HOUSE_FLAG,
WM_YARD_ZONE_SLOT.THRESHOLD_GUARD_HOUSE_FLAG,
WM_YARD_ZONE_SLOT.MARK_FOR_DELETION_FLAG,
WM_YARD_ZONE_SLOT.WM_CREATED_SOURCE_TYPE,
WM_YARD_ZONE_SLOT.WM_CREATED_SOURCE,
WM_YARD_ZONE_SLOT.WM_CREATED_TSTMP,
WM_YARD_ZONE_SLOT.WM_LAST_UPDATED_SOURCE_TYPE,
WM_YARD_ZONE_SLOT.WM_LAST_UPDATED_SOURCE,
WM_YARD_ZONE_SLOT.WM_LAST_UPDATED_TSTMP,
WM_YARD_ZONE_SLOT.DELETE_FLAG,
WM_YARD_ZONE_SLOT.LOAD_TSTMP
FROM WM_YARD_ZONE_SLOT
...
EXP_OUTPUT_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( 
	...
	"IF (FIL_UNCHANGED_RECORDS___YARD_ZONE_SLOT_ID IS NOT NULL AND FIL_UNCHANGED_RECORDS___i_WM_YARD_ZONE_SLOT_ID IS NULL, 'INSERT', IF (FIL_UNCHANGED_RECORDS___YARD_ZONE_SLOT_ID IS NULL AND FIL_UNCHANGED_RECORDS___i_WM_YARD_ZONE_SLOT_ID IS NOT NULL AND ( FIL_UNCHANGED_RECORDS___v_i_WM_CREATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_RECORDS___v_i_WM_LAST_UPDATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) ), 'DELETE', IF (FIL_UNCHANGED_RECORDS___YARD_ZONE_SLOT_ID IS NOT NULL AND FIL_UNCHANGED_RECORDS___i_WM_YARD_ZONE_SLOT_ID IS NOT NULL AND ( FIL_UNCHANGED_RECORDS___v_i_WM_CREATED_TSTMP <> FIL_UNCHANGED_RECORDS___v_CREATED_DTTM OR FIL_UNCHANGED_RECORDS___v_i_WM_LAST_UPDATED_TSTMP <> FIL_UNCHANGED_RECORDS___v_LAST_UPDATED_DTTM ), 'UPDATE', NULL))) as o_UPDATE_VALIDATOR" 
)
