...
Shortcut_to_WM_YARD_ZONE_SLOT11.createOrReplaceTempView('WM_YARD_ZONE_SLOT_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_YARD_ZONE_SLOT_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_YARD_ID = trg.WM_YARD_ID AND src.WM_YARD_ZONE_ID = trg.WM_YARD_ZONE_ID AND src.WM_YARD_ZONE_SLOT_ID = trg.WM_YARD_ZONE_SLOT_ID )
