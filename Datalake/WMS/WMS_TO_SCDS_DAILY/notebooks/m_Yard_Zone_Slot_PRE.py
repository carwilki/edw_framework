...
def m_Yard_Zone_Slot_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_YARD_ZONE_SLOT_PRE = EXPTRANS.selectExpr(
        ...
        "CAST(YARD_ZONE_SLOT_STATUS AS SMALLINT) as YARD_ZONE_SLOT_STATUS",
        "CAST(X_COORDINATE AS DECIMAL(14,3)) as X_COORDINATE",
        "CAST(Y_COORDINATE AS DECIMAL(14,3)) as Y_COORDINATE",
        "CAST(Z_COORDINATE AS DECIMAL(14,3)) as Z_COORDINATE",
        "CAST(MAX_CAPACITY AS INT) as MAX_CAPACITY",
        "CAST(USED_CAPACITY AS INT) as USED_CAPACITY",
        "CAST(MARK_FOR_DELETION AS TINYINT) as MARK_FOR_DELETION",
        "CAST(IS_GUARD_HOUSE AS TINYINT) as IS_GUARD_HOUSE",
        "CAST(IS_THRESHOLD_GUARD_HOUSE AS SMALLINT) as IS_THRESHOLD_GUARD_HOUSE",
