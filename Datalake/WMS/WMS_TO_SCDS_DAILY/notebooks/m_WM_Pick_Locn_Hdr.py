...
refined_perf_table = f"{refine}.WM_PICK_LOCN_HDR"
raw_perf_table = f"{raw}.WM_PICK_LOCN_HDR_PRE"
...
WM_INVN_LOCK_CD,
WM_XCESS_WAVE_NEED_PROC_TYPE,
WM_PUTWY_TYPE,
WM_PICK_LOCN_ASSIGN_ZONE,
PICK_TO_LIGHT_FLAG,
...
.withColumn("FIL_UNCHANGED_RECORDS___v_CREATE_DATE_TIME", expr("""IF(FIL_UNCHANGED_RECORDS___CREATE_DATE_TIME IS NULL, date'1900-01-01', FIL_UNCHANGED_RECORDS___CREATE_DATE_TIME)""")) \
	...
	.withColumn("FIL_UNCHANGED_RECORDS___v_WM_CREATED_TSTMP", expr("""IF(FIL_UNCHANGED_RECORDS___WM_CREATED_TSTMP IS NULL, date'1900-01-01', FIL_UNCHANGED_RECORDS___WM_CREATED_TSTMP)""")) \
	.withColumn("FIL_UNCHANGED_RECORDS___v_WM_LAST_UPDATED_TSTMP", expr("""IF(FIL_UNCHANGED_RECORDS___WM_LAST_UPDATED_TSTMP IS NULL, date'1900-01-01', FIL_UNCHANGED_RECORDS___WM_LAST_UPDATED_TSTMP)""")) \
...
EXP_UPDATE_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
    ...
    "CASE WHEN TRIM(UPPER(FIL_UNCHANGED_RECORDS___REPL_FLAG)) IN ('Y', '1') THEN '1' ELSE '0' END as REPL_FLAG_EXP", \
    ...
    "CASE WHEN TRIM(UPPER(FIL_UNCHANGED_RECORDS___PICK_TO_LIGHT_FLAG)) IN ('Y', '1') THEN '1' ELSE '0' END as PICK_TO_LIGHT_FLAG_EXP", \
    "CASE WHEN TRIM(UPPER(FIL_UNCHANGED_RECORDS___PICK_TO_LIGHT_REPL_FLAG)) IN ('Y', '1') THEN '1' ELSE '0' END as PICK_TO_LIGHT_REPL_FLAG_EXP", \
...
RTR_DELETE_DELETE = EXP_UPDATE_VALIDATOR.selectExpr( \
	"DC_NBR as DC_NBR", \
	"PICK_LOCN_HDR_ID as PICK_LOCN_HDR_ID", \
	"LOCN_ID as LOCN_ID", \
	"REPL_LOCN_BRCD as REPL_LOCN_BRCD", \
	"PUTWY_TYPE as PUTWY_TYPE", \
	"MAX_NBR_OF_SKU as MAX_NBR_OF_SKU", \
	"REPL_FLAG_EXP as REPL_FLAG", \
	"PICK_LOCN_ASSIGN_ZONE as PICK_LOCN_ASSIGN_ZONE", \
	"CREATE_DATE_TIME as CREATE_DATE_TIME", \
	"MOD_DATE_TIME as MOD_DATE_TIME", \
	"USER_ID as USER_ID", \
	"REPL_CHECK_DIGIT as REPL_CHECK_DIGIT", \
	"MAX_VOL as MAX_VOL", \
	"MAX_WT as MAX_WT", \
	"REPL_X_COORD as REPL_X_COORD", \
	"REPL_Y_COORD as REPL_Y_COORD", \
	"REPL_Z_COORD as REPL_Z_COORD", \
	"REPL_TRAVEL_AISLE as REPL_TRAVEL_AISLE", \
	"REPL_TRAVEL_ZONE as REPL_TRAVEL_ZONE", \
	"XCESS_WAVE_NEED_PROC_TYPE as XCESS_WAVE_NEED_PROC_TYPE", \
	"PICK_LOCN_ASSIGN_TYPE as PICK_LOCN_ASSIGN_TYPE", \
	"SUPPR_PR40_REPL as SUPPR_PR40_REPL", \
	"COMB_4050_REPL as COMB_4050_REPL", \
	"PICK_TO_LIGHT_FLAG_EXP as PICK_TO_LIGHT_FLAG", \
	"PICK_TO_LIGHT_REPL_FLAG_EXP as PICK_TO_LIGHT_REPL_FLAG", \
	...
	"i_WM_LOCATION_ID as i_WM_LOCATION_ID", \
	"WM_PICK_LOCN_HDR_ID as WM_PICK_LOCN_HDR_ID", \
	"WM_LOCN_ID as WM_LOCN_ID", \
	"WM_LOCN_HDR_ID as WM_LOCN_HDR_ID", \
	"WM_PICK_LOCN_ASSIGN_TYPE as WM_PICK_LOCN_ASSIGN_TYPE", \
	"WM_LOCN_PUTAWAY_LOCK as WM_LOCN_PUTAWAY_LOCK", \
	"WM_INVN_LOCK_CD as WM_INVN_LOCK_CD", \
	"WM_XCESS_WAVE_NEED_PROC_TYPE as WM_XCESS_WAVE_NEED_PROC_TYPE", \
	"WM_PUTWY_TYPE as WM_PUTWY_TYPE", \
	"WM_PICK_LOCN_ASSIGN_ZONE as WM_PICK_LOCN_ASSIGN_ZONE", \
	"i_WM_PICK_TO_LIGHT_FLAG as i_WM_PICK_TO_LIGHT_FLAG", \
	"i_WM_PICK_TO_LIGHT_REPL_FLAG as i_WM_PICK_TO_LIGHT_REPL_FLAG", \
	"WM_REPL_FLAG as WM_REPL_FLAG", \
	"WM_REPL_LOCN_BRCD as WM_REPL_LOCN_BRCD", \
	"WM_REPL_TRAVEL_AISLE as WM_REPL_TRAVEL_AISLE", \
	"WM_REPL_TRAVEL_ZONE as WM_REPL_TRAVEL_ZONE", \
	"WM_SUPPR_PR40_REPL as WM_SUPPR_PR40_REPL", \
	"WM_COMB_4050_REPL as WM_COMB_4050_REPL", \
	"WM_REPL_CHECK_DIGIT as WM_REPL_CHECK_DIGIT", \
	"i_WM_REPL_X_COORD as i_WM_REPL_X_COORD", \
	"i_WM_REPL_Y_COORD as i_WM_REPL_Y_COORD", \
	"i_WM_REPL_Z_COORD as i_WM_REPL_Z_COORD", \
	"i_WM_MAX_NBR_OF_SKU as i_WM_MAX_NBR_OF_SKU", \
	"i_WM_MAX_VOL as i_WM_MAX_VOL", \
	"i_WM_MAX_WT as i_WM_MAX_WT", \
	"WM_USER_ID as WM_USER_ID", \
	"i_WM_WM_VERSION_ID as i_WM_WM_VERSION_ID", \
	...
	"i_WM_LOAD_TSTMP as i_WM_LOAD_TSTMP", \
	...
	"i_WM_DELETE_FLAG as i_WM_DELETE_FLAG" ,\
...
Shortcut_to_WM_PICK_LOCN_HDR2 = UPD_DELETE.selectExpr( \
	...
	"CAST(NULL AS STRING) as WM_PICK_LOCN_ASSIGN_TYPE", \
	"CAST(NULL AS STRING) as WM_LOCN_PUTAWAY_LOCK", \
	"CAST(NULL AS STRING) as WM_INVN_LOCK_CD", \
	"CAST(NULL AS BIGINT) as WM_XCESS_WAVE_NEED_PROC_TYPE", \
	"CAST(NULL AS STRING) as WM_PUTWY_TYPE", \
	"CAST(NULL AS STRING) as WM_PICK_LOCN_ASSIGN_ZONE", \
	"CAST(NULL AS BIGINT) as PICK_TO_LIGHT_FLAG", \
	"CAST(NULL AS BIGINT) as PICK_TO_LIGHT_REPL_FLAG", \
	"CAST(NULL AS BIGINT) as WM_REPL_FLAG", \
	"CAST(NULL AS STRING) as WM_REPL_LOCN_BRCD", \
	"CAST(NULL AS STRING) as WM_REPL_TRAVEL_AISLE", \
	"CAST(NULL AS STRING) as WM_REPL_TRAVEL_ZONE", \
	"CAST(NULL AS BIGINT) as WM_SUPPR_PR40_REPL", \
	"CAST(NULL AS BIGINT) as WM_COMB_4050_REPL", \
	"CAST(NULL AS STRING) as WM_REPL_CHECK_DIGIT", \
	"CAST(NULL AS BIGINT) as REPL_X_COORD", \
	"CAST(NULL AS BIGINT) as REPL_Y_COORD", \
	"CAST(NULL AS BIGINT) as REPL_Z_COORD", \
	"CAST(NULL AS BIGINT) as MAX_NBR_OF_SKU", \
...
Shortcut_to_WM_PICK_LOCN_HDR3 = UPD_INSERT_UPDATE.selectExpr(
	...
	"CAST(PICK_LOCN_ASSIGN_TYPE1 AS STRING) as WM_PICK_LOCN_ASSIGN_TYPE",
	"CAST(LOCN_PUTAWAY_LOCK1 AS STRING) as WM_LOCN_PUTAWAY_LOCK",
	"CAST(INVN_LOCK_CODE1 AS STRING) as WM_INVN_LOCK_CD",
	"CAST(XCESS_WAVE_NEED_PROC_TYPE1 AS TINYINT) as WM_XCESS_WAVE_NEED_PROC_TYPE",
	"CAST(PUTWY_TYPE1 AS STRING) as WM_PUTWY_TYPE",
	"CAST(PICK_LOCN_ASSIGN_ZONE1 AS STRING) as WM_PICK_LOCN_ASSIGN_ZONE",
	"CAST(PICK_TO_LIGHT_FLAG1 AS TINYINT) as PICK_TO_LIGHT_FLAG",
	"CAST(PICK_TO_LIGHT_REPL_FLAG1 AS TINYINT) as PICK_TO_LIGHT_REPL_FLAG",
	"CAST(REPL_FLAG1 AS TINYINT) as WM_REPL_FLAG",
	"CAST(REPL_LOCN_BRCD1 AS STRING) as WM_REPL_LOCN_BRCD",
	"CAST(REPL_TRAVEL_AISLE1 AS STRING) as WM_REPL_TRAVEL_AISLE",
	"CAST(REPL_TRAVEL_ZONE1 AS STRING) as WM_REPL_TRAVEL_ZONE",
	"CAST(SUPPR_PR40_REPL1 AS SMALLINT) as WM_SUPPR_PR40_REPL",
	"CAST(COMB_4050_REPL1 AS SMALLINT) as WM_COMB_4050_REPL",
	"CAST(REPL_CHECK_DIGIT1 AS STRING) as WM_REPL_CHECK_DIGIT",
	"CAST(REPL_X_COORD1 AS DECIMAL(13,5)) as REPL_X_COORD",
	"CAST(REPL_Y_COORD1 AS DECIMAL(13,5)) as REPL_Y_COORD",
	"CAST(REPL_Z_COORD1 AS DECIMAL(13,5)) as REPL_Z_COORD",
	"CAST(MAX_NBR_OF_SKU1 AS SMALLINT) as MAX_NBR_OF_SKU",
...
try:
  ...
  executeMerge(Shortcut_to_WM_PICK_LOCN_HDR3, refined_perf_table, primary_key)
