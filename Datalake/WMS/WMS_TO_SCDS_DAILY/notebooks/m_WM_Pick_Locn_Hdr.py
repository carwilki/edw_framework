...
Shortcut_to_WM_PICK_LOCN_HDR3 = UPD_INSERT_UPDATE.selectExpr( \
	...
	"CAST(PICK_LOCN_HDR_ID1 AS BIGINT) as WM_PICK_LOCN_HDR_ID", \
	...
	"CAST(XCESS_WAVE_NEED_PROC_TYPE1 AS BIGINT) as WM_XCESS_WAVE_NEED_PROC_TYPE", \
	"CAST(PUTWY_TYPE1 AS STRING) as WM_PUTWY_TYPE", \
	"CAST(PICK_LOCN_ASSIGN_ZONE1 AS STRING) as WM_PICK_LOCN_ASSIGN_ZONE", \
	"CAST(PICK_TO_LIGHT_FLAG1 AS BIGINT) as PICK_TO_LIGHT_FLAG", \
	"CAST(PICK_TO_LIGHT_REPL_FLAG1 AS BIGINT) as PICK_TO_LIGHT_REPL_FLAG", \
	"CAST(REPL_FLAG1 AS BIGINT) as WM_REPL_FLAG", \
	...
	"CAST(SUPPR_PR40_REPL1 AS BIGINT) as WM_SUPPR_PR40_REPL", \
	"CAST(COMB_4050_REPL1 AS BIGINT) as WM_COMB_4050_REPL", \
	"CAST(REPL_CHECK_DIGIT1 AS STRING) as WM_REPL_CHECK_DIGIT", \
	"CAST(REPL_X_COORD1 AS BIGINT) as REPL_X_COORD", \
	"CAST(REPL_Y_COORD1 AS BIGINT) as REPL_Y_COORD", \
	"CAST(REPL_Z_COORD1 AS BIGINT) as REPL_Z_COORD", \
	"CAST(MAX_NBR_OF_SKU1 AS BIGINT) as MAX_NBR_OF_SKU", \
