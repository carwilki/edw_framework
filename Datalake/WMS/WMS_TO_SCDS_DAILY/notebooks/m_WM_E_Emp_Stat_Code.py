...
Shortcut_to_WM_E_EMP_STAT_CODE1 = UPD_DELETE.selectExpr( \
	...
	"CAST(DELETE_FLAG2 AS TINYINT) as DELETE_FLAG"\
)
# Shortcut_to_WM_E_EMP_STAT_CODE1.write.saveAsTable(f'{raw}.WM_E_EMP_STAT_CODE')

Shortcut_to_WM_E_EMP_STAT_CODE1.createOrReplaceTempView('WM_E_EMP_STAT_CODE_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_E_EMP_STAT_CODE_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_EMP_STAT_ID = trg.WM_EMP_STAT_ID )
