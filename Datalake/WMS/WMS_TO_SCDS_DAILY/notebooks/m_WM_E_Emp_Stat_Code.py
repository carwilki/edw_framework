...
WM_E_EMP_STAT_CODE.LOCATION_ID,
WM_E_EMP_STAT_CODE.WM_EMP_STAT_ID,
WM_E_EMP_STAT_CODE.WM_EMP_STAT_CODE,
WM_E_EMP_STAT_CODE.WM_EMP_STAT_DESC,
WM_E_EMP_STAT_CODE.WM_UNQ_SEED_ID,
WM_E_EMP_STAT_CODE.MISC_TXT_1,
WM_E_EMP_STAT_CODE.MISC_TXT_2,
WM_E_EMP_STAT_CODE.MISC_NUM_1,
WM_E_EMP_STAT_CODE.MISC_NUM_2,
WM_E_EMP_STAT_CODE.WM_USER_ID,
WM_E_EMP_STAT_CODE.WM_VERSION_ID,
WM_E_EMP_STAT_CODE.WM_CREATE_TSTMP,
WM_E_EMP_STAT_CODE.WM_MOD_TSTMP,
WM_E_EMP_STAT_CODE.WM_CREATED_TSTMP,
...
WM_E_EMP_STAT_CODE_PRE.DC_NBR,
WM_E_EMP_STAT_CODE_PRE.EMP_STAT_ID,
WM_E_EMP_STAT_CODE_PRE.EMP_STAT_CODE,
WM_E_EMP_STAT_CODE_PRE.DESCRIPTION,
WM_E_EMP_STAT_CODE_PRE.CREATE_DATE_TIME,
WM_E_EMP_STAT_CODE_PRE.MOD_DATE_TIME,
WM_E_EMP_STAT_CODE_PRE.USER_ID,
WM_E_EMP_STAT_CODE_PRE.MISC_TXT_1,
WM_E_EMP_STAT_CODE_PRE.MISC_TXT_2,
WM_E_EMP_STAT_CODE_PRE.MISC_NUM_1,
WM_E_EMP_STAT_CODE_PRE.MISC_NUM_2,
WM_E_EMP_STAT_CODE_PRE.VERSION_ID,
WM_E_EMP_STAT_CODE_PRE.UNQ_SEED_ID,
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_REC_temp.selectExpr( \
	...
	"IF (FIL_UNCHANGED_REC___EMP_STAT_ID IS NOT NULL AND FIL_UNCHANGED_REC___WM_EMP_STAT_ID IS NULL, 'INSERT', IF (FIL_UNCHANGED_REC___EMP_STAT_ID IS NULL AND FIL_UNCHANGED_REC___WM_EMP_STAT_ID IS NOT NULL AND ( FIL_UNCHANGED_REC___v_WM_CREATE_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_REC___v_WM_MOD_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_REC___v_WM_CREATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) OR FIL_UNCHANGED_REC___v_WM_LAST_UPDATED_TSTMP >= DATE_ADD(- 14, {Prev_Run_Dt}) ), 'DELETE', IF (FIL_UNCHANGED_REC___EMP_STAT_ID IS NOT NULL AND FIL_UNCHANGED_REC___WM_EMP_STAT_ID IS NOT NULL AND ( FIL_UNCHANGED_REC___v_WM_CREATED_TSTMP <> FIL_UNCHANGED_REC___v_CREATED_DTTM OR FIL_UNCHANGED_REC___v_WM_LAST_UPDATED_TSTMP <> FIL_UNCHANGED_REC___v_LAST_UPDATED_DTTM OR FIL_UNCHANGED_REC___v_WM_CREATE_TSTMP <> FIL_UNCHANGED_REC___v_CREATE_DATE_TIME OR FIL_UNCHANGED_REC___v_WM_MOD_TSTMP <> FIL_UNCHANGED_REC___v_MOD_DATE_TIME ), 'UPDATE', NULL))) as o_UPD_VALIDATOR" \
)
