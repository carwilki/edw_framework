...
def m_WM_Facility_PRE(dcnbr, env):
    ...
    Shortcut_to_WM_FACILITY_PRE = EXPTRANS.selectExpr( \
        ...
        "CAST(INBOUNDS_RS_AREA_ID AS BIGINT) as INBOUNDS_RS_AREA_ID", \
        "CAST(OUTBOUND_RS_AREA_ID AS BIGINT) as OUTBOUND_RS_AREA_ID", \
        "CAST(INBOUND_REGION_ID AS BIGINT) as INBOUND_REGION_ID", \
        "CAST(OUTBOUND_REGION_ID AS BIGINT) as OUTBOUND_REGION_ID", \
        "CAST(FACILITY_TZ AS BIGINT) as FACILITY_TZ", \
        "CAST(DROP_INDICATOR AS BIGINT) as DROP_INDICATOR", \
        "CAST(HOOK_INDICATOR AS BIGINT) as HOOK_INDICATOR", \
        ...
        "CAST(TRACK_ONTIME_INDICATOR AS BIGINT) as TRACK_ONTIME_INDICATOR", \
        ...
        "CAST(BUSINESS_GROUP_ID_1 AS BIGINT) as BUSINESS_GROUP_ID_1", \
        "CAST(BUSINESS_GROUP_ID_2 AS BIGINT) as BUSINESS_GROUP_ID_2", \
        ...
        "CAST(DSP_DR_CONFIGURATION_ID AS BIGINT) as DSP_DR_CONFIGURATION_ID", \
        ...
        "CAST(DRIVEIN_TIME AS BIGINT) as DRIVEIN_TIME", \
        "CAST(CHECKIN_TIME AS BIGINT) as CHECKIN_TIME", \
        "CAST(DRIVEOUT_TIME AS BIGINT) as DRIVEOUT_TIME", \
        "CAST(CHECKOUT_TIME AS BIGINT) as CHECKOUT_TIME", \
        ...
        "CAST(OVER_BOOK_PERCENTAGE AS BIGINT) as OVER_BOOK_PERCENTAGE", \
        ...
        "CAST(DEF_DRIVER_TYPE_ID AS BIGINT) as DEF_DRIVER_TYPE_ID", \
        "CAST(DEF_TRACTOR_ID AS BIGINT) as DEF_TRACTOR_ID", \
        "CAST(DEF_EQUIPMENT_ID AS BIGINT) as DEF_EQUIPMENT_ID", \
        ...
        "CAST(AUDIT_PARTY_ID AS BIGINT) as AUDIT_PARTY_ID", \
