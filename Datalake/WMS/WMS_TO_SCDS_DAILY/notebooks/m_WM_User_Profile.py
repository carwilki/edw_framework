...
Shortcut_to_WM_USER_PROFILE1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(USER_PROFILE_ID AS BIGINT) as WM_USER_PROFILE_ID", 
	"CAST(LOGIN_USER_ID AS STRING) as WM_LOGIN_USER_ID", 
	"CAST(MENU_ID AS BIGINT) as WM_MENU_ID", 
	"CAST(EMPLYE_ID AS STRING) as WM_EMPLOYEE_ID", 
	"CAST(RESTR_TASK_GRP_TO_DFLT AS BIGINT) as RESTR_TASK_GRP_TO_DFLT_FLAG", 
	"CAST(RESTR_MENU_MODE_TO_DFLT AS BIGINT) as RESTR_MENU_MODE_TO_DFLT_FLAG", 
	...
	"CAST(ALLOW_TASK_INT_CHG AS BIGINT) as ALLOW_TASK_INT_CHG_FLAG", 
	...
	"CAST(RF_MENU_ID AS BIGINT) as WM_RF_MENU_ID", 
	"CAST(PAGE_SIZE AS BIGINT) as PAGE_SIZE", 
	"CAST(VOCOLLECT_WORK_TYPE AS BIGINT) as WM_VOCOLLECT_WORK_TYPE", 
	...
	"CAST(TASK_GRP_JUMP_FLAG AS BIGINT) as TASK_GRP_JUMP_FLAG", 
	"CAST(AUTO_3PL_LOGIN_FLAG AS BIGINT) as AUTO_3PL_LOGIN_FLAG", 
	"CAST(SECURITY_CONTEXT_ID AS BIGINT) as WM_SECURITY_CONTEXT_ID", 
	...
	"CAST(CLS_TIMEZONE_ID AS BIGINT) as WM_CLS_TIMEZONE_ID", 
	"CAST(DAL_CONNECTION_STRING AS STRING) as DAL_CONNECTION_STRING", 
	"CAST(USER_SECURITY_CONTEXT_ID AS BIGINT) as WM_USER_SECURITY_CONTEXT_ID", 
	"CAST(DFLT_TASK_INT AS BIGINT) as DFLT_TASK_INT", 
	"CAST(MOBILE_HELP_TEXT AS BIGINT) as MOBILE_HELP_TEXT_FLAG", 
	"CAST(MOB_SPLASH_SCREEN_FLAG AS BIGINT) as MOB_SPLASH_SCREEN_FLAG", 
	"CAST(SCREEN_TYPE_ID AS BIGINT) as WM_SCREEN_TYPE_ID", 
...
Shortcut_to_WM_USER_PROFILE1.write.saveAsTable(f'{raw}.WM_USER_PROFILE')
Shortcut_to_WM_USER_PROFILE1 = UPD_INS_UPD.selectExpr( 
	"CAST(LOCATION_ID AS BIGINT) as LOCATION_ID", 
	"CAST(USER_PROFILE_ID AS BIGINT) as WM_USER_PROFILE_ID", 
	"CAST(LOGIN_USER_ID AS STRING) as WM_LOGIN_USER_ID", 
