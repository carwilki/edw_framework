...
Shortcut_to_WM_ITEM_PACKAGE_CBO = UPD_INS_UPD.selectExpr(
	...
	"CAST(ITEM_PACKAGE_ID AS DECIMAL(9,0)) as WM_ITEM_PACKAGE_ID",
	"CAST(ITEM_ID AS DECIMAL(9,0)) as WM_ITEM_ID",
	"CAST(PACKAGE_UOM_ID AS DECIMAL(8,0)) as WM_PACKAGE_UOM_ID",
	"CAST(GTIN1 AS STRING) as GTIN",
	"CAST(BUSINESS_PARTNER_ID AS STRING) as WM_BUSINESS_PARTNER_ID",
	"CAST(IS_STD1 AS DECIMAL(1,0)) as STANDARD_UOM_FLAG",
