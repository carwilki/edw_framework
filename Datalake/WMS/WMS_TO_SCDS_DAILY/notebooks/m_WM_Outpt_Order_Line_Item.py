...
Shortcut_to_WM_OUTPT_ORDER_LINE_ITEM1 = UPD_INS_UPD.selectExpr( \
	...
	"CAST(o_REC_PROC_FLAG AS BIGINT) as WM_REC_PROC_FLAG", \
	"CAST(REC_XPANS_FIELD AS STRING) as WM_REC_XPANS_FIELD", \
	"CAST(PLANNED_QUANTITY AS BIGINT) as PLANNED_QTY", \
	...
	"CAST(BACK_ORD_QTY AS BIGINT) as BACK_ORDERED_QTY", \
	"CAST(USER_CANCELED_QTY AS BIGINT) as USER_CANCELED_QTY", \
	"CAST(PPACK_QTY AS BIGINT) as WM_PPACK_QTY", \
	"CAST(PPACK_GRP_CODE AS STRING) as WM_PPACK_GRP_CD", \
	"CAST(SHIPPED_QTY AS BIGINT) as WM_SHIPPED_QTY", \
	"CAST(PRICE AS BIGINT) as WM_PRICE", \
	"CAST(PRICE_TKT_TYPE AS STRING) as WM_PRICE_TKT_TYPE", \
	"CAST(RETAIL_PRICE AS BIGINT) as WM_RETAIL_PRICE", \
	"CAST(ACTUAL_COST AS BIGINT) as WM_ACTUAL_COST", \
	...
	"CAST(ORIG_ITEM_ID AS BIGINT) as WM_ORIG_ITEM_ID", \
	"CAST(ORIG_ORDER_QTY AS BIGINT) as WM_ORIG_ORDER_QTY", \
