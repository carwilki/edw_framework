...
WM_OUTPT_ORDER_LINE_ITEM.LOCATION_ID,
WM_OUTPT_ORDER_LINE_ITEM.WM_OUTPT_ORDER_LINE_ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM.WM_CREATED_TSTMP,
WM_OUTPT_ORDER_LINE_ITEM.WM_LAST_UPDATED_TSTMP,
WM_OUTPT_ORDER_LINE_ITEM.LOAD_TSTMP
FROM WM_OUTPT_ORDER_LINE_ITEM
WHERE WM_OUTPT_ORDER_LINE_ITEM_ID IN (SELECT OUTPT_ORDER_LINE_ITEM_ID FROM WM_OUTPT_ORDER_LINE_ITEM_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_OUTPT_ORDER_LINE_ITEM_PRE.DC_NBR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.OUTPT_ORDER_LINE_ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ACTUAL_COST_CURRENCY_CODE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ACTUAL_SHIPPED_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ASSORT_NBR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.BACK_ORD_QTY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.BATCH_CTRL_NBR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.BATCH_NBR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.CNTRY_OF_ORGN,
WM_OUTPT_ORDER_LINE_ITEM_PRE.COMMODITY_CLASS,
WM_OUTPT_ORDER_LINE_ITEM_PRE.CREATED_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.CREATED_SOURCE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.CREATED_SOURCE_TYPE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.CUSTOMER_ITEM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.EXP_INFO_CODE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.GTIN,
WM_OUTPT_ORDER_LINE_ITEM_PRE.INVC_BATCH_NBR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.INVN_TYPE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_ATTR_1,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_ATTR_2,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_ATTR_3,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_ATTR_4,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_ATTR_5,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LAST_UPDATED_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LAST_UPDATED_SOURCE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LINE_ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LINE_TYPE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.MANUFACTURING_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.MISC_INSTR_10_BYTE_1,
WM_OUTPT_ORDER_LINE_ITEM_PRE.MISC_INSTR_10_BYTE_2,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORDER_QTY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORDER_QTY_UOM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ORDER_LINE_ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ORDER_QTY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ORDER_QTY_UOM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PARENT_LINE_ITEM_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PICKUP_END_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PICKUP_REFERENCE_NUMBER,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PICKUP_START_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PLANNED_QUANTITY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PLANNED_QUANTITY_UOM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PLANNED_SHIP_DATE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PPACK_GRP_CODE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PPACK_QTY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PRICE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PRICE_TKT_TYPE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PROC_DTTM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PROC_STAT_CODE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PRODUCT_STATUS,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PURCHASE_ORDER_LINE_NUMBER,
WM_OUTPT_ORDER_LINE_ITEM_PRE.REASON_CODE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.REC_PROC_FLAG,
WM_OUTPT_ORDER_LINE_ITEM_PRE.REC_XPANS_FIELD,
WM_OUTPT_ORDER_LINE_ITEM_PRE.RETAIL_PRICE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.SHIPPED_QTY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.TC_COMPANY_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.UNIT_VOL,
WM_OUTPT_ORDER_LINE_ITEM_PRE.UNIT_WT,
WM_OUTPT_ORDER_LINE_ITEM_PRE.UOM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.USER_CANCELED_QTY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.VERSION_NBR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.AISLE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.AREA,
WM_OUTPT_ORDER_LINE_ITEM_PRE.BAY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LVL,
WM_OUTPT_ORDER_LINE_ITEM_PRE.POSN,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ZONE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_COLOR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_COLOR_SFX,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_SEASON,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_SEASON_YEAR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_SECOND_DIM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_SIZE_DESC,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_QUALITY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_STYLE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_STYLE_SFX,
WM_OUTPT_ORDER_LINE_ITEM_PRE.SIZE_RANGE_CODE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.SIZE_REL_POSN_IN_TABLE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.SHELF_DAYS,
WM_OUTPT_ORDER_LINE_ITEM_PRE.TEMP_ZONE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_COLOR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_COLOR_SFX,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_SEASON,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_SEASON_YEAR,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_SECOND_DIM,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_SIZE_DESC,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_QUALITY,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_STYLE,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ORIG_ITEM_STYLE_SFX,
WM_OUTPT_ORDER_LINE_ITEM_PRE.TC_ORDER_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.TC_PURCHASE_ORDERS_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ITEM_NAME,
WM_OUTPT_ORDER_LINE_ITEM_PRE.ACTUAL_COST,
WM_OUTPT_ORDER_LINE_ITEM_PRE.TC_ORDER_LINE_ID,
WM_OUTPT_ORDER_LINE_ITEM_PRE.PURCHASE_ORDER_NUMBER,
WM_OUTPT_ORDER_LINE_ITEM_PRE.EXT_PURCHASE_ORDER,
WM_OUTPT_ORDER_LINE_ITEM_PRE.LOAD_TSTMP
FROM WM_OUTPT_ORDER_LINE_ITEM_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
EXP_UPD_VALIDATOR = FIL_UNCHANGED_RECORDS_temp.selectExpr( \
	...
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_UNCHANGED_RECORDS___REC_PROC_FLAG ) ) ) , 'Y','1' , '1','1','0' ) as o_REC_PROC_FLAG", \
