...
Shortcut_to_WM_UN_NUMBER1 = UPD_INS_UPD.selectExpr( 
	...
	"CAST(HAZMAT_UOM AS BIGINT) as WM_HAZMAT_UOM", 
	...
	"CAST(REPORTABLE_QTY AS BIGINT) as REPORTABLE_QTY_FLAG", 
	"CAST(IS_ACCESSIBLE AS BIGINT) as ACCESSIBLE_FLAG", 
	"CAST(RESIDUE_INDICATOR_CODE AS STRING) as RESIDUE_INDICATOR_CD", 
	"CAST(HAZMAT_CLASS_QUAL AS STRING) as HAZMAT_CLASS_QUAL", 
	"CAST(NOS_INDICATOR_CODE AS BIGINT) as NOS_INDICATOR_CD", 
...
Shortcut_to_WM_UN_NUMBER1.write.saveAsTable(f'{raw}.WM_UN_NUMBER')
Shortcut_to_WM_UN_NUMBER1 = UPD_INS_UPD.selectExpr( 
	"CAST(LOCATION_ID AS BIGINT) as LOCATION_ID", 
	"CAST(UN_NUMBER_ID AS BIGINT) as WM_UN_NBR_ID", 
	"CAST(TC_COMPANY_ID AS BIGINT) as WM_TC_COMPANY_ID", 
