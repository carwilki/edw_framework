...
WM_UN_NUMBER_PRE.DC_NBR,
WM_UN_NUMBER_PRE.UN_NUMBER_ID,
WM_UN_NUMBER_PRE.TC_COMPANY_ID,
WM_UN_NUMBER_PRE.UN_NUMBER_VALUE,
WM_UN_NUMBER_PRE.UN_NUMBER_DESCRIPTION,
WM_UN_NUMBER_PRE.UNN_CLASS_DIV,
WM_UN_NUMBER_PRE.UNN_SUB_RISK,
WM_UN_NUMBER_PRE.UNN_HAZARD_LABEL,
WM_UN_NUMBER_PRE.UNN_PG,
WM_UN_NUMBER_PRE.UNN_SP,
WM_UN_NUMBER_PRE.UNN_AIR_BOTH_INST_LTD,
WM_UN_NUMBER_PRE.UNN_AIR_BOTH_QTY_LTD,
WM_UN_NUMBER_PRE.UNN_AIR_BOTH_INST,
WM_UN_NUMBER_PRE.UNN_AIR_BOTH_QTY,
WM_UN_NUMBER_PRE.UNN_AIR_CARGO_INST,
WM_UN_NUMBER_PRE.UNN_AIR_CARGO_QTY,
WM_UN_NUMBER_PRE.UN_NUMBER,
WM_UN_NUMBER_PRE.RQ_FIELD_1,
WM_UN_NUMBER_PRE.RQ_FIELD_2,
WM_UN_NUMBER_PRE.RQ_FIELD_3,
WM_UN_NUMBER_PRE.RQ_FIELD_4,
WM_UN_NUMBER_PRE.RQ_FIELD_5,
WM_UN_NUMBER_PRE.HZC_FIELD_1,
WM_UN_NUMBER_PRE.HZC_FIELD_2,
WM_UN_NUMBER_PRE.HZC_FIELD_3,
WM_UN_NUMBER_PRE.HZC_FIELD_4,
WM_UN_NUMBER_PRE.HZC_FIELD_5,
WM_UN_NUMBER_PRE.MARK_FOR_DELETION,
WM_UN_NUMBER_PRE.CREATED_SOURCE_TYPE,
WM_UN_NUMBER_PRE.CREATED_SOURCE,
WM_UN_NUMBER_PRE.CREATED_DTTM,
WM_UN_NUMBER_PRE.LAST_UPDATED_SOURCE_TYPE,
WM_UN_NUMBER_PRE.LAST_UPDATED_SOURCE,
WM_UN_NUMBER_PRE.LAST_UPDATED_DTTM,
WM_UN_NUMBER_PRE.UN_NUMBER_VERSION,
WM_UN_NUMBER_PRE.HAZMAT_UOM,
WM_UN_NUMBER_PRE.MAX_HAZMAT_QTY,
WM_UN_NUMBER_PRE.REGULATION_SET,
WM_UN_NUMBER_PRE.TRANS_MODE,
WM_UN_NUMBER_PRE.REPORTABLE_QTY,
WM_UN_NUMBER_PRE.TECHNICAL_NAME,
WM_UN_NUMBER_PRE.ADDL_DESC,
WM_UN_NUMBER_PRE.PHONE_NUMBER,
WM_UN_NUMBER_PRE.CONTACT_NAME,
WM_UN_NUMBER_PRE.IS_ACCESSIBLE,
WM_UN_NUMBER_PRE.RESIDUE_INDICATOR_CODE,
WM_UN_NUMBER_PRE.HAZMAT_CLASS_QUAL,
WM_UN_NUMBER_PRE.NOS_INDICATOR_CODE,
WM_UN_NUMBER_PRE.HAZMAT_MATERIAL_QUAL,
WM_UN_NUMBER_PRE.FLASH_POINT_TEMPERATURE,
WM_UN_NUMBER_PRE.FLASH_POINT_TEMPERATURE_UOM,
WM_UN_NUMBER_PRE.HAZARD_ZONE_CODE,
WM_UN_NUMBER_PRE.RADIOACTIVE_QTY_CALC_FACTOR,
WM_UN_NUMBER_PRE.RADIOACTIVE_QUANTITY_UOM,
WM_UN_NUMBER_PRE.EPAWASTESTREAM_NUMBER,
WM_UN_NUMBER_PRE.WASTE_CHARACTERISTIC_CODE,
WM_UN_NUMBER_PRE.NET_EXPLOSIVE_QUANTITY_FACTOR,
WM_UN_NUMBER_PRE.HAZMAT_EXEMPTION_REF_NUMBR,
WM_UN_NUMBER_PRE.RQ_FIELD_6,
WM_UN_NUMBER_PRE.RQ_FIELD_7,
WM_UN_NUMBER_PRE.RQ_FIELD_8,
WM_UN_NUMBER_PRE.RQ_FIELD_9,
WM_UN_NUMBER_PRE.RQ_FIELD_10,
WM_UN_NUMBER_PRE.RQ_FIELD_11,
WM_UN_NUMBER_PRE.RQ_FIELD_12,
WM_UN_NUMBER_PRE.RQ_FIELD_13,
WM_UN_NUMBER_PRE.RQ_FIELD_14,
WM_UN_NUMBER_PRE.RQ_FIELD_15,
WM_UN_NUMBER_PRE.RQ_FIELD_16,
WM_UN_NUMBER_PRE.RQ_FIELD_17,
WM_UN_NUMBER_PRE.RQ_FIELD_18,
WM_UN_NUMBER_PRE.RQ_FIELD_19,
WM_UN_NUMBER_PRE.RQ_FIELD_20
FROM WM_UN_NUMBER_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_UN_NUMBER.LOCATION_ID,
WM_UN_NUMBER.WM_UN_NBR_ID,
WM_UN_NUMBER.WM_CREATED_TSTMP,
WM_UN_NUMBER.WM_LAST_UPDATED_TSTMP,
WM_UN_NUMBER.LOAD_TSTMP
FROM WM_UN_NUMBER
WHERE WM_UN_NBR_ID IN (SELECT UN_NUMBER_ID FROM WM_UN_NUMBER_PRE)""").withColumn("sys_row_id", monotonically_increasing_id())
