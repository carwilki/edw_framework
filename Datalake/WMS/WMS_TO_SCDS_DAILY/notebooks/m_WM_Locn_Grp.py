...
Shortcut_to_WM_LOCN_GRP1.createOrReplaceTempView('WM_LOCN_GRP_DEL')
...
Shortcut_to_WM_LOCN_GRP2 = UPD_INSERT_UPDATE.selectExpr(
	...
	"CAST(LOCN_GRP_ID AS INT) as WM_LOCN_GRP_ID",
	"CAST(GRP_TYPE AS SMALLINT) as WM_GRP_TYPE",
