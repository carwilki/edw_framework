...
WM_E_ACT_PRE.DC_NBR,
WM_E_ACT_PRE.ACT_ID,
WM_E_ACT_PRE.CREATE_DATE_TIME,
WM_E_ACT_PRE.MOD_DATE_TIME,
WM_E_ACT_PRE.USER_ID,
WM_E_ACT_PRE.JOB_FUNC_ID,
WM_E_ACT_PRE.WHSE,
WM_E_ACT_PRE.LABOR_TYPE_ID,
WM_E_ACT_PRE.MONITOR_UOM,
WM_E_ACT_PRE.MISC_TXT_1,
WM_E_ACT_PRE.MISC_TXT_2,
WM_E_ACT_PRE.MISC_NUM_1,
WM_E_ACT_PRE.MISC_NUM_2,
WM_E_ACT_PRE.OVERRIDE_PROC_ZONE_ID,
WM_E_ACT_PRE.PROC_ZONE_LOCN_IND,
WM_E_ACT_PRE.LM_MAN_EVNT_REQ_APRV,
WM_E_ACT_PRE.LM_KIOSK_REQ_APRV,
WM_E_ACT_PRE.WM_REQ_APRV,
WM_E_ACT_PRE.VERSION_ID,
WM_E_ACT_PRE.LABOR_ACTIVITY_ID,
WM_E_ACT_PRE.VHCL_TYPE_ID,
WM_E_ACT_PRE.UNQ_SEED_ID,
WM_E_ACT_PRE.CREATED_DTTM,
WM_E_ACT_PRE.LAST_UPDATED_DTTM,
WM_E_ACT_PRE.DISPLAY_UOM,
WM_E_ACT_PRE.THRUPUT_GOAL,
WM_E_ACT_PRE.LOAD_TSTMP
FROM WM_E_ACT_PRE""").withColumn("sys_row_id", monotonically_increasing_id())
...
WM_E_ACT.LOCATION_ID,
WM_E_ACT.WM_ACT_ID,
WM_E_ACT.WM_WHSE,
WM_E_ACT.WM_JOB_FUNC_ID,
WM_E_ACT.WM_LABOR_TYPE_ID,
WM_E_ACT.MONITOR_UOM,
WM_E_ACT.WM_OVERRIDE_PROC_ZONE_ID,
WM_E_ACT.WM_PROC_ZONE_LOCN_IND,
WM_E_ACT.LM_MAN_EVNT_REQ_APRV_FLAG as LM_MAN_EVNT_REQ_APRV ,
WM_E_ACT.LM_KIOSK_REQ_APRV_FLAG as LM_KIOSK_REQ_APRV ,
WM_E_ACT.REQ_APRV_FLAG as REQ_APRV ,
WM_E_ACT.WM_LABOR_ACTIVITY_ID,
WM_E_ACT.WM_VHCL_TYPE_ID,
WM_E_ACT.WM_UNQ_SEED_ID,
WM_E_ACT.WM_DISPLAY_UOM,
WM_E_ACT.WM_THRUPUT_GOAL,
WM_E_ACT.MISC_TXT_1,
WM_E_ACT.MISC_TXT_2,
WM_E_ACT.MISC_NUM_1,
WM_E_ACT.MISC_NUM_2,
WM_E_ACT.WM_USER_ID,
WM_E_ACT.WM_VERSION_ID,
WM_E_ACT.WM_CREATED_TSTMP,
WM_E_ACT.WM_CREATE_TSTMP,
WM_E_ACT.WM_MOD_TSTMP,
WM_E_ACT.WM_LAST_UPDATED_TSTMP,
WM_E_ACT.DELETE_FLAG,
WM_E_ACT.UPDATE_TSTMP,
WM_E_ACT.LOAD_TSTMP
FROM WM_E_ACT
...
EXP_EVALUATE = FIL_NO_CHANGE_REC_temp.selectExpr( \
	...
	"FIL_NO_CHANGE_REC___PROC_ZONE_LOCN_IND as PROC_ZONE_LOCN_IND", \
	"FIL_NO_CHANGE_REC___LM_MAN_EVNT_REQ_APRV1 as LM_MAN_EVNT_REQ_APRV1", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_NO_CHANGE_REC___LM_MAN_EVNT_REQ_APRV1 ) ) ) , 'Y','1' , '1','1','0' ) as o_LM_MAN_EVNT_REQ_APRV", \
	"FIL_NO_CHANGE_REC___LM_KIOSK_REQ_APRV1 as LM_KIOSK_REQ_APRV1", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_NO_CHANGE_REC___LM_KIOSK_REQ_APRV1 ) ) ) , 'Y','1','0' ) as o_LM_KIOSK_REQ_APRV", \
	"FIL_NO_CHANGE_REC___WM_REQ_APRV as WM_REQ_APRV", \
	"DECODE ( LTRIM ( RTRIM ( UPPER ( FIL_NO_CHANGE_REC___WM_REQ_APRV ) ) ) , 'Y','1' , '1','1','0' ) as o_WM_REQ_APRV", \
	"FIL_NO_CHANGE_REC___VERSION_ID as VERSION_ID", \
	"FIL_NO_CHANGE_REC___LABOR_ACTIVITY_ID as LABOR_ACTIVITY_ID", \
	"FIL_NO_CHANGE_REC___VHCL_TYPE_ID as VHCL_TYPE_ID", \
	"FIL_NO_CHANGE_REC___UNQ_SEED_ID as UNQ_SEED_ID", \
...
Shortcut_to_WM_E_ACT2 = UPD_DEL.selectExpr( \
	...
	"CAST(lit(None) AS STRING) as WM_WHSE", \
	"CAST(lit(None) AS BIGINT) as WM_JOB_FUNC_ID", \
	"CAST(lit(None) AS BIGINT) as WM_LABOR_TYPE_ID", \
	"CAST(lit(None) AS BIGINT) as WM_LABOR_ACTIVITY_ID", \
	"CAST(lit(None) AS BIGINT) as WM_PROC_ZONE_LOCN_IND", \
	"CAST(lit(None) AS BIGINT) as WM_OVERRIDE_PROC_ZONE_ID", \
	"CAST(lit(None) AS BIGINT) as WM_VHCL_TYPE_ID", \
	"CAST(lit(None) AS BIGINT) as WM_UNQ_SEED_ID", \
	"CAST(lit(None) AS BIGINT) as LM_MAN_EVNT_REQ_APRV_FLAG", \
	"CAST(lit(None) AS BIGINT) as LM_KIOSK_REQ_APRV_FLAG", \
	"CAST(lit(None) AS BIGINT) as REQ_APRV_FLAG", \
	"CAST(lit(None) AS STRING) as MONITOR_UOM", \
	"CAST(lit(None) AS STRING) as WM_DISPLAY_UOM", \
	"CAST(lit(None) AS BIGINT) as WM_THRUPUT_GOAL", \
	"CAST(lit(None) AS STRING) as MISC_TXT_1", \
	"CAST(lit(None) AS STRING) as MISC_TXT_2", \
	"CAST(lit(None) AS BIGINT) as MISC_NUM_1", \
	"CAST(lit(None) AS BIGINT) as MISC_NUM_2", \
...
Shortcut_to_WM_E_ACT1.write.saveAsTable(f'{raw}.WM_E_ACT')