ode converted on 2023-06-26 10:02:17
import os
import argparse
...
EXP_INT_CONV = SQ_Shortcut_to_WM_E_ACT_PRE_temp.selectExpr( \
	...
	"cast(SQ_Shortcut_to_WM_E_ACT_PRE___DC_NBR as int) as DC_NBR", \
...
.withColumn("FIL_NO_CHANGE_REC___v_CREATE_DATE_TIME", expr("""IF(FIL_NO_CHANGE_REC___CREATE_DATE_TIME IS NULL, date'1900-01-01', FIL_NO_CHANGE_REC___CREATE_DATE_TIME)""")) \
	...
	.withColumn("FIL_NO_CHANGE_REC___v_CREATED_DTTM", expr("""IF(FIL_NO_CHANGE_REC___CREATED_DTTM IS NULL, date'1900-01-01', FIL_NO_CHANGE_REC___CREATED_DTTM)""")) \
	.withColumn("FIL_NO_CHANGE_REC___v_LAST_UPDATED_DTTM", expr("""IF(FIL_NO_CHANGE_REC___LAST_UPDATED_DTTM IS NULL, date'1900-01-01', FIL_NO_CHANGE_REC___LAST_UPDATED_DTTM)""")) \
	...
	.withColumn("FIL_NO_CHANGE_REC___v_in_WM_CREATED_TSTMP", expr("""IF(FIL_NO_CHANGE_REC___in_WM_CREATED_TSTMP IS NULL, date'1900-01-01', FIL_NO_CHANGE_REC___in_WM_CREATED_TSTMP)""")) \
	.withColumn("FIL_NO_CHANGE_REC___v_in_WM_LAST_UPDATED_TSTMP", expr("""IF(FIL_NO_CHANGE_REC___in_WM_LAST_UPDATED_TSTMP IS NULL, date'1900-01-01', FIL_NO_CHANGE_REC___in_WM_LAST_UPDATED_TSTMP)"""))
...
EXP_EVALUATE = FIL_NO_CHANGE_REC_temp.selectExpr( \
	...
	f"IF(FIL_NO_CHANGE_REC___ACT_ID IS NOT NULL AND FIL_NO_CHANGE_REC___in_WM_ACT_ID IS NULL, 'INSERT', IF(FIL_NO_CHANGE_REC___ACT_ID IS NULL AND FIL_NO_CHANGE_REC___in_WM_ACT_ID IS NOT NULL AND ( FIL_NO_CHANGE_REC___v_in_WM_CREATED_TSTMP >= DATE_ADD('{Prev_Run_Dt}',-14) OR FIL_NO_CHANGE_REC___v_in_WM_LAST_UPDATED_TSTMP >= DATE_ADD('{Prev_Run_Dt}',-14) OR FIL_NO_CHANGE_REC___v_in_WM_CREATE_TSTMP >= DATE_ADD('{Prev_Run_Dt}',-14) OR FIL_NO_CHANGE_REC___v_in_WM_MOD_TSTMP >= DATE_ADD('{Prev_Run_Dt}',-14) ), 'DELETE', IF(FIL_NO_CHANGE_REC___ACT_ID IS NOT NULL AND FIL_NO_CHANGE_REC___in_WM_ACT_ID IS NOT NULL AND ( FIL_NO_CHANGE_REC___v_in_WM_CREATED_TSTMP <> FIL_NO_CHANGE_REC___v_CREATED_DTTM OR FIL_NO_CHANGE_REC___v_in_WM_LAST_UPDATED_TSTMP <> FIL_NO_CHANGE_REC___v_LAST_UPDATED_DTTM OR FIL_NO_CHANGE_REC___v_in_WM_CREATE_TSTMP <> FIL_NO_CHANGE_REC___v_CREATE_DATE_TIME OR FIL_NO_CHANGE_REC___v_in_WM_MOD_TSTMP <> FIL_NO_CHANGE_REC___v_MOD_DATE_TIME ), 'UPDATE', NULL))) as LOAD_FLAG" \
)
...
RTR_INS_UPD_DEL_DEL = EXP_EVALUATE.selectExpr( \
	...
	"USER_ID as USER_ID", \
	"JOB_FUNC_ID as JOB_FUNC_ID", \
	"WHSE as WHSE", \
	"LABOR_TYPE_ID as LABOR_TYPE_ID", \
	"MONITOR_UOM1 as MONITOR_UOM1", \
	"MISC_TXT_11 as MISC_TXT_11", \
	"MISC_TXT_21 as MISC_TXT_21", \
	"MISC_NUM_11 as MISC_NUM_11", \
	"MISC_NUM_21 as MISC_NUM_21", \
	"OVERRIDE_PROC_ZONE_ID as OVERRIDE_PROC_ZONE_ID", \
	"PROC_ZONE_LOCN_IND as PROC_ZONE_LOCN_IND", \
	"o_LM_MAN_EVNT_REQ_APRV as LM_MAN_EVNT_REQ_APRV1", \
	"o_LM_KIOSK_REQ_APRV as LM_KIOSK_REQ_APRV1", \
	"o_WM_REQ_APRV as WM_REQ_APRV", \
	"VERSION_ID as VERSION_ID", \
	"LABOR_ACTIVITY_ID as LABOR_ACTIVITY_ID", \
	"VHCL_TYPE_ID as VHCL_TYPE_ID", \
	"UNQ_SEED_ID as UNQ_SEED_ID", \
	"CREATED_DTTM as CREATED_DTTM", \
	"LAST_UPDATED_DTTM as LAST_UPDATED_DTTM", \
	"DISPLAY_UOM as DISPLAY_UOM", \
	"THRUPUT_GOAL as THRUPUT_GOAL", \
	"LOAD_TSTMP2 as LOAD_TSTMP2", \
	...
	"in_WM_JOB_FUNC_ID as in_WM_JOB_FUNC_ID", \
	"in_WM_WHSE as in_WM_WHSE", \
	"in_WM_LABOR_TYPE_ID as in_WM_LABOR_TYPE_ID", \
	"in_MONITOR_UOM as in_MONITOR_UOM", \
	"in_MISC_TXT_1 as in_MISC_TXT_1", \
	"in_MISC_TXT_2 as in_MISC_TXT_2", \
	"in_MISC_NUM_1 as in_MISC_NUM_1", \
	"in_MISC_NUM_2 as in_MISC_NUM_2", \
	"in_WM_OVERRIDE_PROC_ZONE_ID as in_WM_OVERRIDE_PROC_ZONE_ID", \
	"in_WM_PROC_ZONE_LOCN_IND as in_WM_PROC_ZONE_LOCN_IND", \
	"in_LM_MAN_EVNT_REQ_APRV as in_LM_MAN_EVNT_REQ_APRV", \
	"in_LM_KIOSK_REQ_APRV as in_LM_KIOSK_REQ_APRV", \
	"in_REQ_APRV as in_REQ_APRV", \
	"in_WM_VERSION_ID as in_WM_VERSION_ID", \
	"in_WM_LABOR_ACTIVITY_ID as in_WM_LABOR_ACTIVITY_ID", \
	"in_WM_VHCL_TYPE_ID as in_WM_VHCL_TYPE_ID", \
	"in_WM_UNQ_SEED_ID as in_WM_UNQ_SEED_ID", \
	"in_WM_CREATED_TSTMP as in_WM_CREATED_TSTMP", \
	"in_WM_LAST_UPDATED_TSTMP as in_WM_LAST_UPDATED_TSTMP", \
	"in_WM_DISPLAY_UOM as in_WM_DISPLAY_UOM", \
	"in_WM_THRUPUT_GOAL as in_WM_THRUPUT_GOAL", \
...
Shortcut_to_WM_E_ACT2.createOrReplaceTempView('WM_E_ACT_DEL')

spark.sql(f"""
          MERGE INTO {refined_perf_table} trg
          USING WM_E_ACT_DEL src
          ON (src.LOCATION_ID = trg.LOCATION_ID AND src.WM_ACT_ID = trg.WM_ACT_ID )
...
Shortcut_to_WM_E_ACT1 = UPD_INS_UPD.selectExpr(
	...
	"CAST(LABOR_ACTIVITY_ID1 AS INT) as WM_LABOR_ACTIVITY_ID",
	"CAST(PROC_ZONE_LOCN_IND1 AS INT) as WM_PROC_ZONE_LOCN_IND",
	"CAST(OVERRIDE_PROC_ZONE_ID1 AS INT) as WM_OVERRIDE_PROC_ZONE_ID",
	"CAST(VHCL_TYPE_ID1 AS INT) as WM_VHCL_TYPE_ID",
	"CAST(UNQ_SEED_ID1 AS INT) as WM_UNQ_SEED_ID",
	"CAST(LM_MAN_EVNT_REQ_APRV11 AS TINYINT) as LM_MAN_EVNT_REQ_APRV_FLAG",
	"CAST(LM_KIOSK_REQ_APRV11 AS TINYINT) as LM_KIOSK_REQ_APRV_FLAG",
	"CAST(WM_REQ_APRV1 AS TINYINT) as REQ_APRV_FLAG",
	"CAST(MONITOR_UOM11 AS STRING) as MONITOR_UOM",
	"CAST(DISPLAY_UOM1 AS STRING) as WM_DISPLAY_UOM",
	"CAST(THRUPUT_GOAL1 AS DECIMAL(20,7)) as WM_THRUPUT_GOAL",
	"CAST(MISC_TXT_111 AS STRING) as MISC_TXT_1",
	"CAST(MISC_TXT_211 AS STRING) as MISC_TXT_2",
	"CAST(MISC_NUM_111 AS DECIMAL(20,7)) as MISC_NUM_1",
	"CAST(MISC_NUM_211 AS DECIMAL(20,7)) as MISC_NUM_2",
