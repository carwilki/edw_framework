...
Shortcut_to_WM_TRAILER_REF = UPD_INS_UPD.selectExpr(
	...
	"CAST(TRAILER_STATUS AS SMALLINT) as WM_TRAILER_STATUS",
	...
	"CAST(TRAILER_LOCATION_STATUS AS SMALLINT) as WM_TRAILER_LOCATION_STATUS",
	"CAST(ACTIVE_VISIT_ID AS INT) as WM_ACTIVE_VISIT_ID",
	"CAST(ACTIVE_VISIT_DETAIL_ID AS INT) as WM_ACTIVE_VISIT_DETAIL_ID",
	"CAST(PROTECTION_LEVEL AS INT) as WM_PROTECTION_LEVEL",
	"CAST(PRODUCT_CLASS AS INT) as WM_PRODUCT_CLASS",
	"CAST(CONVEYABLE AS TINYINT) as CONVEYABLE_FLAG",
