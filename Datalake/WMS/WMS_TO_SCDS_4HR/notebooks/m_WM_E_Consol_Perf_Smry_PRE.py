...
def perf_smry(dcnbr, env):
    ...
    FROM WMSMIS.E_CONSOL_PERF_SMRY
    WHERE 
    ...
    Shortcut_to_WM_E_CONSOL_PERF_SMRY_PRE = SQ_Shortcut_to_E_CONSOL_PERF_SMRY.select(
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.JOB_FUNCTION_NAME.cast(StringType()).alias(
            "JOB_FUNCTION_NAME"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.CLOCK_IN_STATUS.cast(DecimalType(3, 0)).alias(
            "CLOCK_IN_STATUS"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.TOTAL_SAM.cast(DecimalType(20, 7)).alias(
            "TOTAL_SAM"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.TOTAL_PAM.cast(DecimalType(13, 5)).alias(
            "TOTAL_PAM"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.TOTAL_TIME.cast(DecimalType(13, 5)).alias(
            "TOTAL_TIME"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.ADJ_OSDL.cast(DecimalType(13, 5)).alias(
            "ADJ_OSDL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.ADJ_OSIL.cast(DecimalType(13, 5)).alias(
            "ADJ_OSIL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.ADJ_UDIL.cast(DecimalType(13, 5)).alias(
            "ADJ_UDIL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.ADJ_NSDL.cast(DecimalType(13, 5)).alias(
            "ADJ_NSDL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.PAID_BRK.cast(DecimalType(13, 5)).alias(
            "PAID_BRK"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.UNPAID_BRK.cast(DecimalType(13, 5)).alias(
            "UNPAID_BRK"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_OSDL.cast(DecimalType(13, 5)).alias(
            "REF_OSDL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_OSIL.cast(DecimalType(13, 5)).alias(
            "REF_OSIL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_UDIL.cast(DecimalType(13, 5)).alias(
            "REF_UDIL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_NSDL.cast(DecimalType(13, 5)).alias(
            "REF_NSDL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_ADJ_OSDL.cast(DecimalType(13, 5)).alias(
            "REF_ADJ_OSDL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_ADJ_OSIL.cast(DecimalType(13, 5)).alias(
            "REF_ADJ_OSIL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_ADJ_UDIL.cast(DecimalType(13, 5)).alias(
            "REF_ADJ_UDIL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REF_ADJ_NSDL.cast(DecimalType(13, 5)).alias(
            "REF_ADJ_NSDL"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.MISC_NUMBER_1.cast(DecimalType(13, 5)).alias(
            "MISC_NUMBER_1"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.CREATE_DATE_TIME.cast(TimestampType()).alias(
            "CREATE_DATE_TIME"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.MOD_DATE_TIME.cast(TimestampType()).alias(
            "MOD_DATE_TIME"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.START_DATE_TIME.cast(TimestampType()).alias(
            "START_DATE_TIME"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.END_DATE_TIME.cast(TimestampType()).alias(
            "END_DATE_TIME"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.WHSE_DATE.cast(TimestampType()).alias(
            "WHSE_DATE"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.MISC_NUM_2.cast(DecimalType(20, 7)).alias(
            "MISC_NUM_2"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.EVNT_CTGRY_1.cast(StringType()).alias(
            "EVNT_CTGRY_1"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.EVNT_CTGRY_2.cast(StringType()).alias(
            "EVNT_CTGRY_2"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.EVNT_CTGRY_3.cast(StringType()).alias(
            "EVNT_CTGRY_3"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.EVNT_CTGRY_4.cast(StringType()).alias(
            "EVNT_CTGRY_4"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.TEAM_BEGIN_TIME.cast(TimestampType()).alias(
            "TEAM_BEGIN_TIME"
        ),
        ...
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.LOCN_GRP_ATTR.cast(StringType()).alias(
            "LOCN_GRP_ATTR"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.RESOURCE_GROUP_ID.cast(StringType()).alias(
            "RESOURCE_GROUP_ID"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.COMP_ASSIGNMENT_ID.cast(StringType()).alias(
            "COMP_ASSIGNMENT_ID"
        ),
        SQ_Shortcut_to_E_CONSOL_PERF_SMRY.REFLECTIVE_CODE.cast(StringType()).alias(
            "REFLECTIVE_CODE"
        ),
